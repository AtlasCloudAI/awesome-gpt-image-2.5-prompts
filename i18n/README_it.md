...
### No. 3: Ritratto di una Donna Spagnola Minuta Accanto alla Piscina
...
Un ritratto di bellezza verticale raffinato di una donna spagnola minuta seduta accanto a una piscina interna verde menta.
...
### No. 42: Articolo in Manga a Quattro Pannelli in Stile Afternoon
...
Una richiesta per generare un fumetto di quattro pagine nello stile della rivista giapponese Afternoon, basato su un articolo allegato.
...
### No. 43: Scheda Personaggio Cinematografica Premium
...
Una richiesta per creare una scheda di riferimento personaggio a schermo diviso utilizzando linee guida visive rigorose.
...
### No. 44: Sprite Sheet di Combattimento in Pixel Art
...
Una richiesta per generare una sprite sheet semplificata di animazione di combattimento in pixel art da 128px, con sfondo trasparente.
...
### No. 45: Sprite Sheet Pixel Art per Movimenti di Battaglia del Personaggio
...
Una richiesta per generare una sprite sheet in pixel art di 16 fotogrammi per i movimenti di battaglia di un personaggio.
...
### No. 46: Sprite Sheet Pixel Art per Battaglie di Personaggi
...
Una richiesta per creare uno sprite sheet in pixel art semplificato da 128px con 16 frame, che rappresenti le mosse di combattimento di un personaggio, inclusi stati di inattività, fendente, guardia e atterramento.
...
### No. 47: Ritratto Fotorealistico con Riferimento all'Identità
...
Una richiesta per creare un ritratto fotorealistico a figura intera, utilizzando una foto di riferimento per preservare l'identità del soggetto.
...
### No. 48: Scheda Personaggio 'Bibbia' per Marty & Doc
...
Una richiesta per generare una scheda di riferimento personaggio a schermo diviso per due personaggi, utilizzando linee guida visive rigorose.
...
### No. 49: Scheda Personaggio Bibbia per Ted & John
...
Un prompt per generare una scheda personaggio a schermo diviso utilizzando riferimenti visivi rigorosi per due personaggi.
...
### No. 50: Bibbia del Personaggio a Schermo Diviso per Dom & Brian
...
Un prompt per generare una scheda personaggio a schermo diviso utilizzando riferimenti caricati per due personaggi.
...
### No. 51: Scheda Personaggio Cinematografica per Baby
...
Un prompt per generare una scheda personaggio premium per il personaggio Baby, con tipografia audace e rigorosa aderenza ai riferimenti visivi.
...
### No. 52: Bibbia del Personaggio Cinematografica per Schmidt & Jenko
...
### No. 53: Bibbia del Personaggio Cinematografica per Gordon
...
Un prompt per creare una scheda personaggio premium con tipografia audace e rigorosi riferimenti visivi.
...
### No. 54: Scheda Personaggio Bibbia per Johnny & Tucker
...
Un prompt per generare una scheda di riferimento per personaggi a schermo diviso utilizzando linee guida visive rigorose.
...
### No. 55: Scheda Personaggio Bibbia per Neo & Trinity
...
Un prompt per generare una scheda di riferimento per personaggi a schermo diviso per Neo e Trinity utilizzando linee guida visive rigorose.
...
### No. 56: Bibbia del Personaggio Kevin contro i Banditi Bagnati
...
Un prompt per generare una scheda personaggio premium per Kevin contro i Banditi Bagnati utilizzando rigorosi riferimenti visivi.
...
### No. 57: Scatto di Moda Editoriale su Scale del Tetto Notturno
...
Un prompt per una foto iperrealistica di uno scatto di moda editoriale su scale di un tetto notturno, con una sensazione cinematografica fresca.
...
### No. 58: Scheda Personaggio Bibbia per Riggs & Murtaugh
...
Un prompt per generare una scheda di riferimento per personaggi a schermo diviso per due personaggi utilizzando linee guida visive rigorose.
...
### No. 59: Scheda Personaggio Cinematografico Premium per Mike e Marcus
...
Un prompt per generare una scheda di riferimento personaggio a schermo diviso utilizzando linee guida visive rigorose.
...
### No. 60: Scheda Personaggio Cinematografico Premium per Lee e Carter
...
Un prompt per creare una scheda di riferimento personaggio a schermo diviso utilizzando guide visive rigorose.
...
### No. 61: Figura Realistica in Scala 1/7 sulla Scrivania
...
Una prompt per generare un'immagine di una figura realistica di un personaggio in scala 1/7 su una scrivania per computer, con base trasparente.
...
### No. 62: Riferimento all'Identità Facciale Attraverso la Composizione
...
Una prompt di IA per generare una singola foto che presenta sette versioni dello stesso uomo adulto utilizzando un riferimento all'identità facciale.
...
### No. 63: Ritratto di Moda Utilizzando un Riferimento all'Identità Facciale
...
Una prompt per generare un ritratto di moda premium a figura intera, utilizzando una foto come riferimento all'identità facciale.
...
### No. 64: Ritratto Cinematografico Onirico da Riferimento
...
Una richiesta per creare un ritratto cinematografico realistico e onirico preservando l'identità del soggetto e le sue caratteristiche naturali.
...
### No. 65: Ritratto in Claymation 3D da Foto
...
Una richiesta per generare un ritratto dettagliato e carino in claymation 3D che mantenga l'identità e la somiglianza del soggetto da una foto caricata dall'utente.
...
### No. 66: Poster Artistico Editoriale per una Località
...
Una richiesta per creare un poster editoriale verticale ad alta risoluzione in uno stile giocoso da rivista di design giapponese.
...
### No. 67: Scena Animata da Due Immagini di Riferimento
...
Un prompt per creare una scena animata di un bambino piccolo che gioca in una camera da letto accogliente.
...
### No. 68: Ritratto Anni '80 da Riferimento Facciale
...
Un prompt per generare un ritratto in stile retrò-vintage degli anni '80, preservando esattamente i tratti facciali e l'identità del soggetto.
...
### No. 69: Scheda di Riferimento per il Design di un Personaggio
...
Un prompt per generare una scheda modello professionale per un personaggio basata su un'immagine di riferimento fornita.
...
### No. 70: Trasferimento di Stile su un Motociclista
...
Un nuovo soggetto reso nello stile visivo esatto portato dall'immagine di input.
...
### No. 71: Scambio di Abbigliamento che Preserva l'Identità
...
Indumenti da immagini di riferimento adattati al soggetto, lasciando inalterati volto, posa e illuminazione.
...
### No. 72: Cane Inserito in una Scena Ritrattistica
...
Un soggetto tratto da un riferimento e collocato in un altro, con luce e sfondo adattati.
...
### No. 73: Schizzo Trasformato in una Valle Fotorealistica
...
Un disegno reso in modo fotorealistico preservandone il layout, le proporzioni e la prospettiva.
...
### No. 74: Persona Inserita in una Scena di Attacco di Orso
...
Una scena d'azione simile a una fotografia, costruita attorno a una persona fornita, volutamente non cinematografica.
...
### No. 75: Personaggio Coerente per Libri per Bambini
...
Un eroe da libro illustrato ad acquerello, specificato in modo sufficientemente dettagliato da rimanere lo stesso in tutte le illustrazioni.
...
### No. 76: Ritratto Candido nella Metropolitana di NYC
...
Una richiesta per una foto di vita quotidiana in stile candido di una donna con lineamenti morbidi e capelli scuri spettinati nella metropolitana di New York.
...
### No. 77: Scheda di Riferimento per Personaggio Cinematografico a Pannelli Multipli
...
Una richiesta per generare una scheda di riferimento del personaggio che mostra la stessa donna reale in vista frontale, 3/4, di profilo e posteriore.
...
### No. 78: Opera d'Arta a Vignetta Minimal in Acquerello Basata su Foto
...
Una richiesta per trasformare una fotografia caricata in un'opera d'arte raffinata che combina realismo fotografico con uno stile minimal a vignetta in acquerello.
...
### No. 11: Sprite Sheet in Pixel Art per Personaggio
...
Una richiesta per creare una sprite sheet semplificata in pixel art da 128px per le mosse di battaglia di un personaggio, disposta in una griglia 4x4 con sfondo trasparente.
...
### No. 12: Trasforma Sole e Nuvole in un Fiore di Loto
...
Una prompt per migliorare una foto di nuvole e sole in modo che il sole assomigli al centro di un fiore e le nuvole a un loto, senza alterare l'immagine originale.
...
### No. 13: Infografica Tradotta in Spagnolo
...
Una modifica che cambia solo la lingua del testo e lascia inalterato ogni altro pixel del layout.
...
### No. 14: Ritaglio di Prodotto su Sfondo Trasparente
...
Un'immagine di prodotto isolata su un canale alfa pulito, con silhouette nitida, nessun alone e leggibilità dell'etichetta intatta.
...
### No. 15: Rimozione di un Oggetto da un Ritratto
...
Una modifica in una sola riga che rimuove un singolo oggetto e non cambia nient'altro.
...
### No. 16: Cartellone Rivisitato come una Sera d'Inverno
...
Una modifica di follow-up di cinque parole che cambia stagione e ora del giorno su un mockup esistente.
...
### No. 17: Sedie della Cucina Sostituite con Modelli in Legno
...
Una modifica di una stanza che sostituisce solo le sedie, mantenendo l'angolazione, l'illuminazione e le ombre sul pavimento.
...
### No. 6: Screenshot Realistico di un RPG Romantico di Nuova Generazione
...
Un prompt per generare uno screenshot realistico da un immaginario RPG romantico open-world 3D di nuova generazione, dalla prospettiva del protagonista.
...
### No. 7: Diorama in Miniatura Premium di un Monumento
...
Un prompt per generare un diorama 3D carino ed elegante di una struttura famosa, con tonalità pastello tenui e dettagli artigianali.
...
### No. 8: Arte Botanica Verticale in Carta di Donna Slanciata
...
Un'opera d'arte botanica verticale in carta che raffigura una donna slanciata di profilo, con un abito di foglie e un ombrellino color avorio.
...
### No. 9: Kit di Modellismo Fotorealistico di Paladino Bianco e Oro
...
Un prompt per generare un'immagine fotorealistica di un robot paladino bianco e oro come kit di modellismo, esposto in un negozio di elettronica con molte scatole uniformi.
...
### No. 41: Scena di Strada Piovosa Dopo la Chiusura
...
### No. 42: Editoriale di Moda con Vento e Seta
...
### No. 43: Foto Realistica da iPhone della Tesla Model Y
...
### No. 44: Città Eco-Futuristica al Crepuscolo con Luna
...
### No. 45: Grande Esercito con Drago nella Pioggia
...
### No. 46: Coniglio Nano Olandese Grigio che Salta
...
### No. 47: Coppia Anime nel Parco ad Alto Dettaglio
...
### No. 48: Il Sogno della Camera Rossa su Rotolo Lungo
...
### No. 49: Serie Architettonica Brutalista nel Deserto
...
### No. 50: Fotografia di Passeggiata in Strada all'Ora d'Oro
...
### No. 51: Collezione di Poster di Viaggio di Lusso
...
### No. 52: Ritratto Candidato in Parco Urbano
...
### No. 53: Scheda di Riferimento per Personaggio Assassino del Deserto
...
### No. 54: Foto di Moda di Donna dell'Asia Orientale in Lounge
...
### No. 55: Opera d'Arte di Francobollo Postale Viaggi Vintage
...
### No. 56: Poster di Viaggio Vintage di Struttura Iconica
...
### No. 57: Ritratto di Moda Candidato in Autorimessa
...
### No. 58: Scena Miniaturizzata di Cibo Artigianale
...
### No. 59: Diorama Miniaturizzato di Fronte Negozio
...
### No. 60: Diorama Miniaturizzato di Struttura Iconica
...
### No. 61: Ritratto in Studio Asimmetrico di Alta Moda
...
### No. 62: Paesaggio di Labirinto Bianco Scolpito dal Vento
...
### No. 63: Il Cavaliere del Drago Bianco e la Piccola Pietra
...
### No. 64: Ritratto Editoriale di Uomo Sicuro di Sé
...
### No. 65: Ritratto di Moda in Studio a Corpo Intero
...
### No. 66: Capolavoro per Campagna di Viaggio di Lusso
...
### No. 67: Routine Mattutina del Maestro Mago Blu
...
### No. 68: Nave in Arrivo alla Costa di Gesso Bianco
...
### No. 69: Ritratto del Personaggio Pescatore Elfo del Mare
...
### No. 70: Ritratto Professionale in Studio
...
### No. 71: Uomo Sicuro di Sé in Interno Moderno e Lussuoso
...
### No. 72: Fantasy: Lanciere Addormentato alla Scrivania
...
### No. 73: Cavaliere del Drago in Riposo all'Ombra
...
### No. 74: Uomo Elegante in una Libreria Accogliente alla Sera
...
### No. 75: Postino Dullahan in una Notte d'Autunno
...
### No. 76: Ritratto Editoriale a Corpo Intero in Borgogna
...
### No. 77: Pomeriggio della Maestra Mago Blu
...
### No. 78: Tramonto su Terra Spaccata con Fiamme
...
### No. 79: Vascello a Vela Antico al Tramonto Dorato
...
### No. 80: Cavaliere del Drago Bianco Controlla la Ferita all'Ala
...
### No. 81: Viaggiatore Rammenda un Drappo Blu in una Città Vulcanica
...
### No. 82: Mattina in un Mondo Specchio con un Lanciere
...
### No. 83: La Maestra Mago Blu Luna Prima dell'Alba
...
### No. 84: Paesaggio Dove il Fuoco Sfugge dalla Terra
...
### No. 85: Cavaliere del Drago Nero Luna di Notte
...
### No. 86: Frieren e Fern in un Posto Sereno
...
### No. 87: Colline Scolpite dal Vento e dalla Pioggia
...
### No. 88: Antica Signora con Ventaglio Davanti al Bambù
...
### No. 89: Robot della Polizia che Trainano una Scialuppa di Salvataggio
...
### No. 90: Foto CCD Diurna di un Osservatorio Urbano
...
### No. 91: Ritratto di Vita Verticale in Stile iPhone
...
### No. 92: Poster in Stile Cinese Nuovo con Finestra Fiorita
...
### No. 93: Ritratto Editoriale Fotorealistico di una Donna dell'Asia Orientale
...
### No. 94: Robot dell'Unità Macchinari Pesanti della Polizia che Puliscono il Fiume
...
### No. 95: Ritratto Editoriale Fotorealistico con Viso a Forma di Cuore-Ovale
...
### No. 96: Ritratto iPhone di una Giovane Donna
...
### No. 97: Donna Zen Vicino all'Acqua in Estate
...
### No. 98: Ritratto a Mezza Figura di una Donna dell'Asia Orientale
...
### No. 99: Scatto di Moda in un Caffè-Libreria sul Tetto Urbano
...
### No. 100: Ritratto Editoriale Fotorealistico di una Donna dell'Asia Orientale
...
### No. 101: Poster di Copertina Minimalista Zen Orientale
...
### No. 102: Squadra Robotica dell'Unità Macchinari Pesanti della Polizia
...
### No. 103: Foto di Vita Sportiva Urbana di Giorno, Luminosa in Stile CCD
...
### No. 104: Copertina Verticale Poster Minimalista Zen
...
### No. 105: Donna Seduta Accanto a una Finestra Rotonda
...
### No. 106: Squadra Robotica della Polizia che Ferma un Camion in Fuga
...
### No. 107: Ritratto Editoriale a Corpo Intero di Giovane Donna
...
### No. 108: Ritratto Fotorealistico fino alla Vita con Occhiali
...
### No. 109: Copertina Poster Minimalista Zen con Donna e Cicalino da Vento
...
### No. 110: Città Post-Apocalittica con Vegetazione Verde
...
### No. 111: Donna Giapponese con Viso da Tanuki di Notte
...
### No. 112: Vista del Delfino su Donne in Acquario di Vetro
...
### No. 113: Scena Miniaturizzata in Argilla Polimerica di Negozio di Marca
...
### No. 114: Annuncio di Moda con Ripresa a Terra Inclinata
...
### No. 115: Duello Anime Disegnato a Mano con Ciliegi in Fiore
...
### No. 116: Abito da Sposa Gotico Nero da Sposa Infestata
...
### No. 117: Ritratto Cinematografico Malinconico di Donna dell'Asia Orientale
...
### No. 118: Ritratto Cinematografico Notturno su Attraversamento Pedonale Bagnato
...
### No. 119: Ritratto Ravvicinato con Occhi Dorati Luminosi
...
### No. 120: Ritratto Fotorealistico con Occhiali e Occhiolino
...
### No. 121: Ritratto in Stile Pellicola Analogica con Capelli Scomposti
...
### No. 122: Ritratto Cinematografico che Galleggia in Acque Scure
...
### No. 123: Ritratto di Bellezza in Studio con Treccia Laterale
...
### No. 124: Ritratto di Donna in Auto con Hijab
...
### No. 125: Donna che si Scatta un Selfie con l'Hijab
...
### No. 126: Ritratto di Donna che Guarda oltre la Spalla
...
### No. 127: Ritratto di Donna con Occhiali
...
### No. 128: Ritratto Ravvicinato con Rossetto Vivido
...
### No. 129: Ritratto con Capelli Bagnati e Spalla Scoperta
...
### No. 130: Ritratto Cinematografico di Donna dell'Asia Orientale
...
### No. 131: Ritratto Fotorealistico con Occhiali
...
### No. 132: Ritratto Cinematografico con Riflessi Miele
...
### No. 133: Ritratto Fotorealistico con Taglio alla Paggetto
...
### No. 134: Ritratto di Donna in Hijab e Cappellino
...
### No. 135: Selfie Ritratto in Hijab di Chiffon
...
### No. 136: Ritratto Cinematografico di Donna dell'Asia Orientale in Lacrime
...
### No. 137: Ritratto di Donna con Benda Oculare in Pizzo Ingioiellata
...
### No. 138: Intenso Ritratto Cinematografico con Capelli Spettinati
...
### No. 139: Ritratto Ravvicinato con Capelli Scuri Lucidi
...
### No. 140: Ritratto Sorridente Abbronzato con Lucidità di Sudore
...
### No. 141: Ritratto Espressivo con Eyeliner ad Ala
...
### No. 142: Selfie Ritratto con Espressione di Bacio
...
### No. 143: Ritratto di Giovane Donna Sorridente
...
### No. 144: Selfie di Donna con Capelli Mezza Acconciatura
...
### No. 145: Fasi della Terra Inghiottita da un Buco Nero
...
### No. 146: Personaggi: Guerriero Cyberpunk contro Boss Meccanico
...
### No. 147: Dea Celeste che Discende Davanti al Palazzo
...
### No. 148: Fanciulla Celeste in Vista Tre Quarti Illuminata dal Sole
...
### No. 149: Fanciulla Celeste Seduta Accanto alla Piscina di Giada
...
### No. 150: Dea Celeste sui Gradini del Palazzo di Giada
...
### No. 151: Ritratto in Antico Santuario Rituale Cinese
...
### No. 152: Ritratto di Donna in Oscuro Santuario Rituale
...
### No. 153: Primo Piano Ritratto durante il Festival Nuo Notturno
...
### No. 154: Birra con Corona di Schiuma Densa
...
### No. 155: Cubo di Tofu Sollevato dallo Stufato
...
### No. 156: Cucchiaio di Condimento al Peperoncino
...
### No. 157: Primo Piano Ritratto di Donna in Soggiorno
...
### No. 158: Ritratto di Donna Sdraiata in Camera da Letto in Penombra
...
### No. 159: Ritratto Onirico di Donna nell'Erba Estiva
...
### No. 160: Ritratto di Donna presso un Porto Blu Brillante
...
### No. 161: Ritratto di Strada a Parigi di Giovane Donna
...
### No. 162: Ritratto Spontaneo in Metropolitana di Notte
...
### No. 163: Orologio con Onda d'Urto di Ghiaccio e Fumo
...
### No. 164: Distribuzione a Strati di Pasticceria con Profondità
...
### No. 165: Ritratto in Camera da Letto con Luce Soffusa in Abito Sottoveste
...
### No. 166: Auto con Contrasto di Pennacchio di Polvere Esplosiva
...
### No. 167: Silhouette di Strega Controluce da Fuoco Celeste
...
### No. 168: Cuore di Salsa di Pomodoro che Sorge da una Ciotola di Koshari
...
### No. 169: Pezzi degli Scacchi Scolpiti da Filamenti di Pasta
...
### No. 170: Bottiglia di Olio di Sesamo con Braccia da Pugile sul Ring
...
### No. 171: Scena del Piano Cucina di un Appartamento Moderno Compatto
...
### No. 172: Involtino di Shawarma Inclinato verso l'Alto come un Razzo
...
### No. 173: Mascotte Banana che Tiene una Lattina Sovradimensionata
...
### No. 174: Foto Candid Notturna di Donna dell'Asia Orientale
...
### No. 175: Crema del Biscotto come Minuscola Superficie di Pattinaggio
...
### No. 176: Binario delle Montagne Russe Fatto di Patatine Impilate
...
### No. 177: Zone di Riflettore Rosso Dietro il Secchio Eroe
...
### No. 178: Flusso di Pasta Lucida come Linea di Movimento Verticale
...
### No. 179: Animazione Cinematografica 2.5D a Guazzo
...
### No. 180: Ritratto Cinematografico Malinconico nell'Oscurità
...
### No. 181: Uomo Gigante Accanto alla Statua della Libertà
...
### No. 182: Ritratto all'Ora d'Oro su Portico Rustico
...
### No. 183: Ritratto Cinematografico in un Prato
...
### No. 184: Ritratto Candidato Verticale di Donna
...
### No. 185: Barretta Diagonale con Zona Gusto Strappata
...
### No. 186: Ritratto Femminile in Specchio Ovale
...
### No. 187: Vortice di Bicchiere da Birra nel Deserto
...
### No. 188: Bottiglia di Birra in Primo Piano
...
### No. 189: Dipinto di Mondrian come Mobile da Scrivania
...
Una richiesta per trasformare 'Composizione con Rosso, Blu e Giallo' di Mondrian in un mobile da scrivania funzionale con cassetti colorati.
...
### No. 190: Immagine Realistica di una Cosa Surreale
...
Una richiesta per generare un'immagine altamente realistica di un soggetto surreale immaginato.
...
### No. 191: Umanità Minuscola in un Mondo di Mandarino
...
Un'immagine di esseri umani minuscoli che vivono all'interno di un mandarino, con gli spicchi di frutta che formano l'architettura.
...
### No. 192: Figura Minacciosa di Profilo Netto
...
Una richiesta per generare un'immagine di una figura minacciosa con capelli corvini e labbra rosso sangue, di profilo netto.
...
### No. 193: Pubblicità per App di Incontri Fittizia
...
Una richiesta per generare una pubblicità per un'app di incontri che presenti modelli giovani Kalenjin.
...
### No. 194: Ritratto Rooftop con Radio Prima dell'Alba
...
Una richiesta per generare un ritratto di un volto segnato dal tempo su un tetto, con una radio, prima dell'alba.
...
### No. 195: Tunnel Vuoto di Fushimi Inari all'Alba
...
Una richiesta per generare una scena serena e mattutina delle iconiche porte vermiglioni del santuario Fushimi Inari di Kyoto, in stile immagine per una campagna di viaggio.
...
### No. 196: Mondo Interiore Basato sulle Preferenze di Arte AI
...
Una richiesta per un'illustrazione che rifletta il mondo interiore dell'utente, basata sulle sue precedenti preferenze in materia di arte generata dall'intelligenza artificiale.
...
### No. 197: Scatto Macro di un Processore Futuristico a Forma di Città
...
Una richiesta per uno scatto macro di un processore trasparente, grande quanto una stanza, che contiene al suo interno una città luminosa.
...
### No. 198: Autoritratto Simbolico di Linguaggio e Codice
...
Un'immagine che raffigura un autoritratto simbolico in cui linguaggio, codice e creatività sono interconnessi dalla luce.
...
### No. 199: Mondo Alieno con Retro-Futurismo Mediterraneo
...
Una richiesta per generare un'immagine di un insediamento umano su un mondo alieno, caratterizzato da un'architettura d'ispirazione mediterranea con elementi retro-futuristi.
...
### No. 200: Ritratto della Tsaritsa Anastasya, Arconte Cryo
...
Una richiesta per generare un ritratto della Tsaritsa, un'Arconte Cryo e sovrana, descritta con vari titoli regali e malinconici.
...
### No. 201: Fermata dell'Autobus nella Nebbia Mattutina
...
Un'immagine poetica di una fermata dell'autobus nella nebbia del mattino, dove il vapore sale prima che arrivi qualcuno, e il primo treno è un pensiero al suo interno.
...
### No. 202: Notte in Lavanderia con Meduse e Previsioni Cosmiche
...
Una scena che raffigura una lavanderia notturna con meduse all'esterno, dove una ragazza controlla un bollettino meteorologico cosmico.
...
### No. 203: Ritratto di Guerriera Wuxia
...
Una richiesta per generare un ritratto in formato 9:16 di una guerriera dell'Asia orientale, alta ed elegante, con armatura a strati e vesti, che impugna una spada lunga.
...
### No. 204: Foto Retro da Telefono Rurale di una Donna
...
Un prompt per un'immagine in formato 9:16 che raffigura una giovane donna dell'Asia orientale in un ambiente rurale, catturata con un'estetica da telefono retro.
...
### No. 205: Due Donne in Qipao in un Giardino Cinese
...
Un prompt per generare una foto iperrealistica di due giovani donne dell'Asia orientale in nuovi qipao di stile cinese, sedute in un sereno giardino tradizionale.
...
### No. 206: Selfie di una Ballerina in Tonalità Grigie
...
Un prompt per un selfie verticale realistico e ravvicinato in formato 9:16 di una giovane ballerina dell'Asia orientale, in uno stile di vita grigio di alto livello, fresco e onirico.
...
### No. 207: Fotografia Editoriale del Palco di un Concerto K-Pop
...
Un prompt per una foto cinematografica in stile editoriale di un'idol femminile K-pop ventenne a un concerto.
...
### No. 208: Elegante Donna dell'Asia Orientale su Balcone in Pietra
...
Un prompt per una foto di moda verticale 9:16 di una bellissima donna adulta dell'Asia orientale appoggiata a una ringhiera classica in pietra.
...
### No. 209: Paesaggio Pittorico con Drammatici Cumuli
...
Un prompt per generare un dettagliato paesaggio romantico di belle arti, focalizzato su un cielo luminoso e nuvole torreggianti.
...
### No. 210: Link Inseguito da Polli Burattino
...
Un'immagine di Link inseguito da uno stormo arrabbiato di morbidi polli burattino attraverso il Villaggio di Kakariko.
...
### No. 211: Terasse di Riso di Bali all'Alba
...
Un prompt per un'immagine di una scena serena e nebbiosa del mattino delle terrazze di riso di Bali, in stile campagna di viaggio.
...
### No. 212: Prince of Persia che Salta in Pixel Art
...
Un prompt per generare un'immagine nello stile del Monumentalismo a Retino Cobalto, che raffigura il personaggio originale di Prince of Persia mentre salta tra piattaforme.
...
### No. 213: Gentile Shinigami che Guida le Anime
...
Un prompt poetico che descrive una ragazza, un messaggero della morte, in piedi al confine tra vita e morte in una fredda nebbia notturna, che offre una mano come guida per un addio silenzioso.
...
### No. 214: Talismani d'Oro nella Notte Oscura
...
Una scena di notte che sprofonda nel nero, dove solo l'oro illumina una presenza talismanica, con le parole 'Passeggiata Notturna' e 'Sopprimi il Male'.
...
### No. 215: Il Sogno della Sposa al Confine
...
Un prompt poetico che descrive una ragazza non umana al confine tra vita e morte che sogna di diventare una sposa e vede il proprio riflesso.
...
### No. 216: Yokai che Legge in una Stanza Piovosa
...
Una scena di un essere temuto, Fufu, che legge un libro in una vecchia stanza in una giornata piovosa, con un piccolo uccello che vi si è intrufolato.
...
### No. 217: Sprite Sheet in Pixel Art del Personaggio Volpe
...
Una prompt per generare una sprite sheet di animazione in pixel art rifinita di un personaggio di nome Noxa, una piccola volpe che raccoglie stelle.
...
### No. 218: Infografica Concettuale del Telefono Piehevole Apple
...
Una prompt per generare un'infografica fotorealistica di un telefono pieghevole Apple, nello stile pulito e distintivo del marchio.
...
### No. 219: Ritratto di Bellezza Ravvicinato di Giovane Donna dell'Asia Orientale
...
Un ritratto fotorealistico ravvicinato di una giovane donna dell'Asia orientale con illuminazione soffice e texture della pelle dettagliata.
...
### No. 220: Donna Asiatica al Tramonto su Strada Costiera
...
Una foto candidata fotorealistica di una giovane donna asiatica accanto a una strada costiera al tramonto, vista dall'interno di un'auto.
...
### No. 221: Macro a Livello dell'Acqua dell'Isola-Foglia di Loto
...
Una richiesta per uno scatto macro cinematografico dal livello dell'acqua, che raffigura una foglia di lotto come un'isola abitata da tre minuscole figure in Hanfu.
...
### No. 222: Artiglio Gigante a Tre Punte con Filo da Katana
...
Una richiesta per un'arma gigante a due mani con tre punte, le cui lame sono affilate e lucidate come una spada giapponese.
...
### No. 223: Ambasciatore di una Stagione nella Luce del Mattino
...
Una richiesta poetica che descrive un ambasciatore per una stagione con la luce del mattino, pelle da rivista e vetro così sottile da non nascondere.
...
### No. 224: Ritratto di Profilo con Corona Geometrica Dorata
...
Una richiesta d'immagine per una figura autorevole di profilo netto che indossa una corona di dischi geometrici dorati su capelli scuri raccolti.
...
### No. 225: Principessa Raggiante con Tiara di Diamanti
...
Una richiesta d'immagine AI per una figura raggiante che indossa una tiara di diamanti sovradimensionata, di profilo netto.
...
### No. 226: Ritratto Ravvicinato di una Donna dell'Asia Orientale in Stile Wuxia
...
Un ritratto iperrealistico di una giovane donna dell'Asia orientale in stile wuxia con prospettiva grandangolare estrema.
...
### No. 227: Ritratto a Corpo Intero di una Donna in Ambiente Domestico Casual
...
Una richiesta per una foto verticale 9:16, a corpo intero e iperrealistica, di una giovane donna dell'Asia orientale in un'atmosfera domestica rilassata con toni cinematografici caldi.
...
### No. 228: Sprite Sheet di Personaggio Chibi con 16 Pose
...
Una richiesta per generare una sprite sheet in griglia 4x4 di un personaggio chibi con varie pose.
...
### No. 229: Selfie Fotorealistica con Smartphone in Camera da Letto
...
Un selfie fotorealistico in formato paesaggio, scattato con smartphone, di una giovane donna dell'Asia orientale che si rilassa su un letto di notte.
...
### No. 230: Miniatura 3D di un Paese da Punti di Riferimento Iconici
...
Un prompt per generare una mappa in miniatura 3D in cui il confine di un paese è composto dai suoi punti di riferimento iconici e simboli culturali.
...
### No. 231: Ritratto Cinematografico di una Donna a Parigi
...
Un prompt per una foto cinematografica ultra-realistica di una donna musulmana del sud-est asiatico che cammina vicino alla Torre Eiffel.
...
### No. 232: Animali Ricostruiti con Tessuti di Alta Moda
...
Un prompt per generare una griglia 2x2 di animali ricostruiti utilizzando i tessuti caratteristici di quattro iconiche case di moda di lusso.
...
### No. 233: Poster della Campagna per Smartphone di Fascia Premium
...
Un prompt per generare un poster promozionale di alta gamma per smartphone nello stile distintivo di Apple.
...
### No. 234: Poster di Viaggio Moderno con Architettura
...
Un prompt per creare un poster di viaggio di alta gamma con uno stile di stampa serigrafica vintage e una composizione a portale architettonico.
...
### No. 235: Charmander in Claymation Stop Motion che Esce dall'Uovo
...
Un prompt per creare un'animazione in stop-motion di uno Charmander in stile argilla che esce da un uovo e sputa fuoco.
...
### No. 236: La Mela di Magritte come una Pila di Blocchi Appunti
...
Una reinterpretazione creativa de 'Il Figlio dell'Uomo' di Magritte in cui la mela fluttuante è sostituita da una pila di blocchi appunti a forma di mela.
...
### No. 237: Ritratto di Moda Iperrealista in Casa Giapponese
...
Un ritratto di moda iperrealista di una donna che cammina in un corridoio di legno tradizionale giapponese.
...
### No. 238: Sfondo Ultra-Minimal dell'Impero Romano
...
Uno sfondo ultra-minimal che raffigura un grande tempio romano con colonne, acquedotti e rovine in tonalità calde dorate.
...
### No. 239: Fotogramma Anime di Binario Piovoso
...
Una prompt per generare un fotogramma anime inesistente che raffigura pioggia su un marciapiede, un treno in arrivo e un pesce koi che fluttua sopra una città.
...
### No. 240: Persona che Fa Amicizia con un Gatto nel Caos
...
Una scena che raffigura qualcuno che, dopo essersi coinvolto in varie vicende, finisce per fare amicizia con un gatto.
...
### No. 241: Medusa Volpe nell'Acquario degli Altopiani
...
Un'immagine di una volpe dagli occhi assonnati e di meduse all'interno di un acquario su un altopiano, resa in uno stile privo di particelle luminose granulari.
...
### No. 242: Donna in Kimono che Mangia Riso con Lingua di Manzo
...
Un'immagine di una donna in kimono, con una scena che raffigura un pasto a base di lingua di manzo e riso d'orzo.
...
### No. 243: Foto Spontanea di Donna in Soggiorno Accogliente di Notte
...
Una prompt per una foto fotorealistica e spontanea di una giovane donna in un ambiente accogliente di soggiorno notturno.
...
### No. 244: Donna Chuunibyou in Abito Gothic Lolita
...
Un'immagine in stile anime di una donna chuunibyou con trucco Jirai che indossa un abito Gothic Lolita con top a spalle scoperte e un lungo vestito con corsetto.
...
### No. 245: Donna che Rimane con l'Ex Fidanzato Morente
...
Una prompt che descrive una donna che scopre che il suo ex fidanzato l'ha lasciata perché sta morendo e decide di rimanere con lui fino alla fine.
...
### No. 246: Ritratto di una Donna in Uniforme
...
Una prompt poetica che descrive un personaggio di nome Rhiannah con un'uniforme geometrica, un occhio blu ghiaccio, spalle squadrate e labbra rosse.
...
### No. 247: Laboratorio di Tintura all'Indaco nel Jiangnan
...
Una prompt per un'immagine di una scena di laboratorio di tintura nel Jiangnan, con tintura blu, telai di legno, un ponte di pietra e luce mattutina sull'acqua.
...
### No. 248: Ritratto Ravvicinato con Capelli Intrecciati
...
Un ritratto fotorealistico per sfondo 16:9 di una giovane donna dalla pelle chiara con lentiggini, occhi azzurri e capelli biondo-biancastri intrecciati.
...
### No. 249: Ritratto Candido Fotorealistico di un Marinaio
...
Un'istantanea in stile 35mm di un anziano marinaio che sistema la sua rete, con texture reali della pelle e dei materiali.
...
### No. 250: Scena di Folla Storicamente Accurata del 1969
...
Una folla all'aperto fotorealistica a Bethel, New York, in una specifica data del 1969, ricostruita con accuratezza storica.
...
### No. 251: Cartolina di Natale Nostalgica con Orsacchiotto
...
Una cartolina per le feste di qualità da stampa, basata su una scena da scatola dei ricordi con una riga verbatim di testo della cartolina.
...
### No. 252: Aeroplano Giocattolo Vintage da Collezione in Blister
...
Uno scatto da collezione in stile retail, in confezione blister con una riga verbatim di testo per l'imballaggio.
...
### No. 253: Ufficio Postale sulle Nuvole in uno Stile di Libro Illustrato Rasserenante
...
Una scena fantastica di una nuvola soffice trasformata in un ufficio postale dove piccoli animali in uniforme smistano lettere, resa in uno stile morbido e rasserenante da libro illustrato.
...
### No. 254: Ritratto Cinematografico Iperrealista su una Motocicletta
...
Un ritratto cinematografico iperrealista di un uomo barbuto ed elegante su una motocicletta personalizzata.
...
### No. 255: Ritratto Editoriale di Alta Moda in Bianco e Nero
...
Una richiesta per creare un ritratto di alta moda in bianco e nero di un giovane uomo con capelli ricci e abbigliamento a strati.
...
### No. 6: Poster in Stile Art Déco in Oro e Blu Marino
...
Un'illustrazione per poster in stile Art Déco in formato quadrato, con eleganti linee in oro e blu marina su carta color crema.
...
### No. 40: Campagna Instagram di Viaggio con Smartphone come Punto Focale
...
Una richiesta per creare un annuncio pubblicitario premium per Instagram sul tema del viaggio, con uno smartphone moderno come elemento visivo centrale.
...
### No. 41: Poster Social Verticale per Figura da Collezione
...
Una richiesta per un poster verticale ad alta risoluzione per i social media che pubblicizzi una figura da collezione premium, con tipografia audace e sfondo giallo piatto.
...
### No. 42: Copertina di Libro con Design Gerarchico
...
Una richiesta per progettare una copertina di libro con una forte gerarchia tipografica e leggibilità.
...
### No. 43: Poster per Conferenza di Neuroscienze
...
Una richiesta per generare un poster per una conferenza di neuroscienze del 2026, basato su un articolo e regolamenti forniti.
...
### No. 44: Griglia di Diorami Fluttuanti di Città Iconiche
...
Una richiesta per generare una griglia 2x2 di diorami di città fluttuanti, sospesi in uno studio grigio.
...
### No. 45: Griglia di Poster Satirici di Sistema su Argomenti Frustranti
...
Una richiesta per una griglia 2x2 di poster editoriali satirici su argomenti frustranti.
...
### No. 46: Modello di Poster di Viaggio a Diorama di Carta
...
Una richiesta per creare un poster di viaggio verticale di alta qualità, che raffiguri un punto di riferimento cittadino come un diorama di carta dettagliato e fatto a mano.
...
### No. 47: Scheda Personaggio Cinematografica per Calvin & Bob
...
Una richiesta per creare una scheda personaggio a schermo diviso con uno sfondo ad acquerello.
...
### No. 48: Scheda Personaggio Cinematografica per Sofia
...
Un prompt per generare una scheda personaggio premium con tipografia audace e un'immagine eroica drammatica di una barista di nome Sofia.
...
### No. 49: Coperture Murarie di Propaganda Letteraria Drammatiche
...
Una prompt per generare una griglia 2x2 di coperture murarie drammatiche in stile propaganda per quattro libri di pubblico dominio.
...
### No. 50: Diorami Concettuali a Spaccato per Quattro Marchi
...
Una prompt per generare una griglia 2x2 di diorami concettuali a spaccato per quattro aziende della Fortune 500.
...
### No. 51: Poster Pubblicitario per Calzature per Bambini con Ragazza e Sneaker Gigante
...
Una richiesta per generare un poster pubblicitario gioioso con una ragazza e una sneaker gigante.
...
### No. 52: Storyboard Commerciale per Profumo di Lusso
...
Un prompt per uno storyboard di prodotto cinematografico che presenta un profumo di lusso alla rosa in un layout editoriale pulito.
...
### No. 53: Storyboard Commerciale per Profumo di Lusso
...
Un prompt per uno storyboard di spot commerciale cinematografico che presenta un profumo di lusso alla rosa.
...
### No. 54: Griglia di Vista Esplosa Tecnica
...
Una prompt per generare una griglia 2x2 di illustrazioni tecniche che mostrano viste esplose 3D di macchinari complessi.
...
### No. 55: Illustrazione a Fumetti a Piena Pagina a Colori
...
Una prompt per generare un'illustrazione a fumetti shonen a piena pagina, colorata e umoristica, utilizzando un'autentica composizione da pagina di fumetto.
...
### No. 56: Infografica Tecnica di una Macchina da Caffè
...
Un'infografica esplicativa che traccia il flusso di una macchina automatica per espresso dall'inizio alla fine.
...
### No. 57: Annuncio Campagna Streetwear con Slogan Esatto
...
Un'immagine per una campagna di abbigliamento streetwear giovanile che riporta uno slogan preciso, leggibile, all'interno del layout.
...
### No. 58: Logo Minimal di una Pasticceria su Sfondo Trasparente
...
Un logo per pasticceria in stile piatto, simile a un vettore, fornito centrato su un canale alfa pulito senza sfondo.
...
### No. 59: Fumetto a Quattro Pannelli di un Animale Domestico a Casa da Solo
...
Una striscia verticale di quattro pannelli che sviluppa un inizio, una svolta e una battuta finale attraverso i pannelli.
...
### No. 60: Interfaccia Utente di un'App per il Mercato Agricolo in una Cornice iPhone
...
Una bozza pratica di app mobile con intestazione, elenco venditori e offerte speciali, inserita in una cornice di dispositivo.
...
### No. 61: Diagramma Didattico sulla Respirazione Cellulare
...
Un diagramma di biologia per le scuole superiori con etichette che collega glicolisi, ciclo di Krebs e catena di trasporto degli elettroni.
...
### No. 62: Slide sull'Opportunità di Mercato per una Serie A
...
Una slide per presentazione con diagramma TAM/SAM/SOM, barre di crescita, note a piè di pagina e una gerarchia di dati reali.
...
### No. 63: Mockup di Cartellone Pubblicitario con Titolo Esatto
...
Un mockup di cartellone autostradale che riporta un titolo testuale verbatim in caratteri sans-serif in grassetto.
...
### No. 64: Pannello Manga con Fumetti
...
Un'immagine in stile manga di una ragazza che dice "Ehi, ascolta!" e un ragazzo che copre il suo fumetto con il suo fumetto di pensiero che dice "Farò finta di non aver sentito", disegnato in un rapporto d'aspetto verticale 4:5.
...
### No. 65: Pannello Manga: Ragazza Morde il Fumetto
...
Una scena in stile manga di un ragazzo che dice "Non combatteremo?" e una ragazza dall'aspetto feroce che morde il suo fumetto.
...
### No. 66: Griglia Editoriale delle Mode per Decenni
...
Una richiesta per generare una griglia 2x2 che visualizza quattro movimenti della moda di decenni diversi in uno stile poster editoriale 16:9.
...
### No. 67: Griglia dei Sistemi di Governo
...
Una richiesta per generare un'immagine a griglia 2x2 che visualizza quattro diversi sistemi di governo in uno stile pastello da libro illustrato.
...
### No. 68: Poster di Eredità Eroica per un Giocatore di Scacchi
...
Una richiesta per generare una griglia 2x2 di poster tributo illustrati ed eroici per quattro leggende degli scacchi scomparse.
...
- [Atlas Cloud GPT Image 2.5 Flare text-to-image](https://www.atlascloud.ai/it/models/openai/gpt-image-2.5-flare/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Flare edit](https://www.atlascloud.ai/it/models/openai/gpt-image-2.5-flare/edit?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Sunburst text-to-image](https://www.atlascloud.ai/it/models/openai/gpt-image-2.5-sunburst/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
