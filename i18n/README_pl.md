...
### No. 3: Portret drobnej Hiszpanki przy basenie
...
Wypolerowany, pionowy portret piękna, przedstawiający drobną Hiszpankę siedzącą przy miętowo-zielonym krytym basenie.
...
### No. 4: Dwie Kobiety w Kamiennym Łuku
...
Prompt do stworzenia obrazu dwóch kobiet ujętych w ramie wypłowiałego od słońca kamiennego łuku.
...
### No. 5: Portret na Wielopanelowej Karcie Postaci
...
Prompt do wygenerowania karty postaci z czterema studyjnymi fotografiami tej samej kobiety z różnych kątów.
...
### No. 6: Dziewięć Naklejek z Emotikonami i Tekstem
...
Prompt do wygenerowania siatki 3x3 z różnymi naklejkami emotikonowymi na podstawie postaci referencyjnej, zawierającymi tekst chiński i angielski na jasnym gradientowym tle.
...
### No. 7: Arkusz Sprite'ów z Czterema Animacjami Postaci w Stylu Dot-Art
...
Prompt do wygenerowania arkusza sprite'ów z czterema typami animacji postaci w stylu dot art, każda do 4 klatek, zachowujących spójny design.
...
### No. 8: Dzieło Sztuki Inspirowane Szkicem
...
Prompt do stworzenia oryginalnego dzieła sztuki na podstawie szkicu, zachowującego jego główny temat, emocje i gestykulację, przy jednoczesnym przekształceniu szczegółów.
...
### No. 9: Poranne Zdjęcie Lifestyle'owe Kobiety
...
Fotorealistyczny, poranny portret lifestyle'owy młodej kobiety o kasztanowo-czerwonych włosach.
...
### No. 10: Kobieta Odpoczywająca w Domowym Biurze
...
Prompt do wygenerowania fotorealistycznego zdjęcia smartfonem przedstawiającego młodą kobietę relaksującą się na sofie w nowoczesnym domowym biurze.
...
### No. 11: Portret Młodej Kobiety zrobiony iPhone'em
...
Prompt do wygenerowania realistycznego portretu młodej kobiety w pomieszczeniu, zrobionego iPhone'em, z refleksyjnym tłem.
...
### No. 12: Arkusz Sprite'ów w Stylu Pixel Art dla Postaci
...
Prompt do wygenerowania uproszczonego arkusza sprite'ów w pixel art o rozmiarze 128px z przezroczystym tłem i układem 4x4 dla akcji bitewnych postaci.
...
### No. 13: Dzienny Obóz Namiotowy na Podstawie Szkicu
...
Seria promptów do przekształcenia dziecięcego rysunku w nastrojowy nocny obóz namiotowy, następnie w dzienną wersję, a na końcu zmiany ubioru postaci na kombinezon.
...
### No. 14: Minimalistyczna Sztuka Kraju z Jedną Linią
...
Prompt do stworzenia pionowego, minimalistycznego wydruku artystycznego kraju za pomocą jednej ciągłej linii.
...
### No. 15: Transformacja Portretu Historycznego na Rok 1985
...
Prompt do ponownego wyobrażenia sobie wyglądu osoby w latach 80., przy zachowaniu jej podstawowej tożsamości i cech.
...
### No. 16: Mockup 3D Markowania Oversize T-Shirtów
...
Prompt do wygenerowania mockupu 3D dwóch unoszących się oversize T-shirtów pokazujących widok z przodu i z tyłu.
...
### No. 17: Luksusowa Kolażowa Sesja Edytorialska z Odzieżą Męską
...
Prompt do stworzenia luksusowej kolażowej sesji edytorialskiej z odzieżą męską, wykorzystującej przesłane zdjęcie jako referencję twarzy.
...
### No. 18: Referencja Tożsamości Twarzy i Kompozycji
...
Prompt instruujący użycie przesłanego obrazu w celu zachowania cech twarzy i naturalnego wyglądu osoby.
...
### No. 19: Realistyczny Profesjonalny Portret Studyjny
...
Prompt do stworzenia profesjonalnego portretu studyjnego z wykorzystaniem przesłanego zdjęcia dla tożsamości twarzy i kompozycji.
...
### No. 20: Kolażowa Sesja Modowa ze Spójnym Modelem
...
Prompt do stworzenia kolażu modowego ze spójnym modelem męskim przy użyciu referencji tożsamości twarzy.
...
### No. 21: Portret Astronautki w Futurystycznej Kabinie
...
Prompt do wygenerowania fotorealistycznego portretu pewnej siebie astronautki w futurystycznej kabinie statku kosmicznego.
...
### No. 22: Ultrarealistyczny studyjny portret modowy
...
Prompt do stworzenia pełnopostaciowego, ultrarealistycznego studyjnego portretu modowego z wykorzystaniem przesłanego zdjęcia jako referencji twarzy.
...
### No. 23: Kinematograficzny lifestylowy portret z motocyklem
...
Ultrarealistyczny portret mężczyzny siedzącego na zewnątrz obok premium sportowego motocykla.
...
### No. 24: Ultrarealistyczny portret redakcyjny
...
Prompt AI do stworzenia ultrarealistycznego portretu redakcyjnego mężczyzny z wykorzystaniem referencji tożsamości twarzy.
...
### No. 25: Premium portret modowy z referencji
...
Prompt do stworzenia premium portretu modowego stylowego dorosłego mężczyzny z wykorzystaniem referencji tożsamości twarzy.
...
### No. 26: Swobodny lifestylowy portret z referencji
...
Prompt do generowania wysokiej jakości, ultra fotorealistycznego, swobodnego portretu lifestylowego kobiety na podstawie obrazu referencyjnego.
...
### No. 27: Zimowy portret modowy ze zdjęcia
...
Prompt AI do stworzenia realistycznego, zimowego portretu modowego na zewnątrz z wykorzystaniem zdjęcia osoby jako referencji twarzy.
...
### No. 28: Ultrarealistyczny Luksusowy Portret Studyjny
...
Prompt AI do wygenerowania ultrarealistycznego, luksusowego portretu studyjnego stylowego dorosłego mężczyzny.
...
### No. 29: Filmowy Kolaż Portretowy w Deszczu
...
Prompt do stworzenia filmowego kolażu portretowego w deszczu, wykorzystujący przesłane zdjęcie jako odniesienie dla kompozycji i atmosfery.
...
### No. 30: Zachowanie Tożsamości na Selfie ze Smartfona
...
Prompt do wygenerowania pionowego (3:4), ultrarealistycznego selfie ze smartfona, które wiernie zachowuje konkretne rysy twarzy i wygląd kobiety.
...
### No. 31: Filmowy Portret Mody z Zachowaniem Tożsamości
...
Prompt do wygenerowania zbliżeniowego portretu modowego, który zachowuje tożsamość i wygląd osoby.
...
### No. 32: Zbliżeniowy Formalny Portret Studyjny
...
Prompt do stworzenia zbliżeniowego portretu studyjnego młodego mężczyzny w formalnym stroju z wykorzystaniem referencji twarzy.
...
### No. 33: Kinograficzne Zdjęcie z Zachowaniem Tożsamości
...
Prompt do stworzenia fotorealistycznego, kinograficznego obrazu konkretnej Azjatki, z zachowaniem jej tożsamości i cech.
...
### No. 34: Kinograficzna Sesja Mody z Referencją Tożsamości
...
Prompt do wygenerowania kinograficznego zdjęcia modowego kobiety w ciemnym otoczeniu, z zachowaniem jej tożsamości ze zdjęcia referencyjnego.
...
### No. 35: Ultrarealistyczny Portret Redakcyjny z Referencji
...
Prompt generowania obrazu do stworzenia ultrarealistycznego portretu redakcyjnego dorosłego mężczyzny, wykorzystujący przesłane zdjęcie jako referencję tożsamości twarzy.
...
### No. 36: Walka ze smokiem i zdrajcą z toporem
...
Prompt do wygenerowania obrazu przedstawiającego walkę ze smokiem, w której uczestniczy zdradziecki wojownik z toporem, przy użyciu ChatGPT Astra.
...
### No. 37: Heroiczny gigantyczny robot - fotorealistyczny kadr
...
Prompt do stworzenia obrazu przedstawiającego heroicznego, gigantycznego robota z dynamicznego, fotorealistycznego ujęcia.
...
### No. 38: Styl anime na podstawie przesłanego obiektu
...
Prompt do stworzenia obrazu w stylu anime z pewną kreską, minimalnym cieniowaniem cel-shading i jasnymi, nasyconymi kolorami.
...
### No. 39: Produkt - frontowe, płaskie ujęcie z czytelną etykietą
...
Prompt do wygenerowania dwóch obrazów produktowych z czytelnymi, łatwymi do odczytania etykietami, w stylu frontowego, płaskiego ułożenia (flat-lay).
...
### No. 40: Fantastyczna scena z orłem i odniesieniem
...
Prompt do stworzenia filmowej, fantastycznej sceny przedstawiającej kobietę w centrum, przed gigantycznym, majestatycznym bielikiem z rozpostartymi skrzydłami.
...
### No. 41: Reklama high-fashion z tożsamością modelki
...
Prompt do stworzenia premium, hiperrealistycznej reklamy wysokiej mody, która zachowuje specyficzną tożsamość twarzy modelki.
...
### No. 42: Artykuł jako czteropanelowa manga w stylu Afternoon
...
Prompt do wygenerowania czterostronicowego komiksu w stylu japońskiego magazynu Afternoon na podstawie załączonego artykułu.
...
### No. 43: Premium, filmowa karta postaci (Character Bible Sheet)
...
Prompt do stworzenia podzielonej na sekcje karty referencyjnej postaci z użyciem ścisłych wytycznych wizualnych.
...
### No. 44: Arkusz sprite'ów do walki w pixel arcie
...
Prompt do wygenerowania uproszczonego, 128-pikselowego arkusza animacji walki w pixel arcie, z przezroczystym tłem.
...
### No. 45: Arkusz sprite'ów postaci do walki w pixel arcie
...
Prompt do wygenerowania 16-klatkowego arkusza sprite'ów w pixel arcie, przedstawiającego ruchy walki postaci.
...
### No. 46: Arkusz Sprite'ów Pixel Art do Walki Postaci
...
Prompt do stworzenia uproszczonego arkusza sprite'ów w pixel art o rozmiarze 128px z 16 klatkami, przedstawiającego ruchy bojowe postaci, w tym stany: bezczynności, cięcia, obrony i powalenia.
...
### No. 47: Fotorealistyczny Portret z Referencją Tożsamości
...
Prompt do stworzenia pełnopostaciowego, fotorealistycznego portretu z wykorzystaniem zdjęcia referencyjnego w celu zachowania tożsamości osoby.
...
### No. 48: Karta Opisowa Postaci Marty'ego i Doca
...
Prompt do wygenerowania podzielonej ekranowo karty referencyjnej dla dwóch postaci z użyciem ścisłych wytycznych wizualnych.
...
### No. 49: Karta postaci Teda i Johna
...
Prompt do wygenerowania karty postaci na podzielonym ekranie z wykorzystaniem ścisłych odniesień wizualnych dla dwóch postaci.
...
### No. 50: Karta postaci na podzielonym ekranie dla Doma i Briana
...
Prompt do wygenerowania karty postaci na podzielonym ekranie z wykorzystaniem przesłanych odniesień dla dwóch postaci.
...
### No. 51: Filmowa karta postaci dla Baby
...
Prompt do wygenerowania premium karty postaci dla postaci Baby, z odważną typografią i ścisłym przestrzeganiem odniesień wizualnych.
...
### No. 52: Filmowa karta postaci dla Schmidta i Jenko
...
### No. 53: Filmowa karta postaci dla Gordona
...
Prompt do stworzenia premium karty postaci z odważną typografią i ścisłym odniesieniem wizualnym.
...
### No. 54: Karta postaci dla Johnny'ego i Tuckera
...
Prompt do wygenerowania karty odniesień postaci na podzielonym ekranie z wykorzystaniem ścisłych wytycznych wizualnych.
...
### No. 55: Karta postaci dla Neo i Trinity
...
Prompt do wygenerowania karty odniesień postaci na podzielonym ekranie dla Neo i Trinity z wykorzystaniem ścisłych wytycznych wizualnych.
...
### No. 56: Karta postaci Kevin kontra Mokrzy Bandyci
...
Prompt do wygenerowania premium karty postaci dla Kevin kontra Mokrzy Bandyci z wykorzystaniem ścisłych odniesień wizualnych.
...
### No. 57: Redakcyjne zdjęcie mody na nocnych schodach dachowych
...
Prompt do stworzenia hiperrealistycznego zdjęcia redakcyjnego mody na nocnych schodach dachowych z chłodnym, filmowym klimatem.
...
### No. 58: Karta postaci Riggsa i Murtaugha
...
Prompt do wygenerowania karty odniesień postaci na podzielonym ekranie dla dwóch postaci z wykorzystaniem ścisłych wytycznych wizualnych.
...
### No. 59: Luksusowy kinowy arkusz postaci dla Mike'a i Marcusa
...
Prompt do wygenerowania rozdzielonego arkusza referencyjnego postaci z wykorzystaniem ścisłych wytycznych wizualnych.
...
### No. 60: Luksusowy kinowy arkusz postaci dla Lee i Cartera
...
Prompt do stworzenia rozdzielonego arkusza referencyjnego postaci z wykorzystaniem ścisłych przewodników wizualnych.
...
### No. 61: Realistyczna figurka w skali 1/7 na biurku
...
Prompt do wygenerowania obrazu realistycznej figurki postaci w skali 1/7 na biurku komputerowym z przezroczystą podstawą.
...
### No. 62: Referencja tożsamości twarzy w kompozycji
...
Prompt AI do wygenerowania jednego zdjęcia przedstawiającego siedem wersji tego samego dorosłego mężczyzny z użyciem referencji tożsamości twarzy.
...
### No. 63: Portret modowy z użyciem referencji tożsamości twarzy
...
Prompt do wygenerowania premium, pełnopostaciowego portretu modowego z użyciem zdjęcia jako referencji tożsamości twarzy.
...
### No. 64: Oniryczny, kinowy portret na podstawie referencji
...
Prompt do stworzenia realistycznego, onirycznego i kinowego portretu, który zachowuje tożsamość i naturalne cechy portretowanej osoby.
...
### No. 65: Portret w 3D w stylu claymation na podstawie zdjęcia
...
Prompt do wygenerowania szczegółowego, uroczego portretu 3D w stylu animacji plastelinowej (claymation), który zachowuje tożsamość i podobieństwo osoby ze zdjęcia przesłanego przez użytkownika.
...
### No. 66: Artystyczny plakat edytorialny dla lokalizacji
...
Prompt do stworzenia wysokorozdzielczego, pionowego plakatu edytorialnego w zabawnej stylistyce japońskiego design-zine.
...
### No. 67: Animowana Scena z Dwóch Obrazów Referencyjnych
...
Prompt do stworzenia animowanej sceny przedstawiającej małe dziecko bawiące się w przytulnej sypialni.
...
### No. 68: Portret z Lat 80. na Podstawie Referencji Twarzy
...
Prompt do wygenerowania portretu w retro-wintage stylu lat 80., zachowującego dokładne rysy twarzy i tożsamość osoby.
...
### No. 69: Arkusz Referencyjny Projektu Postaci
...
Prompt do wygenerowania profesjonalnego arkusza modelowego postaci na podstawie dostarczonego obrazu referencyjnego.
...
### No. 70: Przeniesienie stylu na motocyklistę
...
Nowy obiekt przedstawiony w dokładnym stylu wizualnym przeniesionym z obrazu wejściowego.
...
### No. 71: Zamiana stroju z zachowaniem tożsamości
...
Ubrania z obrazów referencyjnych dopasowane do osoby, z niezmienioną twarzą, pozą i oświetleniem.
...
### No. 72: Pies wkomponowany w scenę portretową
...
Obiekt pobrany z jednego odniesienia i umieszczony w innym, z dopasowanym światłem i tłem.
...
### No. 73: Szkic przekształcony w fotorealistyczną dolinę
...
Rysunek przedstawiony fotorealistycznie, przy zachowaniu jego układu, proporcji i perspektywy.
...
### No. 74: Osoba wstawiona w scenę ataku niedźwiedzia
...
Fotograficzna scena akcji zbudowana wokół dostarczonej osoby, celowo niekinematograficzna.
...
### No. 75: Spójna postać z książki dla dzieci
...
Bohater książki obrazkowej w technice akwareli, określony na tyle precyzyjnie, by pozostać identycznym na różnych ilustracjach.
...
### No. 76: Portret Candid w Nowojorskim Metrze
...
Prompt do stworzenia naturalnego, lifestylowego zdjęcia kobiety o delikatnych rysach twarzy i rozczochranych ciemnych włosach w nowojorskim metrze.
...
### No. 77: Wielopanelowa Karta Referencyjna Postaci Filmowej
...
Prompt do wygenerowania karty referencyjnej postaci przedstawiającej tę samą, realistyczną kobietę z widoków: z przodu, 3/4, z profilu i z tyłu.
...
### No. 78: Minimalistyczne Obrazki Akwarelowe na Podstawie Zdjęcia
...
Prompt do przekształcenia przesłanego zdjęcia w wyrafinowane dzieło sztuki łączące fotorealizm z minimalistycznym, akwarelowym stylem winiet.
...
### No. 2: Przekształć Zdjęcia w Indywidualne Plakaty Premium
...
Instrukcja JSON do konwersji każdego przesłanego zdjęcia na osobny, wysokiej jakości plakat bez ich łączenia.
...
### No. 3: Nocne Biuro z Ekranem Przedstawiającym Schemat Blokowy
...
Prompt do wygenerowania nocnego pokoju do nauki, a następnie zastąpienia wyłącznie zawartości ekranu laptopa schematem blokowym automatyzacji.
...
### No. 4: Przerysowanie w stylu dwustronicowej mangi
...
Prompt do przerysowania obrazu w stylu dwustronicowej mangi, z zachowaniem dialogów, fabuły i ustawień postaci.
...
### No. 5: Edycja otoczenia w malarski styl
...
Prompt do edycji tła środowiskowego w bardziej swobodny, malarski styl, z zachowaniem określonych elementów kompozycyjnych.
...
### No. 6: Przywróć Uszkodzony Portret Wintage
...
Prompt do odrestaurowania poważnie uszkodzonego starego portretu na czyste, nowocześnie wyglądające zdjęcie z wykorzystaniem przesłanego obrazu jako referencji.
...
### No. 7: Przemalowanie Samochodu na Neonową Czerń
...
Prompt do zmiany koloru obiektu na neonową czerń przy zachowaniu jego oryginalnego kształtu, tekstury i materiału.
...
### No. 8: Pionowy Obraz z Dwoma Panelami Oryginału i Edycji
...
Prompt do stworzenia pojedynczego pionowego obrazu z dwoma ułożonymi pionowo panelami, gdzie górny panel pozostaje oryginalnym zdjęciem referencyjnym.
...
### No. 9: Przytnij Zdjęcie do Określonego Proporcji
...
Prompt do zmiany rozmiaru zdjęcia na wybrany format (proporcje), przy zachowaniu naturalnego położenia głównego tematu.
...
### No. 10: Portret w twardym świetle z ostrymi cieniami
...
Prompt opisujący portret oświetlony twardym, niełagodzonym światłem słonecznym z okna pod określonym kątem, tworzącym ostre cienie na twarzy.
...
### No. 11: Arkusz sprite'ów w pixel art dla postaci
...
Prompt do stworzenia uproszczonego, 128-pikselowego arkusza sprite'ów z animacją walki dla postaci, ułożonego w siatce 4x4 na przezroczystym tle.
...
### No. 12: Przekształcenie Słońca i Chmur w Kwiat Lotosu
...
Prompt do ulepszenia zdjęcia chmur i słońca, aby słońce przypominało środek kwiatu, a chmury - lotos, bez modyfikowania oryginalnego obrazu.
...
### No. 13: Infografika przetłumaczona na język hiszpański
...
Edycja, która zmienia tylko język tekstu, pozostawiając każdy inny piksel układu bez zmian.
...
### No. 14: Wycięcie produktu na przezroczystym tle
...
Zdjęcie produktu izolowane na czystym kanale alfa z wyraźną sylwetką, bez poświaty i z zachowaną czytelnością etykiety.
...
### No. 15: Usunięcie obiektu z portretu
...
Jednolinijkowa edycja, która usuwa pojedynczy obiekt i nie zmienia niczego innego.
...
### No. 16: Billboard przeobrażony w zimowy wieczór
...
Pięciowyrazowa edycja kontynuująca, która zmienia porę roku i porę dnia na istniejącej makiecie.
...
### No. 17: Wymiana krzeseł kuchennych na drewniane
...
Edycja pomieszczenia, która zastępuje tylko krzesła, zachowując kąt, oświetlenie i cienie na podłodze.
...
### No. 6: Realistyczne zrzuty ekranu z RPG nowej generacji o tematyce romantycznej
...
Prompt do wygenerowania realistycznego zrzutu ekranu z fikcyjnej, nowej generacji, trójwymiarowej gry RPG typu open-world o tematyce romantycznej, z perspektywy protagonisty.
...
### No. 7: Elegantyczna miniaturowa diorama przedstawiająca znany zabytek
...
Prompt do wygenerowania uroczej, eleganckiej, trójwymiarowej dioramy słynnej budowli w pastelowych odcieniach, z ręcznie wykonanymi detalami.
...
### No. 8: Pionowa botaniczna sztuka papierowa przedstawiająca smukłą kobietę
...
Pionowe, botaniczne dzieło sztuki z papieru, przedstawiające smukłą kobietę z profilu, w sukni z liści i z kościanym parasolem.
...
### No. 9: Fotorealistyczny model do sklejania białego i złotego paladyna
...
Prompt do wygenerowania fotorealistycznego obrazu przedstawiającego białego i złotego robota-paladyna jako model do sklejania, wyeksponowany w sklepie elektronicznym z wieloma jednolitymi pudełkami.
...
### No. 10: Reportażowe Zdjęcie Podróżnicze przy Zabytkowym Murze
...
Realistyczne, reportażowe zdjęcie podróżnicze przedstawiające młodą kobietę przy zabytkowym murze miejskim nocą, z oświetlonym tradycyjnym chińskim budynkiem w tle.
...
### No. 11: Wintage'owy Plakat Podróżniczy dla Lokalizacji
...
Prompt do stworzenia plakatu podróżniczego inspirowanego latami 20. i 30. XX wieku, w stylu ilustracji z warstwowym reliefem papierowym i tłoczeniem, w stonowanej palecie kolorystycznej.
...
### No. 12: Makrofotografia Oka Motyla, Wibrysa Kota
...
Fotorealistyczne, makro zbliżenie przedstawiające wibrys kota, fasetkowe oczy motyla oraz skórę dziewczyny.
...
### No. 13: Luksusowy Zegarek na Mockupie z Marmuru
...
Fotorealistyczny mockup reklamy magazynowej luksusowego zegarka-chronografu z tytanu, z czytelnym tekstem na tarczy.
...
### No. 14: Mockup Produktowy Ekskluzywnej Torby Kawy
...
Fotorealistyczny, komercyjny mockup matowej, czarnej torby z kawą, z line-artem gór na rustykalnym drewnie.
...
### No. 15: Plakat Lookbook'a dla E-commerce Mody
...
Prompt do wygenerowania czystego plakatu lookbook'a modowego z młodą modelką w jesiennej stylizacji, z użyciem miękkich pastelowych kolorów.
...
### No. 16: Miniaturowa Scena Podróżnicza z Zabytkiem
...
Prompt do wygenerowania urokliwej, ręcznie wykonanej sceny miniaturowej, przedstawiającej maleńki model 3D ikonicznego zabytku.
...
### No. 17: Portret Redakcyjny Kobiety z Widokiem na Miasto
...
Fotorealistyczny portret redakcyjny dorosłej kobiety pochodzenia wschodnioazjatyckiego, spoglądającej na miasto o zmierzchu.
...
### No. 18: Filmowy Portret Kobiety w Słonecznej Kawiarni
...
Prompt do stworzenia fotorealistycznego, filmowego portretu dorosłej kobiety pochodzenia wschodnioazjatyckiego w słonecznej, sąsiedzkiej kawiarni.
...
### No. 19: Asymetryczny Portret Redakcyjny z Pół-Twarzy
...
Prompt do stworzenia portretu w stylu redakcyjnym, z modelem umieszczonym przy lewej krawędzi kadru.
...
### No. 20: Ekskluzywny Plakat Artystyczno-Redakcyjny dla Lokalizacji
...
Prompt do stworzenia wysokiej jakości, nowoczesnego plakatu w stylu artbooka dla określonej lokalizacji.
...
### No. 21: Ciepła Nocna Scena z Kobietą Czytającą w Domu
...
Prompt do wygenerowania realistycznego zdjęcia poziomego 16:9 przedstawiającego kobietę w ciepłym, zwyczajnym wnętrzu mieszkania nocą.
...
### No. 22: Ekskluzywny Parfait z Nielubianych Potraw
...
Prompt do wygenerowania ekskluzywnego parfaitu złożonego wyłącznie z powszechnie nielubianych produktów spożywczych, zawierającego 30 rodzajów składników z adnotacjami.
...
### No. 23: Japoński Wintage'owy Plakat Podróżniczy z Ery Showa
...
Prompt do stworzenia wysokiej jakości, pionowego plakatu podróżniczego w stylu japońskiej turystyki kolejowej z połowy XX wieku.
...
### No. 24: Filmowy Portret na Peronie Metra
...
Portret młodej kobiety o brązowych włosach, stojącej nieruchomo, podczas gdy pociąg pędzi obok, wykonany z wysoką wiernością.
...
### No. 25: Portret z Wysokiego Kąta w Qipao
...
Portret z wysokiego kąta wysokiej, smukłej modelki z wyrafinowanym makijażem i lisim kształtem twarzy, ubranej w qipao, w miękkim, onirycznym oświetleniu.
...
### No. 26: Zalana Równina z Niedopasowanym Odbiciem
...
Prompt do stworzenia filmowego kadru przedstawiającego zalaną równinę o zmierzchu z domostwem i topolami, charakteryzującego się niedopasowanym odbiciem w wodzie.
...
### No. 27: Siatka 3x3 w Stylu Klipu Vocaloid
...
Prompt do stworzenia siatki 3x3 z różnymi ujęciami w stylu klipu muzycznego Vocaloid, w formacie 16:9.
...
### No. 28: Arkusz Sprite'ów Wrony w Stylu 16-bitowym
...
Prompt do wygenerowania arkusza sprite'ów w stylu 16-bitowym przedstawiającego wronę w locie, starcie i lądowaniu.
...
### No. 29: Gladiator na Koniu – Ujęcie z Ekstremalnie Niskiego Kąta
...
Ekstremalnie niskie ujęcie gladiatora na koniu bojowym, widzianego ze skalistej górskiej ścieżki.
...
### No. 30: Zbliżenie Rafy z Ośmiornicą
...
Prompt nakazujący przybliżenie na rafę, obserwację światła na kamieniu i uwzględnienie dokładnie ośmiu ramion.
...
### No. 31: Kadr Filmowy Anamorficzny: Kobiety w Piwonii
...
Szerokie, anamorficzne zdjęcie pięciu miniaturowych Chinek siedzących wewnątrz dużej, bladoróżowej piwonii.
...
### No. 32: Kobieta wśród Gęstych Różowo Kwitnących Gałęzi
...
Zdjęcie kobiety otoczonej gęstymi, różowo kwitnącymi gałęziami, które wypełniają pierwszy plan i tło.
...
### No. 33: Robot na Plaży o Zachodzie Słońca
...
Realistyczna, filmowa scena przedstawiająca robota siedzącego na plaży o zachodzie słońca, patrzącego na piasek w swojej dłoni.
...
### No. 34: Cyberpunkowy Stroj z Puszystymi Wilczymi Uszami
...
Prompt do wygenerowania cyberpunkowego stylu kostiumu z neonoworóżowymi i zielonymi futrzanymi wilczymi uszami oraz obrożą.
...
### No. 35: Zbliżeniowe Selfie Młodej Kobiety
...
Prompt na surowe zdjęcie z iPhone'a młodej kobiety z piegami i rozwianymi włosami.
...
### No. 36: Prezydent z Lat 80. Wita Obcego na Trawniku Białego Domu
...
Prompt do wygenerowania obrazu przedstawiającego zdjęcie w stylu lat 80., na którym Prezydent wita obcego na trawniku Białego Domu.
...
### No. 37: Kadr Filmowy z Uczty Królewskiej z Dynastii Tang
...
Kadr filmowy w formacie panoramicznym, przedstawiający fikcyjną, wystawną nocną ucztę królewską z czasów dynastii Tang.
...
### No. 38: Realistyczna Fotografia Modowa Wschodnioazjatyckiej Kobiety
...
Prompt do realistycznej fotografii modowej przedstawiającej dorosłą Wschodnioazjatkę z długimi czarnymi włosami, ciepłym światłem i cieniem na twarzy oraz naturalną fakturą skóry.
...
### No. 39: Portret Tajwańskiej Kobiety z Filtrem Czarnej Mgły
...
Prompt do portretu z filtrem czarnej mgły, nakładaną maską i subtelnymi podbiczeniami w stylu miękkiego światła fotografii CCD.
...
### No. 40: Czerwona Lycoris Nad Rzeką Po Deszczu
...
Prompt do wygenerowania realistycznego obrazu pojedynczej czerwonej lycoris z kroplami deszczu, umieszczonej nad brzegiem rzeki po opadach.
...
### No. 41: Uliczna Scena po Zamknięciu w Deszczowy Wieczór
...
Prompt do nastrojowego obrazu przedstawiającego osobę po godzinach zamknięcia, skupiającego się na mokrej wełnie, skórze i świetle latarni ulicznej.
...
### No. 42: Sesja Fashion Editorial z Wiatrem i Jedwabiem
...
Prompt do sceny z sesji fashion editorial z trzema osobami stylizowanymi przez wiatr, z ostrym światłem słonecznym i obfitością jedwabiu.
...
### No. 43: Realistyczne Zdjęcie z iPhone'a Przedstawiające Teslę Model Y
...
Prompt do wygenerowania realistycznego zdjęcia z iPhone'a przedstawiającego Teslę Model Y na parkingu, wykonanego przy użyciu aparatu 0.5x.
...
### No. 44: Ekologiczne Miasto Przyszłości o Zmierzchu z Księżycem
...
Prompt opisujący ekologiczne miasto przyszłości o zmierzchu, miasto księżycowe z ogromną Ziemią, serafickiego rycerza strażnika galaktyki oraz srebrnowłosą królową tańczącą w katedrze z lodu.
...
### No. 45: Wielka Armia ze Smokiem w Deszczu
...
Złożona scena przedstawiająca armię liczącą ponad 100 osób, postać Luny, białego smoka, japoński szyld, skomplikowane operowanie włócznią oraz odbicia w deszczu.
...
### No. 46: Skaczący Szary Królik Holenderski
...
Prompt do wygenerowania obrazów skaczącego królika oraz skaczącego szarego królika rasy Holenderski Karzełek.
...
### No. 47: Para anime w parku - wysoka szczegółowość
...
Prompt do generowania obrazu przedstawiającego młodego mężczyznę i kobietę w stylu anime, w codziennych ubraniach, w dużym parku, wyrenderowany w ultra wysokiej rozdzielczości 16K ze zwiększonym kontrastem i nasyceniem.
...
### No. 48: Sen czerwonego pawilonu - długi zwój
...
Prompt do zrekonstruowania sceny z "Snu czerwonego pawilonu" jako tradycyjnego chińskiego malarstwa na długim zwoju.
...
### No. 49: Seria architektury brutalistycznej na pustyni
...
Prompt do generowania obrazów monumentalnej architektury ziemnej w stylu pustynnego brutalizmu, zawierającej połączenia z celebrytami-architektami.
...
### No. 50: Zdjęcie spaceru ulicą w złotej godzinie
...
Prompt do fotorealistycznego zdjęcia smartfonem przedstawiającego kobietę idącą po zadrzewionej ulicy w złotej godzinie.
...
### No. 51: Kolekcja luksusowych plakatów podróżniczych
...
Prompt do stworzenia wyrafinowanej kolekcji luksusowych plakatów podróżniczych inspirowanych Santorini, Wybrzeżem Amalfitańskim i Paryżem.
...
### No. 52: Reportażowy portret w miejskim parku
...
Reportażowy portret na zewnątrz przedstawiający młodą kobietę z długimi, ciemnobrązowymi włosami w spokojnym miejskim parku w słoneczne popołudnie.
...
### No. 53: Arkusz referencyjny postaci - zabójca z pustyni
...
Prompt do wygenerowania filmowego arkusza referencyjnego postaci przedstawiającego zabójczego zabójcę z pustyni.
...
### No. 54: Zdjęcie modowe Azjatki w salonie
...
Prompt do ultra fotorealistycznego zdjęcia modowego smartfonem, przedstawiającego piękną kobietę z Azji Wschodniej w prywatnym salonie nocą.
...
### No. 55: Znaczek pocztowy w stylu vintage z motywem podróżniczym
...
Prompt do stworzenia znaczka pocztowego w stylu vintage przedstawiającego charakterystyczny punkt orientacyjny kraju i elementy kulturowe.
...
### No. 56: Wintage'owy plakat podróżniczy z ikoniczną budowlą
...
Prompt do stworzenia stylizowanego, ręcznie malowanego vintage'owego plakatu podróżniczego przedstawiającego rozpoznawalny zabytek architektoniczny.
...
### No. 57: Reportażowy portret modowy w podziemnym garażu
...
Ultra fotorealistyczny portret pięknej kobiety eurazjatyckiej w nowoczesnym podziemnym garażu.
...
### No. 58: Ręcznie Robiona Miniaturowa Scena z Jedzeniem
...
Prompt do wygenerowania urokliwej miniaturowej sceny przedstawiającej konkretną potrawę na ceramicznym talerzu.
...
### No. 59: Miniaturowa Diorama Witryny Sklepowej
...
Prompt do wygenerowania fantazyjnej, trójwymiarowej miniaturowej dioramy z gliny przedstawiającej rozpoznawalny sklep lub markę.
...
### No. 60: Miniaturowa Diorama z Ikoniczną Budowlą
...
Prompt do stworzenia szczegółowego, przytulnego miniaturowego świata z centralną ikoniczną strukturą.
...
### No. 61: Asymetryczne Studio Portretowe z Wysoką Modą
...
Prompt do zbliżeniowego portretu mężczyzny na białym tle studyjnym z asymetryczną kompozycją.
...
### No. 62: Krajobraz Białego Labiryntu Rzeźbionego przez Wiatr
...
Opisowy prompt do wygenerowania krajobrazu białego labiryntu uformowanego przez erozję wietrzną na przestrzeni czasu.
...
### No. 63: Biały Rycerz Smoka i Mały Kamień
...
Scena przedstawiająca Białego Rycerza Smoka nocą, zatrzymanego nie przez wroga, lecz przez pojedynczy mały kamień, z filozoficznym podpisem.
...
### No. 64: Portret redakcyjny pewnego siebie mężczyzny
...
Prompt do generowania premium, redakcyjnego portretu studyjnego pewnego siebie mężczyzny z krótkimi czarnymi włosami.
...
### No. 65: Pełnopostaciowy studyjny portret modowy
...
Prompt do generowania pełnopostaciowego portretu pewnego siebie męskiego modela w ciepłym, jednolitym studiu.
...
### No. 66: Arcydzieło kampanii luksusowych podróży
...
Prompt do wyrafinowanej kampanii lifestylowej z zakresu luksusowych podróży, łączącej doświadczenia alpejskie, dubajskie i z europejskich chat.
...
### No. 67: Poranna rutyna Mistrza Niebieskiego Maga
...
Scena przedstawiająca poranek Mistrza Niebieskiego Maga, w którym grzebienie, gumki do włosów i sznurowadła kończą swoją pracę, podczas gdy on czyta raporty.
...
### No. 68: Statek przybywający do Białego Kredowego Wybrzeża
...
Opisowy prompt do sceny, w której statek przybywa do brzegu z białej ziemi, soli i wapienia, z niewidocznymi krainami w oddali.
...
### No. 69: Portret postaci: Elf rybak znad morza
...
Prompt opisujący elfa żyjącego nad morzem, przybrzeżnego rybaka, który odczytuje znaki oceanu.
...
### No. 70: Profesjonalny studyjny portret do zdjęć biznesowych
...
Prompt do generowania profesjonalnego studyjnego portretu (zdjęcia biznesowego) dorosłego mężczyzny.
...
### No. 71: Pewny siebie mężczyzna w luksusowym nowoczesnym wnętrzu
...
Ultrarealistyczny lifestylowy portret pewnego siebie mężczyzny w luksusowym nowoczesnym wnętrzu z ciemnym drewnianym wejściem i dużym lustrem.
...
### No. 72: Fantastyczny Włócznik Śpiący przy Biurku
...
Poetycki prompt opisujący noc włócznika, który wspomina słoje drewna na biurku przed nieziemską mapą.
...
### No. 73: Smoczy Rycerz Odpoczywający w Cieniu
...
Scena przedstawiająca dwóch smoczych rycerzy odpoczywających pod skrzydłem smoka, z mapą i twardym chlebem.
...
### No. 74: Stylowy Mężczyzna w Przytulnej Wieczornej Bibliotece
...
Ultrarealistyczny portret mężczyzny relaksującego się w ekskluzywnej bibliotece-wypoczynkowej wczesnym wieczorem.
...
### No. 75: Dullahan Listonosz w Jesienną Noc
...
Nocny listonosz idzie jesienną drogą obsadzoną czerwonymi liliami pod nocnym niebem.
...
### No. 76: Pełnopostaciowy Portret Edytorski w Kolorze Burgunda
...
Ultrarealistyczny edytorski portret pewnego siebie czarnoskórego mężczyzny w eleganckim garniturze, siedzącego w minimalistycznym studiu.
...
### No. 77: Popołudnie Mistrzyni Błękitnej Magii
...
Scena przedstawiająca popołudnie Mistrzyni Błękitnej Magii, której magia rozprasza światło słoneczne i kostkę brukową, zanim dotrą do niej.
...
### No. 78: Zachód Słońca nad Pękniętą Ziemią z Płomieniami
...
Opisowy prompt do sceny przedstawiającej zmierzch na dzikich terenach, z cienkimi płomieniami wydobywającymi się ze szczelin w ziemi i Morzem Kaspijskim w oddali.
...
### No. 79: Zabytkowy Żaglowiec o Złotym Zachodzie Słońca
...
Ultrarealistyczny obraz zabytkowego drewnianego żaglowca w dramatycznej scenie zachodu słońca na oceanie.
...
### No. 80: Rycerz Białego Smoka Sprawdzający Kontuzję Skrzydła
...
Scena, w której Mistrz Rycerza Białego Smoka ostrożnie sprawdza kontuzję lewego skrzydła śpiącego smoka w oświetlonej księżycem smoczej stajni.
...
### No. 81: Podróżnik Naprawiający Niebieską Tkaninę w Wulkanicznym Mieście
...
Scena naprawiania niebieskiej tkaniny podróżnej w wulkanicznym mieście po południu, z odległymi górami w tle.
...
### No. 82: Poranek w Świecie Luster z Włócznikiem
...
Prompt przedstawiający włócznika, który utracił swój największy tytuł, rozpoczynającego dzień od mokrych sznurowadeł w poranek świata luster.
...
### No. 83: Mistrzyni Niebieskiej Magii Luna Przed Świtem
...
Scena przedstawiająca Mistrzynię Niebieskiej Magii Lunę przed świtem, z książkami, krzesłem i herbatą, z czasów, gdy nie potrzebowano jeszcze jej ciała.
...
### No. 84: Krajobraz, Gdzie Ogień Wycieka z Ziemi
...
Opisowy prompt do krajobrazu, w którym ogień wycieka z ziemi na suchej pustkowi, z płynącym szarym błotem i Morzem Kaspijskim w oddali.
...
### No. 85: Nocna Rycerka Czarnego Smoka Luna
...
Scena przedstawiająca Rycerkę Czarnego Smoka Lunę nocą, sprawdzającą odciski na dłoniach od włóczni, podczas gdy El Drago śpi obok niej.
...
### No. 86: Frieren i Fern w Dobrym Miejscu
...
Ilustracja SFW przedstawiająca rozmowę między postaciami Fern i Frieren.
...
### No. 87: Wzgórza Rzeźbione Przez Wiatr i Deszcz
...
Poetycki prompt opisujący krajobraz, gdzie zieleń blaknie, odsłaniając warstwy ochry, rdzy, szaro-bieli i bladej zieleni na wzgórzach rzeźbionych przez wiatr i deszcz.
...
### No. 88: Starożytna Dama z Wachlarzem Przed Bambusem
...
Prompt AI do wygenerowania tapety w estetyce wschodniej, przedstawiającej klasyczną kobietę z okrągłym wachlarzem na tle białej ściany i cieni bambusa.
...
### No. 89: Policyjne Roboty Ratunkowe Holujące Łódź Ratunkową
...
Prompt przedstawiający Zespół Ciężkich Maszyn Roboticznych Tokijskiej Policji, ratujący ewakuowanych osób poprzez holowanie łodzi ratunkowej.
...
### No. 90: Miejskie Obserwatorium, Dzienne Zdjęcie w Stylu CCD
...
Prompt do wygenerowania jasnego, dziennego zdjęcia lifestylowego w stylu CCD, przedstawiającego urban exploration na tarasie obserwatorium astronomicznego.
...
### No. 91: Pionowy Portret Lifestylowy z iPhona
...
Prompt do wygenerowania realistycznego, naturalnego portretu młodej kobiety w stylu zdjęć z iPhone'a.
...
### No. 92: Plakat w Nowym Stylu Chińskim z Kwiatowym Oknem
...
Prompt do generowania obrazu przedstawiającego elegancki, minimalistyczny plakat orientalny z klasyczną kobietą przy szmaragdowo-zielonym, kwiatowym oknie.
...
### No. 93: Fotorealistyczny Portret Edytorialny Azjatki
...
Szczegółowy prompt do wygenerowania fotorealistycznego portretu edytorialnego młodej kobiety pochodzenia wschodnioazjatyckiego (do kolan, na poziomie oczu) z określonymi cechami twarzy.
...
### No. 94: Roboty Jednostki Ciężkich Maszyn Policji Sprzątające Rzekę
...
Prompt opisujący oddział robotów z policyjnej jednostki ciężkich maszyn, sprzątający śmieci, które tamują przepływ rzeki.
...
### No. 95: Fotorealistyczny Portret Edytorialny z Twarzą w Kształcie Serca
...
Szczegółowy prompt do wygenerowania edytorialnego portretu (do kolan, na poziomie oczu) młodej kobiety pochodzenia wschodnioazjatyckiego z określonymi cechami twarzy.
...
### No. 96: Portret z iPhona Młodej Kobiety
...
Prompt do wygenerowania realistycznego, swobodnego, pionowego zdjęcia (format 9:16) kobiety w wieku 20-26 lat, jakby wykonanego głównym aparatem iPhone'a.
...
### No. 97: Kobieta Zen nad Wodą Latem
...
Prompt do wygenerowania tapety w estetyce wschodniej, przedstawiającej kobietę nad wodą w minimalistycznym, orzeźwiającym stylu.
...
### No. 98: Portret w Ujęciu Cowboy Shot Azjatki
...
Szczegółowy prompt do fotorealistycznego, edytorialnego portretu młodej kobiety pochodzenia wschodnioazjatyckiego (ujęcie od bioder w górę) z określonymi cechami twarzy.
...
### No. 99: Modowe Zdjęcie w Miejskiej Książkowej Kafejce na Dachu
...
Prompt do wygenerowania jasnego, dziennego zdjęcia lifestylowego w stylu CCD, z miejską, artystyczną scenerią i określonym ubiorem.
...
### No. 100: Fotorealistyczny Portret Edytorialny Azjatki
...
Szczegółowy prompt do wygenerowania edytorialnego portretu (do kolan, na poziomie pasa) młodej kobiety pochodzenia wschodnioazjatyckiego z określonymi cechami twarzy.
...
### No. 101: Minimalistyczny Plakat Okładkowy w Stylu Orientalnym Zen
...
Prompt do wygenerowania minimalistycznej tapety orientalnej, przedstawiającej pełną gracji kobietę w starożytnym stylu, przechodzącą przez niebieskie drzwi z wiśniowymi kwiatami.
...
### No. 102: Policyjny zespół robotów Jednostki Ciężkiego Sprzętu
...
Obraz przedstawiający policyjny zespół robotów z Jednostki Przeciwdziałania Ciężkiemu Sprzętowi usuwający pojazdy z drogi zalanej ulewą.
...
### No. 103: Dzienne, jasne, miejskie zdjęcie życia sportowego w stylu CCD
...
Prompt do wygenerowania jasnego, dziennego zdjęcia lifestyle'owego w stylu CCD, osadzonego w miejskim otoczeniu sportowym.
...
### No. 104: Zen, minimalistyczny, pionowy plakat okładkowy
...
Prompt do stworzenia minimalistycznej, jasnej i czystej pionowej okładki w formacie 9:16 z nowoczesną, wschodnią estetyką kobiecą i porannym klimatem.
...
### No. 105: Kobieta siedząca przy okrągłym oknie
...
Prompt do wygenerowania minimalistycznego plakatu w stylu wschodniego Zen, przedstawiającego kobietę odpoczywającą przy okrągłym oknie.
...
### No. 106: Policyjny oddział robotów zatrzymujący wymykającą się spod kontroli ciężarówkę
...
Obraz przedstawiający policyjny oddział robotów z Jednostki Przeciwdziałania Ciężkiemu Sprzętowi, próbujący zatrzymać wymykającą się spod kontroli ciężarówkę.
...
### No. 107: Pełnokadrowy portret edytorialny młodej kobiety
...
Prompt do pełnokadrowego, edytorialnego portretu młodej Japonki lub Koreanki na poziomie oczu, noszącej kolczyki typu hoop.
...
### No. 108: Fotorealistyczny portret do pasa z okularami
...
Portret do pasa, widziany z poziomu kolan, przedstawiający młodą Japonkę lub Koreankę noszącą śmiałe, białe okulary w grubej oprawie.
...
### No. 109: Zen, minimalistyczny plakat okładkowy z kobietą i dzwonkiem wietrznym
...
Prompt do wygenerowania obrazu przedstawiającego kobietę dotykającą dzwonka wietrznego przy oknie, w minimalistycznym stylu wschodniego Zen.
...
### No. 110: Postapokaliptyczne miasto z zieloną roślinnością
...
Szczegółowe zdjęcie postapokaliptycznego miasta w Shenzhen w Chinach, porośniętego zieloną roślinnością.
...
### No. 111: Japonka o twarzy podobnej do tanuki w nocnej scenerii
...
Prompt do wygenerowania fotorealistycznego obrazu fikcyjnej młodej Japonki o twarzy podobnej do tanuki, w cichej, nocnej scenerii.
...
### No. 112: Widok delfina na kobiety w szklanym akwarium
...
Realistyczny obraz z perspektywy delfina, patrzącego przez okrągłe, szklane akwarium na kobiety odwiedzające tętniące życiem, damskie akwarium.
...
### No. 113: Miniaturowa scena sklepu markowego z gliny polimerowej
...
Prompt do stworzenia miniaturowego modelu z gliny przedstawiającego sklep markowy z przytulnymi detalami chodnika.
...
### No. 114: Reklama mody z niskim ujęciem na przechylonym podłożu
...
Kampania reklamowa mody dla fikcyjnej marki, przedstawiająca sześć osób w żywych ubraniach na tle kobaltowego nieba, ujęcie z niskiej perspektywy.
...
### No. 115: Ręcznie rysowany pojedynek anime z wiśniowymi kwiatami
...
Scena z ręcznie rysowanego japońskiego filmu animowanego z końca lat 90., przedstawiająca kobietę z kataną naprzeciwko szermierza pod opadającymi kwiatami wiśni.
...
### No. 116: Czarna, nawiedzona panna młoda - gothic suknia ślubna
...
Prompt na strój gothic, halloweenowej, horrorowej panny młodej z mroczną, romantyczną elegancją.
...
### No. 117: Nastrojowy, filmowy portret młodej Azjatki
...
Prompt na wysoko kontrastowy, filmowy zbliżony portret młodej kobiety z Azji Wschodniej o bladej skórze i długich, czarnych włosach.
...
### No. 118: Filmowy nocny portret uliczny na mokrym przejściu dla pieszych
...
Prompt na filmowy portret młodej kobiety z Azji Wschodniej na mokrym przejściu dla pieszych w nocy.
...
### No. 119: Zbliżony portret z jarzącymi się złotymi oczami
...
Prompt na filmowy, zbliżony portret młodej kobiety z Azji Wschodniej z kruczoczarnymi włosami i jarzącymi się złotymi oczami.
...
### No. 120: Fotorealistyczny portret w okularach z mrugnięciem
...
Fotorealistyczny portret młodej Azjatki w okularach z falowanymi włosami, delikatnie mrugającej okiem.
...
### No. 121: Portret w stylu analogowego filmu z rozwichrzonymi włosami
...
Fotorealistyczny portret w stylu analogowego filmu przedstawiający młodą Azjatkę z rozczochranymi czarnymi włosami, patrzącą w obiektyw.
...
### No. 122: Filmowy portret unoszący się w ciemnej wodzie
...
Filmowy portret spokojnej młodej kobiety unoszącej się w nieruchomej wodzie z mokrymi włosami.
...
### No. 123: Studyjny portret piękna z bocznym warkoczem
...
Fotorealistyczny studyjny portret piękna młodej Azjatki o świetlistej cerze, długich czarnych włosach i zamkniętych oczach.
...
### No. 124: Portret kobiety w samochodzie w hidżabie
...
Fotorealistyczne zbliżenie portretowe młodej Azjatki w samochodzie, noszącej jasnobeżowy hidżab.
...
### No. 125: Kobieta robiąca sobie selfie w hidżabie
...
Prompt do wygenerowania obrazu młodej kobiety w jasnym hidżabie, robiącej sobie selfie przy drewnianym stole.
...
### No. 126: Portret kobiety spoglądającej przez ramię
...
Szczegółowy prompt do wygenerowania fotorealistycznego portretu młodej Azjatki spoglądającej przez ramię.
...
### No. 127: Portret kobiety w okularach
...
Portret młodej Azjatki w okularach, z falowanymi włosami i spokojnym wyrazem twarzy.
...
### No. 128: Zbliżony portret z żywą szminką
...
Fotorealistyczny portret młodej Azjatki o porcelanowej cerze, migdałowych oczach i żywej szmince.
...
### No. 129: Portret z mokrymi włosami i obnażonym ramieniem
...
Fotorealistyczny portret młodej kobiety o wilgotnej cerze i mokrych czarnych włosach, spoglądającej przez ramię.
...
### No. 130: Filmowy portret Azjatki
...
Zbliżony portret młodej Azjatki z długimi ciemnymi falowanymi włosami na czarnym tle.
...
### No. 131: Fotorealistyczny portret w okularach
...
Fotorealistyczny portret młodej Azjatki z długimi falowanymi włosami, okrągłymi okularami i łagodnym wyrazem twarzy.
...
### No. 132: Filmowy portret z miodowymi pasemkami
...
Prompt do filmowego zbliżonego portretu młodej Azjatki z falowanymi jasnobrązowymi włosami i spokojnym wyrazem twarzy.
...
### No. 133: Fotorealistyczny portret z fryzurą na bobka
...
Fotorealistyczne zbliżenie portretowe młodej Azjatki z krótkim czarnym bobkiem, dymnym cieniem do powiek i promienną cerą.
...
### No. 134: Portret kobiety w hidżabie i czapce
...
Zbliżony portret młodej kobiety o jasnej karnacji i spokojnym wyrazie twarzy, ubranej w biały hidżab i czarną czapkę baseballową.
...
### No. 135: Selfie w szyfonowym hidżabie
...
Zbliżony portret selfie młodej kobiety pochodzenia wschodnioazjatyckiego o jasnej karnacji i delikatnych rysach twarzy, noszącej brudnoróżowy szyfonowy hidżab.
...
### No. 136: Filmowy portret zapłakanej kobiety z Azji Wschodniej
...
Fotorealistyczny, zbliżony portret młodej kobiety o błyszczącej, zlanymi łzami skórze i delikatnych grzywkach.
...
### No. 137: Portret kobiety z wysadzaną klejnotami koronkową opaską na oko
...
Zbliżony portret młodej kobiety o bladej skórze i czarnej, krótkiej fryzurze, z jednym widocznym czerwonym okiem, a drugim zakrytym wysadzaną klejnotami czarną koronkową opaską.
...
### No. 138: Intensywny filmowy portret z rozwichrzonymi włosami
...
Zbliżony, filmowy portret młodej kobiety z długimi czarnymi włosami, patrzącej prosto w obiektyw.
...
### No. 139: Zbliżony portret z błyszczącymi ciemnymi włosami
...
Szczegółowy prompt do wygenerowania portretu młodej kobiety o jasnej karnacji i długich ciemnych włosach.
...
### No. 140: Uśmiechnięty, nasłoneczniony portret z połyskiem potu
...
Zbliżony portret młodej kobiety pochodzenia wschodnioazjatyckiego z rozwichrzonymi czarnymi włosami, mrużącej oczy i uśmiechającej się, z zaróżowioną, wilgotną skórą.
...
### No. 141: Ekspresyjny portret z eyelinerem w kształcie skrzydełek
...
Szczegółowy prompt do wygenerowania zbliżonego portretu młodej kobiety pochodzenia południowoazjatyckiego o określonych rysach twarzy i makijażu.
...
### No. 142: Selfie z wyrazem twarzy do pocałunku
...
Prompt do zbliżonego portretu selfie młodej kobiety pochodzenia wschodnioazjatyckiego z zamkniętymi oczami i rozluźnionym wyrazem twarzy.
...
### No. 143: Portret uśmiechniętej młodej kobiety
...
Prompt do wygenerowania portretu młodej kobiety pochodzenia wschodnioazjatyckiego lub indonezyjskiego o jasnej cerze, delikatnym makijażu i łagodnym, przyjaznym wyrazie twarzy.
...
### No. 144: Selfie kobiety z włosami związanymi w półkucyk
...
Prompt do wygenerowania fotorealistycznego portretu selfie młodej kobiety pochodzenia wschodnioazjatyckiego o określonych cechach i stylizacji.
...
### No. 145: Fazy pochłaniania Ziemi przez czarną dziurę
...
Prompt do wygenerowania czterech obrazów przedstawiających wizualne fazy pochłaniania Ziemi przez czarną dziurę z punktu widzenia ludzkiego obserwatora.
...
### No. 146: Postacie: Wojownik cyberpunk vs. mechaniczny boss
...
Prompt opisujący dwie postacie: wojownika cyberpunk z kataną oraz masywną mechaniczną istotę-bossa.
...
### No. 147: Niebiańska Bogini zstępująca przed Pałacem
...
Obraz majestatycznej chińskiej niebiańskiej bogini w ceremonialnym hanfu, zstępującej przez różowo-złote chmury przed niebiański pałac.
...
### No. 148: Niebiańska Dziewica w świetle poranka (widok z 3/4)
...
Obraz niebiańskiej dziewicy w kościanym hanfu, oświetlonej porannym światłem, z płynącymi wstęgami i złotymi spinekami do włosów.
...
### No. 149: Niebiańska Dziewica siedząca przy Jadeitowym Stawie
...
Obraz spokojnej chińskiej niebiańskiej dziewicy w jedwabnym hanfu, dotykającej lotosu przy turkusowym stawie.
...
### No. 150: Niebiańska Bogini na stopniach Jadeitowego Pałacu
...
Obraz eleganckiej chińskiej niebiańskiej bogini na szczycie białych jadeitowych schodów, w haftowanym hanfu z unoszącymi się jedwabnymi wstęgami.
...
### No. 151: Portret w starożytnej chińskiej świątyni rytualnej
...
Fotorealistyczny, filmowy portret dorosłej Azjatki wschodniej w ciemnej, starożytnej chińskiej świątyni rytualnej z maskami Nuo i świecami.
...
### No. 152: Portret kobiety w ciemnej świątyni rytualnej
...
Fotorealistyczny, filmowy portret Azjatki wschodniej z mokrymi czarnymi włosami i dymnym makijażem w ciemnej, starożytnej świątyni.
...
### No. 153: Portret zbliżeniowy nocą podczas Festiwalu Nuo
...
Portret zbliżeniowy dorosłej Azjatki wschodniej obok zniszczonej maski Nuo podczas nocnego festiwalu rytualnego.
...
### No. 154: Piwo z gęstą koroną piany
...
Prompt do wygenerowania fotorealistycznego obrazu piwa z gęstą, kaskadową koroną piany na szklance z ostrym rantem.
...
### No. 155: Kostka tofu uniesiona z gulaszu
...
Opisowy prompt do obrazu porowatej kostki tofu uniesionej nad garnkiem, z pojedynczą kroplą bursztynowego bulionu przyczepioną do niej.
...
### No. 156: Łyżka pikantnej pasty chili
...
Obraz łyżki pikantnej pasty chili z wyraźnymi czerwonymi kostkami chili, przyciemnionymi na kolor herbaty zieleninami, jasnozieloną papryką, jasnymi fasolkami i przejrzystym bursztynowo-czerwonym olejem.
...
### No. 157: Portret zbliżeniowy kobiety w salonie
...
Ultrarealistyczne zbliżenie portretowe młodej kobiety z figlarnym wyrazem twarzy w przytulnym, nowoczesnym salonie.
...
### No. 158: Portret kobiety leżącej w przyciemnionej sypialni
...
Prompt do fotorealistycznego, pionowego portretu młodej kobiety leżącej na pościeli w przyciemnionej sypialni nocą.
...
### No. 159: Oniryczny portret kobiety w letniej trawie
...
Obraz inspirowany filmem, przedstawiający młodą kobietę pochodzenia wschodnioazjatyckiego odpoczywającą w wysokiej trawie, delikatnie oświetloną ciepłym światłem dziennym.
...
### No. 160: Portret kobiety przy jasnoniebieskim porcie
...
Portret w stylu ziarna filmowego, przedstawiający młodą kobietę pochodzenia wschodnioazjatyckiego swobodnie kucającą przy jasnoniebieskim porcie w słoneczny, wietrzny dzień.
...
### No. 161: Portret młodej kobiety na paryskiej ulicy
...
Prompt do portretu ulicznego w wysokiej rozdzielczości, wykonanego w naturalnym świetle, przedstawiającego młodą kobietę o azjatyckim wyglądzie na ulicy handlowej inspirowanej Paryżem.
...
### No. 162: Reportażowy portret w metrze nocą
...
Fotorealistyczny, reportażowy portret dorosłej kobiety pochodzenia wschodnioazjatyckiego, siedzącej przy oknie pociągu nocą.
...
### No. 163: Zegarek z lodowo-dymną falą uderzeniową
...
Obraz przedstawiający zegarek z okrągłą falą uderzeniową z lodu i dymu za nim, zachowującą czysty sylwetkowy kształt.
...
### No. 164: Warstwowy wystrój piekarni z głębią
...
Prompt do wygenerowania obrazu premiumowej wystawy piekarniczej z produktami ułożonymi na wyraźnych poziomach wysokości, aby stworzyć wrażenie głębi.
...
### No. 165: Delikatnie oświetlony portret w sypialni w satynowej sukience
...
Fotorealistyczny portret dorosłej kobiety pochodzenia wschodnioazjatyckiego w kościanej, satynowej sukience w delikatnie oświetlonej sypialni.
...
### No. 166: Samochód z Kontrastującym Piochem Wybuchowego Kurzu
...
Obraz potężnego samochodu, który generuje za sobą ogromny pióropusz kurzu, pozostając jednocześnie czysty i cichy na pierwszym planie.
...
### No. 167: Silhouetka Wiedźmy Podświetlona Przez Kosmiczny Ogień
...
Obraz przedstawiający sylwetkę wiedźmy podświetloną przez masywną, pomarańczowo-złotą chmurę kosmicznego ognia.
...
### No. 168: Serce z Błyszczącego Sosu Pomidorowego Wznoszące się z Miski Koshari
...
Obraz przedstawiający błyszczący sos pomidorowy formujący kształt serca unoszący się nad miską koshari.
...
### No. 169: Figury Szachowe Wyrzeźbione z Nitek Makaronu
...
Prompt do wygenerowania figur szachowych wyrzeźbionych z ręcznie robionych nitek makaronu o rozpoznawalnych sylwetkach.
...
### No. 170: Butelka Oleju Sezamowego z Rękoma Boksera na Ringu
...
Obraz przedstawiający przewymiarowaną butelkę oleju sezamowego ze złotymi rękami boksera stojącego zwycięsko na ringu bokserskim.
...
### No. 171: Scena z Blatem w Kompaktowej Nowoczesnej Kuchni Apartamentowej
...
Prompt do wygenerowania obrazu kompaktowej, nowoczesnej kuchni apartamentowej z blatem śniadaniowym, ciągłym blatem roboczym, stalową zlewą, kuchenką i patelnią.
...
### No. 172: Wrap Shawarma Uniesiony Pod Kątem Jak Rakieta
...
Prompt do wygenerowania obrazu wrapa shawarma ustawionego pod kątem niczym rakieta, z naciskiem na otwarte nadzienie jako punkt centralny.
...
### No. 173: Maskotka-Banan Trzymająca Przewymiarowaną Puszkę
...
Obraz przedstawiający biegnącą maskotkę w kształcie banana, która trzyma przewymiarowaną, zimną aluminiową puszkę wyciągniętą w stronę kamery.
...
### No. 174: Reportażowe Zdjęcie Nocne Wschodnioazjatyckiej Kobiety
...
Prompt do wygenerowania realistycznego, reportażowego zdjęcia Wschodnioazjatyckiej kobiety o określonych cechach i oświetleniu.
...
### No. 175: Krem Ciasteczka jako Miniaturowa Powierzchnia do Jazdy na Łyżwach
...
Obraz przedstawiający ciastko, w którym warstwa waniliowego kremu unosi się, tworząc gładką, miniaturową powierzchnię do jazdy na łyżwach, przekształcając skalę w zimowy świat.
...
### No. 176: Tor Kolejki Górskiej z Ułożonych w Stos Chrupek
...
Obraz przedstawiający tor kolejki górskiej skonstruowany z idealnie ułożonych w stos chrupek, zawierający pełną pętlę.
...
### No. 177: Czerwone Strefy Świateł Punktowych za Głównym Wiaderkiem
...
Prompt do obrazu opisujący trzy czyste, czerwone strefy świateł punktowych z drugoplanowymi scenkami z życia codziennego umieszczonymi za głównym, eksponowanym wiaderkiem.
...
### No. 178: Błyszczący Strumień Makaronu jako Pionowa Linia Ruchu
...
Koncepcja minimalistycznego plakatu przedstawiająca pojedynczy, błyszczący strumień makaronu jako centralny, pionowy element.
...
### No. 179: Filmowa Animacja 2.5D w Stylu Gwaszu
...
Prompt do stworzenia filmowej animacji 2.5D w malarskim, koncepcyjnym stylu gwaszu z widoczną teksturą pędzla i płaskimi plamami barwnymi.
...
### No. 180: Nastrojowy, filmowy portret w ciemności
...
Filmowy portret mężczyzny z rozczochranymi włosami wyłaniającego się z cienia, z dramatycznym oświetleniem i ultrarealistyczną teksturą.
...
### No. 181: Gigantyczny mężczyzna obok Statuy Wolności
...
Ultrarealistyczne, filmowe zdjęcie podróżnicze przedstawiające przystojnego młodego mężczyznę jako giganta stojącego obok Statuy Wolności.
...
### No. 182: Portret w złotej godzinie na rustykalnym ganku
...
Ciepły, naturalny portret lifestylowy młodego mężczyzny pijącego herbatę na rustykalnym ganku podczas złotej godziny.
...
### No. 183: Filmowy portret na łące
...
Ultrarealistyczny portret kobiety w kapeluszu kowbojskim stojącej na zielonej łące z bylicą i sosnami.
...
### No. 184: Pionowy, naturalny portret kobiety
...
Prompt do wygenerowania pionowego, naturalnego zdjęcia młodej kobiety pochodzenia wschodnioazjatyckiego o określonych cechach.
...
### No. 185: Pasek po przekątnej z rozdartą strefą smaku
...
Prompt do wygenerowania obrazu zapakowanego po przekątnej deserowego batonika z rozdartym opakowaniem, tworzącym efekt otwartych ust w obrębie świata tematycznie związanego z deserami.
...
### No. 186: Portret kobiety w owalnym lustrze
...
Portret piękności kobiety odbity w pionowym, owalnym lustrze, z matową, kobaltową szminką na ustach.
...
### No. 187: Wir kufla piwa na pustyni
...
Surrealistyczny obraz wysokiego kufla piwa wyłaniającego się z pustyni jako wijący się wir z piasku i piwa.
...
### No. 188: Butelka piwa na pierwszym planie
...
Prompt do stworzenia obrazu przedstawiającego dużą, ostrą, częściowo przyciętą, prawdziwą butelkę piwa w prawym dolnym rogu pierwszego planu.
...
### No. 189: Obraz Mondriana jako biurkowy schowek
...
Prompt do przekształcenia 'Kompozycji z czerwienią, błękitem i żółcią' Mondriana w funkcjonalny biurkowy schowek z kolorowymi szufladami.
...
### No. 190: Realistyczny obraz surrealistycznej rzeczy
...
Prompt do wygenerowania wysoce realistycznego obrazu wymyślonego, surrealistycznego obiektu.
...
### No. 191: Malutcy ludzie w świecie mandarynki
...
Obraz przedstawiający miniaturowych ludzi żyjących wewnątrz mandarynki, gdzie segmenty owocu tworzą architekturę.
...
### No. 192: Groźna postać w ostrym profilu
...
Prompt do wygenerowania obrazu groźnej postaci z kruczoczarnymi włosami i krwistoczerwonymi ustami, ukazanej w ostrym profilu.
...
### No. 193: Reklama fikcyjnej aplikacji randkowej
...
Prompt do wygenerowania reklamy aplikacji randkowej przedstawiającej młode modele z grupy etnicznej Kalenjin.
...
### No. 194: Portret na dachu z radiem przed wschodem słońca
...
Prompt do wygenerowania portretu naznaczonej życiem twarzy na dachu, z radiem, tuż przed wschodem słońca.
...
### No. 195: Pusty tunel Fushimi Inari o świcie
...
Prompt do wygenerowania spokojnej, porannej sceny przedstawiającej ikoniczne, cynobrowe bramy w chramie Fushimi Inari w Kioto, w stylu obrazu kampanii podróżniczej.
...
### No. 196: Wewnętrzny Świat Oparty na Preferencjach Sztuki AI
...
Prompt żądający ilustracji odzwierciedlającej wewnętrzny świat użytkownika na podstawie jego wcześniejszych preferencji dotyczących sztuki AI.
...
### No. 197: Makro Ujęcie Futurystycznego Procesora-Miasta
...
Prompt do makro ujęcia przezroczystego, wielkości pokoju procesora, zawierającego świecące się miasto.
...
### No. 198: Symboliczny Autoportret Języka i Kodu
...
Obraz przedstawiający symboliczny autoportret, w którym język, kod i kreatywność są połączone światłem.
...
### No. 199: Obcy Świat ze Śródziemnomorskim Retro-Futuryzmem
...
Prompt do wygenerowania obrazu ludzkiej osady na obcym świecie, prezentującej architekturę inspirowaną stylem śródziemnomorskim z elementami retro-futuryzmu.
...
### No. 200: Portret Krio Archona Carycy Anastazji
...
Prompt do wygenerowania portretu Carycy, Krio Archona i władczyni, opisywanej za pomocą różnych królewskich i pełnych smutku tytułów.
...
### No. 201: Przystanek Autobusowy w Porannej Mgle
...
Poetycki obraz przystanku autobusowego w porannej mgle, gdzie para unosi się, zanim ktokolwiek przybędzie, a najwcześniejszy pociąg jest myślą w środku.
...
### No. 202: Noc w Praniu z Meduzami i Kosmiczną Prognozą
...
Scena przedstawiająca pralnię nocą, z meduzami na zewnątrz, gdzie dziewczyna sprawdza kosmiczną prognozę pogody.
...
### No. 203: Portret Wojowniczki Wuxia
...
Prompt do wygenerowania portretu o proporcjach 9:16 wysokiej, eleganckiej wojowniczki z Azji Wschodniej w warstwowej zbroi i szatach, dzierżącej długi miecz.
...
### No. 204: Zdjęcie telefonem w stylu retro kobiety na wsi
...
Prompt do stworzenia obrazu w formacie 9:16 przedstawiającego młodą Azjatkę w wiejskiej scenerii, uchwyconej w estetyce retro telefonu.
...
### No. 205: Dwie kobiety w qipao w chińskim ogrodzie
...
Prompt do wygenerowania hiperrealistycznego zdjęcia dwóch młodych Azjatek w nowoczesnych, chińskich qipao, siedzących w spokojnym, tradycyjnym ogrodzie.
...
### No. 206: Selfie tancerki w odcieniach szarości
...
Prompt do stworzenia pionowego, realistycznego selfie w formacie 9:16 młodej azjatyckiej tancerki w chłodnym, onirycznym, wysokiej klasy stylu życia w odcieniach szarości.
...
### No. 207: Redakcyjna fotografia sceniczna koncertu K-Pop
...
Prompt do stworzenia filmowego, redakcyjnego zdjęcia 20-letniej żeńskiej idoli K-pop na koncercie.
...
### No. 208: Elegancka Azjatka na kamiennym balkonie
...
Prompt do zdjęcia modowego w pionie 9:16, przedstawiającego piękną dorosłą Azjatkę opartą o klasyczną kamienną balustradę.
...
### No. 209: Malowniczy krajobraz z dramatycznymi chmurami kłębiastymi
...
Prompt do wygenerowania szczegółowego, romantycznego krajobrazu w stylu sztuki pięknej, skupionego na świetlistym niebie i strzelistych chmurach.
...
### No. 210: Link ścigany przez kurczaki-marionetki
...
Obraz przedstawiający Linka ściganego przez rozwścieczone stado puszystych kurczaków-marionetek przez Wioskę Kakariko.
...
### No. 211: Tarasy ryżowe na Bali o świcie
...
Prompt do obrazu przedstawiającego spokojną, mglistą poranną scenę tarasów ryżowych na Bali, w stylu kampanii podróżniczej.
...
### No. 212: Pixel art skaczącego Księcia Persji
...
Prompt do wygenerowania obrazu w stylu Cobalt Dither Monumentalism, przedstawiającego oryginalną postać Księcia Persji skaczącą między platformami.
...
### No. 213: Łagodny Shinigami prowadzący dusze
...
Poetycki prompt opisujący dziewczynę, żniwiarza śmierci, stojącą na granicy życia i śmierci w zimnej nocnej mgle, wyciągającą dłoń jako przewodnika do cichego pożegnania.
...
### No. 214: Złote talizmany w ciemną noc
...
Scena, w której noc pogrąża się w czerni, a jedynie złoto oświetla talizmaniczną obecność, zawierająca słowa 'Nocny Spacer' i 'Tłumić Zło'.
...
### No. 215: Sen panny młodej na granicy
...
Poetycki prompt opisujący nieludzką dziewczynę na granicy życia i śmierci, śniącą o zostaniu panną młodą i widzącą swoje odbicie.
...
### No. 216: Yokai czytający w deszczowym pokoju
...
Scena przedstawiająca budzącą strach istotę, Fufu, czytającą książkę w starym pokoju w deszczowy dzień, wraz z małym ptaszkiem, który się tam zabłąkał.
...
### No. 217: Arkusz sprite'ów w pixel art postaci lisa
...
Prompt do wygenerowania dopracowanego arkusza animacji w pixel art postaci o imieniu Noxa, małego lisa zbierającego gwiazdy.
...
### No. 218: Infografika koncepcyjna składanego telefonu Apple
...
Prompt do wygenerowania fotorealistycznej infografiki przedstawiającej koncepcyjny składany telefon Apple w charakterystycznym, czystym stylu marki.
...
### No. 219: Zbliżony portret pięknej młodej Azjatki
...
Fotorealistyczne zbliżenie portretowe młodej Azjatki z miękkim oświetleniem i szczegółowo oddaną fakturą skóry.
...
### No. 220: Azjatka przy nadmorskiej drodze o zachodzie słońca
...
Fotorealistyczne, naturalne zdjęcie młodej Azjatki stojącej przy nadmorskiej drodze o zachodzie słońca, widziane z wnętrza samochodu.
...
### No. 221: Makro ujęcie z poziomu wody: Liść lotosu jako wyspa
...
Prompt do kinowego ujęcia makro z poziomu wody, przedstawiającego liść lotosu jako wyspę zamieszkaną przez trzy maleńkie postacie w hanfu.
...
### No. 222: Gigantyczny trójzębny pazur z ostrzem jak katana
...
Prompt do stworzenia gigantycznej, dwuręcznej broni z trzema zębami, których ostrza są naostrzone i wypolerowane jak japoński miecz.
...
### No. 223: Ambasador pory roku w porannym świetle
...
Poetycki prompt opisujący ambasadora pory roku w porannym świetle, z magazynową skórą i szkłem tak cienkim, że niczego nie ukrywa.
...
### No. 224: Portret profilowy z geometryczną złotą koroną
...
Prompt do obrazu przedstawiającego władczą postać w ostrym profilu, noszącą koronę z geometrycznych złotych dysków na spiętych ciemnych włosach.
...
### No. 225: Promienna księżniczka z diamentową tiara
...
Prompt AI do obrazu przedstawiającego promienną postać w ostrym profilu, noszącą przewymiarowaną diamentową tiarę.
...
### No. 226: Zbliżony portret Azjatki w stylu wuxia
...
Hiperrealistyczny portret młodej Azjatki w stylu wuxia z ekstremalnie szerokokątną perspektywą.
...
### No. 227: Portret pełnej postaci kobiety w domowym otoczeniu
...
Prompt do pionowego (9:16), pełnofigurowego, hiperrealistycznego zdjęcia młodej Azjatki w leniwej, domowej atmosferze z ciepłymi, kinowymi tonami.
...
### No. 228: Arkusz sprite'ów postaci chibi z 16 pozami
...
Prompt do wygenerowania arkusza sprite'ów postaci chibi z różnymi pozami, ułożonymi w siatce 4x4.
...
### No. 229: Fotorealistyczne Selfie Smartfonem w Sypialni
...
Fotorealistyczne selfie w formacie krajobrazowym, wykonane smartfonem, przedstawiające młodą Azjatkę ze Wschodu relaksującą się na łóżku nocą.
...
### No. 230: 3D Miniaturowy Kraj z Ikonicznych Zabytków
...
Prompt do wygenerowania trójwymiarowej miniaturowej mapy, na której granice kraju tworzą jego ikoniczne zabytki i symbole kulturowe.
...
### No. 231: Filmowy Portret Kobiety w Paryżu
...
Prompt do stworzenia ultrarealistycznego, filmowego zdjęcia przedstawiającego kobietę z Azji Południowo-Wschodniej w hidżabie, spacerującą w pobliżu wieży Eiffla.
...
### No. 232: Zwierzęta Odbudowane z Luksusowych Tkanin Mody
...
Prompt do wygenerowania siatki 2x2 przedstawiającej zwierzęta zrekonstruowane przy użyciu charakterystycznych tkanin czterech ikonicznych domów mody luksusowej.
...
### No. 233: Plakat Kampanii Premium Smartfona
...
Prompt do wygenerowania wysokiej klasy plakatu promocyjnego smartfona w charakterystycznym stylu Apple.
...
### No. 234: Nowoczesny Plakat Podróżniczy z Architekturą
...
Prompt do stworzenia wysokiej jakości plakatu podróżniczego w stylu vintage sitodruku z kompozycją architektonicznego portalu.
...
### No. 235: Poklatkowa Animacja Plastelinowego Charmandera Wykluwającego się
...
Prompt do stworzenia animacji poklatkowej w stylu claymation, przedstawiającej plastelinowego Charmandera wykluwającego się z jaja i ziejącego ogniem.
...
### No. 236: Jabłko Magritte'a jako Stos Notatników
...
Kreatywna reinterpretacja 'Syna człowieczego' Magritte'a, w której unoszące się jabłko zastąpiono stosem papierowych notatek w kształcie jabłka.
...
### No. 237: Hiperrealistyczny Portret Mody w Japońskim Domu
...
Hiperrealistyczny portret modowy przedstawiający kobietę idącą tradycyjnym japońskim drewnianym korytarzem.
...
### No. 238: Ultra-Minimalistyczna Tapeta z Cesarstwem Rzymskim
...
Ultra-minimalistyczna tapeta przedstawiająca wspaniałą rzymską świątynię z kolumnami, akweduktami i ruinami w ciepłych, złotych tonacjach.
...
### No. 239: Klatka Anime z Deszczowym Peronem
...
Prompt do wygenerowania nieistniejącej klatki anime przedstawiającej deszcz na peronie, nadjeżdżający pociąg oraz karpia koi dryfującego nad miastem.
...
### No. 240: Osoba Zaprzyjaźniająca się z Kotem Pośrodku Chaosu
...
Scena przedstawiająca kogoś, kto po zaangażowaniu się w różne sprawy, kończy na zaprzyjaźnieniu się z kotem.
...
### No. 241: Lis-Meduza w Wysokogórskim Akwarium
...
Obraz przedstawiający sennego lisa i meduzy wewnątrz akwarium na wyżynie, wykonany w stylu bez ziarnistych cząsteczek światła.
...
### No. 242: Kobieta w Kimono Jedząca Ryż z Ozorem
...
Obraz kobiety w kimono, ze sceną przedstawiającą posiłek z ozora wołowego i ryżu jęczmiennego.
...
### No. 243: Reportażowe Zdjęcie Kobiety w Przytulnym Nocnym Salonie
...
Prompt na fotorealistyczne, reportażowe zdjęcie młodej kobiety w przytulnym, nocnym wnętrzu salonu.
...
### No. 244: Kobieta Chuunibyou w Gotyckim Lolicie
...
Obraz w stylu anime przedstawiający kobietę z chuunibyou i makijażem Jirai, ubraną w strój gotyckiego lolicia z topami na ramiączkach i długą sukienką z gorsetem.
...
### No. 245: Kobieta Zostająca z Umierającym Byłym Chłopakiem
...
Prompt opisujący kobietę, która dowiaduje się, że jej były chłopak ją zostawił, ponieważ umiera, i postanawia zostać z nim do końca.
...
### No. 246: Portret Kobiety w Mundurze
...
Poetycki prompt opisujący postać o imieniu Rhiannah w geometrycznym mundurze, z lodowatoniebieskim okiem, kwadratowymi ramionami i czerwonymi ustami.
...
### No. 247: Warsztat Farbiarski Indigo w Jiangnan
...
Prompt na obraz przedstawiający scenę z farbiarni w Jiangnan, z niebieską farbą, drewnianymi ramami, kamiennym mostem i porannym światłem na wodzie.
...
### No. 248: Portret z Bliska z Warkoczem
...
Fotorealistyczny portret w formacie 16:9 na tapetę, przedstawiający młodą kobietę o jasnej cerze, piegach, niebieskich oczach i splecionych białoblond włosach.
...
### No. 249: Fotorealistyczny, naturalny portret marynarza
...
Naturalne, 35-milimetrowe zdjęcie starszego marynarza naprawiającego sieć, z realistyczną teksturą skóry i materiałów.
...
### No. 250: Scena tłumu z 1969 roku z zachowaniem realiów epoki
...
Fotorealistyczny tłum na zewnątrz w Bethel w stanie Nowy Jork, w konkretny dzień z 1969 roku, z zachowaniem realiów epoki.
...
### No. 251: Nostalgiczna kartka świąteczna z misiem
...
Kartka świąteczna jakości drukarskiej, oparta na scenie z pudełka na pamiątki, z jedną dosłowną linią tekstu.
...
### No. 252: Zabytkowy samolot zabawka kolekcjonerski w blisterze
...
Ujęcie kolekcjonerskie w stylu detalicznym, w opakowaniu blister, z jedną dosłowną linią tekstu na opakowaniu.
...
### No. 253: Pocztowa Chmura w Uzdrawiającym Stylu Książki Obrazkowej
...
Kapryśna scena przedstawiająca miękką chmurę przekształconą w urząd pocztowy, gdzie małe zwierzęta w mundurach sortują listy, oddana w miękkim, uzdrawiającym stylu książki obrazkowej.
...
### No. 254: Hiperrealistyczny Portret Filmowy na Motocyklu
...
Hiperrealistyczny, filmowy portret stylowego, brodatego mężczyzny na customowym motocyklu.
...
### No. 255: Czarno-Biały Portret Redakcyjny w Stylu High Fashion
...
Prompt do stworzenia czarno-białego, wysokomodowego portretu redakcyjnego młodego mężczyzny z kręconymi włosami i warstwowym ubraniem.
...
### No. 6: Plakat w stylu Art Deco w kolorach złota i granatu
...
Ilustracja plakatu w stylu Art Deco w formacie kwadratowym, z eleganckimi, złotymi i granatowymi liniami na kremowym papierze.
...
### No. 7: Kolekcja Hiperrealistycznych Pinów Emaliowanych
...
Prompt do stworzenia kolekcji ośmiu wysokiej jakości pinów emaliowanych ze złotymi obwódkami i błyszczącymi powierzchniami na ciemnym tle.
...
### No. 8: Ciemny Interfejs UI Panelu Analitycznego SaaS
...
Prompt do wygenerowania interfejsu panelu analitycznego SaaS w ciemnym motywie kolorystycznym, z określonymi etykietami i elementami UI.
...
### No. 9: Zrzut Ekranu Strony Internetowej Kreatywnej Firmy Projektowej
...
Prompt do wygenerowania pełnego, frontalnego, pozbawionego perspektywy zrzutu ekranu strony desktopowej dla chińskiej strony internetowej kreatywnej firmy projektowej.
...
### No. 10: Siatka Fotografii Dawnej Mody Chińskiej
...
Prompt do wygenerowania profesjonalnej, wysokiej klasy serii fotografii dawnej mody chińskiej, przedstawiającej pełny proces ubierania się Song Yu w buduarze z czasów dynastii Song, ułożonej w ścisłą siatkę 3x3.
...
### No. 11: Zegar Analogowy, Burger i Napój
...
Prompt do wygenerowania obrazu przedstawiającego zegar analogowy wskazujący godzinę 15:32, burgera z grillowanym złotym serem provolone oraz szklankę.
...
### No. 12: Kwadratowy Układ z Niebiesko-Białym Telefonem i Kartami
...
Kwadratowy obraz SNS w kolorach niebieskim i białym, przedstawiający jeden smartfon, trzy karty z obrazami, japoński tytuł, szerokie marginesy i bez dodatkowego tekstu.
...
### No. 13: Rozdział Podręcznika Fizyki o Elektromagnetyzmie
...
Prompt do wygenerowania rozdziału o elektromagnetyzmie do hiszpańskojęzycznej książki z fizyki.
...
### No. 14: Jednostronicowa Manga o Eksploracji Kosmosu
...
Prompt do wygenerowania jednostronicowej, pionowej, czarno-białej komiksowej planszy o tematyce rozwoju kosmosu.
...
### No. 15: Izometryczna Szklana Kostka z Kolorowymi Kulami
...
Widok izometryczny przezroczystej szklanej kostki zawierającej czerwoną kulę w lewym górnym tylnym rogu i niebieską kulę w prawym dolnym przednim rogu, z zieloną kulą nad kostką i żółtym słupem przechodzącym od lewego dołu do prawej góry.
...
### No. 16: Plakat Typograficzny i Okładka Magazynu
...
Prompt do wygenerowania typograficznego plakatu z listą modeli oraz okładki magazynu z logotypem i tytułami na okładce.
...
### No. 17: Pionowa reklama luksusowego zegarka
...
Prompt do pionowej reklamy luksusowej, przedstawiającej duży zegarek w ciemno-szmaragdowym studiu.
...
### No. 18: Arkusz referencyjny projektu postaci
...
Prompt do wygenerowania malarskiego arkusza referencyjnego projektu postaci z liniami konstrukcyjnymi i określonym układem.
...
### No. 19: Podzielona karta postaci do Character Bible
...
Prompt do wygenerowania premium, podzielonej karty postaci dla dwóch oryginalnych bohaterów.
...
### No. 20: Korporacyjna Kompozycja Kolażu Portretowego
...
Ultrarealistyczny korporacyjny kolaż portretowy przedstawiający trójwarstwową kompozycję mężczyzny.
...
### No. 21: Kompozycja Podziału na Zdjęcie i Ilustrację
...
Prompt do stworzenia pionowego obrazu łączącego oryginalne zdjęcie z ręcznie rysowaną ilustracją tej samej sceny.
...
### No. 22: Arkusz Karty Postaci z Podziałem Ekranu
...
Prompt do stworzenia karty postaci z podziałem ekranu, z odważnym centralnym rozdzielaczem i neonowym tłem w stylu akwareli.
...
### No. 23: Komiks: Poszukiwacze przygód planujący w tawernie
...
Prompt do wygenerowania dwustronicowej kolorowej mangi przedstawiającej poszukiwaczy przygód omawiających wyzwanie w lochu w tawernie, z dialogami i efektami dźwiękowymi.
...
### No. 24: Rysunek techniczny ekspresu do kawy
...
Schemat techniczny domowego ekspresu do kawy w stylu rysunku mechanicznego z lat 60.
...
### No. 25: Nowoczesny interfejs dashboardu SaaS dla platformy AI
...
Prompt do wygenerowania wysokiej rozdzielczości, nowoczesnego interfejsu dashboardu SaaS w rozdzielczości 4K dla platformy analitycznej AI, utrzymanego w stylistyce eleganckiego dark mode.
...
### No. 26: Interfejs użytkownika ekwipunku w mrocznym fantasy RPG
...
Prompt do wygenerowania interfejsu ekwipunku w wysokiej rozdzielczości dla mrocznego fantasy RPG, przedstawiającego zbrojnego paladyna.
...
### No. 27: Plakat z sushi i wklęsłym logotypem
...
Prompt do plakatu przedstawiającego duży, wklęsły, głęboko czerwony logotyp w tle, który nie nakłada się na sylwetkę sushi.
...
### No. 28: Opakowanie produktu w trzech ujęciach
...
Prompt do wizualizacji kartonowego opakowania produktu w trzech etapach: jako izolowany produkt główny, w kontekście składników oraz obok gotowej potrawy.
...
### No. 29: Ujęcie produktu z otaczającymi składnikami
...
Prompt do obrazu przedstawiającego centralną saszetkę produktu otoczoną miseczkami, jagodami, ziarnami i liśćmi, z wyraźnym pionowym korytarzem.
...
### No. 30: Siatka identycznych plakatów z menu kawy
...
Prompt do zaprojektowania kolekcjonerskiego plakatu z menu kawy, zawierającego spójne czarne pola, skalę kubka, strefę tytułu, mikrotekst oraz mosiężne klipsy.
...
### No. 31: Billboard 3D z produktem przekraczającym płaszczyznę
...
Prompt do wizualizacji billboardu 3D, na którym główny pojemnik wystaje poza wewnętrzną płaszczyznę, rzucając cienie kontaktowe.
...
### No. 32: Trzy stożki w linii z centralnym bohaterem
...
Prompt do kompozycji przedstawiającej trzy stożki smakowe, w których centralny stożek pistacjowy jest dominujący, a boczne stożki są ustawione pod kątem jako elementy ramujące.
...
### No. 33: Ułożone panele ze spójnym układem
...
Prompt do wygenerowania pięciu ułożonych w stos paneli ze spójnym układem marki, zawierającym logo, kolumnę z nagłówkiem, odznakę i kompozycję produktu.
...
### No. 34: Poziome akty degustacyjne z nazwami dań
...
Prompt do plakatu przedstawiającego cztery poziome akty, z których każdy zawiera czarną miskę z parą i przesadnie dużą, pędzlową nazwę dania.
...
### No. 35: Interfejs Postu Społecznościowego Przecinający Strumień Sosu
...
Prompt do obrazu przedstawiającego minimalistyczny, czarny pasek interfejsu postu społecznościowego przecinający poziomo strumień sosu.
...
### No. 36: Plakat z pionową kompozycją podziału
...
Prompt do stworzenia plakatu z pionowym podziałem, ukazującym czystą, naturalną stronę w kontraście do ciemnej strony z ukrytymi składnikami.
...
### No. 37: Czekoladowe, płynne łuki oprawiające produkt
...
Prompt do stworzenia premium plakatu produktowego, przedstawiającego dwa powściągliwe, ciemnobrązowe, płynne łuki czekolady, które w symetrycznym, orbitalnym ruchu oprawiają produkt.
...
### No. 38: Dwa paski produktu skrzyżowane po przekątnej
...
Prompt opisujący dwa zapakowane paski produktu skrzyżowane po przekątnej przez środek w przeciwnych kierunkach.
...
### No. 39: Trzy miski ułożone po przekątnej
...
Prompt do stworzenia obrazu przedstawiającego trzy miski ułożone po przekątnej od pierwszego planu do tła.
...
### No. 40: Kampania podróżnicza na Instagramie ze smartfonem jako kotwicą wizualną
...
Prompt do stworzenia premium reklamy podróżniczej na Instagramie, z nowoczesnym smartfonem jako wizualną kotwicą.
...
### No. 41: Pionowy plakat społecznościowy dla figurki kolekcjonerskiej
...
Prompt do stworzenia wysokorozdzielczego, pionowego plakatu na media społecznościowe reklamującego premium figurkę kolekcjonerską, z odważną typografią i płaskim, żółtym tłem.
...
### No. 42: Projekt okładki książki z hierarchią typograficzną
...
Prompt do zaprojektowania okładki książki z silną hierarchią typograficzną i czytelnością.
...
### No. 43: Plakat konferencji neurobiologicznej
...
Prompt do wygenerowania plakatu konferencyjnego na spotkanie neurobiologiczne w 2026 roku, na podstawie dostarczonego artykułu i regulaminu.
...
### No. 44: Unosząca się Kratka Dioram z Ikonicznymi Miastami
...
Prompt do wygenerowania kratki 2x2 przedstawiającej unoszące się dioramy miast zawieszone w szarym studio.
...
### No. 45: Kratka Satyrycznych Plakatów Systemowych o Drażniących Tematach
...
Prompt do kratki 2x2 satyrycznych plakatów edytorialnych na frustrujące tematy.
...
### No. 46: Szablon Plakatu Podróżniczego z Dioramą Papierową
...
Prompt do stworzenia premium, pionowego plakatu podróżniczego przedstawiającego charakterystyczny punkt miasta jako szczegółową, ręcznie robioną dioramę papierową.
...
### No. 47: Filmowa Karta Postaci dla Calvina i Boba
...
Prompt do stworzenia podzielonej ekranowo karty postaci z tłem w stylu akwareli.
...
### No. 48: Filmowa karta postaci dla Sofii
...
Prompt do wygenerowania premium karty postaci z odważną typografią i dramatycznym, głównym zdjęciem baristki o imieniu Sofia.
...
### No. 49: Dramatyczne okładki ścienne w stylu propagandowym
...
Prompt do wygenerowania siatki 2x2 dramatycznych okładek ściennych w stylu propagandowym dla czterech książek z domeny publicznej.
...
### No. 50: Koncepcyjne dioramy przekrojowe dla czterech marek
...
Prompt do wygenerowania siatki 2x2 koncepcyjnych dioram przekrojowych dla czterech firm z listy Fortune 500.
...
### No. 51: Plakat reklamowy obuwia dziecięcego z dziewczynką i gigantycznym sneakerem
...
Prompt do wygenerowania radosnego plakatu reklamowego przedstawiającego dziewczynkę i gigantycznego sneakera.
...
### No. 52: Scenorys Reklamy Luksusowych Perfum
...
Prompt do stworzenia filmowego scenorysu produktu, przedstawiającego luksusowe perfumy różane w czystym układzie edytorskim.
...
### No. 53: Scenorys Reklamy Luksusowych Perfum
...
Prompt do stworzenia filmowego scenorysu reklamy produktu, przedstawiającego luksusowe perfumy różane.
...
### No. 54: Techniczna Siatka Widoków Rozłożonych
...
Prompt do generowania siatki 2x2 ilustracji technicznych przedstawiających rozłożone widoki 3D skomplikowanych maszyn.
...
### No. 55: Pełnostronicowa Kolorowa Ilustracja Komiksowa
...
Prompt do wygenerowania pełnostronicowej, kolorowej i humorystycznej ilustracji w stylu shonen mangi, z wykorzystaniem autentycznej kompozycji strony komiksowej.
...
### No. 56: Infografika techniczna ekspresu do kawy
...
Objaśniająca infografika przedstawiająca kompleksowy przepływ w automatycznym ekspresie do kawy.
...
### No. 57: Reklama kampanii streetwear z dokładnym hasłem
...
Obraz kampanii młodzieżowej odzieży ulicznej, który w czytelny sposób renderuje jedno, dokładne hasło wewnątrz układu.
...
### No. 58: Minimalistyczne logo piekarni na przezroczystym tle
...
Płaskie, przypominające wektor logo piekarni, dostarczone wycentrowane na czystym kanale alfa, bez żadnego tła.
...
### No. 59: Komiks czteropanelowy o zwierzęciu samotnym w domu
...
Pionowy pasek komiksowy z czterema panelami, przedstawiający początek, zwrot akcji i pointę.
...
### No. 60: Interfejs aplikacji targu rolnego w ramce iPhone'a
...
Praktyczny makiet aplikacji mobilnej z nagłówkiem, listą sprzedawców i promocjami, umieszczony w ramce urządzenia.
...
### No. 61: Schemat oddychania komórkowego do wykorzystania w klasie
...
Opisany schemat biologii na poziomie szkoły średniej, łączący glikolizę, cykl Krebsa i łańcuch transportu elektronów.
...
### No. 62: Slajd prezentacji możliwości rynkowych dla rundy Series A
...
Slajd do prezentacji inwestorskiej z diagramem TAM/SAM/SOM, wykresami wzrostu, przypisami i rzeczywistą hierarchią danych.
...
### No. 63: Makieta billboardu z dokładnym nagłówkiem
...
Makieta billboardu przy autostradzie z jednym dosłownym nagłówkiem w pogrubionej czcionce bezszeryfowej.
...
Obraz w stylu mangi przedstawiający dziewczynę mówiącą "Hej, słuchaj!" oraz chłopca, który zakrywa jej dymkę swoją dymką z myślą "Udaję, że tego nie słyszałem", narysowany w pionowym formacie 4:5.
...
### No. 65: Panel Mangowy: Dziewczyna Gryzie Dymkę
...
Scena w stylu mangi, na której chłopiec pyta "Nie będziemy walczyć?", a wyglądająca zaciekle dziewczyna gryzie jego dymkę dialogową.
...
### No. 66: Siatka Redakcyjna: Moda z Dekad
...
Prompt do wygenerowania siatki 2x2 wizualizującej cztery ruchy modowe z różnych dekad, w stylu plakatu redakcyjnego o proporcjach 16:9.
...
Prompt do wygenerowania obrazu w siatce 2x2 wizualizującej cztery różne systemy rządów, w pastelowym stylu książki obrazkowej.
...
### No. 68: Plakat Hołdu dla Szachisty
...
Prompt do wygenerowania siatki 2x2 z bohaterskimi, ilustrowanymi plakatami-hołdami dla czterech zmarłych legend szachowych.
...
- [Atlas Cloud GPT Image 2.5 Flare text-to-image](https://www.atlascloud.ai/pl/models/openai/gpt-image-2.5-flare/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Flare edit](https://www.atlascloud.ai/pl/models/openai/gpt-image-2.5-flare/edit?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Sunburst text-to-image](https://www.atlascloud.ai/pl/models/openai/gpt-image-2.5-sunburst/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
