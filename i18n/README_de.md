...
### No. 4: Zwei Frauen in einem Steinbogen
...
Ein Prompt für ein Bild von zwei Frauen, die von einem sonnenbleichen Steinbogen eingerahmt werden.
...
### No. 5: Mehrteiliges Charakterporträt-Blatt
...
Ein Prompt zur Generierung eines Charakterblatts mit vier Studiofotografien derselben Frau aus verschiedenen Blickwinkeln.
...
### No. 6: Neun Emoji-Aufkleber mit Text
...
Eine Prompt zur Erstellung eines 3x3-Rasters verschiedener Emoji-Aufkleber basierend auf einer Referenzfigur, mit chinesischem und englischem Text auf einem hellen Verlaufshintergrund.
...
### No. 7: Sprite-Sheet mit vier Pixelkunst-Charakterbewegungen
...
Eine Prompt zur Erstellung eines Sprite-Sheets mit vier Arten von Pixelkunst-Charakteranimationen, jeweils bis zu 4 Frames, unter Beibehaltung eines konsistenten Designs.
...
### No. 8: Kunstwerk inspiriert von einer Skizze
...
Eine Prompt zur Erstellung eines originellen Kunstwerks basierend auf einer Skizze, das deren Kernmotiv, Emotion und Gestaltung bewahrt, während die Details neu interpretiert werden.
...
### No. 9: Morgendliches Lifestyle-Foto einer Frau
...
Ein fotorealistisches morgendliches Lifestyle-Porträt einer jungen Frau mit rotbraunem Haar.
...
### No. 10: Frau, die sich im Homeoffice zurücklehnt
...
Eine Prompt zur Erstellung eines fotorealistischen Smartphone-Fotos einer jungen Frau, die auf einem Sofa in einem modernen Homeoffice entspannt.
...
### No. 11: iPhone-Porträt einer jungen Frau
...
Eine Prompt zur Erstellung eines realistischen iPhone-Porträts einer jungen Frau in Innenräumen mit einem reflektierenden Hintergrund.
...
### No. 12: Pixel-Art-Sprite-Sheet für eine Figur
...
Ein Prompt zur Erzeugung eines vereinfachten 128px-Pixel-Art-Sprite-Sheets mit transparentem Hintergrund und einem 4x4-Layout für Kampfaktionen einer Figur.
...
### No. 13: Tageszeitlicher Campingplatz aus einer Skizze
...
Eine Reihe von Prompts, um eine Kinderzeichnung in einen stimmungsvollen Nacht-Campingplatz, dann in eine Tagesversion zu verwandeln und schließlich die Kleidung der Figur in Overalls zu ändern.
...
### No. 14: Minimalistische Einlinien-Landeskunst
...
Ein Prompt zur Erstellung eines vertikalen, minimalistischen Kunstdrucks eines Landes mit einer einzigen durchgehenden Linie.
...
### No. 15: Historische Porträtverwandlung 1985
...
Ein Prompt, um das Erscheinungsbild einer Person in den 1980er Jahren neu zu interpretieren, während ihre Kernidentität und Merkmale erhalten bleiben.
...
### No. 16: 3D-Übergroßes T-Shirt-Branding-Mockup
...
Ein Prompt zur Erstellung eines 3D-Mockups von zwei schwebenden, übergroßen T-Shirts mit Front- und Rückansicht.
...
### No. 17: Luxus-Herrenmode-Editorial-Collage
...
Ein Prompt zur Erstellung einer Luxus-Herrenmode-Editorial-Collage unter Verwendung eines hochgeladenen Fotos als Gesichtsreferenz.
...
### No. 18: Gesichtsidentität und Kompositionsreferenz
...
Ein Prompt, der die Verwendung eines hochgeladenen Bildes anweist, um die Gesichtsmerkmale und das natürliche Aussehen eines Subjekts zu bewahren.
...
### No. 19: Realistisches professionelles Studio-Porträt
...
Ein Prompt zur Erstellung eines professionellen Studio-Porträts unter Verwendung eines hochgeladenen Fotos für Gesichtsidentität und Komposition.
...
### No. 20: Fashion-Editorial-Collage mit konsistentem Model
...
Ein Prompt zur Erstellung einer Fashion-Collage mit einem konsistenten männlichen Model unter Verwendung einer Gesichtsidentitätsreferenz.
...
### No. 21: Astronautin in futuristischem Cockpit-Porträt
...
Ein Prompt zur Erstellung eines fotorealistischen Porträts einer selbstbewussten Astronautin in einem futuristischen Raumschiffcockpit.
...
### No. 22: Ultrarealistisches Studio-Modeporträt
...
Eine Prompt zur Erstellung eines Ganzkörper-, ultrarealistischen Studio-Modeporträts unter Verwendung eines hochgeladenen Bildes als Gesichtsreferenz.
...
### No. 23: Cinematisches Motorrad-Lifestyle-Porträt
...
Ein ultrarealistisches Porträt eines Mannes, der draußen neben einem Premium-Sportmotorrad sitzt.
...
### No. 24: Ultrarealistisches Editorial-Porträt
...
Eine KI-Prompt zur Erstellung eines ultrarealistischen Editorial-Porträts eines Mannes unter Verwendung einer Gesichtsidentitätsreferenz.
...
### No. 25: Premium-Modeporträt aus Referenz
...
Eine Prompt zur Erstellung eines Premium-Modeporträts eines stilvollen erwachsenen Mannes unter Verwendung einer Gesichtsidentitätsreferenz.
...
### No. 26: Ungezwungenes Lifestyle-Porträt aus Referenz
...
Eine Prompt zur Erstellung eines hochwertigen, ultra-fotorealistischen, ungezwungenen Lifestyle-Porträts einer Frau basierend auf einem Referenzbild.
...
### No. 27: Winter-Modeporträt aus Foto
...
Eine KI-Prompt zur Erstellung eines realistischen Outdoor-Winter-Modeporträts unter Verwendung eines Subjektfotos als Gesichtsreferenz.
...
### No. 28: Ultrarealistisches Luxus-Studio-Porträt
...
Ein KI-Prompt zur Erzeugung eines ultrarealistischen Luxus-Studio-Porträts eines stilvollen erwachsenen Mannes.
...
### No. 29: Filmische Regen-Porträt-Collage
...
Ein Prompt zur Erstellung einer filmischen Regen-Porträt-Collage unter Verwendung eines hochgeladenen Bildes als Referenz für Komposition und Atmosphäre.
...
### No. 30: Smartphone-Selfie-Identitätserhaltung
...
Ein Prompt zur Erzeugung eines 3:4 vertikalen, ultrarealistischen Smartphone-Selfies, das die Gesichtszüge und das Aussehen einer bestimmten Frau originalgetreu bewahrt.
...
### No. 31: Filmisches Fashion-Porträt-Identität
...
Ein Prompt zur Erzeugung eines Nahaufnahme-Fashion-Porträts, das die Identität und das Aussehen eines Subjekts bewahrt.
...
### No. 32: Nahaufnahme formelles Studio-Porträt
...
Ein Prompt zur Erstellung eines Nahaufnahme-Studio-Porträts eines jungen Mannes in formeller Kleidung unter Verwendung einer Gesichtsreferenz.
...
### No. 33: Cinematografisches Lifestyle-Foto mit Identitätserhalt
...
Eine Prompt zur Erstellung eines fotorealistischen, cinematografischen Bildes einer spezifischen ostasiatischen Frau unter Bewahrung ihrer Identität und Gesichtszüge.
...
### No. 34: Cinematografische Fashion-Editorial-Aufnahme mit Identitätsreferenz
...
Eine Prompt zur Generierung eines cinematografischen Fashion-Fotos einer Frau in einer dunklen Umgebung unter Bewahrung ihrer Identität anhand eines Referenzbildes.
...
### No. 35: Ultrarealistisches Editorial-Porträt von einer Referenz
...
Eine Bildgenerierungs-Prompt zur Erstellung eines ultrarealistischen Editorial-Porträts eines erwachsenen Mannes unter Verwendung eines hochgeladenen Bildes als Gesichtsidentitätsreferenz.
...
### No. 36: Drachenkampf mit verräterischer Axtkämpferin
...
Ein Prompt zur Erzeugung eines Bildes eines Drachenkampfes mit einer verräterischen Axtkämpferin, unter Verwendung von ChatGPT Astra.
...
### No. 37: Heroischer Riesentoboter aus fotorealistischer Perspektive
...
Ein Prompt zur Erstellung eines Bildes, das einen heroischen Riesentoboter aus einer dynamischen, fotorealistischen Perspektive zeigt.
...
### No. 38: Anime-Stil basierend auf hochgeladenem Motiv
...
Ein Prompt zur Erstellung eines Anime-Stil-Bildes mit selbstbewussten Linien, minimaler Cel-Shading und hellen, gesättigten Farben.
...
### No. 39: Produkt-Frontalaufnahme mit klarem Etikett
...
Ein Prompt zur Erzeugung von zwei Produktbildern mit klaren, lesbaren Etiketten im frontalen, flach liegenden Stil.
...
### No. 40: Fantasy-Szene mit Adler und Referenz
...
Ein Prompt für eine cinematografische Fantasy-Szene, die eine Frau zeigt, die vor einem riesigen, majestätischen Weißkopfseeadler mit ausgebreiteten Flügeln zentriert ist.
...
### No. 41: High-Fashion-Werbung mit Model-Identität
...
Ein Prompt zur Erstellung eines premium, hyperrealistischen High-Fashion-Werbeimages, das die Gesichtsidentität eines bestimmten Models bewahrt.
...
### No. 42: Artikel zu Vier-Panel-Manga im Afternoon-Stil
...
Ein Prompt, um basierend auf einem beigefügten Artikel einen vierseitigen Comic im Stil des japanischen Magazins Afternoon zu generieren.
...
### No. 43: Hochwertiges filmisches Charakter-Referenzblatt
...
Ein Prompt zur Erstellung eines geteilten Charakter-Referenzblatts unter Verwendung strenger visueller Richtlinien.
...
### No. 44: Pixel-Art-Kampf-Sprite-Sheet
...
Ein Prompt zur Generierung eines vereinfachten 128px Pixel-Art-Kampfanimations-Sprite-Sheets mit transparentem Hintergrund.
...
### No. 45: Charakter-Kampf-Sprite-Sheet in Pixel-Art
...
Ein Prompt zur Generierung eines 16-Bilder umfassenden Pixel-Art-Sprite-Sheets für die Kampfbewegungen eines Charakters.
...
### No. 46: Pixel-Art-Sprite-Sheet für Charakterkampfbewegungen
...
Eine Prompt zur Erstellung eines vereinfachten 128px Pixel-Art-Sprite-Sheets mit 16 Frames für die Kampfbewegungen eines Charakters, inklusive Ruheposition, Hieb, Abwehr und Niederschlag.
...
### No. 47: Fotorealistisches Porträt mit Identitätsreferenz
...
Eine Prompt zur Erstellung eines fotorealistischen Ganzkörperporträts unter Verwendung eines Referenzfotos, um die Identität des Subjekts zu bewahren.
...
### No. 48: Marty & Doc Charakter-Bibelblatt
...
Eine Prompt zur Generierung eines geteilten Charakterreferenzblatts für zwei Charaktere unter Verwendung strenger visueller Richtlinien.
...
### No. 49: Charakterbogen für Ted & John
...
Ein Prompt, um einen geteilten Charakterbogen unter strenger Verwendung visueller Referenzen für zwei Charaktere zu generieren.
...
### No. 50: Geteilter Charakterbogen für Dom & Brian
...
Ein Prompt, um einen geteilten Charakterbogen unter Verwendung hochgeladener Referenzen für zwei Charaktere zu generieren.
...
### No. 51: Cinematischer Charakterbogen für Baby
...
Ein Prompt, um einen hochwertigen Charakterbogen für den Charakter Baby mit markanter Typografie und strenger Einhaltung visueller Referenzen zu generieren.
...
### No. 52: Cinematischer Charakterbogen für Schmidt & Jenko
...
### No. 53: Cinematischer Charakterbogen für Gordon
...
Ein Prompt zur Erstellung eines hochwertigen Charakterbogens mit markanter Typografie und strenger visueller Referenz.
...
### No. 54: Charakterbogen für Johnny & Tucker
...
Ein Prompt, um einen geteilten Charakterreferenzbogen unter strengen visuellen Richtlinien zu generieren.
...
### No. 55: Charakterbogen für Neo & Trinity
...
Ein Prompt, um einen geteilten Charakterreferenzbogen für Neo und Trinity unter strengen visuellen Richtlinien zu generieren.
...
### No. 56: Charakterbogen für Kevin gegen die Wet Bandits
...
Ein Prompt, um einen hochwertigen Charakterbogen für Kevin gegen die Wet Bandits unter strenger Verwendung visueller Referenzen zu generieren.
...
### No. 57: Editoriale Modeaufnahme auf nächtlicher Dachterrassen-Treppe
...
Ein Prompt für ein hyperrealistisches Foto einer nächtlichen Dachterrassen-Treppen-Modeeditorial mit kühlem, cinematischem Gefühl.
...
### No. 58: Charakterbogen für Riggs & Murtaugh
...
Ein Prompt, um einen geteilten Charakterreferenzbogen für zwei Charaktere unter strengen visuellen Richtlinien zu generieren.
...
### No. 59: Premium Cinematic Character Bible Sheet für Mike & Marcus
...
Ein Prompt zur Erstellung eines geteilten Charakter-Referenzblattes unter Verwendung strenger visueller Richtlinien.
...
### No. 60: Premium Cinematic Character Bible Sheet für Lee & Carter
...
Ein Prompt zur Erstellung eines geteilten Charakter-Referenzblattes unter Verwendung strenger visueller Anleitungen.
...
### No. 61: Realistische 1/7-Skala-Figur auf dem Schreibtisch
...
Eine Eingabeaufforderung zur Erzeugung eines Bildes einer realistischen 1/7-Skala-Charakterfigur auf einem Computerschreibtisch mit transparentem Sockel.
...
### No. 62: Gesichtsidentitätsreferenz über die Komposition hinweg
...
Eine KI-Eingabeaufforderung zur Erzeugung eines einzelnen Fotos mit sieben Versionen desselben erwachsenen Mannes unter Verwendung einer Gesichtsidentitätsreferenz.
...
### No. 63: Modeporträt unter Verwendung einer Gesichtsidentitätsreferenz
...
Eine Eingabeaufforderung zur Erzeugung eines hochwertigen Ganzkörper-Modeporträts unter Verwendung eines Fotos als Gesichtsidentitätsreferenz.
...
### No. 64: Traumhaftes filmisches Porträt aus einer Referenz
...
Ein Prompt, um ein realistisches, traumhaftes filmisches Porträt zu erstellen, das die Identität und natürlichen Merkmale des Motivs bewahrt.
...
### No. 65: 3D-Knetanimations-Porträt aus einem Foto
...
Ein Prompt, um ein detailliertes, niedliches 3D-Knetanimations-Porträt zu generieren, das die Identität und Ähnlichkeit des Motivs aus einem hochgeladenen Benutzerfoto beibehält.
...
### No. 66: Editorielles Kunstposter für einen Ort
...
Ein Prompt, um ein hochauflösendes vertikales editoriales Poster im verspielten japanischen Design-Zine-Stil zu erstellen.
...
### No. 67: Animierte Szene aus zwei Referenzbildern
...
Ein Prompt zur Erstellung einer animierten Szene eines Kleinkindes, das in einem gemütlichen Schlafzimmer spielt.
...
### No. 68: 1980er-Jahre-Porträt aus Gesichtsreferenz
...
Ein Prompt zur Erzeugung eines Porträts im Retro-Vintage-Stil der 1980er Jahre, das die exakten Gesichtszüge und die Identität der Person bewahrt.
...
### No. 69: Charakterdesign-Referenzblatt
...
Ein Prompt zur Erzeugung eines professionellen Charakter-Model-Sheets basierend auf einem bereitgestellten Referenzbild.
...
### No. 70: Stiltransfer auf einen Motorradfahrer
...
Ein neues Motiv, das im exakten visuellen Stil des Eingabebildes dargestellt wird.
...
### No. 71: Outfit-Tausch unter Beibehaltung der Identität
...
Kleidungsstücke aus Referenzbildern, die dem Motiv angepasst werden, wobei Gesicht, Pose und Beleuchtung unverändert bleiben.
...
### No. 72: Hund in eine Porträtszene komponiert
...
Ein Motiv aus einer Referenz, das in eine andere mit angeglichenem Licht und Hintergrund platziert wird.
...
### No. 73: Skizze in ein fotorealistisches Tal verwandelt
...
Eine Zeichnung, die fotorealistisch gerendert wird, während ihr Layout, ihre Proportionen und Perspektive erhalten bleiben.
...
### No. 74: Person in eine Bärenangriffsszene eingefügt
...
Eine fotorealistische Actionszene, die um eine gelieferte Person herum aufgebaut ist, bewusst unkinematisch.
...
### No. 75: Konsistente Kinderbuch-Figur
...
Ein Aquarell-Bilderbuchheld, der so präzise spezifiziert ist, dass er über Illustrationen hinweg gleich bleibt.
...
### No. 2: Fotos in individuelle Premium-Poster umwandeln
...
Eine JSON-Anweisung, um jedes hochgeladene Foto in ein separates, hochwertiges Poster zu konvertieren, ohne sie zusammenzuführen.
...
### No. 3: Nächtliches Büro mit Flussdiagramm-Bildschirm
...
Ein Prompt zur Erzeugung eines nächtlichen Arbeitszimmers und dann zum Ersetzen nur des Laptop-Bildschirminhalts durch ein Automatisierungs-Flussdiagramm.
...
### No. 4: Zweiseitige Story-Manga-Neugestaltung
...
Ein Prompt, um ein Bild im Stil eines zweiseitigen Story-Mangas neu zu zeichnen, wobei Dialoge, Handlung und Charaktereinstellungen erhalten bleiben.
...
### No. 5: Umgebung in malerischen Stil bearbeiten
...
Ein Prompt, um eine Umgebungsplatte in einen lockereren, malerischen Stil zu bearbeiten, während bestimmte kompositorische Elemente erhalten bleiben.
...
### No. 6: Beschädigtes Vintage-Porträt restaurieren
...
Ein Prompt zur Restaurierung eines stark beschädigten alten Porträts in ein sauberes, modern aussehendes Foto unter Verwendung eines hochgeladenen Bildes als Referenz.
...
### No. 7: Auto in Neon-Schwarz umfärben
...
Ein Prompt, um die Farbe eines Objekts in Neon-Schwarz zu ändern, während seine ursprüngliche Form, Textur und Materialität erhalten bleiben.
...
### No. 8: Vertikales Zweipanel-Bild: Original und bearbeitet
...
Eine Prompt zur Erstellung eines einzelnen vertikalen Bildes mit zwei übereinander angeordneten Panels, wobei das obere Panel das Original-Referenzfoto bleibt.
...
### No. 9: Fotografie auf bestimmtes Seitenverhältnis zuschneiden
...
Eine Prompt, um ein Foto auf ein gewähltes Seitenverhältnis zu skalieren, während das Hauptmotiv natürlich positioniert bleibt.
...
### No. 10: Porträt mit hartem Licht und scharfen Schatten
...
Ein Prompt, der ein Porträt beschreibt, das von hartem, ungefiltertem Sonnenlicht aus einem Fenster in einem bestimmten Winkel beleuchtet wird und scharfe Schatten auf dem Gesicht erzeugt.
...
### No. 11: Pixel-Art-Sprite-Sheet für einen Charakter
...
Ein Prompt, um ein vereinfachtes 128px Pixel-Art-Kampfbewegungs-Sprite-Sheet für einen Charakter zu erstellen, angeordnet in einem 4x4-Raster mit transparentem Hintergrund.
...
### No. 12: Sonne und Wolken zu einer Lotusblume verstärken
...
Ein Prompt zur Verbesserung eines Fotos von Wolken und Sonne, um die Sonne wie eine Blütenmitte und die Wolken wie einen Lotus erscheinen zu lassen, ohne das Originalbild zu verändern.
...
### No. 13: Ins Spanische übersetzte Infografik
...
Eine Bearbeitung, die nur die Sprache des Textes austauscht und jeden anderen Pixel des Layouts unverändert lässt.
...
### No. 14: Produktfreistellung auf transparentem Hintergrund
...
Ein Packshot, isoliert auf sauberem Alphakanal mit klarer Silhouette, ohne Halos und mit erhaltener Etikettenlesbarkeit.
...
### No. 15: Objektentfernung aus einem Porträt
...
Eine einzeilige Bearbeitung, die ein einzelnes Objekt entfernt und sonst nichts verändert.
...
### No. 16: Werbetafel als Winterabend neu belebt
...
Eine fünfwörtige Folge-Bearbeitung, die Jahreszeit und Tageszeit auf einem bestehenden Mockup ändert.
...
### No. 17: Küchenstühle gegen Holzstühle getauscht
...
Eine Raum-Bearbeitung, die nur die Stühle ersetzt und Perspektive, Beleuchtung und Bodenschatten beibehält.
...
### No. 10: Ungezwungenes Reisefoto an einer historischen Mauer
...
Ein realistisches, ungezwungenes Reisefoto einer jungen Frau an einer historischen Stadtmauer bei Nacht mit einem leuchtenden traditionellen chinesischen Gebäude.
...
### No. 11: Vintage-Reiseposter für einen Ort
...
Ein Prompt zur Erstellung eines von den 1920er-1930er Jahren inspirierten Reiseposters mit einem geschichteten Papierrelief- und geprägten Illustrationsstil in einer gedämpften Farbpalette.
...
### No. 12: Makrofoto von Schmetterlingsauge, Katzenbart
...
Eine fotorealistische Makro-Nahaufnahme eines Katzenbarts, von Facettenaugen eines Schmetterlings und der Haut eines Mädchens.
...
### No. 13: Luxus-Uhr auf Marmor-Mockup
...
Ein fotorealistisches Mockup für eine Zeitschriftenanzeige einer luxuriösen Titan-Chronographen-Uhr mit klarem Zifferblatttext.
...
### No. 14: Hochwertiges Kaffeetüten-Produkt-Mockup
...
Ein fotorealistisches kommerzielles Mockup einer mattschwarzen Kaffeetüte mit Berg-Line-Art auf rustikalem Holz.
...
### No. 15: Fashion-E-Commerce-Lookbook-Poster
...
Ein Prompt zur Generierung eines sauberen Fashion-Lookbook-Posters mit einem jungen weiblichen Model in Herbstkleidung, gestaltet mit weichen Pastellfarben.
...
### No. 16: Miniatur-Reiseszene mit Wahrzeichen
...
Ein Prompt zur Generierung einer charmanten, handgefertigten Miniatur-Szene mit einem winzigen 3D-Modell eines ikonischen Wahrzeichens.
...
### No. 17: Editoriales Porträt einer Frau mit Blick über die Stadt
...
Ein fotorealistisches editoriales Porträt einer erwachsenen ostasiatischen Frau mit Blick über eine Stadt in der Abenddämmerung.
...
### No. 18: Cinematisches Porträt einer Frau in einem sonnenbeschienenen Café
...
Ein Prompt für ein fotorealistisches cinematisches Porträt einer erwachsenen ostasiatischen Frau in einem sonnenbeschienenen Nachbarschaftscafé.
...
### No. 19: Asymmetrisches redaktionelles Halbgesichtsporträt
...
Eine Prompt zur Erstellung eines redaktionellen Porträts, bei dem das Motiv am linken Bildrand positioniert ist.
...
### No. 20: Premium redaktionelles Kunstposter für einen Ort
...
Eine Prompt zur Erstellung eines hochwertigen, modernen Kunstbuch-Stil-Posters für einen bestimmten Ort.
...
### No. 21: Warme Nachtszene einer lesenden Frau zu Hause
...
Eine Prompt zur Erstellung eines realistischen 16:9-Querformatfotos einer Frau in einer warmen, gewöhnlichen Wohnung bei Nacht.
...
### No. 22: Deluxe-Parfait aus unbeliebten Lebensmitteln
...
Eine Prompt zur Erstellung eines Deluxe-Parfait, das nur aus allgemein unbeliebten Lebensmitteln besteht, mit 30 Zutatenarten und Anmerkungen.
...
### No. 23: Japanisches Vintage-Reiseposter aus der Shōwa-Ära
...
Eine Prompt zur Erstellung eines hochwertigen, vertikalen Reiseposters im Stil des japanischen Eisenbahntourismus der Mitte des 20. Jahrhunderts.
...
### No. 24: Filmisches Porträt auf einer U-Bahn-Plattform
...
Ein hochauflösendes Porträt einer jungen Frau mit braunen Haaren, die regungslos steht, während ein Zug vorbeirast.
...
### No. 25: Porträt aus der Vogelperspektive in Qipao
...
Ein Porträt aus der Vogelperspektive eines großen, schlanken Models mit raffiniertem Make-up und einem fuchsartigen Gesicht, das ein Qipao in weichem, traumhaftem Licht trägt.
...
### No. 26: Überflutete Ebene mit nicht passender Reflexion
...
Eine Prompt für eine filmische Filmstandaufnahme einer überfluteten Ebene in der Dämmerung mit einem Bauernhaus und Pappeln, die eine nicht passende Reflexion im Wasser zeigt.
...
### No. 27: Vocaloid-MV-Stil 3x3-Raster
...
Eine Prompt zur Erstellung eines 3x3-Rasters verschiedener Aufnahmen im Stil eines Vocaloid-Musikvideos mit einem 16:9-Seitenverhältnis.
...
### No. 28: 16-Bit Krähen-Spritesheet
...
Eine Prompt zur Erstellung eines Spritesheets im 16-Bit-Stil einer Krähe im Flug, beim Start und bei der Landung.
...
### No. 29: Gladiator zu Pferd aus extremer Untersicht
...
Eine extreme Untersicht eines Gladiators auf einem Schlachtross, betrachtet von einem felsigen Bergpfad aus.
...
### No. 30: Nahaufnahme eines Riffs mit Oktopus
...
Eine Prompt, die anweist, auf ein Riff hereinzuzoomen, das Licht auf dem Stein zu beobachten und genau acht Arme einzubeziehen.
...
### No. 31: Kinematografisches anamorphes Standbild von Frauen in einer Pfingstrose
...
Ein breites anamorphes Foto von fünf Miniatur-Chinesinnen, die in einer großen blassrosa Pfingstrose sitzen.
...
### No. 32: Frau zwischen dichten rosa blühenden Zweigen
...
Ein Foto einer Frau, umgeben von dichten rosa blühenden Zweigen, die den Vorder- und Hintergrund ausfüllen.
...
### No. 33: Roboter am Strand bei Sonnenuntergang
...
Eine realistische, kinematografische Szene eines Roboters, der bei Sonnenuntergang am Strand sitzt und Sand in seiner Hand betrachtet.
...
### No. 34: Cyberpunk-Flauschige-Wolfsohren-Outfit
...
Eine Prompt zur Erstellung eines Cyberpunk-stilisierten flauschigen Kostüms mit neonpinken und -grünen Wolfsohren aus Fell und einem Choker.
...
### No. 35: Nahaufnahme-Selfie einer jungen Frau
...
Eine Prompt für ein unbearbeitetes iPhone-Foto einer jungen Frau mit Sommersprossen und windzerzausten Haaren.
...
### No. 36: Präsident der 1980er Jahre begrüßt Alien auf dem Rasen des Weißen Hauses
...
Eine Prompt zur Erstellung eines Bildes, das ein Foto im Stil der 1980er Jahre zeigt, auf dem ein Präsident ein Alien auf dem Rasen des Weißen Hauses begrüßt.
...
### No. 37: Filmstill eines königlichen Banketts der Tang-Dynastie
...
Ein breitformatiges historisches Filmstill, das ein fiktives, üppiges nächtliches Bankett am Hofe der Tang-Dynastie darstellt.
...
### No. 38: Realistische Modefotografie einer ostasiatischen Frau
...
Ein Prompt für ein realistisches Modefoto einer erwachsenen ostasiatischen Frau mit langen schwarzen Haaren, warmem Licht und Schatten auf ihrem Gesicht und natürlicher Hauttextur.
...
### No. 39: Porträt einer taiwanesischen Frau mit Schwarz-Mist-Filter
...
Ein Prompt für ein Porträt mit einem Schwarz-Mist-Filter, Überlagerungsmaske und Soft-Light-CCD-Fotografie mit subtilen Glanzlichtern.
...
### No. 40: Rote Higanbana am Fluss nach dem Regen
...
Ein Prompt zur Erzeugung eines realistischen Bildes einer einzelnen roten Higanbana (Spinnenlilie) mit Regentropfen, am Flussufer nach dem Regen.
...
### No. 41: Regnerische Straßenszene nach Ladenschluss
...
Ein Prompt für ein stimmungsvolles Bild, das eine Person nach Ladenschluss zeigt, mit Fokus auf nasser Wolle, Haut und Straßenlaternenlicht.
...
### No. 42: Fashion Editorial mit Wind und Seide
...
Ein Prompt für eine Fashion-Editorial-Szene mit drei Personen, die vom Wind gestylt werden, mit hartem Sonnenlicht und reichlich Seide.
...
### No. 43: Realistisches iPhone-Foto eines Tesla Model Y
...
Ein Prompt zur Erzeugung eines realistischen iPhone-Fotos eines Tesla Model Y auf einem Parkplatz, aufgenommen mit einer 0,5x-Kamera.
...
### No. 44: Öko-Zukunftsstadt in der Dämmerung mit Mond
...
Ein Prompt, das eine Öko-Zukunftsstadt in der Abenddämmerung, eine Mondstadt mit einer riesigen Erde, einen Seraphim-Wächterritter der Galaxie und eine silberhaarige Königin, die in einer Eiskristallkathedrale tanzt, beschreibt.
...
### No. 45: Große Armee mit Drachen im Regen
...
Eine komplexe Szene mit einer Armee von über 100 Personen, der Figur Luna, einem weißen Drachen, einem japanischen Schild, komplexer Speerführung und regnerischen Reflexionen.
...
### No. 46: Graues Niederländisches Zwergkaninchen beim Springen
...
Ein Prompt zur Erzeugung von Bildern eines hüpfenden Kaninchens und eines grauen Niederländischen Zwergkaninchens beim Hüpfen.
...
### No. 47: Anime-Paar im Park, hohe Detailgenauigkeit
...
Ein Bildgenerierungs-Prompt für einen jungen Mann und eine junge Frau im Anime-Stil in Freizeitkleidung in einem großen Park, gerendert in ultrahoher 16K-Auflösung mit verstärktem Kontrast und Sättigung.
...
### No. 48: Traum der Roten Kammer als traditionelle chinesische Bildrolle
...
Ein Prompt, um eine Szene aus 'Traum der Roten Kammer' als traditionelle chinesische Langbildrolle zu rekonstruieren.
...
### No. 49: Wüsten-Brutalismus-Architektur-Serie
...
Ein Prompt zur Generierung von Bildern monolithischer Erdarchitektur im Wüsten-Brutalismus-Stil mit Mash-ups von Promi-Architekten.
...
### No. 50: Fotografie eines Spaziergangs zur Goldenen Stunde
...
Ein Prompt für ein fotorealistisches Smartphone-Foto einer Frau, die zur Goldenen Stunde auf einer baumgesäumten Straße spaziert.
...
### No. 51: Luxus-Reiseposter-Kollektion
...
Ein Prompt zur Erstellung einer anspruchsvollen Luxus-Reiseposter-Kollektion, inspiriert von Santorini, der Amalfiküste und Paris.
...
### No. 52: Ungezwungenes Porträt im Stadtpark
...
Ein ungezwungenes Outdoor-Porträt einer jungen Frau mit langem dunkelbraunem Haar in einem friedlichen Stadtpark an einem sonnigen Nachmittag.
...
### No. 53: Charakter-Referenzblatt für Wüstenattentäter
...
Ein Prompt zur Generierung eines filmischen Charakter-Referenzblatts, das einen tödlichen Wüstenattentäter zeigt.
...
### No. 54: Modefoto einer ostasiatischen Frau in einer Lounge
...
Ein Prompt für ein ultra-fotorealistisches Smartphone-Modefoto einer schönen ostasiatischen Frau in einer privaten Lounge bei Nacht.
...
### No. 55: Vintage-Reisepostbriefmarke als Kunstwerk
...
Ein Prompt zur Erstellung einer Briefmarke im Vintage-Stil, die ein ikonisches Wahrzeichen und kulturelle Elemente eines Landes zeigt.
...
### No. 56: Vintage-Reiseposter eines ikonischen Bauwerks
...
Ein Prompt zur Erstellung eines stilisierten, handgemalten Vintage-Reiseposters mit einem erkennbaren architektonischen Wahrzeichen.
...
### No. 57: Ungezwungenes Modeporträt in einer Parkgarage
...
Ein ultra-fotorealistisches Porträt einer schönen eurasischen Frau in einer modernen unterirdischen Parkgarage.
...
### No. 58: Handgefertigte Miniatur-Essensszene
...
Ein Prompt zur Erstellung einer charmanten Miniatur-Szene mit einem bestimmten Gericht auf einem Keramikteller.
...
### No. 59: Ladenfront-Miniaturdiorama
...
Ein Prompt zur Erstellung eines verspielten 3D-Ton-Miniaturdioramas eines bekannten Ladens oder einer Marke.
...
### No. 60: Miniaturdiorama eines ikonischen Bauwerks
...
Ein Prompt zur Erstellung einer detaillierten, gemütlichen Miniaturwelt mit einem zentralen ikonischen Bauwerk.
...
### No. 61: Asymmetrisches High-Fashion-Studio-Porträt
...
Ein Prompt für ein Nahaufnahme-Porträt eines Mannes vor einem weißen Studiohintergrund mit asymmetrischer Komposition.
...
### No. 62: Vom Wind geformte weiße Labyrinth-Landschaft
...
Ein beschreibender Prompt zur Erstellung einer Landschaft eines weißen Labyrinths, das durch Winderosion über die Zeit geformt wurde.
...
### No. 63: Weißer Drachenritter und kleiner Stein
...
Eine Szene, die einen Weißen Drachenritter bei Nacht zeigt, der nicht von einem Feind, sondern von einem einzigen kleinen Stein aufgehalten wird, mit einer philosophischen Bildunterschrift.
...
### No. 64: Editorial-Porträt eines selbstbewussten Mannes
...
Eine Prompt zur Erstellung eines hochwertigen, editorialen Studio-Porträts eines selbstbewussten Mannes mit kurzen schwarzen Haaren.
...
### No. 65: Ganzkörper-Modeporträt im Studio
...
Eine Prompt zur Erstellung eines Ganzkörper-Porträts eines selbstbewussten männlichen Models in einer warmen, nahtlosen Studioatmosphäre.
...
### No. 66: Meisterwerk einer Luxus-Reisekampagne
...
Eine Prompt für eine anspruchsvolle Luxus-Lifestyle-Reisekampagne, die alpine, dubaische und europäische Chalet-Erlebnisse vereint.
...
### No. 67: Morgenroutine des Blaumagier-Meisters
...
Eine Szene, die die Morgenroutine eines Blaumagier-Meisters zeigt, in der Kämme, Haargummis und Schnürsenkel ihre Arbeit beenden, während er Berichte liest.
...
### No. 68: Schiff erreicht die Weiße Kreideküste
...
Eine beschreibende Prompt für eine Szene, in der ein Schiff an einer Küste aus weißer Erde, Salz und Kalkstein ankommt, mit ungesehenen Ländern dahinter.
...
### No. 69: Charakterporträt eines See-Elfen-Fischers
...
Eine Prompt, die einen Elfen beschreibt, der am Meer lebt, ein Küstenfischer, der die Zeichen des Ozeans liest.
...
### No. 70: Professionelles Studio-Bewerbungsfoto
...
Eine Prompt zur Erstellung eines professionellen Studio-Bewerbungsfotos eines erwachsenen Mannes.
...
### No. 71: Selbstbewusster Mann in luxuriösem modernem Interieur
...
Ein ultrarealistisches Lifestyle-Porträt eines selbstbewussten Mannes in einem luxuriösen modernen Interieur mit einer dunklen Holztür und einem großen Spiegel.
...
### No. 72: Fantasy-Speerwerfer schläft am Schreibtisch
...
Ein poetischer Prompt, der die Nacht eines Speerwerfers beschreibt, der sich an die Maserung eines Schreibtisches vor einer überweltlichen Karte erinnert.
...
### No. 73: Drachenritter ruht im Schatten
...
Eine Szene, die zwei Drachenritter zeigt, die unter einem Drachenflügel eine Pause machen, mit einer Karte und hartem Brot.
...
### No. 74: Stilvoller Mann in gemütlicher Abendbibliothek
...
Ein ultrarealistisches Porträt eines Mannes, der in einem edlen Bibliotheks-Loungebereich am frühen Abend entspannt.
...
### No. 75: Dullahan-Postbote in Herbstnacht
...
Ein Nachtpostbote geht eine Herbststraße entlang, die mit roten Higanbana unter einem Nachthimmel gesäumt ist.
...
### No. 76: Ganzkörper-Editorial-Porträt in Bordeaux
...
Ein ultrarealistisches Editorial-Porträt eines selbstbewussten schwarzen Mannes in einem sauberen Anzug, sitzend in einem minimalistischen Studio-Setting.
...
### No. 77: Nachmittag der Blauzauber-Meisterin
...
Eine Szene, die den Nachmittag einer Blauzauber-Meisterin zeigt, in dem Magie Sonnenlicht und Kopfsteinpflaster beseitigt, bevor sie sie erreichen.
...
### No. 78: Sonnenuntergang über rissiger Erde mit Flammen
...
Ein beschreibender Prompt für eine Szene einer Dämmerungswildnis mit dünnen Flammen, die aus Bodenspalten aufsteigen, und dem Kaspischen Meer in der Ferne.
...
### No. 79: Segelschiff im Vintage-Stil bei goldenem Sonnenuntergang
...
Ein ultrarealistisches Bild eines hölzernen Segelschiffs im Vintage-Stil in einer dramatischen Ozeanszene bei Sonnenuntergang.
...
### No. 80: Weißer Drachenritter überprüft Flügelverletzung
...
Eine Szene, in der ein Meister des Weißen Drachenritter-Ordens vorsichtig die linke Flügelverletzung eines schlafenden Drachen in einem mondbeschienenen Drachenstall untersucht.
...
### No. 81: Reisender flickt blaues Tuch in Vulkanstadt
...
Eine Szene, in der am Nachmittag ein blaues Reisetuch in einer Vulkanstadt geflickt wird, mit Bergen in der Ferne.
...
### No. 82: Morgen in einer Spiegelwelt mit einem Speerkämpfer
...
Eine Prompt, die einen Speerkämpfer darstellt, der seinen größten Titel verloren hat und seinen Tag mit nassen Schnürsenkeln im Morgen einer Spiegelwelt beginnt.
...
### No. 83: Blaumagier-Meisterin Luna vor der Dämmerung
...
Eine Szene, die Blaumagier-Meisterin Luna vor der Dämmerung zeigt, mit Büchern, einem Stuhl und Tee, aus einer Zeit, als sie ihren Körper noch nicht benötigte.
...
### No. 84: Landschaft, in der Feuer aus der Erde sickert
...
Eine beschreibende Prompt für eine Landschaft, in der Feuer aus der Erde sickert, in einer trockenen Wildnis, mit grauem Schlammfluss und dem Kaspischen Meer in der Ferne.
...
### No. 85: Schwarze Drachenritterin Luna bei Nacht
...
Eine Szene, die die Schwarze Drachenritterin Luna bei Nacht zeigt, wie sie ihre Speerschwielen überprüft, während El Drago neben ihr schläft.
...
### No. 86: Frieren und Fern an einem guten Ort
...
Eine SFW-Illustration, die ein Gespräch zwischen den Charakteren Fern und Frieren darstellt.
...
### No. 87: Von Wind und Regen geformte Hügel
...
Eine poetische Prompt, die eine Landschaft beschreibt, in der Grün verblasst und Schichten aus Ocker, Rost, Grauweiß und Blassgrün auf von Wind und Regen geformten Hügeln freilegt.
...
### No. 88: Antike Dame mit Fächer vor Bambus
...
Eine KI-Prompt zur Erstellung eines östlich-ästhetischen Wallpapers, das eine klassische Frau mit einem Rundfächer vor einer weißen Wand und Bambusschatten zeigt.
...
### No. 89: Polizei-Rettungsroboter ziehen Rettungsboot
...
Eine Prompt, die ein schweres Maschinen-Roboterteam der Tokioter Polizei darstellt, das Evakuierte rettet, indem es ein Rettungsboot zieht.
...
### No. 90: Städtische Sternwarte am Tag, CCD-Foto
...
Eine Prompt zur Erstellung eines hellen, tageslichtähnlichen CCD-Stil-Lifestyle-Fotos, das Urban Exploration auf einer astronomischen Beobachtungsplattform zeigt.
...
### No. 91: Vertikales iPhone-Lifestyle-Porträt
...
Eine Prompt zur Erstellung eines realistischen, ungezwungenen Porträts einer jungen Frau im iPhone-Stil.
...
### No. 92: Neuer chinesischer Stil Blumenfenster-Poster
...
Eine Bildgenerierungs-Prompt für ein elegantes, minimalistisches orientalisches Poster mit einer klassischen Frau an einem jadegrünen Blumenfenster.
...
### No. 93: Fotorealistisches Editorial-Porträt einer ostasiatischen Frau
...
Eine detaillierte Prompt zur Erstellung eines fotorealistischen Porträts einer jungen ostasiatischen Frau bis zu den Knien auf Augenhöhe mit spezifischen Gesichtszügen.
...
### No. 94: Polizei-Schwermaschinen-Roboter reinigen Fluss
...
Eine Prompt, die ein Roboterteam der Polizei-Schwermaschineneinheit beschreibt, das Müll beseitigt, der einen Fluss aufstaut.
...
### No. 95: Fotorealistisches Editorial-Porträt mit Herz-Oval-Gesicht
...
Eine detaillierte Prompt zur Erstellung eines Editorial-Porträts einer jungen ostasiatischen Frau bis zu den Knien auf Augenhöhe mit spezifischen Gesichtszügen.
...
### No. 96: iPhone-Porträt einer jungen Frau
...
Eine Prompt zur Erstellung eines realistischen, lässigen vertikalen Fotos (9:16) einer Frau im Alter von 20-26 Jahren, als wäre es mit der Hauptkamera eines iPhones aufgenommen.
...
### No. 97: Zen-Frau am Wasser im Sommer
...
Eine Prompt zur Erstellung eines östlich-ästhetischen Wallpapers, das eine Frau am Wasser in einem minimalistischen, erfrischenden Stil zeigt.
...
### No. 98: Cowboy-Shot-Porträt einer ostasiatischen Frau
...
Eine detaillierte Prompt für ein fotorealistisches Editorial-Porträt einer jungen ostasiatischen Frau mit spezifischen Gesichtszügen.
...
### No. 99: Städtisches Dachterrassen-Buchcafé-Fotoshooting
...
Eine Prompt zur Erstellung eines hellen, tageslichtähnlichen CCD-Stil-Lifestyle-Fotos mit urbanem, künstlerischem Setting und spezifischer Kleidung.
...
### No. 100: Fotorealistisches Editorial-Porträt einer ostasiatischen Frau
...
Eine detaillierte Prompt zur Erstellung eines Editorial-Porträts einer jungen ostasiatischen Frau bis zur Taille auf Augenhöhe mit spezifischen Gesichtszügen.
...
### No. 101: Orientalisches Zen-Minimalist-Cover-Poster
...
Eine Prompt zur Erstellung eines orientalisch-minimalistischen Wallpapers, das eine anmutige, antik-stilvolle Frau zeigt, die durch eine blaue Tür mit Kirschblüten geht.
...
### No. 102: Polizei-Roboterteam der Schwerlast-Einheit
...
Ein Bild eines Polizei-Roboterteams der Schwerlast-Einheit, das Fahrzeuge von einer durch Starkregen überfluteten Straße räumt.
...
### No. 103: Heller CCD-Stil Urban Sports Lifestyle-Foto am Tag
...
Ein Prompt zur Erzeugung eines hellen, tagsüber aufgenommenen Lifestyle-Fotos im CCD-Stil in einem urbanen Sportumfeld.
...
### No. 104: Zen-minimalistisches vertikales Cover-Poster
...
Ein Prompt zur Erstellung eines minimalistischen, hellen und sauberen 9:16-Vertikal-Covers mit moderner östlicher weiblicher Ästhetik und Morgenstimmung.
...
### No. 105: Frau sitzt am runden Fenster
...
Ein Prompt zur Erzeugung eines östlichen Zen-minimalistischen Posters, das eine entspannende Frau an einem runden Fenster zeigt.
...
### No. 106: Polizei-Roboterteam stoppt außer Kontrolle geratenen LKW
...
Ein Bild eines Polizei-Roboterteams der Schwerlast-Einheit, das versucht, einen außer Kontrolle geratenen LKW zu stoppen.
...
### No. 107: Ganzkörper-Editorialporträt einer jungen Frau
...
Ein Prompt für ein ganzkörperliches Editorialporträt auf Augenhöhe einer jungen japanischen oder koreanischen Frau mit Creolen.
...
### No. 108: Fotorealistisches Hüftbild-Porträt mit Brille
...
Ein Hüftbild-Porträt auf Kniehöhe einer jungen japanischen oder koreanischen Frau mit einer auffälligen, weißen Dickrandbrille.
...
### No. 109: Zen-minimalistisches Cover-Poster mit Frau und Windspiel
...
Ein Prompt zur Erzeugung eines Bildes einer Frau, die ein Windspiel an einem Fenster berührt, im minimalistischen östlichen Zen-Stil.
...
### No. 110: Postapokalyptische Stadt mit grüner Vegetation
...
Ein detailliertes Foto einer postapokalyptischen Stadt in Shenzhen, China, die mit grüner Vegetation überwuchert ist.
...
### No. 111: Japanische Frau mit tanuki-ähnlichem Gesicht bei Nacht
...
Ein Prompt zur Erzeugung eines fotorealistischen Bildes einer fiktiven jungen japanischen Frau mit einem tanuki-ähnlichen Gesicht in einer ruhigen Nachtszene.
...
### No. 112: Delfinblick auf Frauen im Glas-Aquarium
...
Ein realistisches Bild aus der Perspektive eines Delfins, der durch ein 360-Grad-Glasbecken auf Frauen in einem belebten, frauenexklusiven Aquarium blickt.
...
### No. 113: Polymerknetmasse-Miniatur einer Markenfiliale
...
Ein Prompt zur Erstellung einer Miniatur-Knetmodell-Szene einer Markenfiliale mit gemütlichen Gehwegdetails.
...
### No. 114: Mode-Werbung mit geneigter Bodenaufnahme
...
Eine Modekampagne für eine fiktive Marke mit sechs Personen in lebhafter Kleidung vor kobaltblauem Himmel, aus einem niedrigen Kamerawinkel aufgenommen.
...
### No. 115: Handgezeichnetes Anime-Duell mit Kirschblüten
...
Eine Szene aus einem späten 1990er Jahre handgezeichneten japanischen Animationsfilm, in der eine Frau mit einem Katana einem Schwertkämpfer unter fallenden Kirschblüten gegenübersteht.
...
### No. 116: Schwarzes Spukbraut-Gothic-Hochzeitskleid
...
Ein Prompt für ein Gothic-Halloween-Horror-Brautkostüm mit dunkler romantischer Eleganz.
...
### No. 117: Düsteres cinematisches Porträt einer ostasiatischen Frau
...
Ein Prompt für ein kontrastreiches, cinematisches Nahporträt einer jungen ostasiatischen Frau mit blasser Haut und langen schwarzen Haaren.
...
### No. 118: Cinematisches Nachtstraßenporträt auf nassem Zebrastreifen
...
Ein Prompt für ein cinematisches Porträt einer jungen ostasiatischen Frau auf einem nassen Zebrastreifen bei Nacht.
...
### No. 119: Nahporträt mit leuchtenden goldenen Augen
...
Ein Prompt für ein cinematisches Nahporträt einer jungen ostasiatischen Frau mit pechschwarzem Haar und leuchtenden goldenen Augen.
...
### No. 120: Fotorealistisches Porträt mit Brille und Zwinkern
...
Ein fotorealistisches Porträt einer jungen ostasiatischen Frau mit Brille und welligem Haar, die sanft zwinkert.
...
### No. 121: Analog-Film-Stil Porträt mit zerzaustem Haar
...
Ein fotorealistisches Analog-Film-Stil-Porträt einer jungen ostasiatischen Frau mit zerzaustem schwarzem Haar, die in die Kamera blickt.
...
### No. 122: Filmisches Porträt im dunklen Wasser schwebend
...
Ein filmisches Porträt einer ruhigen jungen Frau, die mit nassem Haar in stillstehendem Wasser schwebt.
...
### No. 123: Studio-Schönheitsporträt mit Seitenzopf
...
Ein fotorealistisches Studio-Schönheitsporträt einer jungen ostasiatischen Frau mit leuchtender Haut, langem schwarzem Haar und geschlossenen Augen.
...
### No. 124: Porträt einer Frau mit Hijab im Auto
...
Ein fotorealistisches Nahaufnahme-Porträt einer jungen ostasiatischen Frau in einem Auto, die einen hellbeigen Hijab trägt.
...
### No. 125: Frau macht ein Selfie mit Hijab
...
Eine Prompt zur Erzeugung eines Bildes einer jungen Frau in einem hellen Hijab, die an einem Holztisch ein Selfie macht.
...
### No. 126: Porträt einer Frau, die über die Schulter blickt
...
Eine detaillierte Prompt zur Erzeugung eines fotorealistischen Porträts einer jungen ostasiatischen Frau, die über ihre Schulter blickt.
...
### No. 127: Porträt einer Frau mit Brille
...
Ein Porträt einer jungen ostasiatischen Frau mit Brille, welligem Haar und einem ruhigen Ausdruck.
...
### No. 128: Nahaufnahme-Porträt mit lebhaftem Lippenstift
...
Ein fotorealistisches Porträt einer jungen ostasiatischen Frau mit porzellanartiger Haut, Mandelaugen und lebhaftem Lippenstift.
...
### No. 129: Porträt mit nassem Haar und entblößter Schulter
...
Ein fotorealistisches Porträt einer jungen Frau mit feuchter Haut und nassem schwarzem Haar, die über ihre Schulter blickt.
...
### No. 130: Filmisches Porträt einer ostasiatischen Frau
...
Ein Nahaufnahme-Porträt einer jungen ostasiatischen Frau mit langem dunklem welligem Haar vor schwarzem Hintergrund.
...
### No. 131: Fotorealistisches Porträt mit Brille
...
Ein fotorealistisches Porträt einer jungen ostasiatischen Frau mit langem welligem Haar, runder Brille und einem sanften Ausdruck.
...
### No. 132: Filmisches Porträt mit Honig-Highlights
...
Eine Prompt für ein filmisches Nahaufnahme-Porträt einer jungen ostasiatischen Frau mit welligem hellbraunem Haar und einem ruhigen Ausdruck.
...
### No. 133: Fotorealistisches Porträt mit Bob-Frisur
...
Ein fotorealistisches Nahaufnahme-Porträt einer jungen ostasiatischen Frau mit kurzem schwarzem Bob, rauchigem Lidschatten und strahlender Haut.
...
### No. 134: Porträt einer Frau mit Hijab und Kappe
...
Eine Nahaufnahme-Porträt einer jungen Frau mit heller Haut und einem ruhigen Gesichtsausdruck, die einen weißen Hijab und eine schwarze Baseballkappe trägt.
...
### No. 135: Selfie-Porträt mit Chiffon-Hijab
...
Eine Nahaufnahme-Selfie-Porträt einer jungen ostasiatischen Frau mit heller Haut und zarten Gesichtszügen, die einen staubfarbenen Chiffon-Hijab trägt.
...
### No. 136: Filmisches Porträt einer weinenden ostasiatischen Frau
...
Ein fotorealistisches Nahaufnahme-Porträt einer jungen Frau mit glänzender, von Tränen nasser Haut und feinen Pony.
...
### No. 137: Porträt einer Frau mit juwelenbesetztem Spitzen-Augenklappe
...
Eine Nahaufnahme-Porträt einer jungen Frau mit blasser Haut und schwarzem Bob, ein rotes Auge sichtbar und das andere von einer juwelenbesetzten schwarzen Spitzen-Augenklappe bedeckt.
...
### No. 138: Intensives filmisches Porträt mit zerzaustem Haar
...
Eine Nahaufnahme-filmisches Porträt einer jungen Frau mit langen schwarzen Haaren, die direkt in die Kamera blickt.
...
### No. 139: Nahaufnahme-Porträt mit glänzendem dunklem Haar
...
Eine detaillierte Vorlage zur Erstellung eines Porträts einer jungen Frau mit heller Haut und langem dunklem Haar.
...
### No. 140: Lächelndes sonnenverwöhntes Porträt mit Schweißglanz
...
Eine Nahaufnahme-Porträt einer jungen ostasiatischen Frau mit zerzaustem schwarzem Haar, die blinzelt und lächelt, mit geröteter, feucht-glänzender Haut.
...
### No. 141: Ausdrucksstarkes Porträt mit Flügel-Eyeliner
...
Eine detaillierte Vorlage zur Erstellung eines Nahaufnahme-Porträts einer jungen südostasiatischen Frau mit spezifischen Gesichtszügen und Make-up.
...
### No. 142: Selfie-Porträt mit Kuss-Gesichtsausdruck
...
Eine Vorlage für ein Nahaufnahme-Selfie-Porträt einer jungen ostasiatischen Frau mit geschlossenen Augen und einem entspannten Gesichtsausdruck.
...
### No. 143: Porträt einer lächelnden jungen Frau
...
Eine Vorlage zur Erstellung eines Porträts einer jungen ostasiatischen oder indonesischen Frau mit hellem Teint, dezenter Schminke und einem sanften, freundlichen Gesichtsausdruck.
...
### No. 144: Selfie einer Frau mit halboffener Frisur
...
Eine Vorlage zur Erstellung eines fotorealistischen Selfie-Porträts einer jungen ostasiatischen Frau mit spezifischen Merkmalen und Styling.
...
### No. 145: Erde wird von Schwarzem Loch verschlungen - Phasen
...
Eine Vorlage zur Erstellung von vier Bildern, die die visuellen Phasen darstellen, wie die Erde aus der Sicht eines menschlichen Beobachters von einem Schwarzen Loch verschlungen wird.
...
### No. 146: Cyberpunk-Krieger gegen mechanischen Boss-Charakter
...
Ein Prompt, der zwei Charaktere beschreibt: einen Cyberpunk-Katana-Krieger und eine massive mechanische Boss-Entität.
...
### No. 147: Himmlische Göttin, die vor einem Palast herabsteigt
...
Ein Bild einer majestätischen chinesischen himmlischen Göttin in zeremoniellem Hanfu, die durch rosa-goldene Wolken vor einem himmlischen Palast herabsteigt.
...
### No. 148: Himmlische Jungfrau in sonnenbeschienener Dreiviertelansicht
...
Ein Bild einer himmlischen Jungfrau in elfenbeinfarbenem Hanfu, von Morgenlicht beleuchtet, mit fließenden Bändern und goldenen Haarnadeln.
...
### No. 149: Himmlische Jungfrau, sitzend an einem Jadeteich
...
Ein Bild einer friedlichen chinesischen himmlischen Jungfrau in Seiden-Hanfu, die eine Lotusblume an einem türkisfarbenen Teich berührt.
...
### No. 150: Himmlische Göttin auf Jadepalast-Stufen
...
Ein Bild einer eleganten chinesischen himmlischen Göttin auf weißen Jadestufen, in besticktem Hanfu mit treibenden Seidenbändern.
...
### No. 151: Porträt in einem antiken chinesischen Ritualschrein
...
Ein fotorealistisches, filmisches Porträt einer erwachsenen ostasiatischen Frau in einem dunklen antiken chinesischen Ritualschrein mit Nuo-Masken und Kerzen.
...
### No. 152: Porträt einer Frau in einem dunklen Ritualschrein
...
Ein fotorealistisches, filmisches Porträt einer ostasiatischen Frau mit nassem schwarzem Haar und rauchigem Make-up in einem dunklen antiken Schrein.
...
### No. 153: Nahaufnahme-Porträt bei einem nächtlichen Nuo-Fest
...
Eine Nahaufnahme-Porträt einer erwachsenen ostasiatischen Frau neben einer verwitterten Nuo-Maske während eines nächtlichen Ritualfestes.
...
### No. 154: Bier mit dichter Schaumkrone
...
Ein Prompt zur Erzeugung eines fotorealistischen Bildes eines Bieres mit einer dichten, kaskadierenden Schaumkrone auf einem scharfkantigen Glas.
...
### No. 155: Tofuwürfel, der aus einem Eintopf gehoben wird
...
Ein beschreibender Prompt für ein Bild eines porösen Tofuwürfels, der über einem Topf schwebt, mit einem einzelnen bernsteinfarbenen Bröckchen daran.
...
Ein Bild eines Löffels Chili-Relish mit deutlichen roten Chili-Würfeln, tee-dunklen Grüntönen, hellgrüner Paprika, hellen Bohnen und durchscheinendem bernsteinrotem Öl.
...
### No. 157: Nahporträt einer Frau im Wohnzimmer
...
Ein ultrarealistisches Nahporträt einer jungen Frau mit einem verspielten Ausdruck in einem gemütlichen, modernen Wohnzimmer.
...
### No. 158: Porträt einer ruhenden Frau im dunklen Schlafzimmer
...
Ein Prompt für ein fotorealistisches, vertikales Porträt einer jungen Frau, die nachts in einem schwach beleuchteten Schlafzimmer auf Bettwäsche ruht.
...
### No. 159: Träumerisches Porträt einer Frau im Sommergras
...
Ein filmisch inspiriertes Bild einer jungen ostasiatischen Frau, die in hohem Gras ruht, sanft von warmem Tageslicht beleuchtet.
...
### No. 160: Porträt einer Frau am hellblauen Hafen
...
Ein Porträt im Filmkorn-Stil einer jungen ostasiatischen Frau, die lässig an einem hellblauen Hafen an einem sonnigen, windigen Tag hockt.
...
### No. 161: Straßenporträt einer jungen Frau in Paris
...
Ein Prompt für ein hochauflösendes, natürliches Straßenporträt einer jungen, asiatisch aussehenden Frau in einer Paris-inspirierten Einkaufsstraße.
...
### No. 162: Ungezwungenes U-Bahn-Porträt bei Nacht
...
Ein fotorealistisches, ungezwungenes Porträt einer erwachsenen ostasiatischen Frau, die nachts an einem Zugfenster sitzt.
...
### No. 163: Uhr mit Eis- und Rauch-Schockwelle
...
Ein Bild einer Uhr mit einer kreisförmigen Eis- und Rauch-Schockwelle dahinter, die eine klare Silhouette beibehält.
...
### No. 164: Geschichtete Bäckerei-Auslage mit Tiefe
...
Ein Prompt für die Erzeugung eines Bildes einer hochwertigen Bäckereiauslage, bei der die Artikel in deutlichen Höhenstufen angeordnet sind, um Tiefe zu erzeugen.
...
### No. 165: Sanft beleuchtetes Schlafzimmerporträt im Slipkleid
...
Ein fotorealistisches Porträt einer erwachsenen ostasiatischen Frau in einem elfenbeinfarbenen Satin-Slipkleid in einem sanft beleuchteten Schlafzimmer.
...
### No. 166: Auto mit kontrastierender Staubexplosionswolke
...
Ein Bild eines kraftvollen Autos, das eine massive Staubwolke hinter sich erzeugt, während es im Vordergrund sauber und leise bleibt.
...
### No. 167: Hexen-Silhouette, von himmlischem Feuer hinterleuchtet
...
Ein Bild einer Hexen-Silhouette, die von einer massiven orange-goldenen himmlischen Feuerwolke hinterleuchtet wird.
...
### No. 168: Tomaten-Sauce-Herz, das aus einer Koshari-Schüssel aufsteigt
...
Ein Bild von glänzender Tomatensauce, die über einer Schüssel Koshari eine Herzform bildet.
...
### No. 169: Schachfiguren, aus Nudelsträngen geformt
...
Eine Aufforderung, Schachfiguren zu generieren, die aus handgefertigten Nudelsträngen mit erkennbaren Silhouetten geformt sind.
...
### No. 170: Sesamöl-Flasche mit Boxerarmen im Ring
...
Ein Bild einer überdimensionalen Sesamöl-Flasche mit goldenen Boxerarmen, die siegreich in einem Boxring steht.
...
### No. 171: Szene an der Theke einer kompakten modernen Apartmentküche
...
Eine Aufforderung, ein Bild einer kompakten modernen Apartmentküche mit einer Frühstückstheke, durchgehender Arbeitsplatte, Edelstahlspüle, Kochfeld und Bratpfanne zu generieren.
...
### No. 172: Schawarma-Wrap, wie eine Rakete nach oben gerichtet
...
Eine Aufforderung, ein Bild eines Schawarma-Wraps zu generieren, der wie eine Rakete abgewinkelt ist, wobei die offene Füllung als Blickpunkt betont wird.
...
### No. 173: Bananen-Maskottchen hält überdimensionale Dose
...
Ein Bild eines laufenden Bananen-Maskottchens, das eine überdimensionale kalte Aluminiumdose nach vorne in Richtung Kamera hält.
...
### No. 174: Ostasiatische Frau, ungestelltes Nachtfoto
...
Eine Aufforderung, ein realistisches, ungestelltes Foto einer ostasiatischen Frau mit bestimmten Merkmalen und Beleuchtung zu generieren.
...
### No. 175: Kekscreme als Miniatur-Eisfläche
...
Ein Bild eines Kekses, bei dem die Vanillecremeschicht sich zu einer glatten Miniatur-Eisfläche erhebt und den Maßstab in eine Winterwelt verwandelt.
...
### No. 176: Achterbahnschiene aus gestapelten Chips
...
Ein Bild einer Achterbahnschiene, die aus perfekt ausgerichteten, gestapelten Chips konstruiert ist und einen vollen Looping zeigt.
...
### No. 177: Rote Spotlight-Zonen hinter einem Haupt-Eimer
...
Eine Bildbeschreibung mit drei sauberen roten Spotlight-Zonen mit sekundären Lifestyle-Momenten hinter einem Haupt-Eimer.
...
### No. 178: Glänzender Nudelstrom als vertikale Bewegungslinie
...
Ein minimalistisches Poster-Konzept mit einem einzelnen glänzenden Nudelstrom als zentralem vertikalen Element.
...
### No. 179: Cinematische 2,5D-Gouache-Animation
...
Eine Aufforderung, eine cinematische 2,5D-Animation mit einem malerischen Gouache-Concept-Art-Stil zu erstellen, der sichtbare Pinselstrukturen und flache Farbblöcke zeigt.
...
### No. 180: Stimmungsvolles Cinematic-Porträt im Dunkeln
...
Ein cinematografisches Porträt eines Mannes mit zerzausten Haaren, der aus den Schatten auftaucht, mit dramatischer Beleuchtung und ultrarealistischer Textur.
...
### No. 181: Riesenmann neben der Freiheitsstatue
...
Ein ultrarealistisches, cinematografisches Reisefoto eines gutaussehenden jungen Mannes, der als Riese neben der Freiheitsstatue steht.
...
### No. 182: Porträt zur Goldenen Stunde auf rustikaler Veranda
...
Ein warmes, ungekünsteltes Lifestyle-Porträt eines jungen Mannes, der zur Goldenen Stunde Tee auf einer rustikalen Veranda genießt.
...
### No. 183: Cinematografisches Porträt auf einer Wiese
...
Ein ultrarealistisches Porträt einer Frau mit Cowboyhut, die auf einer grünen Wiese mit Salbeibusch und Kiefern steht.
...
### No. 184: Vertikales ungekünsteltes Porträt einer Frau
...
Ein Prompt zur Erzeugung eines vertikalen, ungekünstelten Fotos einer jungen ostasiatischen Frau mit spezifischen Merkmalen.
...
### No. 185: Diagonaler Riegel mit aufgerissenem Geschmacksbereich
...
Ein Prompt zur Erzeugung eines Bildes eines diagonal verpackten Dessertriegels mit aufgerissenem Umhüllung, der einen offenen Mund-Effekt in einer dessertthematischen Welt erzeugt.
...
### No. 186: Frauenporträt in ovalem Spiegel
...
Ein Schönheitsporträt einer Frau, die sich in einem vertikalen, ovalen Spiegel spiegelt, mit matter Kobalt-Lippenstift.
...
### No. 187: Bierglas-Vortex in der Wüste
...
Ein surrealistisches Bild eines aufragenden Bierglases, das aus der Wüste als sich windender Wirbel aus Sand und Bier entsteht.
...
### No. 188: Bierflasche im Vordergrund
...
Ein Prompt für ein Bild mit einer großen, scharfen, teilweise angeschnittenen echten Bierflasche im unteren rechten Vordergrund.
...
### No. 189: Mondrian-Gemälde als Schreibtisch-Aufbewahrungsschrank
...
Ein Prompt, um Mondrians 'Komposition mit Rot, Blau und Gelb' in einen funktionalen Schreibtisch-Aufbewahrungsschrank mit farbigen Schubladen zu verwandeln.
...
### No. 190: Realistisches Bild eines surrealen Gegenstands
...
Ein Prompt, um ein hochrealistisches Bild eines imaginären, surrealen Motivs zu generieren.
...
### No. 191: Winzige Menschen in einer Tangerinenwelt
...
Ein Bild von winzigen Menschen, die in einer Tangerine leben, wobei die Fruchtsegmente die Architektur bilden.
...
### No. 192: Bedrohliche Figur im scharfen Profil
...
Ein Prompt zur Generierung eines Bildes einer bedrohlichen Figur mit rabenschwarzem Haar und blutroten Lippen im scharfen Profil.
...
### No. 193: Werbung für fiktive Dating-App
...
Ein Prompt zur Generierung einer Werbung für eine Dating-App, die junge Kalenjin-Models zeigt.
...
### No. 194: Rooftop-Radio-Porträt vor Sonnenaufgang
...
Ein Prompt zur Generierung eines Porträts eines wettergegerbten Gesichts auf einem Dach mit einem Radio vor Sonnenaufgang.
...
### No. 195: Leerer Fushimi-Inari-Tunnel im Morgengrauen
...
Ein Prompt zur Generierung einer friedlichen, frühmorgendlichen Szene der ikonischen zinnoberroten Tore am Fushimi-Inari-Schrein in Kyoto, gestaltet als Bild für eine Reisekampagne.
...
### No. 196: Innenwelt basierend auf KI-Kunstpräferenzen
...
Eine Prompt, die eine Illustration anfordert, die die Innenwelt des Nutzers widerspiegelt, basierend auf dessen bisherigen KI-Kunstpräferenzen.
...
### No. 197: Makroaufnahme eines futuristischen Stadtprozessors
...
Eine Prompt für eine Makroaufnahme eines transparenten, raumgroßen Prozessors, der eine leuchtende Stadt enthält.
...
### No. 198: Symbolisches Selbstporträt aus Sprache und Code
...
Ein Bild, das ein symbolisches Selbstporträt darstellt, in dem Sprache, Code und Kreativität durch Licht miteinander verbunden sind.
...
### No. 199: Alienwelt mit mediterranem Retro-Futurismus
...
Eine Prompt zur Generierung eines Bildes einer menschlichen Siedlung auf einer Alienwelt mit mediterran inspirierter Architektur und retro-futuristischen Elementen.
...
### No. 200: Porträt der Kryo-Archontin Zarin Anastasya
...
Eine Prompt zur Generierung eines Porträts der Zarin, einer Kryo-Archontin und Herrscherin, beschrieben mit verschiedenen königlichen und traurigen Titeln.
...
### No. 201: Bushaltestelle im Morgennebel
...
Ein poetisches Bild einer Bushaltestelle im Morgennebel, wo Dampf aufsteigt, bevor jemand ankommt, und der früheste Zug ein Gedanke darin ist.
...
### No. 202: Waschsalon-Nacht mit Quallen und kosmischer Vorhersage
...
Eine Szene, die einen Waschsalon bei Nacht zeigt, mit Quallen draußen, wo ein Mädchen eine kosmische Wettervorhersage prüft.
...
### No. 203: Porträt einer Wuxia-Kriegerin
...
Eine Prompt zur Generierung eines 9:16-Porträts einer großen, eleganten ostasiatischen Kriegerin in mehrschichtiger Rüstung und Roben, die ein langes Schwert führt.
...
### No. 204: Retro-Foto einer Frau im ländlichen Stil
...
Ein Prompt für ein 9:16-Bild, das eine junge ostasiatische Frau in einer ländlichen Umgebung zeigt, eingefangen mit einer Retro-Telefon-Ästhetik.
...
### No. 205: Zwei Frauen in Qipao im chinesischen Garten
...
Ein Prompt zur Generierung eines hyperrealistischen Fotos von zwei jungen ostasiatischen Frauen in neuen chinesischen Qipaos, die in einem friedlichen traditionellen Garten sitzen.
...
### No. 206: Selfie einer Tänzerin in Grautönen
...
Ein Prompt für ein 9:16 vertikales, realistisches Nahaufnahme-Selfie einer jungen ostasiatischen Tänzerin in einem coolen, verträumten, hochwertigen Grau-Lifestyle-Stil.
...
### No. 207: Editoriale Konzertbühnenfotografie für K-Pop
...
Ein Prompt für ein cinematisches, editorial-stilisiertes Foto einer 20-jährigen K-Pop-Female-Idol bei einem Konzert.
...
### No. 208: Elegante ostasiatische Frau an steinernem Balkon
...
Ein Prompt für ein 9:16 vertikales Modefoto einer schönen erwachsenen ostasiatischen Frau, die sich an eine klassische steinerne Balustrade lehnt.
...
### No. 209: Malerische Landschaft mit dramatischen Kumuluswolken
...
Ein Prompt zur Erzeugung einer detaillierten, romantischen Kunstlandschaft, die sich auf einen leuchtenden Himmel und hoch aufragende Wolken konzentriert.
...
### No. 210: Link, verfolgt von Puppenhühnern
...
Ein Bild von Link, der von einer wütenden Schar flauschiger Puppenhühner durch Kakariko Village gejagt wird.
...
### No. 211: Bali-Reisterrassen im Morgengrauen
...
Ein Bild-Prompt für eine friedliche, neblige Morgenszene der Reisterrassen von Bali, gestaltet wie eine Reisekampagne.
...
### No. 212: Prince Of Persia springende Pixelkunst
...
Ein Prompt zur Erzeugung eines Bildes im Stil von Cobalt Dither Monumentalism, das die ursprüngliche Prince of Persia-Figur beim Springen über Plattformen darstellt.
...
### No. 213: Sanfter Shinigami, der Seelen führt
...
Ein poetischer Prompt, der ein Mädchen, einen Todesboten, an der Grenze zwischen Leben und Tod in einer kalten Nacht im Nebel beschreibt, das eine Hand als Führung für einen stillen Abschied anbietet.
...
### No. 214: Goldene Talismane in der dunklen Nacht
...
Eine Szene, in der die Nacht in Schwarz versinkt, wo nur Gold eine talismanische Präsenz erhellt, mit den Worten 'Night Walk' und 'Suppress Evil'.
...
### No. 215: Der Traum der Braut an der Grenze
...
Ein poetischer Prompt, der ein nicht-menschliches Mädchen an der Grenze von Leben und Tod beschreibt, das davon träumt, eine Braut zu werden und ihr eigenes Spiegelbild zu sehen.
...
### No. 216: Yokai liest in einem regnerischen Zimmer
...
Eine Szene des gefürchteten Wesens Fufu, das in einem alten Zimmer an einem regnerischen Tag ein Buch liest, mit einem kleinen Vogel, der hereingefunden hat.
...
### No. 217: Pixel-Art-Sprite-Sheet einer Fuchs-Figur
...
Eine Eingabeaufforderung zur Erzeugung eines polierten Pixel-Art-Animations-Sprite-Sheets einer Figur namens Noxa, einem kleinen Fuchs, der Sterne sammelt.
...
### No. 218: Apple-Falttelefon-Konzept-Infografik
...
Eine Eingabeaufforderung zur Erzeugung einer fotorealistischen Infografik eines Apple-Falttelefons im charakteristischen sauberen Stil der Marke.
...
### No. 219: Nahaufnahme eines Schönheitsporträts einer jungen ostasiatischen Frau
...
Eine fotorealistische Nahaufnahme eines Porträts einer jungen ostasiatischen Frau mit weicher Beleuchtung und detaillierter Hauttextur.
...
### No. 220: Asiatische Frau an einer Küstenstraße bei Sonnenuntergang
...
Ein fotorealistisches Schnappschussfoto einer jungen asiatischen Frau neben einer Küstenstraße bei Sonnenuntergang, aus der Perspektive aus dem Inneren eines Autos betrachtet.
...
### No. 221: Makroaufnahme auf Wasserhöhe von einer Seerosenblatt-Insel
...
Ein Prompt für eine filmische Makroaufnahme auf Wasserhöhe, die ein Seerosenblatt als Insel zeigt, die von drei winzigen Figuren in Hanfu bewohnt wird.
...
### No. 222: Riesige dreizackige Klaue mit Katanaschneide
...
Ein Prompt für eine riesige Zweihandwaffe mit drei Zacken, deren Klingen wie ein japanisches Schwert geschärft und poliert sind.
...
### No. 223: Botschafter einer Jahreszeit im Morgenlicht
...
Ein poetischer Prompt, der einen Botschafter für eine Jahreszeit mit Morgenlicht, Magazin-Haut und Glas beschreibt, das dünn genug ist, um nichts zu verbergen.
...
### No. 224: Geometrisches Goldkronen-Profilporträt
...
Ein Bild-Prompt für eine imposante Figur im scharfen Profil, die eine Krone aus geometrischen Goldscheiben über gewundenem dunklem Haar trägt.
...
### No. 225: Strahlende Prinzessin mit Diamanttiara
...
Ein KI-Bild-Prompt für eine strahlende Figur, die eine übergroße Diamanttiara im scharfen Profil trägt.
...
### No. 226: Nahaufnahme-Porträt einer ostasiatischen Frau im Wuxia-Stil
...
Ein hyperrealistisches Porträt einer jungen ostasiatischen Frau im Wuxia-Stil mit extremer Weitwinkelperspektive.
...
### No. 227: Ganzkörperporträt einer Frau in lässiger Heimumgebung
...
Ein Prompt für ein 9:16 vertikales, ganzkörperiges, hyperrealistisches Foto einer jungen ostasiatischen Frau in einer gemütlichen Heim-Atmosphäre mit warmen filmischen Farbtönen.
...
### No. 228: Chibi-Charakter-Sprite-Sheet mit 16 Posen
...
Ein Prompt, um ein 4x4-Raster-Sprite-Sheet eines Chibi-Charakters mit verschiedenen Posen zu generieren.
...
### No. 229: Fotorealistisches Smartphone-Selfie im Schlafzimmer
...
Ein fotorealistisches Landschafts-Smartphone-Selfie einer jungen ostasiatischen Frau, die nachts auf einem Bett entspannt.
...
### No. 230: 3D-Miniaturland aus ikonischen Wahrzeichen
...
Ein Prompt zur Erzeugung einer 3D-Miniaturkarte, bei der die Landesgrenze aus seinen ikonischen Wahrzeichen und kulturellen Symbolen besteht.
...
### No. 231: Cinematisches Porträt einer Frau in Paris
...
Ein Prompt für ein ultrarealistisches, cinematisches Foto einer südostasiatischen Hijabi-Frau, die in der Nähe des Eiffelturms spaziert.
...
### No. 232: Tiere neu gestaltet mit Luxus-Mode-Stoffen
...
Ein Prompt zur Erzeugung eines 2x2-Rasters von Tieren, die mit den charakteristischen Stoffen von vier ikonischen Luxus-Modehäusern rekonstruiert sind.
...
### No. 233: Premium-Smartphone-Kampagnenposter
...
Ein Prompt zur Erzeugung eines hochwertigen Smartphone-Werbeplakats im typischen Apple-Stil.
...
### No. 234: Modernes Reiseplakat mit Architektur
...
Ein Prompt zur Erstellung eines hochwertigen Reiseplakats im Vintage-Siebdruck-Stil mit einer architektonischen Portal-Komposition.
...
### No. 235: Stop-Motion-Knetanimation: Charmander schlüpft
...
Ein Prompt zur Erstellung einer Stop-Motion-Animation im Knetstil, in der ein Charmander aus einem Ei schlüpft und Feuer speit.
...
### No. 236: Magrittes Apfel als Notizzettel-Stapel
...
Eine kreative Neuinterpretation von Magrittes 'Der Sohn des Menschen', bei dem der schwebende Apfel durch einen Stapel apfelförmiger Papiernotizen ersetzt ist.
...
### No. 237: Hyperrealistisches Modeporträt in japanischem Haus
...
Ein hyperrealistisches Modeporträt einer Frau, die in einem traditionellen japanischen Holzkorridor geht.
...
### No. 238: Ultra-minimalistisches Römisches-Reich-Wallpaper
...
Ein ultra-minimalistisches Wallpaper, das einen großen römischen Tempel mit Säulen, Aquädukten und Ruinen in warmen Goldtönen darstellt.
...
### No. 239: Anime-Einzelbild eines regnerischen Bahnsteigs
...
Ein Prompt zur Erzeugung eines nicht existierenden Anime-Einzelbildes mit Regen auf einem Bahnsteig, einem ankommenden Zug und einem Koi-Fisch, der über eine Stadt schwebt.
...
### No. 240: Person, die inmitten von Chaos eine Katze anfreundet
...
Eine Szene, die jemanden zeigt, der nach verschiedenen Verwicklungen schließlich eine Katze anfreundet.
...
### No. 241: Fuchsqualle im Hochland-Aquarium
...
Ein Bild eines schläfrigen Fuchses und von Quallen in einem Aquarium auf einem Hochland, dargestellt in einem Stil ohne körnige Lichtpartikel.
...
### No. 242: Frau im Kimono isst Rinderzungenreis
...
Ein Bild einer Frau im Kimono mit einer Szene, die eine Mahlzeit aus Rinderzunge und Gerstenreis darstellt.
...
### No. 243: Ungezwungenes Foto einer Frau im gemütlichen Nacht-Wohnzimmer
...
Ein Prompt für ein fotorealistisches, ungezwungenes Foto einer jungen Frau in einer gemütlichen nächtlichen Wohnzimmeratmosphäre.
...
### No. 244: Chuunibyou-Frau in Gothic Lolita
...
Ein Anime-stiliges Bild einer Chuunibyou-Frau mit Jirai-Make-up, die ein Gothic-Lolita-Outfit mit schulterfreien Tops und einem Korsett-Langkleid trägt.
...
### No. 245: Frau bleibt bei ihrem sterbenden Ex-Freund
...
Ein Prompt, das eine Frau beschreibt, die erfährt, dass ihr Ex-Freund sie verlassen hat, weil er im Sterben liegt, und beschließt, bis zu seinem Ende bei ihm zu bleiben.
...
### No. 246: Porträt einer Frau in Uniform
...
Ein poetischer Prompt, der eine Figur namens Rhiannah mit geometrischer Uniform, einem eisblauen Auge, kantigen Schultern und roten Lippen beschreibt.
...
### No. 247: Indigofärberwerkstatt in Jiangnan
...
Ein Bild-Prompt für eine Szene in einer Jiangnan-Färberwerkstatt mit blauer Farbe, Holzrahmen, einer Steinbrücke und Morgenlicht auf dem Wasser.
...
### No. 248: Nahporträt mit geflochtenem Haar
...
Ein 16:9 fotorealistisches Wallpaper-Porträt einer hellhäutigen jungen Frau mit Sommersprossen, blauen Augen und geflochtenem weißblondem Haar.
...
### No. 249: Fotorealistisches ungestelltes Porträt eines Seemanns
...
Eine 35mm-artige, ungestellte Aufnahme eines älteren Seemanns, der sein Netz richtet, mit realistischer Haut- und Materialtextur.
...
### No. 250: Epochengetreue 1969-Menschenmengenszene
...
Eine fotorealistische Menschenmenge im Freien in Bethel, New York, an einem benannten Datum im Jahr 1969, epochengetreu inszeniert.
...
### No. 251: Nostalgische Weihnachtskarte mit Teddybär
...
Eine druckreife Feiertagskarte, basierend auf einer Erinnerungsschachtel-Szene mit einer wortgetreuen Zeile Kartentext.
...
### No. 252: Vintage-Spielzeugflugzeug als Sammlerstück in Blisterverpackung
...
Ein aufnahmebereites Sammlerstück in Blisterverpackung mit einer wortgetreuen Verpackungszeile.
...
### No. 7: Hyperrealistische Emaille-Anstecknadel-Kollektion
...
Ein Prompt zur Erstellung einer Kollektion von acht hochwertigen Emaille-Anstecknadeln mit goldenen Umrissen und glänzenden Oberflächen vor dunklem Hintergrund.
...
### No. 8: Dunkles SaaS-Analyse-Dashboard-UI
...
Ein Prompt zur Generierung einer dunkel gehaltenen SaaS-Analyse-Dashboard-Oberfläche mit spezifischen Beschriftungen und UI-Elementen.
...
### No. 9: Screenshot der Website eines Kreativ-Design-Unternehmens
...
Ein Prompt zur Generierung eines vollständigen, frontalen, perspektivfreien Desktop-Webseiten-Screenshots für die chinesische Website eines kreativen Design-Unternehmens.
...
### No. 10: Antike chinesische Fashion-Fotografie-Grid
...
Ein Prompt zur Generierung einer professionellen, hochwertigen antiken chinesischen Fashion-Fotografieserie, die den vollständigen Ankleideprozess von Song Yu in einem Song-Dynastie-Boudoir darstellt, angeordnet in einem strengen 3x3-Grid.
...
### No. 11: Analoguhr, Burger und Getränk
...
Eine Prompt zur Erstellung eines Bildes mit einer Analoguhr, die 15:32 Uhr anzeigt, einem Burger mit gegrilltem, goldfarbenem Provolone-Käse und einem Glas.
...
### No. 12: Quadratisches Blau-Weiß-Layout mit Smartphone und Karten
...
Ein quadratisches SNS-Bild in Blau- und Weißtönen, das ein Smartphone, drei Bildkarten, einen japanischen Titel, breite Ränder und keinen zusätzlichen Text zeigt.
...
### No. 13: Physiklehrbuch-Kapitel über Elektromagnetismus
...
Eine Prompt zur Erstellung eines Kapitels über Elektromagnetismus für ein Physikbuch auf Spanisch.
...
### No. 14: Einseitiger Manga über Weltraumforschung
...
Eine Prompt zur Erstellung eines einseitigen, vertikalen, schwarz-weißen Comics über Weltraumforschung.
...
### No. 15: Isometrischer Glaskubus mit farbigen Kugeln
...
Eine isometrische Perspektive eines transparenten Glaskubus, der eine rote Kugel oben-links-hinten und eine blaue Kugel unten-rechts-vorne enthält, mit einer grünen Kugel über dem Kubus und einer gelben Säule, die von unten-links nach oben-rechts durchgeht.
...
### No. 16: Typografie-Poster und Magazin-Cover
...
Ein Prompt zur Erzeugung eines typografischen Posters mit einer Modellliste und eines Magazin-Covers mit Masthead und Schlagzeilen.
...
### No. 17: Vertikale Luxus-Uhrenwerbung
...
Ein Prompt für eine vertikale Luxusanzeige mit einer großen Uhr in einem dunklen smaragdgrünen Studio.
...
### No. 18: Charakterdesign-Referenzblatt
...
Ein Prompt zur Generierung eines malerischen Charakterdesign-Referenzblatts mit Konstruktionslinien und einem spezifischen Layout.
...
### No. 19: Geteilte Charakterbogen-Seite
...
Eine Prompt zur Erstellung einer hochwertigen, geteilten Charakterbogen-Seite für zwei Originalcharaktere.
...
### No. 20: Corporate Porträt Collage Komposition
...
Eine ultrarealistische Corporate-Porträt-Collage mit einer dreischichtigen Komposition eines Mannes.
...
### No. 21: Foto- und Illustration-Split-Komposition
...
Ein Prompt zur Erstellung eines vertikalen Bildes, das ein Originalfoto mit einer handgezeichneten Illustration derselben Szene kombiniert.
...
### No. 22: Geteilte Charakterbogen-Vorlage
...
Eine Prompt zur Erstellung eines geteilten Charakterbogens mit einem markanten zentralen Trennstrich und einem Neon-Aquarellhintergrund.
...
### No. 23: Abenteurer planen in einer Taverne (Comic)
...
Ein Prompt zur Erzeugung einer zweiseitigen Farb-Manga mit Abenteurern, die in einer Taverne eine Dungeon-Herausforderung besprechen, inklusive Dialog und Soundeffekten.
...
### No. 24: Technische Zeichnung einer Espressomaschine
...
Ein technisches Diagramm einer Haushalts-Espressomaschine im Stil einer mechanischen Zeichnung der 1960er Jahre.
...
### No. 25: Moderne SaaS-Dashboard-UI für KI-Plattform
...
Eine Vorlage zur Erstellung eines hochauflösenden 4K modernen SaaS-Dashboard-Interfaces für eine KI-Analyseplattform mit einem eleganten Dark-Mode-Design.
...
### No. 26: Dunkle Fantasy-Rollenspiel-Inventar-Benutzeroberfläche
...
Ein Prompt zur Erzeugung einer hochauflösenden dunklen Fantasy-Rollenspiel-Inventaroberfläche, die einen gepanzerten Paladin zeigt.
...
### No. 27: Sushi-Poster mit vertieftem Wortzeichen
...
Ein Prompt für ein Poster mit einem großen, vertieften tiefroten Wortzeichen im Hintergrund, das sich nicht mit einer Sushi-Silhouette überschneidet.
...
### No. 28: Produktverpackung in drei Zonen
...
Ein Prompt, um einen Produktkarton in drei Phasen zu visualisieren: als isoliertes Hero-Produkt, im Zutatenkontext und neben dem fertigen Gericht.
...
### No. 29: Produktaufnahme mit umgebenden Zutaten
...
Ein Prompt für ein Bild, das einen zentralen Produktbeutel zeigt, umgeben von Schüsseln, Beeren, Getreide und Blättern, mit einem klaren vertikalen Korridor.
...
### No. 30: Raster identischer Kaffee-Menü-Poster
...
Ein Prompt für das Design eines sammelwürdigen Kaffee-Menü-Posters mit konsistenten schwarzen Feldern, Tassengröße, Titelfeld, Mikrotext und Messingklammern.
...
### No. 31: 3D-Werbetafel mit Produkt, das die Ebene durchbricht
...
Ein Prompt für eine 3D-Werbetafelvisualisierung, bei der ein Hauptprodukt über die innere Ebene hinausragt und Kontaktschatten wirft.
...
### No. 32: Drei-Kegel-Aufstellung mit zentralem Hauptprodukt
...
Ein Prompt für eine Komposition mit drei Geschmackskegeln, bei der der zentrale Pistazienkegel dominant ist und die seitlichen Kegel als rahmende Elemente abgewinkelt sind.
...
### No. 33: Gestapelte Panels mit konsistentem Layout
...
Ein Prompt für die Erzeugung von fünf gestapelten Panels mit einem konsistenten Markenlayout, einschließlich Logo, Überschriftenspalte, Badge und Produktkomposition.
...
### No. 34: Horizontale Verkostungs-Akte mit Gerichtnamen
...
Ein Prompt für ein Poster, das vier horizontale Akte zeigt, jeweils mit einer schwarzen Schüssel mit Dampf und einem übergroßen Gerichtnamen in Pinselschrift.
...
### No. 35: Social-Media-Post-Schnittstelle, die durch Sauce schneidet
...
Eine Aufforderung für ein Bild, das ein minimales schwarzes Social-Media-Post-Interface-Band zeigt, das horizontal durch einen Strahl Sauce schneidet.
...
### No. 36: Poster mit vertikaler Split-Komposition
...
Ein Prompt für ein Poster mit vertikaler Teilung, das eine saubere, natürliche Seite gegenüber einer dunklen Seite mit verborgenen Zutaten zeigt.
...
### No. 37: Flüssige Schokoladenbögen rahmen Produkt ein
...
Ein Prompt für ein Premium-Produktposter, bei dem zwei gezügelte, flüssige Dunkelschokoladenbögen das Produkt in symmetrischer Orbitalbewegung einrahmen.
...
### No. 38: Zwei diagonal gekreuzte Haupt-Riegel
...
Ein Prompt, der zwei verpackte Produktriegel beschreibt, die sich diagonal in entgegengesetzte Richtungen durch die Mitte kreuzen.
...
### No. 39: Drei diagonal angeordnete Schalen
...
Ein Prompt für ein Bild von drei Schalen, die diagonal vom Vordergrund zum Hintergrund angeordnet sind.
...
### No. 40: Instagram-Reisekampagne mit Smartphone als visuellem Anker
...
Ein Prompt zur Erstellung einer hochwertigen Instagram-Reisewerbung, die ein modernes Smartphone als visuellen Ankerpunkt zeigt.
...
### No. 41: Vertikales Social-Media-Poster für Sammelfigur
...
Ein Prompt für ein hochauflösendes, vertikales Social-Media-Poster zur Bewerbung einer hochwertigen Sammelfigur mit kräftiger Typografie und flachem gelbem Hintergrund.
...
### No. 42: Hierarchisches Buchcover-Design
...
Ein Prompt für den Entwurf eines Buchcovers mit starker typografischer Hierarchie und Lesbarkeit.
...
### No. 43: Poster für Neurowissenschafts-Konferenz
...
Ein Prompt zur Generierung eines Konferenzposters für ein Neurowissenschaftstreffen 2026 basierend auf einem bereitgestellten Papier und Vorgaben.
...
### No. 44: Schwebendes Diorama-Gitter ikonischer Städte
...
Eine Prompt zur Generierung eines 2x2-Gitters aus schwebenden Stadtdioramen, die in einem grauen Studio aufgehängt sind.
...
### No. 45: Satirisches System-Poster-Gitter zu frustrierenden Themen
...
Eine Prompt für ein 2x2-Gitter satirischer Editorial-Poster zu frustrierenden Themen.
...
### No. 46: Papierdiorama-Reiseposter-Vorlage
...
Eine Prompt zur Erstellung eines hochwertigen vertikalen Reiseposters, das ein Stadtwahrzeichen als detailliertes handgemachtes Papierdiorama darstellt.
...
### No. 47: Filmisches Charakterblatt für Calvin & Bob
...
Eine Prompt zur Erstellung eines geteilten Charakterblatts mit einem Aquarellhintergrund.
...
### No. 48: Cinematischer Charakterbogen für Sofia
...
Ein Prompt, um einen hochwertigen Charakterbogen mit markanter Typografie und einem dramatischen Hauptbild einer Barista namens Sofia zu generieren.
...
### No. 49: Dramatische literarische Propaganda-Wandcover
...
Eine Eingabeaufforderung zur Erzeugung eines 2x2-Rasters dramatischer Propaganda-Stil-Wandcover für vier gemeinfreie Bücher.
...
### No. 50: Konzeptionelle Schnittdioramen für vier Marken
...
Eine Eingabeaufforderung zur Erzeugung eines 2x2-Rasters konzeptioneller Schnittdioramen für vier Fortune-500-Unternehmen.
...
### No. 51: Kinderfußmode-Werbeplakat mit Mädchen und riesigem Sneaker
...
Ein Prompt, um ein fröhliches Werbeplakat zu generieren, das ein Mädchen und einen riesigen Sneaker zeigt.
...
### No. 52: Luxus-Parfüm-Werbestoryboard
...
Ein Prompt für ein cinematisches Produkt-Storyboard, das ein Luxus-Rosenparfüm in einem sauberen, redaktionellen Layout zeigt.
...
### No. 53: Luxus-Parfüm-Werbestoryboard
...
Ein Prompt für ein cinematisches Produkt-Werbestoryboard, das ein Luxus-Rosenparfüm zeigt.
...
### No. 54: Technische Explosionsansicht-Raster
...
Ein Prompt zur Erzeugung eines 2x2-Rasters technischer Illustrationen, die Explosionsansichten komplexer Maschinen in 3D zeigen.
...
### No. 55: Vollseitige Farb-Comic-Illustration
...
Ein Prompt zur Erzeugung einer vollseitigen, farbenfrohen und humorvollen Shonen-Manga-Illustration mit authentischer Comic-Seitenkomposition.
...
### No. 56: Technische Infografik einer Kaffeemaschine
...
Eine erklärende Infografik, die den Fluss einer automatischen Espressomaschine von Anfang bis Ende nachzeichnet.
...
### No. 57: Streetwear-Kampagnenwerbung mit exaktem Slogan
...
Ein Jugend-Streetwear-Kampagnenbild, das einen exakten Slogan lesbar innerhalb des Layouts darstellt.
...
### No. 58: Minimalistisches Bäckerei-Logo auf transparentem Hintergrund
...
Ein flaches, vektorähnliches Bäckerei-Logo, zentriert auf sauberem Alphakanal ohne Hintergrund geliefert.
...
### No. 59: Vier-Panel-Comic eines alleingelassenen Haustiers
...
Ein vertikaler Vier-Panel-Streifen, der einen Anfang, eine Wendung und eine Pointe über die Panels hinweg trägt.
...
### No. 60: Farmers-Market-App-UI in einem iPhone-Rahmen
...
Ein praktisches Mockup einer mobilen App mit Header, Anbieterliste und Sonderangeboten, platziert in einem Geräterahmen.
...
### No. 61: Zellatmungs-Unterrichtsdiagramm
...
Ein beschriftetes Biologie-Diagramm für die Oberstufe, das Glykolyse, Krebs-Zyklus und Elektronentransportkette verbindet.
...
### No. 62: Series-A-Marktchancen-Folie
...
Eine Pitch-Deck-Folie mit einem TAM/SAM/SOM-Diagramm, Wachstumsbalken, Fußnoten und echter Datenhierarchie.
...
### No. 63: Werbetafel-Mockup mit exakter Schlagzeile
...
Ein Mockup einer Autobahn-Werbetafel, das eine wortgetreue Schlagzeile in serifenloser Fettschrift trägt.
...
- [Atlas Cloud GPT Image 2.5 Flare text-to-image](https://www.atlascloud.ai/de/models/openai/gpt-image-2.5-flare/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Flare edit](https://www.atlascloud.ai/de/models/openai/gpt-image-2.5-flare/edit?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Sunburst text-to-image](https://www.atlascloud.ai/de/models/openai/gpt-image-2.5-sunburst/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
