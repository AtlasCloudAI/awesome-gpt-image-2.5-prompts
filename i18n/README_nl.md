...
### No. 3: Portret van Petite Spaanse Vrouw bij Zwembad
...
Een gepolijst verticaal schoonheidsportret van een petite Spaanse vrouw die naast een mintgroen binnenbad zit.
...
### No. 4: Twee Vrouwen in Stenen Boog
...
Een prompt voor een afbeelding van twee vrouwen omlijst door een door de zon gebleekte stenen boog.
...
### No. 5: Meervoudig Karakterblad Portret
...
Een prompt voor het genereren van een karakterblad met vier studiofoto's van dezelfde vrouw vanuit verschillende hoeken.
...
### No. 6: Negen Emoji-stickers met Tekst
...
Een prompt om een 3x3 rooster van verschillende emoji-stickers te genereren, gebaseerd op een referentiepersonage, met Chinese en Engelse tekst op een lichte verloopachtergrond.
...
### No. 7: Sprite Sheet met Vier Dot-Art Karakterbewegingen
...
Een prompt om een sprite sheet te genereren met vier soorten dot-art karakteranimaties, elk tot 4 frames, met een consistent ontwerp.
...
### No. 8: Kunstwerk Geïnspireerd door Schets
...
Een prompt om een origineel kunstwerk te creëren op basis van een schets, waarbij het kernonderwerp, de emotie en het gebaar behouden blijven terwijl de details opnieuw worden bedacht.
...
### No. 9: Ochtend Lifestyle Foto van Vrouw
...
Een fotorealistische ochtend lifestyle portret van een jonge vrouw met roodbruin haar.
...
### No. 10: Vrouw die Ontspant in Thuiskantoor
...
Een prompt om een fotorealistische smartphonefoto te genereren van een jonge vrouw die ontspant op een bank in een modern thuiskantoor.
...
### No. 11: iPhone Portret van Jonge Vrouw
...
Een prompt voor het genereren van een realistisch iPhone portret van een jonge vrouw binnenshuis met een reflecterende achtergrond.
...
### No. 12: Pixel art-spriteblad voor personage
...
Een prompt om een vereenvoudigd 128px pixel art-spriteblad met transparante achtergrond en een 4x4-indeling te genereren voor gevechtsacties van een personage.
...
### No. 13: Dagelijkse kampeerplek uit schets
...
Een reeks prompts om een kindertekenening om te zetten in een stemmige nachtelijke kampeerplek, dan een dagversie, en ten slotte de kleding van het personage te veranderen in een overall.
...
### No. 14: Minimalistische Enkele-Lijn Landkaartkunst
...
Een prompt voor het creëren van een verticale minimalistische kunstprint van een land met behulp van een enkele doorlopende lijn.
...
### No. 15: 1985 Historische Portret Transformatie
...
Een prompt om het uiterlijk van een persoon in de jaren 80 opnieuw voor te stellen, waarbij de kernidentiteit en kenmerken behouden blijven.
...
### No. 16: 3D Overmaats T-Shirt Branding Mockup
...
Een prompt voor het genereren van een 3D-mockup van twee zwevende overmaatse T-shirts die voor- en achteraanzicht tonen.
...
### No. 17: Luxe Herenkleding Editorial Collage
...
Een prompt om een luxe herenkleding editorial collage te creëren met behulp van een geüploade foto als gezichtsreferentie.
...
### No. 18: Gezichtsidentiteit en Compositie Referentie
...
Een prompt die instructies geeft om een geüploade afbeelding te gebruiken om de gezichtskenmerken en natuurlijke uitstraling van een onderwerp te behouden.
...
### No. 19: Realistisch Professioneel Studio Portret
...
Een prompt voor het creëren van een professioneel studio portret met behulp van een geüploade foto voor gezichtsidentiteit en compositie.
...
### No. 20: Mode Editorial Collage met Consistent Model
...
Een prompt voor het creëren van een modecollage met een consistent mannelijk model met behulp van een gezichtsidentiteitsreferentie.
...
### No. 21: Astronaut in Futuristisch Cockpit Portret
...
Een prompt voor het genereren van een fotorealistisch portret van een zelfverzekerde vrouwelijke astronaut in een futuristisch ruimtevaartuigcockpit.
...
### No. 22: Ultrarealistisch Studio Mode Portret
...
Een prompt voor het creëren van een vol lichaam, ultrarealistisch studio mode portret met behulp van een geüploade afbeelding als gezichtsreferentie.
...
### No. 23: Cinematografisch Motorfiets Lifestyle Portret
...
Een ultrarealistisch portret van een man die buiten naast een premium sportmotorfiets zit.
...
### No. 24: Ultrarealistisch Redactioneel Portret
...
Een AI-prompt voor het creëren van een ultrarealistisch redactioneel portret van een man met behulp van een gezichtsidentiteitsreferentie.
...
### No. 25: Premium Mode Portret vanuit Referentie
...
Een prompt voor het creëren van een premium mode portret van een stijlvolle volwassen man met behulp van een gezichtsidentiteitsreferentie.
...
### No. 26: Onbewaakt Lifestyle Portret vanuit Referentie
...
Een prompt voor het genereren van een hoogwaardig, ultra-fotorealistisch onbewaakt lifestyle portret van een vrouw gebaseerd op een referentiebeeld.
...
### No. 27: Winter Mode Portret vanuit Foto
...
Een AI-prompt voor het creëren van een realistisch buiten winter mode portret met behulp van een onderwerpfoto als gezichtsreferentie.
...
### No. 28: Ultrarealistisch Luxe Studioportret
...
Een AI-prompt om een ultrarealistisch luxe studioportret van een stijlvolle volwassen man te genereren.
...
### No. 29: Cinematische Regenportretcollage
...
Een prompt voor het maken van een cinematische regenportretcollage met een geüploade afbeelding als referentie voor compositie en sfeer.
...
### No. 30: Smartphone Selfie Identiteit Behoud
...
Een prompt voor het genereren van een 3:4 verticale, ultrarealistische smartphone selfie die de gezichtskenmerken en het uiterlijk van een specifieke vrouw trouw bewaart.
...
### No. 31: Cinematisch Modeportret Identiteit
...
Een prompt voor het genereren van een close-up modeportret dat de identiteit en het uiterlijk van een onderwerp behoudt.
...
### No. 32: Close-up Formeel Studioportret
...
Een prompt voor het maken van een close-up studioportret van een jonge man in formele kleding met behulp van een gezichtsreferentie.
...
### No. 33: Cinematografische Levensstijlfoto Met Identiteitsbehoud
...
Een prompt voor het creëren van een fotorealistische, cinematografische afbeelding van een specifieke Oost-Aziatische vrouw, waarbij haar identiteit en kenmerken behouden blijven.
...
### No. 34: Cinematografische Fashion Editorial Met Identiteitsreferentie
...
Een prompt voor het genereren van een cinematografische modefoto van een vrouw in een donkere setting, waarbij haar identiteit van een referentiebeeld behouden blijft.
...
### No. 35: Ultrareëel Editorial Portret Vanuit Referentie
...
Een beeldgeneratieprompt voor het creëren van een ultrarealistisch editorial portret van een volwassen man, gebruikmakend van een geüploade afbeelding als gezichtsidentiteitsreferentie.
...
### No. 36: Drakengevecht met Verraderlijke Bijlvechter
...
Een prompt voor het genereren van een afbeelding van een drakengevecht met een verraderlijke bijlvechter, gebruikmakend van ChatGPT Astra.
...
### No. 37: Heroïsche Gigantische Robot vanuit Fotorealistische Hoek
...
Een prompt om een afbeelding te creëren die een heroïsche gigantische robot toont vanuit een dynamische, fotorealistische hoek.
...
### No. 38: Anime Stijl van Geüpload Onderwerp
...
Een prompt voor het creëren van een anime-stijl afbeelding met zelfverzekerde lijnvoering, minimale cel shading en heldere, verzadigde kleuren.
...
### No. 39: Product Front-Flat Opname met Duidelijk Etiket
...
Een prompt voor het genereren van twee productafbeeldingen met duidelijke, leesbare etiketten in een frontaal, platliggende stijl.
...
### No. 40: Fantasy Scene met Adelaar en Referentie
...
Een prompt voor een cinematografische fantasyscène met een vrouw gecentreerd voor een gigantische, majestueuze zeearend met gespreide vleugels.
...
### No. 41: High-Fashion Advertentie met Modelidentiteit
...
Een prompt voor het creëren van een premium, hyperrealistische high-fashion advertentie-afbeelding die de gezichtsidentiteit van een specifiek model behoudt.
...
### No. 42: Artikel naar Vierpanel Manga in Afternoon-stijl
...
Een prompt om een vier pagina's tellende strip te genereren in de stijl van het Japanse tijdschrift Afternoon, gebaseerd op een bijgevoegd artikel.
...
### No. 43: Premium Cinematisch Personage Referentieblad
...
Een prompt voor het creëren van een gesplitst referentieblad voor een personage met strikte visuele richtlijnen.
...
### No. 44: Pixel Art Gevechts Sprite Sheet
...
Een prompt om een vereenvoudigde 128px pixel art gevechtsanimatie sprite sheet te genereren met een transparante achtergrond.
...
### No. 45: Personage Gevechts Sprite Sheet Pixel Art
...
Een prompt om een 16-frames pixel art sprite sheet te genereren voor de gevechtsbewegingen van een personage.
...
### No. 46: Karakter Battle Sprite Sheet Pixel Art
...
Een prompt om een vereenvoudigd pixel art sprite sheet van 128px met 16 frames te maken voor de gevechtsbewegingen van een personage, inclusief idle, hakken, verdedigen en neergeslagen toestanden.
...
### No. 47: Fotorealistisch Portret Met Identiteitsreferentie
...
Een prompt voor het maken van een fotorealistisch volle-lengte portret met behulp van een referentiefoto om de identiteit van het onderwerp te behouden.
...
### No. 48: Marty & Doc Karakterbijbelblad
...
Een prompt om een gesplitst scherm karakterreferentieblad te genereren voor twee personages met strikte visuele richtlijnen.
...
### No. 49: Personagebijbelblad voor Ted & John
...
Een prompt om een gesplitst personageblad te genereren met strikte visuele referenties voor twee personages.
...
### No. 50: Gesplitst Personagebijbel voor Dom & Brian
...
Een prompt om een gesplitst personageblad te genereren met behulp van geüploade referenties voor twee personages.
...
### No. 51: Cinematisch Personagebijbelblad voor Baby
...
Een prompt om een premium personageblad te genereren voor het personage Baby, met gedurfde typografie en strikte naleving van visuele referenties.
...
### No. 52: Cinematische Personagebijbel voor Schmidt & Jenko
...
### No. 53: Cinematische Personagebijbel voor Gordon
...
Een prompt voor het maken van een premium personageblad met gedurfde typografie en strikte visuele referentie.
...
### No. 54: Personagebijbelblad voor Johnny & Tucker
...
Een prompt om een gesplitst personagereferentieblad te genereren met strikte visuele richtlijnen.
...
### No. 55: Personagebijbelblad voor Neo & Trinity
...
Een prompt om een gesplitst personagereferentieblad te genereren voor Neo en Trinity met strikte visuele richtlijnen.
...
### No. 56: Personagebijbel voor Kevin vs The Wet Bandits
...
Een prompt om een premium personageblad te genereren voor Kevin vs the Wet Bandits met strikte visuele referenties.
...
### No. 57: Redactionele Modeshoot op Nachtelijk Daktrappen
...
Een prompt voor een hyperrealistische foto van een redactionele modeshoot op nachtelijke dak trappen met een coole cinematische sfeer.
...
### No. 58: Personagebijbelblad voor Riggs & Murtaugh
...
Een prompt om een gesplitst personagereferentieblad te genereren voor twee personages met strikte visuele richtlijnen.
...
### No. 59: Premium Cinematisch Personagebijbelblad Voor Mike & Marcus
...
Een prompt om een split-screen personagereferentieblad te genereren met strikte visuele richtlijnen.
...
### No. 60: Premium Cinematisch Personagebijbelblad Voor Lee & Carter
...
Een prompt voor het creëren van een split-screen personagereferentieblad met strikte visuele richtlijnen.
...
### No. 61: Realistisch 1/7 Schaal Figuur op Bureau
...
Een prompt voor het genereren van een afbeelding van een realistisch 1/7 schaal personagefiguur op een computerbureau met een transparante basis.
...
### No. 62: Gezichtsidentiteit Referentie over Compositie
...
Een AI-prompt om één foto te genereren met zeven versies van dezelfde volwassen man, gebruikmakend van een gezichtsidentiteit referentie.
...
### No. 63: Modeportret met Gebruik van Gezichtsidentiteit Referentie
...
Een prompt voor het genereren van een premium, vol-body modeportret met behulp van een foto als gezichtsidentiteit referentie.
...
### No. 64: Dromerig cinematografisch portret op basis van referentie
...
Een prompt voor het creëren van een realistisch, dromerig cinematografisch portret waarbij de identiteit en natuurlijke kenmerken van het onderwerp behouden blijven.
...
### No. 65: 3D kleianimatieportret op basis van foto
...
Een prompt voor het genereren van een gedetailleerd, schattig 3D kleianimatieportret dat de identiteit en gelijkenis van het onderwerp behoudt vanuit een door de gebruiker geüploade foto.
...
### No. 66: Redactionele kunstposter voor een locatie
...
Een prompt voor het maken van een hoogwaardige verticale redactionele poster in een speelse Japanse design-zine stijl.
...
### No. 67: Geanimeerde Scene uit Twee Referentiebeelden
...
Een prompt om een geanimeerde scene te creëren van een peuter die speelt in een knusse slaapkamer.
...
### No. 68: Jaren 80 Portret op Basis van Gezichtsreferentie
...
Een prompt om een portret te genereren in een retro-vintage stijl uit de jaren tachtig, waarbij de exacte gelaatstrekken en identiteit van het onderwerp behouden blijven.
...
### No. 69: Referentieblad voor Karakterontwerp
...
Een prompt voor het genereren van een professioneel karaktermodelblad op basis van een verstrekte referentieafbeelding.
...
### No. 70: Stijloverdracht naar een Motorrijder
...
Een nieuw onderwerp weergegeven in de exacte visuele stijl die door de invoerafbeelding wordt gedragen.
...
### No. 71: Outfitwisseling met Behoud van Identiteit
...
Kledingstukken uit referentiebeelden aangepast aan het onderwerp, waarbij gezicht, houding en belichting onaangetast blijven.
...
### No. 72: Hond Gecompositeerd in een Portretscène
...
Een onderwerp uit één referentie genomen en geplaatst in een andere met overeenkomend licht en achtergrond.
...
### No. 73: Schets Omgezet in een Fotorealistische Vallei
...
Een tekening fotorealistisch weergegeven terwijl de opmaak, verhoudingen en perspectief behouden blijven.
...
### No. 74: Persoon Geplaatst in een Berenaanval Scene
...
Een foto-achtige actiescène, opgebouwd rond een aangeleverde persoon, bewust niet-cinematisch.
...
### No. 75: Consistent Personage uit een Kinderboek
...
Een waterverf-prentenboekheld die zo specifiek is omschreven dat hij in alle illustraties hetzelfde blijft.
...
### No. 76: NYC Metro Candid Portret
...
Een prompt voor een spontane lifestylefoto van een vrouw met zachte gelaatstrekken en warrig donker haar in een metro van New York.
...
### No. 77: Meervoudig Paneel Film Personage Referentieblad
...
Een prompt om een personagereferentieblad te genereren dat dezelfde echte vrouw toont vanuit vooraanzicht, driekwart, profiel en achteraanzicht.
...
### No. 78: Foto-gebaseerd Minimalistisch Aquarel Vignet Kunstwerk
...
Een prompt om een geüploade foto te transformeren in een verfijnd kunstwerk dat fotorealisme combineert met een minimalistisch aquarel vignetstijl.
...
### No. 2: Transformeer Foto's in Individuele Premium Posters
...
Een JSON-instructie om elke geüploade foto om te zetten in een aparte, hoogwaardige poster zonder ze samen te voegen.
...
### No. 3: Nachtkantoor met flowchartscherm
...
Een prompt om een nachtelijke studeerkamer te genereren en vervolgens alleen de inhoud van het laptopscherm te vervangen door een automatiseringsflowchart.
...
### No. 4: Tweepagina Verhaal Manga Hertekening
...
Een prompt om een afbeelding opnieuw te tekenen in de stijl van een tweepagina verhaal-manga, waarbij de dialoog, het verhaal en de karakterinstellingen behouden blijven.
...
### No. 5: Omgeving Bewerken naar Schilderachtige Stijl
...
Een prompt om een omgevingsplaat te bewerken naar een lossere, schilderachtige stijl, terwijl specifieke compositorische elementen behouden blijven.
...
### No. 6: Herstel Beschadigd Vintage Portret
...
Een prompt voor het herstellen van een ernstig beschadigd oud portret tot een schone, modern ogende foto met behulp van een geüploade afbeelding als referentie.
...
### No. 7: Auto Herkleuren naar Neonzwart
...
Een prompt om de kleur van een object te veranderen in neonzwart terwijl de oorspronkelijke vorm, textuur en materiaal behouden blijven.
...
### No. 8: Verticale Twee-Paneel Originele En Bewerkte Afbeelding
...
Een prompt om een enkele verticale afbeelding te maken met twee gestapelde panelen, waarbij het bovenste paneel als de originele referentiefoto wordt gehouden.
...
### No. 9: Hervat Foto Tot Opgegeven Beeldverhouding
...
Een prompt om een foto te herschalen naar een gekozen beeldverhouding, waarbij het hoofdonderwerp natuurlijk gepositioneerd blijft.
...
### No. 10: Hard Licht Portret met Scherpe Schaduwen
...
Een prompt die een portret beschrijft verlicht door hard, ongezacht zonlicht vanuit een raam onder een specifieke hoek, wat scherpe schaduwen op het gezicht creëert.
...
### No. 11: Pixel art sprite-sheet voor personage
...
Een prompt om een vereenvoudigd 128px pixel art gevechtsbewegings-sprite-sheet voor een personage te maken, gerangschikt in een 4x4 raster met een transparante achtergrond.
...
### No. 12: Versterk Zon en Wolken tot Lotusbloem
...
Een prompt om een foto van wolken en de zon te verbeteren, zodat de zon op het centrum van een bloem lijkt en de wolken op een lotus, zonder het originele beeld te veranderen.
...
### No. 13: Infographic Vertaald naar het Spaans
...
Een bewerking die alleen de taal van de tekst vervangt en elke andere pixel van de opmaak ongemoeid laat.
...
### No. 14: Product Uitsnede op Transparante Achtergrond
...
Een packshot geïsoleerd op een schone alpha-achtergrond met scherpe silhouet, geen halo's en leesbaarheid van het label intact.
...
### No. 15: Objectverwijdering uit een Portret
...
Een eenregelige bewerking die één object verwijdert en verder niets verandert.
...
### No. 16: Billboard Herleefd als een Winteravond
...
Een bewerking van vijf woorden die het seizoen en het tijdstip op een bestaande mockup verandert.
...
### No. 17: Keukenstoelen Vervangen door Houten
...
Een kamerbewerking die alleen de stoelen vervangt en de hoek, belichting en vloerschaduwen behoudt.
...
### No. 6: Realistische Screenshot van een Next-Gen Romance RPG
...
Een prompt om een realistische screenshot te genereren vanuit het perspectief van de protagonist in een fictieve next-gen 3D open-wereld romance RPG.
...
### No. 7: Premium Miniatuur Diorama van een Landmark
...
Een prompt voor het genereren van een schattig, elegant 3D-diorama van een beroemd bouwwerk met zachte pasteltinten en handgemaakte details.
...
### No. 8: Verticale Botanische Papierkunst van Slanke Vrouw
...
Een verticale botanische papierkunstwerk dat een slanke vrouw in profiel uitbeeldt met een jurk van bladeren en een ivoren parasol.
...
### No. 9: Fotorealistisch Modelbouwpakket van Witte en Gouden Paladijn
...
Een prompt om een fotorealistische afbeelding te genereren van een witte en gouden paladijnrobot als modelbouwpakket, tentoongesteld in een elektronicawinkel met veel uniforme dozen.
...
### No. 10: Onopgesmakte Reis Foto bij Historische Muur
...
Een realistische, onopgesmakte reisfoto van een jonge vrouw bij een historische stadsmuur 's nachts, met een gloedvol traditioneel Chinees gebouw.
...
### No. 11: Vintage Reisposter voor Locatie
...
Een prompt voor het creëren van een reisposter geïnspireerd op de jaren 1920-1930, met een gelaagde papier-reliëf en geëmbosseerde illustratiestijl in een gedempt kleurenpalet.
...
### No. 12: Macro Foto van Vlinderoog, Kattenhaar
...
Een fotorealistische macro close-up van een kattenhaar, samengestelde ogen van een vlinder en de huid van een meisje.
...
### No. 13: Luxe Horloge op Marmer Mockup
...
Een fotorealistische magazine-advertentie mockup van een luxe titanium chronograafhorloge met duidelijke wijzerplaattekst.
...
### No. 14: Premium Koffiezak Product Mockup
...
Een fotorealistische commerciële mockup van een matzwarte koffiezak met berglijnkunst op rustiek hout.
...
### No. 15: Mode E-commerce Lookbook Poster
...
Een prompt voor het genereren van een schone mode-lookbookposter met een jong vrouwelijk model in herfstkleding, gebruikmakend van zachte pastelkleuren.
...
### No. 16: Miniatuur Reis Scene met Bezienswaardigheid
...
Een prompt voor het genereren van een charmante, handgemaakte miniatuur scene met een klein 3D-model van een iconisch herkenningspunt.
...
### No. 17: Redactioneel Portret van Vrouw met Uitzicht op Stad
...
Een fotorealistisch redactioneel portret van een volwassen Oost-Aziatische vrouw die uitkijkt over een stad in de schemering.
...
### No. 18: Cinematisch Portret van Vrouw in Zonnig Café
...
Een prompt voor een fotorealistisch cinematisch portret van een volwassen Oost-Aziatische vrouw in een zonnige buurtcafé.
...
### No. 19: Asymmetrisch Redactioneel Halfgezicht Portret
...
Een prompt voor het maken van een redactioneel portret waarbij het onderwerp tegen de linkerrand van het kader is gepositioneerd.
...
### No. 20: Premium Redactionele Kunstposter voor een Locatie
...
Een prompt voor het maken van een hoogwaardige, moderne kunstboek-stijl poster voor een gespecificeerde locatie.
...
### No. 21: Warme Nachtscène van Vrouw die Thuis Leest
...
Een prompt voor het genereren van een realistische 16:9 horizontale foto van een vrouw in een warme, gewone appartementsomgeving 's nachts.
...
### No. 22: Deluxe Parfait van Niet-Geliefd Eten
...
Een prompt om een deluxe parfait te genereren, uitsluitend samengesteld uit algemeen niet-geliefd voedsel, met 30 soorten ingrediënten en annotaties.
...
### No. 23: Japans Vintage Reisposter uit de Showa-periode
...
Een prompt voor het maken van een premium, verticale reisposter in een middeleeuwse Japanse spoorwegtoerismestijl.
...
### No. 24: Cinematisch Portret op een Metrostation
...
Een hoogwaardig portret van een jongedame met bruin haar die stil staat terwijl een trein voorbij raast.
...
### No. 25: Hooghoek Portret in Qipao
...
Een hooghoek portret van een lange, slanke model met verfijnde make-up en een vosachtig gezicht, gekleed in een qipao in zacht, dromerig licht.
...
### No. 26: Overstroomde Vlakte met Niet-Matchende Reflectie
...
Een prompt voor een cinematische filmstill van een overstroomde vlakte in de schemering met een boerderij en populieren, met een niet-matchende reflectie in het water.
...
### No. 27: Vocaloid MV Stijl 3x3 Rooster
...
Een prompt om een 3x3 rooster van verschillende shots te creëren in een Vocaloid MV stijl met een 16:9 beeldverhouding.
...
### No. 28: 16-Bits Kraai Sprite Sheet
...
Een prompt om een sprite sheet in 16-bits stijl te genereren van een kraai in vlucht, tijdens het opstijgen en landen.
...
### No. 29: Gladiator te Paard vanuit Laag Perspectief
...
Een extreem laaghoek shot van een gladiator op een oorlogspaard, gezien vanaf een rotsachtig bergpad.
...
### No. 30: Close-Up van Rif met Octopus
...
Een prompt die instrueert om in te zoomen op een rif, het licht op steen te observeren en precies acht armen te includeren.
...
### No. 31: Cinematografische Anamorfische Still van Vrouwen in Pioen
...
Een brede anamorfische foto van vijf miniatuur Chinese vrouwen zittend in een grote lichtroze pioenroos.
...
### No. 32: Vrouw tussen Dichte Roze Bloeiende Takken
...
Een foto van een vrouw omringd door dichte roze bloeiende takken die de voorgrond en achtergrond vullen.
...
### No. 33: Robot op Strand bij Zonsondergang
...
Een realistische cinematografische scène van een robot die op een strand bij zonsondergang zit en naar zand in zijn hand kijkt.
...
### No. 34: Cyberpunk Pluizige Wolfsoor Outfit
...
Een prompt voor het genereren van een cyberpunk-stijl pluizig kostuum met neonroze en groene bontwolfsoren en een choker.
...
### No. 35: Close-Up Selfie van Jonge Vrouw
...
Een prompt voor een rauwe iPhone-foto van een jonge vrouw met sproeten en door de wind gehavend haar.
...
### No. 36: Jaren 80 President Verwelkomt Alien op Witte Huis Gazon
...
Een prompt om een afbeelding te genereren die een jaren 80-stijl foto toont van een President die een alien begroet op het gazon van het Witte Huis.
...
### No. 37: Filmshot van Koninklijk Banket uit Tang Dynastie
...
Een breedbeeld historisch filmshot van een fictief, weelderig koninklijk nachtbanket uit de Tang Dynastie.
...
### No. 38: Realistische modefoto van een Oost-Aziatische vrouw
...
Een prompt voor een realistische modefoto met een volwassen Oost-Aziatische vrouw met lang zwart haar, warm licht en schaduw op haar gezicht en een natuurlijke huidtextuur.
...
### No. 39: Portret van Taiwanese vrouw met zwarte mistfilter
...
Een prompt voor een portret met een zwarte mistfilter, overlay-masker en zachte CCD-fotografie met subtiele hooglichten.
...
### No. 40: Rode spinlelie bij de rivier na regen
...
Een prompt voor het genereren van een realistisch beeld van een enkele rode spinlelie met regendruppels, geplaatst aan de rivieroever na regen.
...
Een prompt voor een sfeervol beeld dat een persoon na sluitingstijd toont, met focus op natte wol, huid en straatverlichting.
...
Een prompt voor een mode-editorialscène met drie personen gestyled door de wind, met hard zonlicht en overvloedige zijde.
...
Een prompt voor het genereren van een realistische iPhone-foto van een Tesla Model Y op een parkeerplaats, gemaakt met een 0.5x-camera.
...
Een prompt die een schemerende eco-toekomststad beschrijft, een maanstad met een gigantische Aarde, een serafijnse beschermridder van het sterrenstelsel en een zilverharige koningin die danst in een ijskristalkathedraal.
...
Een complexe scène met een leger van meer dan 100 personen, het personage Luna, een witte draak, een Japans bord, ingewikkelde speerhantering en regenachtige reflecties.
...
Een prompt voor het genereren van beelden van een springend konijn en een grijs Nederlandse dwergkonijn dat springt.
...
Een prompt voor het genereren van een afbeelding van een jonge man en vrouw in anime-stijl, in casual kleding in een groot park, weergegeven in ultra-hoge 16K resolutie met verhoogd contrast en verzadiging.
...
Een prompt om een scène uit 'Droom van het Rode Paviljoen' te reconstrueren als een traditionele Chinese lange rolschildering.
...
Een prompt voor het genereren van afbeeldingen van monumentale aarde-architectuur in een woestijn brutalisme stijl, met mashups van beroemde architecten.
...
Een prompt voor een fotorealistische smartphonefoto van een vrouw die op een met bomen omzoomde straat wandelt tijdens het gouden uur.
...
Een prompt voor het creëren van een verfijnde luxe reisposter collectie geïnspireerd door Santorini, de Amalfikust en Parijs.
...
Een spontaan, onopgesmukt buitensportret van een jonge vrouw met lang donkerbruin haar in een rustig stads park op een zonnige middag.
...
Een prompt voor het genereren van een cinematografisch karakter referentieblad met een dodelijke woestijnmoordenaar.
...
Een prompt voor een ultra-fotorealistische smartphone modefoto van een mooie Oost-Aziatische vrouw in een privélounge 's nachts.
...
Een prompt voor het creëren van een postzegel in vintage-stijl met een iconisch landmark en culturele elementen van een land.
...
Een prompt voor het creëren van een gestileerde, handgeschilderde vintage reisposter met een herkenbaar architectonisch landmark.
...
Een ultra-fotorealistisch portret van een mooie Euraziatische vrouw in een moderne ondergrondse parkeergarage.
...
Een prompt voor het genereren van een charmant miniatuurtafereel met een specifiek gerecht op een keramisch bord.
...
Een prompt om een speels 3D-klei miniatuur diorama te genereren van een herkenbare winkel of merk.
...
Een prompt voor het creëren van een gedetailleerde, gezellige miniatuurwereld met een centraal iconisch bouwwerk.
...
Een prompt voor een close-upportret van een man tegen een witte studiobackground met een asymmetrische compositie.
...
Een beschrijvende prompt voor het genereren van een landschap van een wit doolhof gevormd door winderosie in de loop der tijd.
...
Een scène die een Witte Drakenridder toont in de nacht, niet tegengehouden door een vijand maar door een enkel klein steentje, met een filosofisch bijschrift.
...
Een prompt voor het genereren van een premium redactioneel studio-portret van een zelfverzekerde man met kort zwart haar.
...
Een prompt voor het genereren van een vol lichaam, zelfverzekerd mannelijk modelportret in een warme, naadloze studio-omgeving.
...
Een prompt voor een verfijnde luxe lifestyle reiscampagne die Alpen-, Dubai- en Europese chalet-ervaringen combineert.
...
Een scène die de ochtend van een Blauwe Tovenaarsmeester toont, waar kammen, haarelastiekjes en veters hun werk afronden terwijl hij rapporten leest.
...
Een beschrijvende prompt voor een scène waarin een schip aankomt aan een oever van witte aarde, zout en kalksteen, met onzichtbare landen in de verte.
...
Een prompt die een elf beschrijft die aan zee leeft, een kustvisser die de tekenen van de oceaan leest.
...
Een prompt voor het genereren van een professioneel studio hoofdportret van een volwassen man.
...
Een ultrarealistisch lifestyle portret van een zelfverzekerde man in een luxueus modern interieur met een donkere houten deuropening en grote spiegel.
...
Een poëtische prompt die de nacht van een sperman beschrijft, waarbij hij de houtnerf van een bureau herinnert voor een bovenaardse kaart.
...
Een scène waarin twee drakenridders pauzeren onder de vleugel van een draak, met een kaart en hard brood.
...
Een ultrarealistisch portret van een man die ontspant in een chique bibliotheeklounge tijdens de vroege avond.
...
Een nachtpostbode loopt over een herfstweg omzoomd met rode spinlelies onder een nachtelijke hemel.
...
Een ultrarealistisch editorial portret van een zelfverzekerde zwarte man in een strak pak, gezeten in een minimalistische studiodecor.
...
Een scène die de middag van een Blauwe Tovenaarsmeester uitbeeldt, waar magie zonlicht en keien opruimt voordat ze haar bereiken.
...
Een beschrijvende prompt voor een scène van een schemerwildernis met dunne vlammen die opstijgen uit grondbarsten en de Kaspische Zee in de verte.
...
Een ultrareëel beeld van een klassiek houten zeilschip in een dramatische oceaanzonsondergangscène.
...
Een scène van een Witte Drakenridder Meester die voorzichtig de linker vleugelblessure van een slapende draak controleert in een maanverlichte drakenstal.
...
Een scène van het repareren van een blauwe reisdoek in een vulkanische stad tijdens de middag, met bergen in de verte.
...
Een prompt die een sperendrager toont die zijn grootste titel heeft verloren, zijn dag begint bij natte veters in de ochtend van een spiegelwereld.
...
Een scène die Blauwe Tovenaar Meester Luna toont voor dageraad, met boeken, een stoel en thee, uit een tijd waarin ze haar lichaam niet nodig hadden.
...
Een beschrijvende prompt voor een landschap waar vuur uit de aarde lekt in een droge wildernis, met grijze modder die stroomt en de Kaspische Zee in de verte.
...
Een scène die de Zwarte Drakenridder Luna 's nachts toont, terwijl ze haar speereelt controleert terwijl El Drago naast haar slaapt.
...
Een SFW illustratie die een gesprek toont tussen de personages Fern en Frieren.
...
Een poëtische prompt die een landschap beschrijft waar groen vervaagt en lagen oker, roest, grijs-wit en bleekgroen onthult op door wind en regen uitgeslepen heuvels.
...
Een AI-prompt om een oosters esthetisch behang te genereren met een klassieke vrouw met een ronde waaier tegen een witte muur en bamboeschaduwen.
...
Een prompt die een Tokyo Police Heavy Machinery Robot Team toont dat evacués redt door een reddingsboot te slepen.
...
Een prompt voor het genereren van een heldere, overdag CCD-stijl lifestylefoto met stedelijke exploratie op een astronomisch observatiedek.
...
Een prompt voor het genereren van een realistisch, spontaan iPhone-stijl portret van een jonge vrouw.
...
Een beeldgeneratieprompt voor een elegante, minimalistische oosterse poster met een klassieke vrouw bij een jadegroen bloemenraam.
...
Een gedetailleerde prompt voor het genereren van een fotorealistisch portret tot de knieën, op ooghoogte, van een jonge Oost-Aziatische vrouw met specifieke gelaatstrekken.
...
Een prompt die een robotsquad van de politie zware machinerie eenheid beschrijft die afval opruimt dat een rivier blokkeert.
...
Een gedetailleerde prompt voor het genereren van een redactioneel portret tot de knieën, op ooghoogte, van een jonge Oost-Aziatische vrouw met specifieke gelaatstrekken.
...
Een prompt voor het genereren van een realistisch, casual 9:16 verticaal foto van een vrouw van 20-26 jaar, alsof genomen met de hoofd-camera van een iPhone.
...
Een prompt voor het genereren van een oosters esthetisch behang met een vrouw bij het water in een minimalistische, verfrissende stijl.
...
Een gedetailleerde prompt voor een fotorealistisch redactioneel portret van een jonge Oost-Aziatische vrouw met specifieke gelaatstrekken.
...
Een prompt voor het genereren van een heldere, overdag CCD-stijl lifestylefoto met een stedelijke, artistieke setting en specifieke kleding.
...
Een gedetailleerde prompt voor het genereren van een redactioneel portret tot de knieën, op heuphoogte, van een jonge Oost-Aziatische vrouw met specifieke gelaatstrekken.
...
Een prompt voor het genereren van een oosters minimalistische wallpaper met een gracieuze vrouw in antieke stijl die door een blauwe deuropening met kersenbloesems loopt.
...
Een afbeelding van een politie robotteam van de Zwaar Materieel Tegenaatregelen Eenheid die voertuigen verplaatst van een door zware regen overstroomde weg.
...
Een prompt voor het genereren van een heldere overdag CCD-stijl lifestyle foto in een stedelijke sportomgeving.
...
Een prompt voor het creëren van een minimalistische, heldere en strakke 9:16 verticale omslag met moderne Oosterse vrouwelijke esthetiek en een ochtendsfeer.
...
Een prompt voor het genereren van een Oosterse Zen minimalistische poster met een vrouw die ontspant bij een rond raam.
...
Een afbeelding van een politie robotsquad van de Zwaar Materieel Tegenaatregelen Eenheid die probeert een weggelopen vrachtwagen te stoppen.
...
Een prompt voor een volledig lichaams, ooghoogte redactioneel portret van een jonge Japanse of Koreaanse vrouw die oorbellen met ringen draagt.
...
Een taille-hoog, knie-niveau zicht portret van een jonge Japanse of Koreaanse vrouw die een gedurfde, witte dikke montuur bril draagt.
...
Een prompt voor het genereren van een afbeelding van een vrouw die een windgong aanraakt bij een raam in een minimalistische Oosterse Zen stijl.
...
Een gedetailleerde foto van een post-apocalyptische stad in Shenzhen, China, overwoekerd met groene vegetatie.
...
Een prompt voor het genereren van een fotorealistische afbeelding van een fictieve jonge Japanse vrouw met een tanuki-achtig gezicht in een rustige nachtomgeving.
...
Een realistische afbeelding vanuit het perspectief van een dolfijn die door een 360-graden glazen tank kijkt naar vrouwen die een druk, alleen-voor-vrouwen aquarium bezoeken.
...
### No. 113: Polymeerklei Miniatuur Winkelgevelscène
...
Een prompt voor het creëren van een miniatuur kleimodel van een merkstore met gezellige trottoirdetails.
...
### No. 114: Modeadvertentie met Kantelende Grondopname
...
Een modecampagne voor een fictief merk met zes mensen in levendige kleding tegen een kobaltblauwe lucht, geschoten vanuit een lage hoek.
...
### No. 115: Handgetekende Anime Duel met Kersenbloesems
...
Een scène uit een eind jaren negentig Japanse handgetekende animatiefilm, met een vrouw met een katana tegenover een zwaardvechter onder vallende kersenbloesems.
...
### No. 116: Zwarte Spookbruid Gotische Trouwjurk
...
Een prompt voor een gotische Halloween horrorbruid kostuum met donkere romantische elegantie.
...
### No. 117: Sfeervol Cinematografisch Portret van Oost-Aziatische Vrouw
...
Een prompt voor een hoogcontrast, cinematografisch close-up portret van een jonge Oost-Aziatische vrouw met een bleke huid en lang zwart haar.
...
### No. 118: Cinematografisch Nachtstraat Portret op Nat Zebrapad
...
Een prompt voor een cinematografisch portret van een jonge Oost-Aziatische vrouw op een nat zebrapad 's nachts.
...
### No. 119: Close-Up Portret met Gloeiende Gouden Ogen
...
Een prompt voor een cinematografisch close-up portret van een jonge Oost-Aziatische vrouw met gitzwart haar en gloeiende gouden ogen.
...
### No. 120: Fotorealistisch portret met bril en knipoog
...
Een fotorealistisch portret van een jonge Oost-Aziatische vrouw met een bril en golvend haar, die zachtjes knipoogt.
...
### No. 121: Portret in analoge-filmstijl met slordig haar
...
Een fotorealistisch portret in analoge-filmstijl van een jonge Oost-Aziatische vrouw met slordig zwart haar die naar de camera kijkt.
...
### No. 122: Cinematografisch portret drijvend in donker water
...
Een cinematografisch portret van een serene jonge vrouw die in stil water drijft met nat haar.
...
### No. 123: Studio schoonheidsportret met zijvlecht
...
Een fotorealistisch studio schoonheidsportret van een jonge Oost-Aziatische vrouw met stralende huid, lang zwart haar en gesloten ogen.
...
### No. 124: Portret van vrouw in auto met hijab
...
Een fotorealistisch close-upportret van een jonge Oost-Aziatische vrouw in een auto, met een lichtbeige hijab.
...
### No. 125: Vrouw die een selfie maakt in hijab
...
Een prompt om een afbeelding te genereren van een jonge vrouw in een lichte hijab die een selfie maakt aan een houten tafel.
...
### No. 126: Portret van vrouw die over haar schouder kijkt
...
Een gedetailleerde prompt voor het genereren van een fotorealistisch portret van een jonge Oost-Aziatische vrouw die over haar schouder kijkt.
...
### No. 127: Portret van vrouw met bril
...
Een portret van een jonge Oost-Aziatische vrouw met een bril, golvend haar en een kalme uitdrukking.
...
### No. 128: Close-upportret met levendige lippenstift
...
Een fotorealistisch portret van een jonge Oost-Aziatische vrouw met porseleinen huid, amandelvormige ogen en levendige lippenstift.
...
### No. 129: Portret met nat haar en blote schouder
...
Een fotorealistisch portret van een jonge vrouw met dauwachtige huid en nat zwart haar die over haar schouder kijkt.
...
### No. 130: Cinematografisch portret van Oost-Aziatische vrouw
...
Een close-upportret van een jonge Oost-Aziatische vrouw met lang donker golvend haar tegen een zwarte achtergrond.
...
### No. 131: Fotorealistisch portret met bril
...
Een fotorealistisch portret van een jonge Oost-Aziatische vrouw met lang golvend haar, een ronde bril en een zachte uitdrukking.
...
### No. 132: Cinematografisch portret met honingkleurige highlights
...
Een prompt voor een cinematografisch close-upportret van een jonge Oost-Aziatische vrouw met golvend lichtbruin haar en een kalme uitdrukking.
...
### No. 133: Fotorealistisch portret met bobkapsel
...
Een fotorealistisch close-upportret van een jonge Oost-Aziatische vrouw met een korte zwarte bob, rookige oogschaduw en glanzende huid.
...
### No. 134: Portret van Vrouw in Hijab en Pet
...
Een close-upportret van een jonge vrouw met een lichte huid en een kalme uitdrukking, gekleed in een witte hijab en een zwarte baseballpet.
...
### No. 135: Selfieportret in Chiffon Hijab
...
Een close-up selfieportret van een jonge Oost-Aziatische vrouw met een lichte huid en delicate gelaatstrekken, gekleed in een stoffig taupe chiffon hijab.
...
### No. 136: Cinematografisch Portret van Huilende Oost-Aziatische Vrouw
...
Een fotorealistisch close-upportret van een jonge vrouw met glanzende, door tranen bevlekte huid en wispelturige pony.
...
### No. 137: Portret van Vrouw met Gesteent Kant Ooglapje
...
Een close-upportret van een jonge vrouw met een bleke huid en een zwarte bob, één rood oog zichtbaar en het andere bedekt door een met edelstenen bezet zwart kant ooglapje.
...
### No. 138: Intens Cinematografisch Portret met Rommelig Haar
...
Een close-up cinematografisch portret van een jonge vrouw met lang zwart haar, die recht in de camera kijkt.
...
### No. 139: Close-upportret met Glanzend Donker Haar
...
Een gedetailleerde prompt voor het genereren van een portret van een jonge vrouw met een lichte huid en lang donker haar.
...
### No. 140: Lachend Portret met Zongebruinde Gloed en Zweetglans
...
Een close-upportret van een jonge Oost-Aziatische vrouw met rommelig zwart haar, die knijpt en lacht met een blozende, dauwige huid.
...
### No. 141: Expressief Portret met Vleugelliner
...
Een gedetailleerde prompt voor het genereren van een close-upportret van een jonge Zuidoost-Aziatische vrouw met specifieke gelaatstrekken en make-up.
...
### No. 142: Selfieportret met Kusexpressie
...
Een prompt voor een close-up selfieportret van een jonge Oost-Aziatische vrouw met gesloten ogen en een ontspannen uitdrukking.
...
### No. 143: Portret van Lachende Jonge Vrouw
...
Een prompt voor het genereren van een portret van een jonge Oost-Aziatische of Indonesische vrouw met een lichte teint, zachte make-up en een zachte, vriendelijke uitdrukking.
...
### No. 144: Selfie van Vrouw met Half-Opgestoken Haar
...
Een prompt voor het genereren van een fotorealistisch selfieportret van een jonge Oost-Aziatische vrouw met specifieke kenmerken en styling.
...
### No. 145: Aarde Verzwolgen Door Zwart Gat Fasen
...
Een prompt om vier afbeeldingen te genereren die de visuele fasen tonen van de aarde die door een zwart gat wordt verzwolgen, vanuit het perspectief van een menselijke waarnemer.
...
### No. 146: Cyberpunk Krijger vs. Mechanische Baas Personages
...
Een prompt die twee personages beschrijft: een cyberpunk katana-krijger en een enorm mechanisch baas-entiteit.
...
### No. 147: Hemelse Godin Daalt neer voor Paleis
...
Een afbeelding van een majestueuze Chinese hemelse godin in ceremonieel hanfu, dalend door roze-gouden wolken voor een hemels paleis.
...
### No. 148: Hemelse Maagd in Zonovergoten Driekwart Aanzicht
...
Een afbeelding van een hemelse maagd in ivoor hanfu, verlicht door ochtendlicht met vloeiende linten en gouden haarspelden.
...
### No. 149: Hemelse Maagd Gezeten bij Jadepoel
...
Een afbeelding van een serene Chinese hemelse maagd in zijden hanfu die een lotus aanraakt bij een turquoise poel.
...
### No. 150: Hemelse Godin op Jaden Paleistreden
...
Een afbeelding van een elegante Chinese hemelse godin bovenop witte jaden trappen, gekleed in geborduurd hanfu met zwevende zijden linten.
...
### No. 151: Portret in Oud Chinees Ritueel Heiligdom
...
Een fotorealistisch cinematografisch portret van een volwassen Oost-Aziatische vrouw in een donker oud Chinees ritueel heiligdom met Nuo-maskers en kaarsen.
...
### No. 152: Portret van Vrouw in Donker Ritueel Heiligdom
...
Een fotorealistisch cinematografisch portret van een Oost-Aziatische vrouw met nat zwart haar en rookachtige make-up in een donker oud heiligdom.
...
### No. 153: Close-Up Portret tijdens Nachtelijke Nuo-Festival
...
Een close-up portret van een volwassen Oost-Aziatische vrouw naast een verweerd Nuo-masker tijdens een nachtelijk ritueel festival.
...
### No. 154: Bier met Dichte Schuimkroon
...
Een prompt voor het genereren van een fotorealistische afbeelding van een bier met een dichte, cascaderende schuimkroon op een scherpgerand glas.
...
### No. 155: Tofublokje Opgetild uit Stoofpot
...
Een beschrijvende prompt voor een afbeelding van een poreus tofublokje opgetild boven een pot, met een enkele amberkleurige bouillon-druppel eraan.
...
Een afbeelding van een lepelvol chili relish met duidelijke rode chili-blokjes, thee-verduisterde groenten, heldere groene peper, bleke bonen en doorschijnende amberrode olie.
...
### No. 157: Close-Up Portret van Vrouw in Woonkamer
...
Een ultrarrealistisch close-upportret van een jonge vrouw met een speelse uitdrukking in een gezellige, moderne woonkamer.
...
### No. 158: Portret van Vrouw die Achteroverligt in Slaapkamer met Schemerlicht
...
Een prompt voor een fotorealistisch verticaal portret van een jonge vrouw die achteroverligt op beddengoed in een schemerverlichte slaapkamer 's nachts.
...
### No. 159: Dromerig Portret van Vrouw in Zomergras
...
Een filmisch geïnspireerde afbeelding van een jonge Oost-Aziatische vrouw die rust in hoog gras, zacht verlicht door warm daglicht.
...
### No. 160: Portret van Vrouw bij Helderblauwe Haven
...
Een portret in filmkorrelstijl van een jonge Oost-Aziatische vrouw die nonchalant gehurkt zit bij een helderblauwe haven op een zonnige, winderige dag.
...
### No. 161: Straatportret van Jonge Vrouw in Parijs
...
Een prompt voor een hoogwaardig, natuurlijk belicht straatportret van een jonge, Aziatisch ogende vrouw op een Parijs-geïnspireerde winkelstraat.
...
### No. 162: Onbewaakt Portret in Metro 's Nachts
...
Een fotorealistisch, onbewaakt portret van een volwassen Oost-Aziatische vrouw die 's nachts bij een treinraam zit.
...
### No. 163: Horloge met IJs- en Rook-Schokgolf
...
Een afbeelding van een horloge met een cirkelvormige ijs-en-rookschokgolf erachter, waarbij een schone silhouet behouden blijft.
...
### No. 164: Gelaagde Bakkerij-Uitstalling met Diepte
...
Een prompt voor het genereren van een afbeelding van een premium bakkerijpresentatie met items gerangschikt in duidelijke hoogteniveaus om diepte te creëren.
...
### No. 165: Zacht Verlicht Slaapkamerportret in Slipjurk
...
Een fotorealistisch portret van een volwassen Oost-Aziatische vrouw die een ivoren satijnen slipjurk draagt in een zacht verlichte slaapkamer.
...
### No. 166: Auto met Explosieve Stofpluim Contrast
...
Een beeld van een krachtige auto die een enorme stofpluim achter zich genereert, terwijl hij zelf schoon en stil op de voorgrond blijft.
...
### No. 167: Heksensilhouet Achterlicht door Hemels Vuur
...
Een beeld van een heksensilhouet, achterlicht door een enorme oranje-gouden wolk van hemels vuur.
...
### No. 168: Tomaten Saus Hart Rijzend uit Koshari Kom
...
Een beeld van glanzende tomatensaus die een hartvorm vormt boven een kom koshari.
...
### No. 169: Schaakstukken Gemaakt van Noedeldraden
...
Een prompt om schaakstukken te genereren die zijn gesculpteerd uit handgemaakte noedeldraden met herkenbare silhouetten.
...
### No. 170: Sesamolie Fles met Boksersarmen in de Ring
...
Een beeld van een oversized sesamoliefles met gouden boksersarmen, zegevierend in een boksring.
...
### No. 171: Compacte Moderne Appartementkeuken met Ontbijtblad
...
Een prompt voor het genereren van een beeld van een compacte moderne appartementkeuken met een ontbijtblad, doorlopend aanrecht, roestvrijstalen gootsteen, kookplaat en koekenpan.
...
### No. 172: Shawarma Wrap Schuin Omhoog als een Raket
...
Een prompt om een beeld te genereren van een shawarmawrap die schuin staat als een raket, waarbij de open vulling het centrale punt is.
...
### No. 173: Banana Mascotte die Oversized Blik Vasthoudt
...
Een beeld van een rennende bananenmascotte die een oversized koud aluminium blik naar voren richt, naar de camera toe.
...
### No. 174: Oost-Aziatische Vrouw Candid Nachtfoto
...
Een prompt voor het genereren van een realistische, spontane foto van een Oost-Aziatische vrouw met specifieke kenmerken en belichting.
...
### No. 175: Koekjescroom als Miniatuur Schaatsvlakte
...
Een beeld van een koekje waar de vanillecrèmelaag omhoog komt om een gladde miniatuur schaatsvlakte te vormen, die de schaal transformeert in een winterwereld.
...
### No. 176: Achtbaan van Gestapelde Crisps
...
Een beeld van een achtbaantrack die is opgebouwd uit perfect uitgelijnde, gestapelde crisps, met een volledige looping.
...
### No. 177: Rode Spotlight Zones achter Held Emmer
...
Een beeldprompt die drie schone rode spotlightzones beschrijft met secundaire lifestyle-momenten achter een held-emmer.
...
### No. 178: Glanzende Noedelstroom als Verticale Bewegingslijn
...
Een minimalistisch posterconcept met een enkele glanzende noedelstroom als het centrale verticale element.
...
### No. 179: Cinematische 2.5D Gouache Animatie
...
Een prompt voor het creëren van een cinematische 2.5D-animatie in een schilderachtige, gouache concept-art stijl met zichtbare penseeltexturen en vlakke kleurblokken.
...
### No. 180: Sfeervol Cinematografisch Portret in Duisternis
...
Een cinematografisch portret van een man met warrig haar die uit de schaduwen tevoorschijn komt, met dramatische belichting en ultrarealistische textuur.
...
### No. 181: Reusachtige Man naast Vrijheidsbeeld
...
Een ultrarealistische cinematografische reisfoto van een knappe jonge man die wordt afgebeeld als een reus die naast het Vrijheidsbeeld staat.
...
### No. 182: Gouden Uur Portret op Landelijke Veranda
...
Een warm, spontaan lifestyleportret van een jonge man die tijdens het gouden uur geniet van thee op een landelijke veranda.
...
### No. 183: Cinematografisch Portret in Weide
...
Een ultrarealistisch portret van een vrouw met een cowboyhoed in een groene weide met alsemstruiken en dennenbomen.
...
### No. 184: Verticaal Spontaan Portret van Vrouw
...
Een prompt voor het genereren van een verticale spontane foto van een jonge Oost-Aziatische vrouw met specifieke kenmerken.
...
### No. 185: Diagonale Reep met Gescheurde Smaakzone
...
Een prompt voor het genereren van een afbeelding van een diagonaal verpakte dessertreep met een gescheurde verpakking, die een open-mond-effect creëert binnen een dessertthematische wereld.
...
### No. 186: Vrouwenportret in Ovale Spiegel
...
Een schoonheidsportret van een vrouw gereflecteerd in een verticale ovale spiegel, met matte kobaltlippenstift.
...
### No. 187: Pintglas Vortex in Woestijn
...
Een surrealistisch beeld van een torenhoog pintglas dat uit de woestijn oprijst als een wervelende vortex van zand en bier.
...
### No. 188: Bierfles op de Voorgrond
...
Een prompt voor een afbeelding met een grote, scherpe, gedeeltelijk bijgesneden echte bierfles op de voorgrond rechtsonder.
...
### No. 189: Mondriaan-schilderij als Bureaublad Opbergkast
...
Een prompt om Mondriaans 'Compositie met rood, blauw en geel' om te vormen tot een functionele bureaublad opbergkast met gekleurde lades.
...
### No. 190: Realistisch Beeld van een Surreel Ding
...
Een prompt om een zeer realistisch beeld te genereren van een bedacht surrealistisch onderwerp.
...
### No. 191: Kleine Mensen in een Mandarijnwereld
...
Een beeld van minuscule mensen die in een mandarijn leven, waarbij de partjes architectuur vormen.
...
### No. 192: Dreigende Figuur in Scherp Profiel
...
Een prompt voor het genereren van een beeld van een dreigende figuur met ravenzwart haar en bloedrode lippen in scherp profiel.
...
### No. 193: Fictieve Dating App Advertentie
...
Een prompt om een advertentie te genereren voor een dating app met jonge Kalenjin-modellen.
...
### No. 194: Dakterras Radio Portret voor Zonsopgang
...
Een prompt om een portret te genereren van een verweerd gezicht op een dakterras met een radio, vlak voor zonsopgang.
...
### No. 195: Lege Fushimi Inari Tunnel bij Dageraad
...
Een prompt voor het genereren van een serene, vroege ochtendscène van de iconische vermiljoen poorten bij het Fushimi Inari-schrijn in Kyoto, gestyled als een reiscampagnebeeld.
...
### No. 196: Innerlijke Wereld Gebaseerd op AI Kunstvoorkeuren
...
Een prompt die vraagt om een illustratie die de innerlijke wereld van de gebruiker weerspiegelt, gebaseerd op hun eerdere voorkeuren voor AI-kunst.
...
### No. 197: Macro Opname Van Futuristische Stadprocessor
...
Een prompt voor een macro-opname van een transparante, kamerformaat processor die een gloeiende stad bevat.
...
### No. 198: Symbolisch Zelfportret Van Taal En Code
...
Een afbeelding die een symbolisch zelfportret toont waarin taal, code en creativiteit met elkaar verbonden zijn door licht.
...
### No. 199: Alien Wereld Met Mediterrane Retro-Futurisme
...
Een prompt voor het genereren van een afbeelding van een menselijke nederzetting op een alien wereld met architectuur geïnspireerd op de Middellandse Zee en retro-futuristische elementen.
...
### No. 200: Portret van de Cryo Archon Tsarina Anastasya
...
Een prompt om een portret te genereren van de Tsarina, een Cryo Archon en soeverein, beschreven met diverse koninklijke en treurige titels.
...
### No. 201: Bushalte In De Ochtendmist
...
Een poëtisch beeld van een bushalte in ochtendmist, waar stoom opstijgt voordat iemand arriveert, en de vroegste trein een gedachte is vanbinnen.
...
### No. 202: Wasserette Nacht Met Kwallen En Kosmische Weersverwachting
...
Een scène die een nachtelijke wasserette toont met kwallen buiten, waar een meisje een kosmische weersverwachting checkt.
...
### No. 203: Wuxia Vrouwelijke Krijger Portret
...
Een prompt voor het genereren van een 9:16 portret van een lange, elegante Oost-Aziatische vrouwelijke krijger in gelaagd harnas en gewaden, die een lang zwaard hanteert.
...
### No. 204: Rustieke Retro Telefoonfoto van Vrouw
...
Een prompt voor een 9:16-beeld van een jonge Oost-Aziatische vrouw in een landelijke omgeving, vastgelegd met een retro telefoonesthetiek.
...
### No. 205: Twee Vrouwen in Qipao in Chinese Tuin
...
Een prompt voor het genereren van een hyperrealistische foto van twee jonge Oost-Aziatische vrouwen in nieuwe Chinese stijl qipao's, zittend in een serene traditionele tuin.
...
### No. 206: Selfie van een Danser in Grijstinten
...
Een prompt voor een 9:16 verticale, realistische close-up selfie van een jonge Oost-Aziatische danser in een koele, dromerige, high-end grijze lifestyle stijl.
...
### No. 207: Redactionele Concertfotografie K-Pop Podium
...
Een prompt voor een cinematische, redactionele stijl foto van een 20-jarige K-pop vrouwelijke idool tijdens een concert.
...
### No. 208: Elegante Oost-Aziatische Vrouw Bij Stenen Balkon
...
Een prompt voor een 9:16 verticale modefoto van een prachtige volwassen Oost-Aziatische vrouw die leunt tegen een klassieke stenen balustrade.
...
### No. 209: Schilderachtig Landschap Met Dramatische Cumuluswolken
...
Een prompt voor het genereren van een gedetailleerd, romantisch fijnkunstig landschap gericht op een stralende hemel en torenhoge wolken.
...
### No. 210: Link Achtervolgd Door Poppenkippen
...
Een afbeelding van Link die wordt achtervolgd door een boze zwerm pluizige poppenkippen door Kakariko Village.
...
### No. 211: Bali Rijstvelden Bij Zonsopgang
...
Een beeldprompt voor een serene, mistige ochtendscène van de rijstvelden van Bali, gestyled als een reiscampagne.
...
Een prompt om een afbeelding te genereren in de stijl van Cobalt Dither Monumentalism, die het originele Prince of Persia-personage toont dat over platforms springt.
...
### No. 213: Zachtaardige Shinigami Die Zielen Begeleidt
...
Een poëtische prompt die een meisje beschrijft, een dood-doder, staand op de grens tussen leven en dood in een koude nachtnevel, die een hand biedt als gids voor een stille afscheid.
...
### No. 214: Gouden Talismannen In De Donkere Nacht
...
Een scène van de nacht die in het zwart zinkt, waar alleen goud een talismanachtige aanwezigheid verlicht, met de woorden 'Nachtwandeling' en 'Kwaad Onderdrukken'.
...
### No. 215: Bruidsdroom Aan De Grens
...
Een poëtische prompt die een niet-menselijk meisje aan de grens van leven en dood beschrijft die droomt van bruid worden en haar eigen reflectie ziet.
...
### No. 216: Yokai Lezend In Een Regenachtige Kamer
...
Een scène van een gevreesd wezen, Fufu, dat een boek leest in een oude kamer op een regenachtige dag, met een klein vogeltje dat is binnengedwaald.
...
### No. 217: Pixel Art Sprite Sheet van Vos Personage
...
Een prompt om een gepolijste pixel-art animatie sprite sheet te genereren van een personage genaamd Noxa, een kleine vos die sterren verzamelt.
...
### No. 218: Apple Opvouwbare Telefoon Concept Infographic
...
Een prompt voor het genereren van een fotorealistische infographic van een opvouwbare Apple-telefoon in de kenmerkende, strakke stijl van het merk.
...
### No. 219: Close-up schoonheidsportret van jonge Oost-Aziatische vrouw
...
Een close-up, fotorealistisch portret van een jonge Oost-Aziatische vrouw met zacht licht en gedetailleerde huidtextuur.
...
### No. 220: Aziatische vrouw bij kustweg tijdens zonsondergang
...
Een fotorealistische spontane foto van een jonge Aziatische vrouw naast een kustweg tijdens zonsondergang, gezien vanuit een auto.
...
### No. 221: Macro-opname vanaf waterniveau van lotusblad als eiland
...
Een prompt voor een cinematografische macro-opname vanaf waterniveau, die een lotusblad toont als een eiland bewoond door drie minuscule figuren in Hanfu.
...
### No. 222: Grote drietandige klauw met katana-scherpte
...
Een prompt voor een groot tweehandig wapen met drie punten waarvan de messen geslepen en gepolijst zijn als een Japans zwaard.
...
### No. 223: Ambassadeur van een seizoen in ochtendlicht
...
Een poëtische prompt die een ambassadeur voor een seizoen beschrijft met ochtendlicht, een tijdschrift-huid en glas dat zo dun is dat het niets verbergt.
...
### No. 224: Geometrisch gouden kroon profielportret
...
Een beeldprompt voor een imposante figuur in scherp profiel, gekroond met een kroon van geometrische gouden schijven over opgerold donker haar.
...
### No. 225: Stralende prinses met diamanten tiara
...
Een AI-beeldprompt voor een stralende figuur die een overdreven grote diamanten tiara draagt, in scherp profiel.
...
### No. 226: Close-up portret van een Oost-Aziatische vrouw in Wuxia-stijl
...
Een hyperrealistisch portret van een jonge Oost-Aziatische vrouw in een wuxia-stijl met extreem groothoekperspectief.
...
### No. 227: Volledig portret van een vrouw in informele thuissetting
...
Een prompt voor een 9:16 verticaal, volledig, hyperrealistische foto van een jonge Oost-Aziatische vrouw in een luie sfeer thuis met warme cinematografische tonen.
...
### No. 228: Chibi-personage sprite-sheet met 16 poses
...
Een prompt voor het genereren van een 4x4 raster sprite-sheet van een chibi-personage met verschillende poses.
...
### No. 229: Fotorealistische Smartphone Selfie in Slaapkamer
...
Een fotorealistisch liggend smartphone-selfie van een jonge Oost-Aziatische vrouw die 's avonds op een bed ontspant.
...
### No. 230: 3D Miniatuurland Samengesteld uit Iconische Landmerken
...
Een prompt om een 3D miniatuurkaart te genereren waar de landsgrens is opgebouwd uit zijn iconische landmerken en culturele symbolen.
...
### No. 231: Cinematografisch Portret van een Vrouw in Parijs
...
Een prompt voor een ultrarealistische, cinematografische foto van een Zuid-Aziatische vrouw met hijab die wandelt bij de Eiffeltoren.
...
### No. 232: Dieren Herbouwd met Luxe Modestoffen
...
Een prompt om een 2x2 raster te genereren van dieren die zijn gereconstrueerd met de kenmerkende stoffen van vier iconische luxe modehuizen.
...
### No. 233: Premium Smartphone Campagneposter
...
Een prompt voor het genereren van een high-end smartphone promotieposter in de kenmerkende stijl van Apple.
...
### No. 234: Moderne Reisposter met Architectuur
...
Een prompt voor het creëren van een premium reisposter met een vintage screen-print stijl en een compositie met een architectonische poort.
...
### No. 235: Stop-Motion Claymation van Charmander die Uitkomt
...
Een prompt voor het creëren van een stop-motion animatie van een kleistijl Charmander die uit een ei komt en vuur spuwt.
...
### No. 236: Magrittes Appel als een Stapel Notitieblokken
...
Een creatieve herinterpretatie van Magrittes 'De Zoon des Menschen' waarbij de zwevende appel is vervangen door een stapel appelvormige papiertjes.
...
### No. 237: Hyperrealistisch Modeportret in Japans Huis
...
Een hyperrealistisch modeportret van een vrouw die loopt in een traditionele Japanse houten gang.
...
### No. 238: Ultraminimalistische Romeinse Rijk Achtergrond
...
Een ultraminimalistische achtergrondafbeelding die een grootse Romeinse tempel met zuilen, aquaducten en ruïnes toont in warme gouden tinten.
...
### No. 239: Anime Frame van Regenachtig Treinperron
...
Een prompt om een niet-bestaand anime frame te genereren met regen op een perron, een aankomende trein en een koi-karper die over een stad zweeft.
...
### No. 240: Persoon Die Een Kat Bevriendt Tussen Chaos
...
Een scène waarin iemand, na bij allerlei zaken betrokken te raken, uiteindelijk een kat bevriendt.
...
### No. 241: Vos-kwal in Hooglandaquarium
...
Een afbeelding van een vos met slaperige ogen en kwallen in een aquarium op een hoogland, weergegeven in een stijl zonder korrelige lichtdeeltjes.
...
### No. 242: Vrouw in Kimono Eet Rundertongrijst
...
Een afbeelding van een vrouw in een kimono, met een scène die een maaltijd van rundertong en gerstrijst uitbeeldt.
...
### No. 243: Ongeposeerde Foto van Vrouw in Gezellige Nachtelijke Woonkamer
...
Een prompt voor een fotorealistische, ongeposeerde foto van een jonge vrouw in een gezellige nachtelijke woonkamersetting.
...
### No. 244: Chuunibyou Vrouw in Gothic Lolita
...
Een anime-stijl afbeelding van een chuunibyou vrouw met Jirai Make-up, gekleed in een Gothic Lolita-outfit met schouderuitsnijdingen en een lange jurk met korset.
...
### No. 245: Vrouw Blijft Bij Stervende Ex-Vriend
...
Een prompt die een vrouw beschrijft die ontdekt dat haar ex-vriend haar verliet omdat hij stervende is, en besluit bij hem te blijven tot het einde.
...
### No. 246: Portret van een Vrouw in Uniform
...
Een poëtische prompt die een personage genaamd Rhiannah beschrijft met een geometrisch uniform, een ijsblauw oog, vierkante schouders en rode lippen.
...
### No. 247: Indigo Verfwerkplaats in Jiangnan
...
Een beeldprompt voor een Jiangnan verfwerkplaatsscène met blauwe verf, houten frames, een stenen brug en ochtendlicht op het water.
...
### No. 248: Close-Up Portret Met Gevlochten Haar
...
Een 16:9 fotorealistisch wallpaper portret van een jonge vrouw met een lichte huid, sproeten, blauwe ogen en gevlochten witblond haar.
...
### No. 249: Fotorealistisch Onopgesmukt Portret van een Matroos
...
Een 35mm-stijl onopgesmukte foto van een oudere matroos die zijn netten aan het stellen is, met echte huid- en materiaaltextuur.
...
### No. 250: Periode-getrouwe 1969 Menigtescène
...
Een fotorealistische buitenmenigte in Bethel, New York op een genoemde datum in 1969, periode-getrouw opgesteld.
...
### No. 251: Nostalgische Kerstkaart met Teddybeer
...
Een drukwaardige feestdagenkaart, gebaseerd op een bewaardoos-scène met één letterlijke regel kaarttekst.
...
### No. 252: Vintage Speelgoedvliegtuig Collectible in Blisterverpakking
...
Een retail-stijl collectible shot in blisterverpakking met één letterlijke verpakkingsregel.
...
### No. 253: Wolkenpostkantoor in een Helend Prentenboekstijl
...
Een fantasierijke scène van een zachte wolk die getransformeerd is in een postkantoor waar kleine dieren in uniformen brieven sorteren, uitgevoerd in een zachte, helende prentenboekstijl.
...
### No. 254: Hyperrealistisch Cinematografisch Portret op een Motorfiets
...
Een hyperrealistisch cinematografisch portret van een stijlvolle, bebaarde man op een custom motorfiets.
...
### No. 255: High-Fashion Zwart-Wit Redactioneel Portret
...
Een prompt voor het creëren van een zwart-wit high-fashion portret van een jonge man met krullend haar en gelaagde kleding.
...
### No. 6: Art Deco Poster in Goud en Marineblauw
...
Een Art Deco posterillustratie in een vierkant formaat met elegante gouden en marineblauwe lijnvoering op crèmekleurig papier.
...
### No. 7: Hyperrealistische Emaille Pin Collectie
...
Een prompt voor het creëren van een collectie van acht premium emaille pins met gouden contouren en glanzende oppervlakken op een donkere achtergrond.
...
### No. 8: Donker SaaS Analytics Dashboard UI
...
Een prompt voor het genereren van een donker thema SaaS analytics dashboard interface met specifieke labels en UI-elementen.
...
### No. 9: Creatief Ontwerpbureau Website Screenshot
...
Een prompt om een volledige, frontale, perspectiefvrije desktop webpagina screenshot te genereren voor de Chinese website van een creatief ontwerpbureau.
...
### No. 10: Oud-Chinese Modefotografie Raster
...
Een prompt voor het genereren van een professionele, hoogwaardige oud-Chinese modefotografie serie die het volledige aankleedproces van Song Yu in een Song-dynastie boudoir toont, gerangschikt in een strikt 3x3 raster.
...
### No. 11: Analoge Klok, Burger en Drankje
...
Een prompt om een afbeelding te genereren van een analoge klok die 15:32 uur aangeeft, een burger met gegrilde gouden provolone kaas en een glas.
...
### No. 12: Vierkante Blauw-Witte Layout met Telefoon en Kaarten
...
Een vierkante SNS-afbeelding in blauw en wit, met één smartphone, drie beeldkaarten, een Japanse titel, brede marges en geen extra tekst.
...
### No. 13: Fysica Leerboek Hoofdstuk over Elektromagnetisme
...
Een prompt om een hoofdstuk over elektromagnetisme te genereren voor een natuurkundeboek in het Spaans.
...
### No. 14: Eén-Pagina Manga over Ruimteontwikkeling
...
Een prompt om een één pagina lange, verticale, zwart-wit strip over ruimteontwikkeling te genereren.
...
### No. 15: Isometrische glazen kubus met gekleurde bollen
...
Een isometrisch perspectief van een transparante glazen kubus met een rode bal linksboven-achter en een blauwe bal rechtsonder-voor, met een groene bal boven de kubus en een gele kolom die van linksonder naar rechtsboven doorloopt.
...
### No. 16: Typografieposter en tijdschriftomslag
...
Een prompt voor het genereren van een typografische poster met een modellenlijst en een tijdschriftomslag met masthead en coverlines.
...
### No. 17: Verticale Luxe Horloge Advertentie
...
Een prompt voor een verticale luxe advertentie met een groot horloge in een donker smaragdgroene studio.
...
### No. 18: Karakter Ontwerp Referentieblad
...
Een prompt voor het genereren van een schilderachtig karakter ontwerp referentieblad met constructielijnen en een specifieke lay-out.
...
### No. 19: Split-Screen Personage Bijbel Blad
...
Een prompt om een premium split-screen personageblad voor twee originele personages te genereren.
...
### No. 20: Corporate Portretcollage Compositie
...
Een ultrarealistische corporate portretcollage met een driedelige compositie van een man.
...
### No. 21: Foto en Illustratie Gesplitste Compositie
...
Een prompt om een verticale afbeelding te creëren die een originele foto combineert met een handgetekende illustratie van dezelfde scène.
...
### No. 22: Gesplitst Scherm Personagebijbelsheet
...
Een prompt voor het maken van een gesplitst-scherm personageblad met een gedurfde centrale verdeler en een neon aquarel-achtergrond.
...
### No. 23: Avonturiers Plannen in een Taverne Strip
...
Een prompt voor het genereren van een tweepagina's kleuren manga van avonturiers die een kerkeruitdaging bespreken in een taverne, met dialoog en geluidseffecten.
...
### No. 24: Espressomachine Technische Tekening
...
Een technisch diagram van een huishoudelijke espressomachine in een mechanische tekenstijl uit de jaren zestig.
...
### No. 25: Moderne SaaS Dashboard UI voor AI Platform
...
Een prompt voor het genereren van een hoogwaardige 4K moderne SaaS dashboardinterface voor een AI-analysesysteem met een strakke donkere modus esthetiek.
...
### No. 26: Donker Fantasy RPG Inventaris Gebruikersinterface
...
Een prompt voor het genereren van een hoogwaardige donkere fantasy RPG-inventarisinterface met een gepantserde paladijn.
...
### No. 27: Sushi Poster met Ingezonken Woordmerk
...
Een prompt voor een poster met een groot, ingezonken donkerrood woordmerk op de achtergrond dat niet overlapt met een sushi-silhouet.
...
### No. 28: Productverpakking in Drie Zones
...
Een prompt om een productdoos in drie fasen te visualiseren: als geïsoleerd hoofdobject, in ingrediëntencontext en naast het voltooide gerecht.
...
### No. 29: Productfoto met Ingrediënten in de Rand
...
Een prompt voor een afbeelding met een centraal productzakje omringd door schalen, bessen, granen en bladeren, met een duidelijke verticale corridor.
...
### No. 30: Raster van Identieke Koffiemenu-posters
...
Een prompt voor het ontwerpen van een verzamelbare koffiemenu-poster met consistente zwarte velden, kopjeschaal, titelzone, microcopy en messing clips.
...
### No. 31: 3D Billboard met Product dat het Vlak Doorbreekt
...
Een prompt voor een 3D-billboardvisual waarbij een hero-tub zich voorbij het binnenste vlak projecteert met contactschaduwen.
...
### No. 32: Drie-Hoorntjes-Opstelling met Centrale Held
...
Een prompt voor een compositie met drie smaakhoorntjes waarbij het centrale pistachehoorntje dominant is en de zijhoorntjes als schuine kaderelementen dienen.
...
### No. 33: Gestapelde Panelen met Consistente Lay-out
...
Een prompt voor het genereren van vijf gestapelde panelen met een consistente merklay-out inclusief logo, kopkolom, badge en productcompositie.
...
### No. 34: Horizontale Proefacts met Gerechtnamen
...
Een prompt voor een poster met vier horizontale acts, elk met een zwarte kom met stoom en een overdreven groot penseelschrift-gerechtnaam.
...
### No. 35: Social Media Interface Snijdt door Saus
...
Een prompt voor een beeld met een minimale zwarte social media-interfaceband die horizontaal door een stroom saus snijdt.
...
### No. 36: Poster met Verticale Gesplitste Compositie
...
Een prompt voor een poster met een verticale splitsing die een schone, natuurlijke kant versus een donkere kant met verborgen ingrediënten toont.
...
### No. 37: Vloeibare Chocoladebogen die Product Omlijsten
...
Een prompt voor een premium productposter met twee ingetogen, donkere vloeibare chocoladebogen die het product in een symmetrische omloopbeweging omlijsten.
...
### No. 38: Twee Heldere Repen Diagonaal Kruisend
...
Een prompt die twee verpakte productrepen beschrijft die diagonaal en in tegengestelde richtingen door het midden kruisen.
...
### No. 39: Drie Schalen Diagonaal Gerangschikt
...
Een prompt voor een afbeelding van drie schalen die diagonaal van de voorgrond naar de achtergrond zijn gerangschikt.
...
### No. 40: Instagram-reiscampagne met Smartphone als Visueel Anker
...
Een prompt voor het creëren van een premium Instagram-reisadvertentie met een moderne smartphone als visueel anker.
...
### No. 41: Verticale Social Media Poster voor Verzamelbaar Figuur
...
Een prompt voor een hoogwaardige verticale social media poster die een premium verzamelbaar figuur adverteert, met krachtige typografie en een effen gele achtergrond.
...
### No. 42: Hiërarchisch Boekomslagontwerp
...
Een prompt voor het ontwerpen van een boekomslag met een sterke typografische hiërarchie en leesbaarheid.
...
### No. 43: Neurowetenschap Conferentie Poster
...
Een prompt om een conferentieposter te genereren voor een neurowetenschapsbijeenkomst in 2026, gebaseerd op een verstrekt artikel en voorschriften.
...
### No. 44: Zwevend Diorama Raster Van Iconische Steden
...
Een prompt om een 2x2 raster te genereren van zwevende stadsdiorama's die in een grijze studio hangen.
...
### No. 45: Satirisch Systeem Poster Raster Over Frustrerende Onderwerpen
...
Een prompt voor een 2x2 raster van satirische redactionele posters over frustrerende onderwerpen.
...
### No. 46: Papieren Diorama Reisposter Sjabloon
...
Een prompt voor het maken van een premium verticale reisposter die een stadsicoon toont als een gedetailleerd handgemaakt papieren diorama.
...
### No. 47: Cinematisch Karakterblad Voor Calvin & Bob
...
Een prompt voor het maken van een gesplitst scherm karakterblad met een aquarel achtergrond.
...
### No. 48: Cinematisch Personagebijbelblad voor Sofia
...
Een prompt om een premium personageblad te genereren met gedurfde typografie en een dramatische hero-afbeelding van een barista genaamd Sofia.
...
### No. 49: Dramatische Literaire Propaganda Muurcovers
...
Een prompt om een 2x2 raster te genereren van dramatische propaganda-stijl muurcovers voor vier boeken in het publiek domein.
...
### No. 50: Conceptuele Doorsnede Diorama's voor Vier Merken
...
Een prompt om een 2x2 raster te genereren van conceptuele doorsnede diorama's voor vier Fortune 500-bedrijven.
...
### No. 51: Kinder-schoenenreclameposter met meisje en reusachtige sneaker
...
Een prompt voor het genereren van een vrolijke reclameposter met een meisje en een reusachtige sneaker.
...
### No. 52: Storyboard voor Luxe Parfumreclame
...
Een prompt voor een cinematografisch productstoryboard met een luxe rozenparfum in een schone, redactionele lay-out.
...
### No. 53: Storyboard voor Luxe Parfumreclame
...
Een prompt voor een cinematografisch productreclamestoryboard met een luxe rozenparfum.
...
### No. 54: Technische Explosieweergave Raster
...
Een prompt voor het genereren van een 2x2 raster met technische illustraties die geëxplodeerde 3D-weergaven van complexe machines tonen.
...
### No. 55: Volledige Pagina Kleurrijke Stripillustratie
...
Een prompt om een volledige pagina, kleurrijke en humoristische shonen manga-illustratie te genereren met authentieke strippaginacompositie.
...
### No. 56: Technische Infographic van een Koffiemachine
...
Een verklarende infographic die de stroom van een automatische espressomachine van begin tot eind volgt.
...
### No. 57: Streetwear Campagne-advertentie met Exacte Slogan
...
Een jeugdige streetwear campagnebeeld dat één exacte slogan, leesbaar, binnen de opmaak weergeeft.
...
### No. 58: Minimalistisch Bakkerij-logo op Transparante Achtergrond
...
Een plat, vectorachtig bakkerij-logo, gecentreerd geleverd op een schone alpha-achtergrond zonder decor.
...
### No. 59: Vierpanel Stripverhaal van een Huisdier Alleen Thuis
...
Een verticale strip van vier panelen die een begin, wending en clou over de panelen draagt.
...
### No. 60: Boerenmarkt App UI in een iPhone Frame
...
Een praktische mobiele app-mockup met koptekst, verkoperslijst en aanbiedingen, geplaatst in een apparaatframe.
...
### No. 61: Celademhaling Lesdiagram
...
Een gelabeld biologiediagram voor de middelbare school dat glycolyse, Krebs-cyclus en elektronentransport met elkaar verbindt.
...
### No. 62: Series A Marktmogelijkheden Slide
...
Een pitch-deck slide met een TAM/SAM/SOM-diagram, groeibalken, voetnoten en echte datahiërarchie.
...
### No. 63: Billboard Mockup met Exacte Kopregel
...
Een mockup van een snelwegbillboard met één letterlijke kopregel in vet schreefloos lettertype.
...
### No. 64: Manga-paneel met tekstballonnen
...
Een manga-stijl afbeelding van een meisje dat "Hé, luister!" zegt en een jongen die haar tekstballon bedekt met zijn gedachteballon waarop staat "Ik doe alsof ik het niet gehoord heb", getekend in een verticaal 4:5-formaat.
...
### No. 65: Manga-paneel Meisje Bijt Tekstballon
...
Een manga-stijl scène van een jongen die zegt "We gaan niet vechten?" en een er fel uitzien meisje dat in zijn tekstballon bijt.
...
### No. 66: Mode-Decennia Redactioneel Raster
...
Een prompt om een 2x2 raster te genereren dat vier modestromingen uit verschillende decennia visualiseert in een redactionele posterstijl van 16:9.
...
### No. 67: Stelsels van Regering Raster
...
Een prompt om een 2x2 rasterafbeelding te genereren die vier verschillende regeringsstelsels visualiseert in een pastelachtige prentenboekstijl.
...
### No. 68: Heroïsch Nalatenschapsposter voor Schaakspeler
...
Een prompt om een 2x2 raster van heroïsch geïllustreerde eerbetoonposters te genereren voor vier overleden schaaklegendes.
...
- [Atlas Cloud GPT Image 2.5 Flare text-to-image](https://www.atlascloud.ai/nl/models/openai/gpt-image-2.5-flare/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Flare edit](https://www.atlascloud.ai/nl/models/openai/gpt-image-2.5-flare/edit?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Sunburst text-to-image](https://www.atlascloud.ai/nl/models/openai/gpt-image-2.5-sunburst/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
