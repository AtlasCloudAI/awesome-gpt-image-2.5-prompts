...
### No. 3: Porträtt av en spansk kvinna vid poolen
...
Ett polerat vertikalt skönhetsporträtt av en spansk kvinna sittande bredvid en mintgrön inomhuspool.
...
### No. 4: Två kvinnor i en stenvalvsöppning
...
En prompt för en bild av två kvinnor inramade av en solblekt stenvalvsöppning.
...
### No. 5: Karaktärsblad med flera bildpaneler
...
En prompt för att generera ett karaktärsblad med fyra studiobilder av samma kvinna från olika vinklar.
...
### No. 6: Nio Emoji-klistermärken med text
...
En prompt för att generera ett 3x3 rutnät med olika emoji-klistermärken baserade på en referenskaraktär, med kinesisk och engelsk text på en lätt gradientbakgrund.
...
### No. 7: Spritekarta med fyra punktkonstkaraktärsrörelser
...
En prompt för att generera en spritekarta med fyra typer av punktkonstkaraktärsanimationer, varje med upp till 4 bildrutor, med konsekvent design.
...
### No. 8: Konstverk inspirerat av skiss
...
En prompt för att skapa ett originellt konstverk baserat på en skiss, som bevarar dess kärnämne, känsla och gestaltning samtidigt som detaljerna omtolkas.
...
### No. 9: Morgonlivsstilsfoto av kvinna
...
Ett fotorealistiskt morgonlivsstilsporträtt av en ung kvinna med auburnrött hår.
...
### No. 10: Kvinna som vilar i hemkontor
...
En prompt för att generera ett fotorealistiskt smartphonefoto av en ung kvinna som vilar på en soffa i ett modernt hemkontor.
...
### No. 11: iPhone-porträtt av ung kvinna
...
En prompt för att generera ett realistiskt iPhone-porträtt av en ung kvinna inomhus med en reflekterande bakgrund.
...
### No. 12: Pixelart-spritesheet för karaktär
...
En prompt för att generera ett förenklat 128px pixelart-spritesheet med genomskinlig bakgrund och ett 4x4-layout för karaktärs stridsaktioner.
...
En serie prompts för att omvandla en barns teckning till ett stämningsfullt nattläger, sedan en dagversion, och slutligen byta karaktärens kläder till overaller.
...
### No. 14: Minimalistisk Enkellinjes Landskapskonst
...
En prompt för att skapa en vertikal minimalistisk konsttryck av ett land med en enda kontinuerlig linje.
...
### No. 15: 1985 Historisk Porträtttransformation
...
En prompt för att omtänka en persons utseende under 1980-talet samtidigt som deras kärnidentitet och drag bevaras.
...
### No. 16: 3D Överdimensionerad T-Shirt Varumärkesmockup
...
En prompt för att generera en 3D-mockup av två svävande överdimensionerade T-shirts som visar fram- och baksida.
...
### No. 17: Lyxherrekiperad Redaktionell Kollage
...
En prompt för att skapa ett lyxigt redaktionellt kollage för herrekipering med hjälp av ett uppladdat foto som ansiktsreferens.
...
### No. 18: Ansiktsidentitet och Kompositionsreferens
...
En prompt som instruerar användning av en uppladdad bild för att bevara ett objekts ansiktsdrag och naturliga utseende.
...
### No. 19: Realistiskt Professionellt Studioporträtt
...
En prompt för att skapa ett professionellt studioporträtt med hjälp av ett uppladdat foto för ansiktsidentitet och komposition.
...
### No. 20: Mode Redaktionellt Kollage med Konsekvent Modell
...
En prompt för att skapa ett modekollage med en konsekvent manlig modell med hjälp av en ansiktsidentitetsreferens.
...
### No. 21: Astronaut i Futuristisk Cockpit Porträtt
...
En prompt för att generera ett fotorealistiskt porträtt av en självsäker kvinnlig astronaut i en futuristisk rymdfarkostcockpit.
...
### No. 22: Ultrarealistiskt studio modeporträtt
...
En prompt för att skapa ett helkropps, ultrarealistiskt studio modeporträtt med hjälp av en uppladdad bild som ansiktsreferens.
...
### No. 23: Filmisk motorcykellivsstilsporträtt
...
Ett ultrarealistiskt porträtt av en man som sitter utomhus bredvid en premium sportmotorcykel.
...
### No. 24: Ultrarealistiskt redaktionellt porträtt
...
En AI-prompt för att skapa ett ultrarealistiskt redaktionellt porträtt av en man med hjälp av en ansiktsidentitetsreferens.
...
### No. 25: Premium modeporträtt från referens
...
En prompt för att skapa ett premium modeporträtt av en stilfull vuxen man med hjälp av en ansiktsidentitetsreferens.
...
### No. 26: Omedvetet livsstilsporträtt från referens
...
En prompt för att generera ett högkvalitativt, ultra-fotorealistiskt omedvetet livsstilsporträtt av en kvinna baserat på en referensbild.
...
### No. 27: Vintermodeporträtt från foto
...
En AI-prompt för att skapa ett realistiskt utomhus vintermodeporträtt med hjälp av ett subjektfoto för ansiktsreferens.
...
### No. 28: Ultrarealistiskt Lyxstudioporträtt
...
En AI-prompt för att generera ett ultrarealistiskt lyxstudioporträtt av en stilfull vuxen man.
...
### No. 29: Filmiskt Regnporträttkollage
...
En prompt för att skapa ett filmiskt regnporträttkollage med en uppladdad bild som referens för komposition och atmosfär.
...
### No. 30: Smarttelefon-Selfie med Identitetsbevarande
...
En prompt för att generera ett 3:4 vertikalt, ultrarealistiskt smartphone-selfie som troget bevarar en specifik kvinnas ansiktsdrag och utseende.
...
### No. 31: Filmiskt Modeporträtt med Identitet
...
En prompt för att generera ett närbildsmodeporträtt som bevarar subjektets identitet och utseende.
...
### No. 32: Närbildsformellt Studioporträtt
...
En prompt för att skapa ett närbildsstudioporträtt av en ung man i formell klädsel med hjälp av ett ansiktsreferensfoto.
...
### No. 33: Filmisk Livsstilsfoto med Identitetsbevarande
...
En prompt för att skapa en fotorealistisk filmisk bild av en specifik östasiatisk kvinna, där hennes identitet och drag bevaras.
...
### No. 34: Filmisk Modeeditorial med Identitetsreferens
...
En prompt för att generera ett filmiskt modefotografi av en kvinna i en mörk miljö, där hennes identitet bevaras från en referensbild.
...
### No. 35: Ultrarealtistisk Editorialporträtt från Referens
...
En bildgenereringsprompt för att skapa ett ultrarealistiskt editorialporträtt av en vuxen man, med hjälp av en uppladdad bild som ansiktsidentitetsreferens.
...
### No. 36: Drakslag med Förrädisk Yxbärare
...
En prompt för att generera en bild av ett drakslag med en förrädisk yxbärare, med hjälp av ChatGPT Astra.
...
### No. 37: Hjältemässig Jätterobot från Fotorealistisk Vinkel
...
En prompt för att skapa en bild som visar en hjältemässig jätterobot från en dynamisk, fotorealistisk vinkel.
...
### No. 38: Anime-stil från Uppladdad Subjekt
...
En prompt för att skapa en anime-stilbild med självsäkra linjer, minimal cel-skuggning och ljusa, mättade färger.
...
### No. 39: Produktbild Från Framifrån med Tydlig Etikett
...
En prompt för att generera två produktbilder med tydliga, läsbara etiketter i en framåtvänd, plattläggningsstil.
...
### No. 40: Fantasy-scen med Örn och Referens
...
En prompt för en cinematisk fantasy-scen med en kvinna centrerad framför en gigantisk, majestätisk vithövdad havsörn med utbredda vingar.
...
### No. 41: High-Fashion Annons med Modellidentitet
...
En prompt för att skapa en premium, hyperrealistisk high-fashion reklambild som bevarar en specifik modells ansiktsidentitet.
...
### No. 42: Artikel till Fyrapanelsmanga i Afternoon-stil
...
En prompt för att generera en fyrasidig serie i stil med den japanska tidningen Afternoon, baserad på en bifogad artikel.
...
### No. 43: Premium Cinematisk Karaktärsbibelsida
...
En prompt för att skapa en uppdelad karaktärsreferenssida med strikta visuella riktlinjer.
...
### No. 44: Pixel Art Strids-Sprite Sheet
...
En prompt för att generera ett förenklat 128px pixel art-stridsanimationssprite sheet med genomskinlig bakgrund.
...
### No. 45: Karaktärs Strids-Sprite Sheet Pixel Art
...
En prompt för att generera ett 16-ramars pixel art-sprite sheet för en karaktärs strörelser i strid.
...
### No. 46: Karaktärsstridsspritesheet i pixelart
...
En prompt för att skapa ett förenklat 128px pixelart-spritesheet med 16 bildrutor för en karaktärs strörelser, inklusive viloläge, hugg, försvar och nedslagslägen.
...
### No. 47: Fotorealistiskt porträtt med identitetsreferens
...
En prompt för att skapa ett helkroppsporträtt i fotorealistisk stil med hjälp av en referensbild för att bevara subjektets identitet.
...
### No. 48: Marty & Doc karaktärsreferenssida
...
En prompt för att generera en delad karaktärsreferenssida för två karaktärer med strikta visuella riktlinjer.
...
### No. 49: Karakterbibel för Ted & John
...
En prompt för att generera ett delat skärmkarakterark med strikta visuella referenser för två karaktärer.
...
### No. 50: Delad skärmkarakterbibel för Dom & Brian
...
En prompt för att generera ett delat skärmkarakterark med uppladdade referenser för två karaktärer.
...
### No. 51: Filmisk karakterbibel för Baby
...
En prompt för att generera ett premiumkarakterark för karaktären Baby, med fet typografi och strikt följd av visuella referenser.
...
### No. 52: Filmisk karakterbibel för Schmidt & Jenko
...
### No. 53: Filmisk karakterbibel för Gordon
...
En prompt för att skapa ett premiumkarakterark med fet typografi och strikta visuella referenser.
...
### No. 54: Karakterbibel för Johnny & Tucker
...
En prompt för att generera ett delat skärmkarakterark med strikta visuella riktlinjer.
...
### No. 55: Karakterbibel för Neo & Trinity
...
En prompt för att generera ett delat skärmkarakterark för Neo och Trinity med strikta visuella riktlinjer.
...
### No. 56: Karakterbibel för Kevin mot Wet Bandits
...
En prompt för att generera ett premiumkarakterark för Kevin mot Wet Bandits med strikta visuella referenser.
...
### No. 57: Redaktionell modeskott på nattetid på taktrappa
...
En prompt för ett hyperrealistiskt foto av ett redaktionellt modeskott på en taktrappa på natten med en cool filmisk känsla.
...
### No. 58: Karakterbibel för Riggs & Murtaugh
...
En prompt för att generera ett delat skärmkarakterark för två karaktärer med strikta visuella riktlinjer.
...
### No. 59: Premium Cinematisk Karaktärsbibel för Mike & Marcus
...
En prompt för att generera ett splittrat karaktärsreferensblad med strikta visuella riktlinjer.
...
### No. 60: Premium Cinematisk Karaktärsbibel för Lee & Carter
...
En prompt för att skapa ett splittrat karaktärsreferensblad med strikta visuella riktlinjer.
...
### No. 61: Realistisk 1/7-skala figur på skrivbord
...
En prompt för att generera en bild av en realistisk 1/7-skala karaktärsfigur på ett datorskrivbord med transparent bas.
...
### No. 62: Ansiktsidentitetsreferens över komposition
...
En AI-prompt för att generera ett enda foto med sju versioner av samma vuxna man med hjälp av en ansiktsidentitetsreferens.
...
### No. 63: Modeporträtt med ansiktsidentitetsreferens
...
En prompt för att generera ett premium helkroppsmodeporträtt med hjälp av ett foto som ansiktsidentitetsreferens.
...
### No. 64: Drömlikt filmiskt porträtt från referens
...
En prompt för att skapa ett realistiskt, drömlikt filmiskt porträtt samtidigt som personens identitet och naturliga drag bevaras.
...
### No. 65: 3D-leranimationsporträtt från foto
...
En prompt för att generera ett detaljerat, sött 3D-leranimationsporträtt som behåller personens identitet och likhet från ett användaruppladdat foto.
...
### No. 66: Redaktionell konstpaffisch för en plats
...
En prompt för att skapa en högupplöst vertikal redaktionell affisch i en lekfull japansk design-zine-stil.
...
### No. 67: Animerad Scen från Två Referensbilder
...
En prompt för att skapa en animerad scen av ett litet barn som leker i ett mysigt sovrum.
...
### No. 68: 1980-talsporträtt från Ansiktsreferens
...
En prompt för att generera ett porträtt i retro-vintage-stil från 1980-talet, som bevarar personens exakta ansiktsdrag och identitet.
...
### No. 69: Karaktärsdesign-Referensblad
...
En prompt för att generera ett professionellt karaktärsmodellblad baserat på en tillhandahållen referensbild.
...
### No. 70: Stilöverföring till en motorcykelförare
...
Ett nytt motiv återgivet i exakt samma visuella stil som finns i indatabilden.
...
### No. 71: Klädbyte som bevarar identitet
...
Plagg från referensbilder anpassade på subjektet med ansikte, pose och belysning oförändrade.
...
### No. 72: Hund komponerad in i en porträttscen
...
Ett motiv hämtat från en referens och placerat i en annan med matchad belysning och bakgrund.
...
### No. 73: Skiss förvandlad till ett fotorealistiskt dalområde
...
En teckning återgiven fotorealistiskt medan dess layout, proportioner och perspektiv bevaras.
...
### No. 74: Person placerad i en björnattackscen
...
En fotoliknande actionscen byggd kring en given person, avsiktligt icke-filmisk.
...
### No. 75: Konsekvent barnbokskaraktär
...
En vattenfärgsbilderbokshjälte som specificeras tillräckligt noggrant för att förbli densamma över illustrationer.
...
### No. 76: Porträtt på tunnelbanan i New York
...
En prompt för ett spontant livsstilsfoto av en kvinna med mjuka drag och rufsigt mörkt hår på tunnelbanan i New York.
...
### No. 77: Flervy-referensblad för filmkaraktär
...
En prompt för att generera ett karaktärsreferensblad som visar samma verkliga kvinna från framifrån, trefjärdedels, profil och bakifrån.
...
### No. 78: Fotobaserat minimalt akvarellvignettverk
...
En prompt för att omvandla ett uppladdat fotografi till ett raffinerat konstverk som kombinerar fotorealistisk stil med en minimal akvarellvignettstil.
...
### No. 2: Omvandla foton till individuella premiumaffischer
...
En JSON-instruktion för att konvertera varje uppladdad fotograf till en separat, hög kvalitetsaffisch utan att slå ihop dem.
...
### No. 3: Nattkontor med flödesschema på skärm
...
En prompt för att generera ett nattarbetsrum och sedan ersätta endast innehållet på laptopskärmen med ett automatiseringsflödesschema.
...
### No. 4: Tvåsidig Story Manga-omritning
...
En prompt för att rita om en bild till en tvåsidig story manga-stil samtidigt som dialog, berättelse och karaktärsinställningar bevaras.
...
### No. 5: Redigera miljö till målarlik stil
...
En prompt för att redigera en miljöplåt till en lösare, målarlik stil samtidigt som specifika kompositionselement bevaras.
...
### No. 6: Återställ Skadat Vintageporträtt
...
En prompt för att återställa ett allvarligt skadat gammalt porträtt till ett rent, modernt utseende foto med hjälp av en uppladdad bild som referens.
...
### No. 7: Färglägg om Bil till Neon Svart
...
En prompt för att ändra ett objekts färg till neon svart samtidigt som dess ursprungliga form, textur och material bevaras.
...
### No. 8: Vertikal Tvåpanelig Original- och Redigerad Bild
...
En prompt för att skapa en enda vertikal bild med två staplade paneler, där den övre panelen hålls som det ursprungliga referensfotot.
...
### No. 9: Omramningsfotografi till Specifikt Bildförhållande
...
En prompt för att ändra storlek på ett fotografi till ett valt bildförhållande samtidigt som huvudmotivet hålls naturligt positionerat.
...
### No. 10: Porträtt med Hårt Ljus och Skarpa Skuggor
...
En prompt som beskriver ett porträtt belyst av hårt, omildat solljus från ett fönster i en specifik vinkel, vilket skapar skarpa skuggor på ansiktet.
...
### No. 11: Pixel Art Sprite Sheet för karaktär
...
En prompt för att skapa ett förenklat 128px pixel art sprite sheet med stridsrörelser för en karaktär, arrangerat i ett 4x4 rutnät med genomskinlig bakgrund.
...
### No. 12: Förstärk Solen och Molnen till en Lotusblomma
...
En prompt för att förbättra ett foto av moln och sol så att solen liknar en blommas mitt och molnen en lotus, utan att ändra originalet.
...
### No. 13: Infografik översatt till spanska
...
En redigering som endast byter ut textens språk och lämnar varje annan pixel i layouten oförändrad.
...
### No. 14: Produktutklipp på genomskinlig bakgrund
...
En produktbild isolerad på ren alfakanal med skarp silhuett, inga halo-effekter och etikettens läsbarhet intakt.
...
### No. 15: Borttagning av objekt från ett porträtt
...
En enradsredigering som tar bort ett enda objekt och inte ändrar något annat.
...
### No. 16: Affisch omvandlad till en vinterkväll
...
En femordsuppföljningsredigering som ändrar årstid och tid på dygnet på en befintlig mockup.
...
### No. 17: Köksstolar bytta ut mot trästolar
...
En rumsredigering som endast byter ut stolarna och behåller vinkel, belysning och golvskuggor.
...
### No. 6: Realistisk skärmdump från ett nästa generations romantik-RPG
...
En prompt för att generera en realistisk skärmdump från ett fiktivt nästa generations 3D-öppenvärldsromantik-RPG ur protagonistens perspektiv.
...
### No. 7: Premium miniatyrdiorama av ett landmärke
...
En prompt för att generera ett sött, elegant 3D-diorama av en berömd byggnad med mjuka pastelltoner och handgjorda detaljer.
...
### No. 8: Vertikal botanisk papperskonst av en slank kvinna
...
Ett vertikalt botaniskt papperskonstverk som avbildar en slank kvinna i profil med en klänning av löv och ett elfenbensparaply.
...
### No. 9: Fotorealistisk modellbyggsats av en vit och gyllene paladin
...
En prompt för att generera en fotorealistisk bild av en vit och gyllene paladinrobot som en modellbyggsats, uppställd i en elektronikaffär med många enhetliga lådor.
...
### No. 10: Oplanerat resefoto vid historisk mur
...
Ett realistiskt, oplanerat resefoto av en ung kvinna vid en historisk stadsmur på natten med en upplyst traditionell kinesisk byggnad.
...
### No. 11: Vintage-reseaffisch för plats
...
En prompt för att skapa en reseaffisch inspirerad av 1920-1930-talen med en lagerpappersrelief och embosserad illustrationstil i ett dämpat färgschema.
...
### No. 12: Makrofoto av fjärilöga, kattskägg
...
Ett fotorealistiskt makronära av ett kattskägg, fjärils sammansatta ögon och en flickas hud.
...
### No. 13: Lyxklocka på marmormockup
...
En fotorealistisk magasinsannonsmockup av en lyxig titankronograf med tydlig urtavletext.
...
### No. 14: Premium kaffepåse produktmockup
...
En fotorealistisk kommersiell mockup av en mattsvart kaffepåse med bergslinjeart på rustikt trä.
...
### No. 15: Mode-e-handels lookbookaffisch
...
En prompt för att generera en ren mode-lookbookaffisch med en ung kvinnlig modell i höstkläder med mjuka pastellfärger.
...
### No. 16: Miniatyrresscen med landmärke
...
En prompt för att generera en charmig, handgjord miniatyrscen med en liten 3D-modell av ett ikoniskt landmärke.
...
### No. 17: Redaktionellt porträtt av kvinna som blickar ut över stad
...
Ett fotorealistiskt redaktionellt porträtt av en vuxen östasiatisk kvinna som blickar ut över en stad i skymningen.
...
### No. 18: Filmiskt porträtt av kvinna i solbelyst kafé
...
En prompt för ett fotorealistiskt filmiskt porträtt av en vuxen östasiatisk kvinna i ett solbelyst grannskapskafé.
...
### No. 19: Asymmetrisk redaktionell halvansiktsporträtt
...
En prompt för att skapa ett redaktionellt porträtt där subjektet är placerat mot bildens vänstra kant.
...
### No. 20: Premium redaktionell konstaffisch för en plats
...
En prompt för att skapa en högklassig, modern konstboksinspirerad affisch för en angiven plats.
...
### No. 21: Varm nattscen av kvinna som läser hemma
...
En prompt för att generera ett realistiskt 16:9 horisontellt foto av en kvinna i en varm, vanlig lägenhetsmiljö på natten.
...
### No. 22: Deluxeparfait av ogillade livsmedel
...
En prompt för att generera ett deluxeparfait som endast består av vanligtvis ogillade livsmedel, med 30 typer av ingredienser och annoteringar.
...
### No. 23: Showa-erans japanska vintage reseaffisch
...
En prompt för att skapa en premium, vertikal reseaffisch i en japansk järnvägsturismstil från mitten av 1900-talet.
...
### No. 24: Filmiskt porträtt på en tunnelbaneperrong
...
Ett högupplöst porträtt av en ung kvinna med brunt hår som står stilla medan ett tåg susar förbi.
...
### No. 25: Högvinkelporträtt i Qipao
...
Ett högvinkelporträtt av en lång, smärt modell med raffinerad sminkning och ett rävliknande ansikte, klädd i qipao i mjukt, drömlikt ljus.
...
### No. 26: Översvämmad slätt med felmatchad reflektion
...
En prompt för en filmisk filmbild som visar en översvämmad slätt vid skymning med en bondgård och popplar, med en felmatchad reflektion i vattnet.
...
### No. 27: Vocaloid MV-stil 3x3 rutnät
...
En prompt för att skapa ett 3x3 rutnät med olika bilder i en Vocaloid musikvideostil med ett 16:9 bildförhållande.
...
### No. 28: 16-bitars kråka-spritesheet
...
En prompt för att generera en spritesheet i 16-bitars stil av en kråka i flykt, start och landning.
...
### No. 29: Gladiator till häst från låg vinkel
...
En extremt lågvinkelsbild av en gladiator på en stridshäst, sedd från en stenig bergsstig.
...
### No. 30: Närbild på rev med bläckfisk
...
En prompt som instruerar att zooma in på ett rev, observera ljus på sten och inkludera exakt åtta armar.
...
### No. 31: Filmisk anamorfisk stillbild av kvinnor i pion
...
En bred anamorfisk fotografisk bild av fem miniatyrkinesiska kvinnor sittande inuti en stor blekrosa pion.
...
### No. 32: Kvinna bland täta rosa blommande grenar
...
Ett fotografi av en kvinna omgiven av täta rosa blommande grenar som fyller förgrunden och bakgrunden.
...
### No. 33: Robot på strand vid solnedgång
...
En realistisk filmisk scen av en robot som sitter på en strand vid solnedgång och tittar på sand i sin hand.
...
### No. 34: Cyberpunk-fluffig vargöron-utstyrsel
...
En prompt för att generera en cyberpunk-stilad fluffig dräkt med neonrosa och gröna pälsvargöron och ett halsband.
...
### No. 35: Närbildsselfie av ung kvinna
...
En prompt för ett rå iPhone-foto av en ung kvinna med fräknar och vindblåst hår.
...
### No. 36: 1980-tals president välkomnar utomjording på Vita husets gräsmatta
...
En prompt för att generera en bild som skildrar ett 1980-talsinspirerat foto av en president som hälsar på en utomjording på Vita husets gräsmatta.
...
### No. 37: Filmstill från kungligt bankett under Tangdynastin
...
Ett bredformat historiskt filmstill som skildrar en fiktiv, extravagant kunglig nattbankett under Tangdynastin.
...
### No. 38: Realistisk modefoto av östasiatisk kvinna
...
En prompt för ett realistiskt modefoto som visar en vuxen östasiatisk kvinna med långt svart hår, varmt ljus och skugga på hennes ansikte, och naturlig hudtextur.
...
### No. 39: Porträtt av taiwanesisk kvinna med svart dimfilter
...
En prompt för ett porträtt med ett svart dimfilter, överlagringsmask och mjukt CCD-fotografi med subtila höjdpunkter.
...
### No. 40: Röd spindellilja vid flod efter regn
...
En prompt för att generera en realistisk bild av en ensam röd spindellilja med regndroppar, placerad vid en flodstrand efter regn.
...
### No. 41: Regnig gatuscen efter stängning
...
En prompt för en atmosfärisk bild som skildrar en person efter stängningsdags, med fokus på våt ull, hud och gatubelysning.
...
### No. 42: Modeeditorial med vind och siden
...
En prompt för en modeeditorialscen med tre personer som stylas av vinden, med hårt solljus och rikligt med siden.
...
### No. 43: Realistiskt iPhone-foto av Tesla Model Y
...
En prompt för att generera ett realistiskt iPhone-foto av en Tesla Model Y på en parkeringsplats med en 0.5x kamera.
...
### No. 44: Skymningsekostad med måne
...
En prompt som beskriver en skymningsmörk ekoframtidsstad, en månstad med en jättelik jordklot, en serafimskyddsknekt av galaxen och en silverhårig drottning som dansar i en iskristallkatedral.
...
### No. 45: Stor armé med drake i regn
...
En komplex scen med en armé på över 100 personer, karaktären Luna, en vit drake, en japansk skylt, intrikat spjuthantering och regniga reflektioner.
...
### No. 46: Grå nederländsk dvärgkanin som hoppar
...
En prompt för att generera bilder av en kanin som hoppar och en grå nederländsk dvärgkanin som hoppar.
...
### No. 47: Anime-par i park med hög detaljrikedom
...
En bildgenereringsprompt för en ung man och kvinna i vardagskläder i anime-stil i en stor park, renderad i ultra-hög 16K-upplösning med förbättrad kontrast och mättnad.
...
### No. 48: Drömmar om röda gemak – långt rullmålning
...
En prompt för att rekonstruera en scen från 'Drömmar om röda gemak' som en traditionell kinesisk lång rullmålning.
...
### No. 49: Ökenbrutalism Arkitekturserie
...
En prompt för att generera bilder av monolitisk jordarkitektur i ökenbrutalism-stil, med kändis-arkitekt-mashups.
...
### No. 50: Guldimmanspromenadfotografi på gata
...
En prompt för ett fotorealistiskt smartphone-foto av en kvinna som går på en trädplanerad gata under guldimmans.
...
En prompt för att skapa en sofistikerad lyxresepostersamling inspirerad av Santorini, Amalfikusten och Paris.
...
### No. 52: Candidporträtt i stadspark
...
Ett spontant utomhusporträtt av en ung kvinna med långt mörkbrunt hår i en fridfull stadspark en solig eftermiddag.
...
### No. 53: Ökenlönnmördare Karaktärsreferensblad
...
En prompt för att generera ett filmiskt karaktärsreferensblad som visar en dödlig ökenlönnmördare.
...
### No. 54: Östasiatisk kvinnas modefoto i lounge
...
En prompt för ett ultra-fotorealistiskt smartphone-modefoto av en vacker östasiatisk kvinna i en privat lounge på natten.
...
### No. 55: Vintage Resefrimärkskonstverk
...
En prompt för att skapa ett frimärke i vintage-stil som visar ett lands ikoniska landmärke och kulturella element.
...
### No. 56: Vintage Reseposter av ikoniskt byggnadsverk
...
En prompt för att skapa en stiliserad, handmålad vintage-reseposter som visar ett igenkännbart arkitektoniskt landmärke.
...
### No. 57: Candid Modeporträtt i parkeringsgarage
...
Ett ultra-fotorealistiskt porträtt av en vacker eurasisk kvinna i ett modernt underjordiskt parkeringsgarage.
...
### No. 58: Handgjord Miniatyrmatscen
...
En prompt för att generera en förtjusande miniatyrscen som visar en specifik maträtt på en keramiktallrik.
...
### No. 59: Butiksfasad Miniatyrdiorama
...
En prompt för att generera ett fantasifullt 3D-lereminiatyrdiorama av en igenkännbar butik eller varumärke.
...
### No. 60: Ikonisk Struktur Miniatyrdiorama
...
En prompt för att skapa en detaljerad, mysig miniatyrvärld med en central ikonisk byggnad som fokus.
...
### No. 61: Asymmetrisk High-Fashion Studioporträtt
...
En prompt för ett närbildsporträtt av en man mot en vit studiobakgrund med en asymmetrisk komposition.
...
### No. 62: Vindhuggen Vit Labyrintlandskap
...
En beskrivande prompt för att generera ett landskap av en vit labyrint formad av vinderosion över tid.
...
### No. 63: Vit Drakriddare och Liten Sten
...
En scen som skildrar en Vit Drakriddare på natten, hejdad inte av en fiende utan av en enda liten sten, med en filosofisk bildtext.
...
### No. 64: Självsäker mans redaktionella porträtt
...
En prompt för att generera ett premium redaktionellt studioporträtt av en självsäker man med kort svart hår.
...
### No. 65: Helkroppsstudio modeporträtt
...
En prompt för att generera ett helkroppsporträtt av en självsäker manlig modell i en varm, sömlös studiomiljö.
...
### No. 66: Mästerverk för lyxresekampanj
...
En prompt för en sofistikerad lyxlifestyle-resekampanj som kombinerar Alperna, Dubai och europeiska chaletupplevelser.
...
### No. 67: Blå magimästarens morgonrutin
...
En scen som skildrar en Blå magimästares morgon där kammar, hårsnoddar och skosnören avslutar sitt arbete medan han läser rapporter.
...
### No. 68: Fartyg anländer till vit kritkust
...
En beskrivande prompt för en scen där ett fartyg anländer till en strand av vit jord, salt och kalksten, med osedda länder bortom.
...
### No. 69: Havsälvsk fiskare karaktärsporträtt
...
En prompt som beskriver en älv som lever vid havet, en kustfiskare som läser havets tecken.
...
### No. 70: Professionellt studio huvudporträtt
...
En prompt för att generera ett professionellt studio huvudporträtt av en vuxen man.
...
### No. 71: Självsäker man i lyxigt modernt interiör
...
Ett ultrarealistiskt livsstilsporträtt av en självsäker man i en lyxig modern interiör med en mörk trädörröppning och stor spegel.
...
### No. 72: Fantasispejare Somnande vid Skrivbord
...
En poetisk prompt som beskriver en spejares natt, där han minns skrivbordets träådror framför en övernaturlig karta.
...
### No. 73: Drakriddare Vilande i Skuggan
...
En scen som skildrar två drakriddare som tar en paus under en drakes vinge, med en karta och hårt bröd.
...
### No. 74: Stilfull Man i Mysig Kvällsbibliotek
...
Ett ultrarealistiskt porträtt av en man som slappnar av i ett exklusivt biblioteksvrå under tidig kväll.
...
### No. 75: Dullahan-Brevbärare under Höstnatt
...
En nattbrevbärare vandrar längs en höstväg kantad av röda spindelliljor under en natthimmel.
...
### No. 76: Helkroppsredaktionellt Porträtt i Bordeaux
...
Ett ultrarealistiskt redaktionellt porträtt av en självsäker svart man i en ren kostym, sittande i en minimalistisk studiomiljö.
...
### No. 77: Blå Magimästares Eftermiddag
...
En scen som skildrar en Blå Magimästares eftermiddag där magi rensar solljus och kullersten innan de når henne.
...
### No. 78: Solnedgång över Sprucken Jord med Flammor
...
En beskrivande prompt för en scen i ett skymningsvildmark med tunna flammor som stiger ur marksprickor och Kaspiska havet i fjärran.
...
### No. 79: Antikt Segelfartyg vid Gyllene Solnedgång
...
En ultrarealtistisk bild av ett antikt träsegelfartyg i en dramatisk oceanisk solnedgångsscen.
...
### No. 80: Vit Drakriddare Kontrollerar Vingskada
...
En scen där en Mästare av de Vita Drakriddarna noggrant kontrollerar vänster vingskada på en sovande drake i en månbelyst drakstall.
...
### No. 81: Resenär Lagar Blått Resetyg i Vulkanstad
...
En scen där man lagar ett blått resetyg i en vulkanstad under eftermiddagen, med avlägsna berg i bakgrunden.
...
### No. 82: Morgon i en Spegelvärld med en Spjutbärare
...
En prompt som skildrar en spjutbärare som har förlorat sin främsta titel och som börjar sin dag från våta skosnören i morgonen i en spegelvärld.
...
### No. 83: Blå Magimästare Luna före Gryning
...
En scen som skildrar Blå Magimästare Luna före gryningen, med böcker, en stol och te, från en tid då de inte behövde hennes kropp.
...
### No. 84: Landskap där Eld Läcker från Jorden
...
En beskrivande prompt för ett landskap där eld läcker från jorden i ett torrt vildmarksområde, med grå lera som flyter och Kaspiska havet i fjärran.
...
### No. 85: Nattlig Svart Drakriddare Luna
...
En scen som skildrar den Svarta Drakriddaren Luna om natten, när hon kontrollerar sina spjutsvalkor medan El Drago sover bredvid henne.
...
### No. 86: Frieren och Fern på en God Plats
...
En SFW-illustration som skildrar ett samtal mellan karaktärerna Fern och Frieren.
...
### No. 87: Kullar Utskurna av Vind och Regn
...
En poetisk prompt som beskriver ett landskap där grönt bleknar och avslöjar lager av ockra, rost, gråvitt och blekgrönt på av vind och regn utskurna kullar.
...
### No. 88: Antik Dam med Solfjäder framför Bambu
...
En AI-prompt för att generera en östligt estetisk bakgrundsbild som föreställer en klassisk kvinna med en rund solfjäder mot en vit vägg med bambuskuggor.
...
### No. 89: Polisens Räddningsrobotar Bogserar Livbåt
...
En prompt som skildrar ett tungmaskineri-robotteam från Tokyopolisen som räddar evakuerade genom att bogsera en livbåt.
...
### No. 90: Stadsobservatorium Dagtid CCD-foto
...
En prompt för att generera ett ljust dagtid CCD-stil livsstilsfoto med urban utforskning på en astronomisk observationsplattform.
...
### No. 91: Vertikal iPhone Livsstilsporträtt
...
En prompt för att generera ett realistiskt, spontant iPhone-stil porträtt av en ung kvinna.
...
### No. 92: Ny Kinesisk Stil Blomsterfönster Affisch
...
En bildgenereringsprompt för en elegant, minimalistisk orientaliskt affisch som föreställer en klassisk kvinna vid ett jadegrönt blomsterfönster.
...
### No. 93: Fotorealistiskt Redaktionellt Porträtt av Östasiatisk Kvinna
...
En detaljerad prompt för att generera ett fotorealistiskt porträtt i knähöjd och ögonhöjd av en ung östasiatisk kvinna med specifika ansiktsdrag.
...
### No. 94: Polisens Tungmaskineri-enhet Robotar Rensar Flod
...
En prompt som beskriver en robotskvad från polisens tungmaskineri-enhet som rensar skräp som dämmer upp en flod.
...
### No. 95: Fotorealistiskt Redaktionellt Porträtt med Hjärta-oval Ansikte
...
En detaljerad prompt för att generera ett redaktionellt porträtt i knähöjd och ögonhöjd av en ung östasiatisk kvinna med specifika ansiktsdrag.
...
### No. 96: iPhone-porträtt av en Ung Kvinna
...
En prompt för att generera ett realistiskt, avslappnat 9:16 vertikalt foto av en kvinna i åldern 20-26 år, som om det tagits med en iPhones huvudkamera.
...
### No. 97: Zen-kvinna vid Vatten på Sommaren
...
En prompt för att generera en östligt estetisk bakgrundsbild som föreställer en kvinna vid vattnet i en minimalistisk, uppfriskande stil.
...
### No. 98: Cowboy Shot Porträtt av Östasiatisk Kvinna
...
En detaljerad prompt för ett fotorealistiskt redaktionellt porträtt av en ung östasiatisk kvinna med specifika ansiktsdrag.
...
### No. 99: Stadstak Bokcafé Modellfoto
...
En prompt för att generera ett ljust, dagtid CCD-stil livsstilsfoto med en urban, konstnärlig miljö och specifika kläder.
...
### No. 100: Fotorealistiskt Redaktionellt Porträtt av Östasiatisk Kvinna
...
En detaljerad prompt för att generera ett redaktionellt porträtt i knähöjd och midjehöjd av en ung östasiatisk kvinna med specifika ansiktsdrag.
...
### No. 101: Orientalisk Zen Minimalistisk Omslagsposter
...
En prompt för att generera en orientaliskt minimalistisk bakgrundsbild som föreställer en graciös kvinna i antik stil som passerar genom en blå dörröppning med körsbärsblommor.
...
En bild av ett polisrobotteam från Tungmaskinenheten som flyttar fordon från en väg översvämmad av kraftigt regn.
...
En prompt för att generera en ljus dagtid CCD-stil livsstilsbild i en urbans sportmiljö.
...
En prompt för att skapa ett minimalistiskt, ljust och rent 9:16 vertikalt omslag med modern östlig kvinnlig estetik och en morgonstämning.
...
En prompt för att generera en östlig Zen-minimalistisk affisch som föreställer en kvinna som slappnar av vid ett runt fönster.
...
En bild av ett polisrobotskvadron från Tungmaskinenheten som försöker stoppa en bortkommen lastbil.
...
En prompt för ett helkroppsredaktionellt porträtt i ögonhöjd av en ung japansk eller koreansk kvinna som bär örhängen.
...
Ett porträtt i midje- till knähöjd av en ung japansk eller koreansk kvinna som bär djärva, vita tjocka glasögonbågar.
...
En prompt för att generera en bild av en kvinna som rör vid en vindspel vid ett fönster i en minimalistisk östlig Zen-stil.
...
En detaljerad bild av en postapokalyptisk stad i Shenzhen, Kina, som är övervuxen med grön vegetation.
...
En prompt för att generera en fotorealistisk bild av en fiktiv ung japansk kvinna med ett tanuki-liknande ansikte i en lugn nattmiljö.
...
### No. 112: Delfinens Vy av Kvinnor i Glasakvarium
...
En realistisk bild från en delfins perspektiv som tittar genom ett 360-graders glastank på kvinnor som besöker ett livfullt, kvinnobestämt akvarium.
...
En prompt för att skapa en miniatyrlerfigur av en varumärkesbutik med mysiga trottoardetaljer.
...
En modeannonskampanj för ett fiktivt varumärke med sex personer i livliga kläder mot en koboltblå himmel, fotograferad från en låg vinkel.
...
En scen från en sen 1990-tals japansk handtecknad animerad film, med en kvinna med en katana som möter en svärdskämpe under fallande körsbärsblommor.
...
En prompt för en gotisk Halloween-spökbrudskostym med mörk romantisk elegans.
...
En prompt för ett högkontrast, cinematiskt närporträtt av en ung östasiatisk kvinna med blek hy och långt svart hår.
...
En prompt för ett cinematiskt porträtt av en ung östasiatisk kvinna på ett vått övergångsställe på natten.
...
En prompt för ett cinematiskt närporträtt av en ung östasiatisk kvinna med kolsvart hår och glödande guldfärgade ögon.
...
Ett fotorealistiskt porträtt av en ung östasiatisk kvinna med glasögon och vågigt hår, som blinkar mjukt.
...
Ett fotorealistiskt porträtt i analog-filmstil av en ung östasiatisk kvinna med rufsigt svart hår som tittar in i kameran.
...
Ett filmiskt porträtt av en lugn ung kvinna som flyter i stilla vatten med vått hår.
...
Ett fotorealistiskt studiobeautyporträtt av en ung östasiatisk kvinna med strålande hy, långt svart hår och slutna ögon.
...
Ett fotorealistiskt närporträtt av en ung östasiatisk kvinna i en bil, klädd i en ljus beige hijab.
...
En prompt för att generera en bild av en ung kvinna i en ljus hijab som tar en selfie vid ett träbord.
...
En detaljerad prompt för att generera ett fotorealistiskt porträtt av en ung östasiatisk kvinna som tittar över axeln.
...
Ett porträtt av en ung östasiatisk kvinna med glasögon, vågigt hår och ett lugnt uttryck.
...
Ett fotorealistiskt porträtt av en ung östasiatisk kvinna med porslinshy, mandelformade ögon och livfullt läppstift.
...
Ett fotorealistiskt porträtt av en ung kvinna med daggig hy och vått svart hår som tittar över axeln.
...
Ett närporträtt av en ung östasiatisk kvinna med långt mörkt vågigt hår mot en svart bakgrund.
...
Ett fotorealistiskt porträtt av en ung östasiatisk kvinna med långt vågigt hår, runda glasögon och ett mjukt uttryck.
...
En prompt för ett filmiskt närporträtt av en ung östasiatisk kvinna med vågigt ljusbrunt hår och ett lugnt uttryck.
...
Ett fotorealistiskt närporträtt av en ung östasiatisk kvinna med en kort svart page, rökig ögonskugga och glödande hy.
...
Ett närbildsporträtt av en ung kvinna med ljus hy och ett lugnt uttryck, klädd i en vit hijab och en svart baseballkeps.
...
Ett närbildsselfie av en ung östasiatisk kvinna med ljus hy och fina drag, klädd i en dammig beige chiffonghijab.
...
Ett fotorealistiskt närbildsporträtt av en ung kvinna med glänsande, tårstrimmig hy och ljusa lugg.
...
Ett närbildsporträtt av en blekhyad ung kvinna med svart page, ett rött öga synligt och det andra täckt av en juvelprydd svart spetsögonlapp.
...
Ett närbildsfilmiskt porträtt av en ung kvinna med långt svart hår som tittar rakt in i kameran.
...
En detaljerad prompt för att generera ett porträtt av en ung kvinna med ljus hy och långt mörkt hår.
...
Ett närbildsporträtt av en ung östasiatisk kvinna med rufsigt svart hår, som kisar och ler med rodnad, daggig hy.
...
En detaljerad prompt för att generera ett närbildsporträtt av en ung sydöstasiatisk kvinna med specifika ansiktsdrag och smink.
...
En prompt för ett närbildsselfie av en ung östasiatisk kvinna med slutna ögon och ett avslappnat uttryck.
...
En prompt för att generera ett porträtt av en ung östasiatisk eller indonesisk kvinna med ljus hy, mjuk sminkning och ett milt, vänligt uttryck.
...
En prompt för att generera ett fotorealistiskt selfieporträtt av en ung östasiatisk kvinna med specifika drag och styling.
...
En prompt för att generera fyra bilder som visar de visuella faserna när Jorden slukas av ett svart hål, sett från en mänsklig observatörs perspektiv.
...
En prompt som beskriver två karaktärer: en cyberpunk-katana-krigare och ett massivt mekaniskt boss-väsen.
...
En bild av en majestätisk kinesisk himmelsk gudinna i ceremoniell hanfu som stiger ned genom rosa-gyllene moln framför ett himmelskt palats.
...
En bild av en himmelsk mö i elfenbensvit hanfu, belyst av morgonljus med flytande band och gyllene hårnålar.
...
En bild av en lugn kinesisk himmelsk mö i sidenhanfu som vidrör en lotus vid en turkos pöl.
...
En bild av en elegant kinesisk himmelsk gudinna ovanpå vita jadetrappsteg, klädd i broderad hanfu med svävande sidenband.
...
Ett fotorealistiskt filmiskt porträtt av en vuxen östasiatisk kvinna i en mörk forntida kinesisk ritualhelgedom med Nuo-ansiktsmasker och ljus.
...
Ett fotorealistiskt filmiskt porträtt av en östasiatisk kvinna med vått svart hår och rökig sminkning i en mörk forntida helgedom.
...
Ett närbildsporträtt av en vuxen östasiatisk kvinna bredvid en väderbiten Nuo-mask under en nattlig ritualfestival.
...
En prompt för att generera en fotorealistisk bild av ett öl med en tät, kaskadformad skumkrona på ett glas med skarp kant.
...
En beskrivande prompt för en bild av en porös tofukub som lyfts ovanför en kastrull, med en enda bärnstensfärgad buljongdroppe fäst.
...
En bild av en sked med chili-relish med tydliga röda chilikubar, te-mörknade grönsaker, ljusgrön peppar, ljusa bönor och genomskinligt bärnstensrött olja.
...
Ett ultrarealistiskt närbildsporträtt av en ung kvinna med ett lekfullt uttryck i ett mysigt, modernt vardagsrum.
...
En prompt för ett fotorealistiskt vertikalt porträtt av en ung kvinna som vilar på sängkläder i ett svagt upplyst sovrum på natten.
...
En filminspirerad bild av en ung ostasiatisk kvinna som vilar i högt gräs, mjukt belyst av varmt dagsljus.
...
Ett porträtt i filmkornsstil av en ung ostasiatisk kvinna som sitter på huk vid en ljusblå hamn en solig, blåsig dag.
...
En prompt för ett högupplöst, naturligt belyst gatporträtt av en ung asiatiskt utseende kvinna på en Paris-inspirerad shoppinggata.
...
Ett fotorealistiskt, omedvetet porträtt av en vuxen ostasiatisk kvinna som sitter vid ett tågfönster på natten.
...
En bild av en klocka med en cirkulär chockvåg av is och rök bakom sig, med bibehållen ren silhuett.
...
En prompt för att generera en bild av en premiumbageridisplay med varor arrangerade i distinkta höjdnivåer för att skapa djup.
...
Ett fotorealistiskt porträtt av en vuxen ostasiatisk kvinna som bär en elfenbensfärgad satängunderklänning i ett mjukt upplyst sovrum.
...
En bild av en kraftfull bil som genererar ett massivt dammoln bakom sig samtidigt som den förblir ren och tyst i förgrunden.
...
En bild av en häxas silhuett belyst bakifrån av ett massivt orangegult moln av himmelsk eld.
...
En bild av glansig tomatsås som formar ett hjärta ovanför en skål med koshari.
...
En prompt för att generera schackpjäser skulpterade av handgjorda nudelstrån med igenkännbara silhuetter.
...
En bild av en förstorad sesamoljeflaska med gyllene boxararmar som står segrande i en boxningsring.
...
En prompt för att generera en bild av ett kompakt modernt lägenhetskök med frukostdisk, kontinuerlig bänkskiva, rostfritt stål-sink, spisplatta och stekpanna.
...
En prompt för att generera en bild av en shawarmarulle vinklad som en raket, med fokus på den öppna fyllningen som det centrala motivet.
...
En bild av en springande bananmaskot som håller en jättestor kall aluminiumburk framåt mot kameran.
...
En prompt för att generera ett realistiskt oplanerat foto av en östasiatisk kvinna med specifika drag och belysning.
...
En bild av en kaka där vaniljgräddelagret höjer sig och formar en slät miniatyråkeryta, vilket förvandlar skalan till en vintervärld.
...
En bild av ett berg- och dalbanespår konstruerat av perfekt inpassade staplade chips, med en fullständig loop.
...
En bildprompt som beskriver tre rena röda spotlightzoner med sekundära livsstilsmoment bakom en hjältehink.
...
Ett minimalistiskt affischkoncept med ett enda glansigt nudelflöde som det centrala vertikala elementet.
...
En prompt för att skapa en filmisk 2.5D-animation med en målaktig gouache-konststil som visar synliga penseldrag och platta färgblock.
...
Ett cinematiskt porträtt av en man med rufsigt hår som framträder ur skuggorna, med dramatisk belysning och ultrarealistisk textur.
...
Ett ultrarealistiskt cinematiskt resefoto av en stilig ung man som porträtteras som en jätte stående bredvid Frihetsgudinnan.
...
Ett varmt, spontant livsstilsporträtt av en ung man som njuter av te på en rustik veranda under den gyllene timmen.
...
Ett ultrarealistiskt porträtt av en kvinna i cowboyhatt stående i en grön äng med malörter och tallar.
...
En prompt för att generera ett vertikalt spontant fotografi av en ung östasiatisk kvinna med specifika drag.
...
En prompt för att generera en bild av en diagonalt förpackad efterrättslista med en riven förpackning, vilket skapar en öppen-mun-effekt inom en efterrättstematisk värld.
...
Ett skönhetsporträtt av en kvinna reflekterad i en vertikal oval spegel, med matt koboltläppstift.
...
En surrealistisk bild av ett högt ölglas som reser sig ur öknen som en virvelvind av sand och öl.
...
En prompt för en bild med en stor, skarp, delvis beskuren riktig ölflaska i nedre högra förgrunden.
...
### No. 189: Mondrian-målning som Skrivbordsförvaringsskåp
...
En prompt för att omvandla Mondrians 'Komposition med rött, blått och gult' till ett funktionellt skrivbordsförvaringsskåp med färgade lådor.
...
### No. 190: Realistisk Bild av en Surreal Sak
...
En prompt för att generera en högrealistisk bild av ett föreställt surrealistiskt motiv.
...
### No. 191: Små Människor i en Mandarinvärld
...
En bild av minuskla människor som bor inuti en mandarin, där fruktsegment formar arkitektur.
...
### No. 192: Hotfull Figur i Skarp Profil
...
En prompt för att generera en bild av en hotfull figur med korpsvart hår och blodröda läppar i skarp profil.
...
### No. 193: Fiktiv Dejtingapp Annons
...
En prompt för att generera en annons för en dejtingapp som visar unga Kalenjin-modeller.
...
### No. 194: Takradio Porträtt före Soluppgång
...
En prompt för att generera ett porträtt av ett väderbitet ansikte på ett tak med en radio före soluppgång.
...
### No. 195: Tom Fushimi Inari-tunnel vid Gryning
...
En prompt för att generera en lugn, tidig morgonscen av de ikoniska vermiljongportarna vid Kyotos Fushimi Inari-shrine, i stil med en resekampanjbild.
...
### No. 196: Inre värld baserad på AI-konstpreferenser
...
En prompt som begär en illustration som speglar användarens inre värld baserat på deras tidigare preferenser för AI-konst.
...
### No. 197: Makrofoto av futuristisk stadsprocessor
...
En prompt för ett makrofoto av en transparent, rumsstor processor som innehåller en glödande stad.
...
### No. 198: Symboliskt självporträtt av språk och kod
...
En bild som avbildar ett symboliskt självporträtt där språk, kod och kreativitet sammankopplas av ljus.
...
### No. 199: Alienvärld med medelhavsinspirerad retrofuturism
...
En prompt för att generera en bild av en mänsklig bosättning på en främmande värld med medelhavsinspirerad arkitektur och retrofuturistiska element.
...
### No. 200: Porträtt av Cryo-arkonten Tsaritsa Anastasya
...
En prompt för att generera ett porträtt av Tsaritsan, en Cryo-arkont och suverän, beskriven med olika kungliga och sorgsna titlar.
...
### No. 201: Busshållplats i morgondimman
...
En poetisk bild av en busshållplats i morgondimma, där ånga stiger innan någon anländer, och det tidigaste tåget är en tanke inuti.
...
### No. 202: Nattlig tvättomat med maneter och kosmisk väderprognos
...
En scen som avbildar en tvättomat på natten med maneter utanför, där en flicka kollar en kosmisk väderprognos.
...
### No. 203: Wuxia-kvinnlig krigarporträtt
...
En prompt för att generera ett 9:16-porträtt av en lång, elegant östasiatisk kvinnlig krigare i lagerpansar och rockar, som håller i ett långt svärd.
...
### No. 204: Retro telefonbild på kvinna i landsbygd
...
En prompt för en 9:16-bild som skildrar en ung östasiatisk kvinna i en landsbygdsmiljö, fångad med en retro telefonestetik.
...
### No. 205: Två kvinnor i qipao i kinesisk trädgård
...
En prompt för att generera ett hyperrealistiskt foto av två unga östasiatiska kvinnor i nya kinesiska qipaos som sitter i en lugn traditionell trädgård.
...
### No. 206: Selfie av en dansare i grå toner
...
En prompt för en 9:16 vertikal, realistisk närbildsselfie av en ung östasiatisk dansare i en cool, drömlik, högklassig grå livsstilsstil.
...
### No. 207: Redaktionell fotografering av K-pop-konsertscen
...
En prompt för ett filmiskt, redaktionellt foto av en 20-årig K-pop-kvinnlig idol på en konsert.
...
### No. 208: Elegant östasiatisk kvinna vid stenbalkong
...
En prompt för ett 9:16 vertikalt modemodefoto av en vacker vuxen östasiatisk kvinna som lutar sig mot ett klassiskt stenräcke.
...
### No. 209: Måleriskt landskap med dramatiska cumulusmoln
...
En prompt för att generera ett detaljerat, romantiskt konstnärligt landskap med fokus på en ljus himmel och höga moln.
...
### No. 210: Link jagad av dockkycklingar
...
En bild på Link som jagas av en arg flock fluffiga dockkycklingar genom Kakariko Village.
...
### No. 211: Balinesiska risterrasser vid gryningen
...
En bildprompt för en lugn, dimmig morgonscen med Balis risterrasser, i stil med en resekampanj.
...
### No. 212: Prince Of Persia hoppande pixelkonst
...
En prompt för att generera en bild i stilen Cobalt Dither Monumentalism, som visar den ursprungliga Prince of Persia-karaktären hoppande mellan plattformar.
...
### No. 213: Mild Shinigami som vägleder själar
...
En poetisk prompt som beskriver en flicka, en dödens skörderska, som står vid gränsen mellan liv och död i en kall nattdimma och sträcker fram en hand som vägledning för ett stilla farväl.
...
### No. 214: Guldtalismaner i den mörka natten
...
En scen där natten sjunker in i svärtan, där endast guld belyser en talismanisk närvaro, med orden 'Night Walk' och 'Suppress Evil'.
...
### No. 215: Brudens dröm vid gränsen
...
En poetisk prompt som beskriver en icke-mänsklig flicka vid gränsen mellan liv och död som drömmer om att bli brud och ser sin egen spegelbild.
...
### No. 216: Yokai som läser i ett regnigt rum
...
En scen av ett fruktat väsen, Fufu, som läser en bok i ett gammalt rum en regnig dag, med en liten fågel som har vandrat in.
...
### No. 217: Pixel Art Sprite Sheet med rävkaraktär
...
En prompt för att generera ett polerat pixel-art-animationssprite sheet av en karaktär vid namn Noxa, en liten räv som samlar stjärnor.
...
### No. 218: Apple vikbart telefonkoncept infografik
...
En prompt för att generera en fotorealistisk infografik av en Apple vikbar telefon i märkets signaturrena stil.
...
### No. 219: Närbild av en ung östasiatisk kvinna i skönhetsporträtt
...
En fotorealistisk närbildsporträtt av en ung östasiatisk kvinna med mjuk belysning och detaljerad hudtextur.
...
### No. 220: Asiatisk kvinna vid kustväg under solnedgång
...
Ett fotorealistiskt spontant foto av en ung asiatisk kvinna bredvid en kustväg vid solnedgång, sedd från insidan av en bil.
...
### No. 221: Makrofoto från vattennivå av lotusblad som ö
...
En prompt för en filmisk makroskott från vattennivå som visar ett lotusblad som en ö bebodd av tre små figurer i Hanfu.
...
### No. 222: Jättelik treudd med katana-vass egg
...
En prompt för ett gigantiskt tvåhandsvapen med tre uddar vars blad är slipade och polerade som en japansk svärdsegg.
...
### No. 223: Säsongens ambassadör i morgonljus
...
En poetisk prompt som beskriver en ambassadör för en säsong med morgonljus, tidningsomslagshud och glas så tunt att det inte döljer.
...
### No. 224: Geometrisk guld-krona profilporträtt
...
En bildprompt för en imposant figur i skarp profil som bär en krona av geometriska guldskivor över uppsatt mörkt hår.
...
### No. 225: Strålande prinsessa med diamanttiara
...
En AI-bildprompt för en strålande figur som bär en överdimensionerad diamanttiara i skarp profil.
...
### No. 226: Närbildsporträtt av en östasiatisk kvinna i Wuxia-stil
...
Ett hyperrealistiskt porträtt av en ung östasiatisk kvinna i wuxia-stil med extremt vidvinkelperspektiv.
...
### No. 227: Helkroppsporträtt av kvinna i avslappnad hemmiljö
...
En prompt för ett 9:16 vertikalt, helkropps, hyperrealistiskt foto av en ung östasiatisk kvinna i en avslappnad hemstämning med varma filmiska toner.
...
### No. 228: Chibi-karaktärs Sprite Sheet med 16 poser
...
En prompt för att generera ett 4x4 rutnäts sprite sheet av en chibi-karaktär med olika poser.
...
### No. 229: Fotorealistisk Smartphone-selfie i Sovrum
...
Ett fotorealistiskt landskaps-selfie taget med smartphone på en ung östasiatisk kvinna som slappnar av i en säng på natten.
...
### No. 230: 3D-miniatyrlandskap av Ikoniska Landmärken
...
En prompt för att generera en 3D-miniatyrkarta där ett lands gränser utgörs av dess ikoniska landmärken och kulturella symboler.
...
### No. 231: Filmiskt Porträtt av en Kvinna i Paris
...
En prompt för ett ultrarealtistiskt filmfoto på en sydostasiatisk kvinna med hijab som promenerar nära Eiffeltornet.
...
### No. 232: Djur Ombyggda med Lyxmodetyger
...
En prompt för att generera ett 2x2 rutnät av djur rekonstruerade med signaturtyger från fyra ikoniska lyxmodeshus.
...
### No. 233: Premium Smartphone-kampanjaffisch
...
En prompt för att generera en exklusiv affisch för kampanj av en smartphone i Apples signaturstil.
...
### No. 234: Modern Reseaffisch med Arkitektur
...
En prompt för att skapa en exklusiv reseaffisch med vintage screen-print-stil och en komposition med ett arkitektoniskt portal.
...
### No. 235: Stop Motion-leranimation av Charmander som Kläcks
...
En prompt för att skapa en stop motion-animation i lerstil av en Charmander som kläcks ur ett ägg och andas eld.
...
### No. 236: Magrittes Äpple som en Anteckningsstapel
...
En kreativ tolkning av Magrittes 'Människosonen' där det svävande äpplet ersatts av en stapel av äppelformade papperslappar.
...
### No. 237: Hyperrealistiskt Modeporträtt i Japanskt Hus
...
Ett hyperrealistiskt modeporträtt av en kvinna som går i en traditionell japansk träkorridor.
...
### No. 238: Ultraminimalistisk Romarrikets Bakgrundsbild
...
En ultraminimalistisk bakgrundsbild som avbildar ett stort romerskt tempel med kolonner, akvedukter och ruiner i varma gyllene toner.
...
### No. 239: Animebildruta av Regnig Tågplattform
...
En prompt för att generera en icke-existerande animebildruta med regn på en plattform, ett ankommande tåg och en karpfisk som svävar över en stad.
...
### No. 240: Person som Blir Vän med en Katt Mitt i Kaos
...
En scen som visar någon som, efter att ha blivit inblandad i olika saker, slutar med att bli vän med en katt.
...
### No. 241: Rävmanet i Höglandsakvarium
...
En bild av en sömnigögd räv och maneter inuti ett akvarium på ett högland, renderad i en stil utan korniga ljuspartiklar.
...
### No. 242: Kvinna i Kimono som Äter Oxstunga med Kornris
...
En bild av en kvinna i kimono, med en scen som visar en måltid med oxstunga och kornris.
...
### No. 243: Oplanerat Foto av Kvinna i Mysigt Nattlivsrum
...
En prompt för ett fotorealistiskt, oplanerat foto av en ung kvinna i en mysig nattmiljö i ett vardagsrum.
...
### No. 244: Chuunibyou-kvinna i Gothic Lolita
...
En anime-stilbild av en chuunibyou-kvinna med Jirai Make som bär en Gothic Lolita-klädsel med axelfria toppar och en korsettlångklänning.
...
### No. 245: Kvinna som Stannar hos sin Döende Ex-pojkvän
...
En prompt som beskriver en kvinna som får veta att hennes ex-pojkvän lämnade henne för att han är döende och bestämmer sig för att stanna hos honom till slutet.
...
### No. 246: Porträtt av en Kvinna i Uniform
...
En poetisk prompt som beskriver en karaktär vid namn Rhiannah med en geometrisk uniform, ett isblått öga, kvadratiska axlar och röda läppar.
...
### No. 247: Indigofärgningsverkstad i Jiangnan
...
En bildprompt för en scen från en färgningsverkstad i Jiangnan med blå färg, träramar, en stenbro och morgonljus på vattnet.
...
### No. 248: Närbildsporträtt med Flätat Hår
...
Ett 16:9 fotorealistiskt bakgrundsporträtt av en ljushyad ung kvinna med fräknar, blå ögon och flätat vittblont hår.
...
### No. 249: Fotorealistisk spontanporträtt av en sjöman
...
Ett spontant foto i 35mm-stil av en äldre sjöman som justerar sitt nät, med realistisk hud- och materialtextur.
...
### No. 250: Periodautentisk folkscen från 1969
...
En fotorealistisk utomhusfolkmassa i Bethel, New York på ett specifikt datum 1969, uppställd periodautentiskt.
...
### No. 251: Nostalgisk julhälsningskort med teddybjörn
...
Ett tryckkvalitetsjulkort baserat på en minnesskåpsscen med en ordagrann rad korttext.
...
### No. 252: Vintage leksaksflygplan som samlarobjekt i blisterförpackning
...
Ett detaljhandelsinspirerat samlarobjekt fotograferat i blisterförpackning med en ordagrann förpackningstext.
...
### No. 253: Molnpostkontor i en läkande bilderboksstil
...
En fantasifull scen där ett mjukt moln är förvandlat till ett postkontor där små djur i uniform sorterar brev, återgiven i en mjuk, läkande bilderboksstil.
...
### No. 254: Hyperrealistiskt cinematiskt porträtt på motorcykel
...
Ett hyperrealistiskt cinematiskt porträtt av en stilig skäggig man på en specialbyggd motorcykel.
...
### No. 255: Svartvit redaktionell högmodesporträtt
...
En prompt för att skapa ett svartvitt högmodesporträtt av en ung man med lockigt hår och lager på lager av kläder.
...
### No. 6: Art Deco-affisch i guld och marinblått
...
En Art Deco-affischillustration i kvadratiskt format med elegant guld och marinblå linjearbete på papper i cremefärg.
...
### No. 7: Hyperrealistisk Emaljknappskollektion
...
En prompt för att skapa en kollektion av åtta premiumemaljknappar med guldkanter och glansiga ytor på en mörk bakgrund.
...
### No. 8: Mörkt SaaS-analysinstrumentpanel UI
...
En prompt för att generera ett mörkt SaaS-analysinstrumentpanel med specifika etiketter och UI-element.
...
### No. 9: Skärmdump för kreativt designföretags webbplats
...
En prompt för att generera en fullständig, frontvänd, perspektivfri skärmdump av en datorwebbsida för ett kreativt designföretags kinesiska webbplats.
...
### No. 10: Forntida kinesisk modefotografisk rutnät
...
En prompt för att generera en professionell, högklassig serie forntida kinesisk modefotografi som skildrar hela påklädningsprocessen för Song Yu i ett Song-dynastins sängkammare, arrangerad i ett strikt 3x3-rutnät.
...
### No. 11: Analog klocka, hamburgare och dryck
...
En prompt för att generera en bild av en analog klocka som visar 15:32, en hamburgare med grillad gyllene provoloneost och ett glas.
...
### No. 12: Kvadratisk blåvit layout med telefon och kort
...
En kvadratisk SNS-bild med blå och vita färger, som visar en smartphone, tre bildkort, en japansk titel, breda marginaler och ingen ytterligare text.
...
### No. 13: Fysiklärobokskapitel om elektromagnetism
...
En prompt för att generera ett kapitel om elektromagnetism till en fysikbok på spanska.
...
### No. 14: Ensidig manga om rymdutveckling
...
En prompt för att generera en ensidig, vertikal, svartvit serie om rymdutveckling.
...
### No. 15: Isometrisk glaskub med färgade sfärer
...
En isometrisk vy av en genomskinlig glaskub som innehåller en röd boll längst upp till vänster bak och en blå boll längst ner till höger fram, med en grön boll ovanför kuben och en gul pelare som passerar igenom från nedre vänster till övre höger.
...
### No. 16: Typografisk affisch och tidningsomslag
...
En prompt för att generera en typografisk affisch med en modellista och ett tidningsomslag med logotyp och omslagstexter.
...
En prompt för en vertikal lyxannons som visar en stor klocka i en mörk smaragdgrön studio.
...
### No. 18: Karaktärsdesignreferensblad
...
En prompt för att generera ett målarlikt karaktärsdesignreferensblad med konstruktionslinjer och en specifik layout.
...
### No. 19: Delad skärm för karaktärsbokark
...
En prompt för att generera ett premium delat skärmark för två originella karaktärer.
...
### No. 20: Företagsporträttkollagekomposition
...
Ett ultrarealistiskt företagsporträttkollage med en trelagerkomposition av en man.
...
### No. 21: Foto- och Illustrationsdelad Komposition
...
En prompt för att skapa en vertikal bild som kombinerar ett originalfoto med en handtecknad illustration av samma scen.
...
### No. 22: Uppdelad Karaktärsbibelsida
...
En prompt för att skapa en uppdelad karaktärssida med en kraftfull central avdelare och en neonakvarellbakgrund.
...
En prompt för att generera en tvåsidig färgmanga där äventyrare diskuterar en dungeon-utmaning i en taverna, med dialog och ljudeffekter.
...
### No. 24: Espressomaskin Teknisk Ritning
...
Ett tekniskt diagram över en hushållsespressomaskin i 1960-talets mekaniska ritstil.
...
### No. 25: Modern SaaS-instrumentpanel för AI-plattform
...
En prompt för att generera ett högupplöst 4K-gränssnitt för en modern SaaS-instrumentpanel till en AI-analysplattform med en elegant mörkt tema-estetik.
...
### No. 26: Mörk Fantasy RPG-inventarie Användargränssnitt
...
En prompt för att generera ett högupplöst inventariegränssnitt i mörk fantasy-stil för ett RPG, med en bepansrad paladin.
...
### No. 27: Sushi-affisch med Försänkt Logotyp
...
En prompt för en affisch med en stor, försänkt mörkröd logotyp i bakgrunden som inte överlappar med en sushi-silhuett.
...
### No. 28: Produktförpackning i Tre Zoner
...
En prompt för att visualisera en produktkartong i tre faser: som en isolerad huvudbild, i ingredienskontext och bredvid den färdiga rätten.
...
### No. 29: Produktbild med Ingredienser i Periferin
...
En prompt för en bild med en central produktpåse omgiven av skålar, bär, spannmål och löv, med en tydlig vertikal korridor.
...
### No. 30: Rutnät med Identiska Kaffemenyaffischer
...
En prompt för att designa en samlarvärd kaffemenyaffisch med konsekventa svarta fält, koppskala, titelzon, mikrotext och mässingsklämmor.
...
### No. 31: 3D-Reklamtavla med Produkt som Bryter Planet
...
En prompt för en 3D-reklamtavlevisual där en huvudburk skjuter ut bortom det inre planet med kontaktskuggor.
...
### No. 32: Tre-Kon Uppställning med Central Hjälte
...
En prompt för en komposition med tre smakkoner där den centrala pistagekonen är dominant och sidokonerna är vinklade inramningselement.
...
### No. 33: Staplade Paneler med Konsekvent Layout
...
En prompt för att generera fem staplade paneler med en konsekvent varumärkeslayout inklusive logotyp, rubrikkolumn, märke och produktkomposition.
...
### No. 34: Horisontella Smakakter med Rättnamn
...
En prompt för en affisch som visar fyra horisontella akter, var och en med en svart skål med ånga och ett överdimensionerat penselskript med rättens namn.
...
### No. 35: Socialt Inläggsgränssnitt som Skär Genom Sås
...
En prompt för en bild som visar ett minimalistiskt svart band för sociala inlägg som skär horisontellt genom ett flöde av sås.
...
### No. 36: Vertikal Delad Kompositionsaffisch
...
En prompt för en affisch med en vertikal delning som visar en ren, naturlig sida kontra en mörk sida med dolda ingredienser.
...
### No. 37: Chokladvätskebågar som Inramar Produkten
...
En prompt för en premium produktaffisch med två behärskade mörka chokladvätskebågar som inramar produkten i en symmetrisk omloppsrörelse.
...
### No. 38: Två Hjältelistor som Korsar Diagonalt
...
En prompt som beskriver två förpackade produktlister som korsar diagonalt genom mitten i motsatta riktningar.
...
### No. 39: Tre Skålar Arrangerade Diagonalt
...
En prompt för en bild av tre skålar arrangerade diagonalt från förgrunden till bakgrunden.
...
### No. 40: Instagram-resekampanj med Smartphone som Visuellt Ankare
...
En prompt för att skapa en premium Instagram-reseannons med en modern smartphone som visuellt ankare.
...
### No. 41: Vertikal Social Poster för Samlarfigur
...
En prompt för en högupplöst vertikal social media-post som annonserar en premium samlarfigur med fet typografi och en platt gul bakgrund.
...
### No. 42: Hierarkisk Bokomslagsdesign
...
En prompt för att designa ett bokomslag med stark typografisk hierarki och läsbarhet.
...
### No. 43: Neurovetenskaplig Konferensaffisch
...
En prompt för att generera en konferensaffisch för ett neurovetenskapligt möte 2026, baserad på tillhandahållen artikel och regler.
...
### No. 44: Svävande dioramanät av ikoniska städer
...
En prompt för att generera ett 2x2 rutnät av svävande stadssilhuetter hängande i en grå studio.
...
### No. 45: Satirisk systemaffischrutnät om frustrerande ämnen
...
En prompt för ett 2x2 rutnät av satiriska redaktionella affischer om frustrerande ämnen.
...
### No. 46: Pappersdiorama-reseaffischmall
...
En prompt för att skapa en premium vertikal reseaffisch som avbildar ett stadslandmärke som ett detaljerat handgjort pappersdiorama.
...
### No. 47: Filmisk karaktärssida för Calvin & Bob
...
En prompt för att skapa en delad karaktärssida med en akvarellbakgrund.
...
### No. 48: Filmisk karakterbibel för Sofia
...
En prompt för att generera ett premiumkarakterark med fet typografi och en dramatisk huvudbild av en barista vid namn Sofia.
...
### No. 49: Dramatiska litterära propagandaväggbeklädnader
...
En prompt för att generera ett 2x2 rutnät med dramatiska propagandastil-väggbeklädnader för fyra verk i public domain.
...
### No. 50: Konceptuella genomskärningsdioraman för fyra varumärken
...
En prompt för att generera ett 2x2 rutnät med konceptuella genomskärningsdioraman för fyra Fortune 500-företag.
...
### No. 51: Barnskoreklampaffisch med flicka och jättestor sneaker
...
En prompt för att generera en glädjefylld reklampaffisch som visar en flicka och en jättestor sneaker.
...
### No. 52: Storyboard för Lyxparfymreklam
...
En prompt för ett filmiskt produktstoryboard med en lyxig ros-parfym i ett rent redaktionellt layout.
...
### No. 53: Storyboard för Lyxparfymreklam
...
En prompt för ett filmiskt produktreklam-storyboard med en lyxig ros-parfym.
...
### No. 54: Teknisk Exploded View Rutnät
...
En prompt för att generera ett 2x2 rutnät med tekniska illustrationer som visar exploderade 3D-vyer av komplexa maskiner.
...
### No. 55: Fullsidig Färgserieillustration
...
En prompt för att generera en helsida med en färgrik och humoristisk shonen-mangaillustration med autentisk serietidningskomposition.
...
### No. 56: Teknisk infografik över en kaffemaskin
...
En förklarande infografik som spårar flödet i en automatisk espressomaskin från början till slut.
...
### No. 57: Streetwear-kampanjannons med exakt slogan
...
En ungdomlig streetwear-kampanjbild som återger en exakt slogan, tydligt läsbar, inom layouten.
...
### No. 58: Minimalistisk bagerilogga på genomskinlig bakgrund
...
En platt, vektorliknande bagerilogga levererad centrerad på ren alfakanal utan bakgrund.
...
### No. 59: Fyrrutig serie om ett husdjur hemma ensamt
...
Ett vertikalt fyrrutans serie som bär på en början, vändning och poäng över rutorna.
...
### No. 60: Farmers Market-appgränssnitt i en iPhone-ram
...
En praktisk mockup av en mobilapp med rubrik, leverantörslista och erbjudanden, placerad i en enhetsram.
...
### No. 61: Diagram över cellulär andning för klassrummet
...
Ett märkt biologidiagram för gymnasiet som kopplar ihop glykolys, Krebs cykel och elektrontransportkedjan.
...
### No. 62: Series A-marknadsmöjlighetsbild
...
En pitchdeck-bild med ett TAM/SAM/SOM-diagram, tillväxtstaplar, fotnoter och en riktig datahierarki.
...
### No. 63: Affischmockup med exakt rubrik
...
En motorvägsaffischmockup som bär en ordagrann rubrik i fet sans-serif.
...
### No. 64: Mangapanel med pratbubblor
...
En mangainspirerad bild av en flicka som säger "Hallå, lyssna!" och en pojke som täcker hennes pratbubbla med sin tankebubbla där det står "Jag låtsas som om jag inte hörde det", ritad i vertikalt 4:5-format.
...
### No. 65: Mangapanel där flickan biter i pratbubbla
...
En mangainspirerad scen där en pojke säger "Ska vi inte slåss?" och en ilsket utseende flicka biter i hans pratbubbla.
...
### No. 66: Redaktionell rutnätsbild över modeårtionden
...
En prompt för att generera ett 2x2-rutnät som visualiserar fyra modeinriktningar från olika årtionden i en redaktionell affischstil med 16:9-format.
...
### No. 67: Rutnätsbild över statsskick
...
En prompt för att generera en 2x2-rutnätsbild som visualiserar fyra olika statsskick i en pastellfärgad sagoboksstil.
...
### No. 68: Hjältemodig arvsposter för schackspelare
...
En prompt för att generera ett 2x2-rutnät med hjältemodigt illustrerade hyllningsposters för fyra avlidna schacklegender.
...
- [Atlas Cloud GPT Image 2.5 Flare text-to-image](https://www.atlascloud.ai/sv/models/openai/gpt-image-2.5-flare/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Flare edit](https://www.atlascloud.ai/sv/models/openai/gpt-image-2.5-flare/edit?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Sunburst text-to-image](https://www.atlascloud.ai/sv/models/openai/gpt-image-2.5-sunburst/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
