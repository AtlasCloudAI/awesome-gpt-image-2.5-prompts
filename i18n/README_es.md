...
### No. 3: Retrato de una Mujer Española Menuda Junto a una Piscina
...
Un retrato de belleza vertical pulido de una mujer española menuda sentada junto a una piscina interior de color verde menta.
...
### No. 4: Dos Mujeres en un Arco de Piedra
...
Un prompt para una imagen de dos mujeres enmarcadas por un arco de piedra blanqueado por el sol.
...
### No. 5: Retrato de Hoja de Personaje Multipanel
...
Un prompt para generar una hoja de personaje con cuatro fotografías de estudio de la misma mujer desde diferentes ángulos.
...
### No. 6: Nueve Pegatinas de Emoji con Texto
...
Una indicación para generar una cuadrícula de 3x3 con diferentes pegatinas de emoji basadas en un personaje de referencia, que presenta texto en chino e inglés sobre un fondo con degradado claro.
...
### No. 7: Hoja de Sprites con Cuatro Movimientos de Personaje en Arte de Puntos
...
Una indicación para generar una hoja de sprites con cuatro tipos de animaciones de personajes en arte de puntos, cada una de hasta 4 cuadros, manteniendo un diseño consistente.
...
### No. 8: Obra de Arte Inspirada en un Boceto
...
Una indicación para crear una obra de arte original basada en un boceto, preservando su sujeto principal, emoción y gesto mientras se reinventan los detalles.
...
### No. 9: Foto de Estilo de Vida Matutino de una Mujer
...
Un retrato fotorrealista de estilo de vida matutino de una joven con cabello rojo caoba.
...
### No. 10: Mujer Recostada en Oficina en Casa
...
Una indicación para generar una foto fotorrealista tomada con smartphone de una joven relajándose en un sofá en una oficina en casa moderna.
...
### No. 11: Retrato con iPhone de una Joven
...
Una indicación para generar un retrato realista con iPhone de una joven en interiores con un fondo reflectante.
...
### No. 12: Hoja de Sprites de Arte Pixel para Personaje
...
Un prompt para generar una hoja de sprites de arte pixel simplificada de 128px con fondo transparente y un diseño de 4x4 para las acciones de batalla de un personaje.
...
### No. 13: Campamento Diurno a Partir de un Boceto
...
Una serie de prompts para transformar el dibujo de un niño en un campamento nocturno con ambiente, luego en una versión diurna, y finalmente cambiar la ropa del personaje por un overol.
...
### No. 14: Arte Minimalista de un País con Línea Continua
...
Una indicación para crear una impresión artística vertical minimalista de un país utilizando una sola línea continua.
...
### No. 15: Transformación de Retrato Histórico de 1985
...
Una indicación para reimaginar la apariencia de una persona en la década de 1980, preservando su identidad central y características.
...
### No. 16: Maqueta 3D de Camisetas Sobredimensionadas para Marca
...
Una indicación para generar una maqueta 3D de dos camisetas sobredimensionadas flotantes que muestran vistas frontal y trasera.
...
### No. 17: Collage Editorial de Ropa de Hombre de Lujo
...
Una indicación para crear un collage editorial de ropa de hombre de lujo utilizando una foto cargada como referencia facial.
...
### No. 18: Referencia de Identidad Facial y Composición
...
Una indicación que instruye el uso de una imagen cargada para preservar las características faciales y la apariencia natural de un sujeto.
...
### No. 19: Retrato de Estudio Profesional Realista
...
Una indicación para crear un retrato de estudio profesional utilizando una foto cargada para la identidad facial y la composición.
...
### No. 20: Collage Editorial de Moda con Modelo Consistente
...
Una indicación para crear un collage de moda con un modelo masculino consistente utilizando una referencia de identidad facial.
...
### No. 21: Retrato de Astronauta en Cabina de Mando Futurista
...
Una indicación para generar un retrato fotorrealista de una astronauta femenina segura en la cabina de mando de una nave espacial futurista.
...
### No. 22: Retrato de Moda de Estudio Ultrarealista
...
Un prompt para crear un retrato de moda de estudio de cuerpo completo y ultrarealista utilizando una imagen cargada como referencia facial.
...
### No. 23: Retrato de Estilo de Vida Cinematográfico con Motocicleta
...
Un retrato ultrarealista de un hombre sentado al aire libre junto a una motocicleta deportiva premium.
...
### No. 24: Retrato Editorial Ultrarealista
...
Un prompt de IA para crear un retrato editorial ultrarealista de un hombre utilizando una referencia de identidad facial.
...
### No. 25: Retrato de Moda Premium a Partir de Referencia
...
Un prompt para crear un retrato de moda premium de un hombre adulto con estilo utilizando una referencia de identidad facial.
...
### No. 26: Retrato de Estilo de Vida Espontáneo a Partir de Referencia
...
Un prompt para generar un retrato de estilo de vida espontáneo de alta calidad y ultra fotorrealista de una mujer basado en una imagen de referencia.
...
### No. 27: Retrato de Moda Invernal a Partir de Foto
...
Un prompt de IA para crear un retrato de moda invernal realista al aire libre utilizando una foto del sujeto como referencia facial.
...
### No. 28: Retrato de Estudio de Lujo Ultra Realista
...
Un prompt de IA para generar un retrato de estudio de lujo ultra realista de un hombre adulto con estilo.
...
### No. 29: Collage de Retrato Cinematográfico con Lluvia
...
Un prompt para crear un collage de retrato cinematográfico con lluvia utilizando una imagen cargada como referencia para la composición y la atmósfera.
...
### No. 30: Preservación de Identidad en Selfie de Smartphone
...
Un prompt para generar un selfie de smartphone vertical ultra realista en formato 3:4 que preserve fielmente los rasgos faciales y la apariencia de una mujer específica.
...
### No. 31: Identidad en Retrato de Moda Cinematográfico
...
Un prompt para generar un retrato de moda en primer plano que preserve la identidad y apariencia del sujeto.
...
### No. 32: Retrato de Estudio Formal en Primer Plano
...
Un prompt para crear un retrato de estudio en primer plano de un hombre joven con atuendo formal utilizando una referencia facial.
...
### No. 33: Foto Cinematográfica de Estilo de Vida con Preservación de Identidad
...
Una indicación para crear una imagen cinematográfica fotorrealista de una mujer asiática oriental específica, preservando su identidad y rasgos.
...
### No. 34: Editorial de Moda Cinematográfica con Referencia de Identidad
...
Una indicación para generar una fotografía de moda cinematográfica de una mujer en un entorno oscuro, preservando su identidad a partir de una imagen de referencia.
...
### No. 35: Retrato Editorial Ultra Realista a partir de Referencia
...
Una indicación para generar imágenes y crear un retrato editorial ultra realista de un hombre adulto, usando una imagen cargada como referencia de identidad facial.
...
### No. 36: Batalla de Dragón con Portador de Hacha Traicionero
...
Un prompt para generar una imagen de una batalla de dragón con un portador de hacha traicionero, utilizando ChatGPT Astra.
...
### No. 37: Ángulo Fotorrealista de Robot Gigante Heroico
...
Un prompt para crear una imagen que muestre un robot gigante heroico desde un ángulo dinámico y fotorrealista.
...
### No. 38: Estilo Anime a partir de un Tema Subido
...
Un prompt para crear una imagen de estilo anime con trazos seguros, sombreado cel minimalista y colores brillantes y saturados.
...
### No. 39: Toma Frontal Plana de Producto con Etiqueta Clara
...
Un prompt para generar dos imágenes de producto con etiquetas claras y legibles en un estilo frontal y plano.
...
### No. 40: Escena Fantástica con Águila y Referencia
...
Una indicación para una escena fantástica cinematográfica que presenta a una mujer centrada ante un águila calva gigantesca y majestuosa con las alas desplegadas.
...
### No. 41: Anuncio de Alta Costura con Identidad del Modelo
...
Una indicación para crear una imagen publicitaria de alta costura premium e hiperrealista que preserve la identidad facial específica de un modelo.
...
### No. 61: Figura Realista a Escala 1/7 en Escritorio
...
Un prompt para generar una imagen de una figura de personaje realista a escala 1/7 en un escritorio de computadora con una base transparente.
...
### No. 62: Referencia de Identidad Facial a través de la Composición
...
Un prompt de IA para generar una sola foto con siete versiones del mismo hombre adulto usando una referencia de identidad facial.
...
### No. 63: Retrato de Moda Usando Referencia de Identidad Facial
...
Un prompt para generar un retrato de moda premium de cuerpo completo usando una foto como referencia de identidad facial.
...
### No. 64: Retrato Cinematográfico Onírico a Partir de Referencia
...
Una indicación para crear un retrato cinematográfico realista y onírico que preserve la identidad y las características naturales del sujeto.
...
### No. 65: Retrato en Claymation 3D a Partir de Foto
...
Una indicación para generar un retrato detallado y adorable en claymation 3D que conserve la identidad y el parecido del sujeto a partir de una foto subida por el usuario.
...
### No. 66: Cartel de Arte Editorial para una Ubicación
...
Una indicación para crear un póster editorial vertical de alta resolución en un estilo juguetón de revista de diseño japonesa.
...
### No. 67: Escena Animada a partir de Dos Imágenes de Referencia
...
Un prompt para crear una escena animada de un niño pequeño jugando en un dormitorio acogedor.
...
### No. 68: Retrato de los Años 80 a partir de una Referencia Facial
...
Un prompt para generar un retrato con un estilo retro-vintage de los años 80, preservando los rasgos faciales exactos y la identidad del sujeto.
...
### No. 69: Hoja de Referencia de Diseño de Personaje
...
Un prompt para generar una hoja de modelo de personaje profesional basada en una imagen de referencia proporcionada.
...
### No. 70: Transferencia de Estilo a un Motociclista
...
Un nuevo sujeto renderizado en el estilo visual exacto de la imagen de entrada.
...
### No. 71: Intercambio de Atuendo Preservando la Identidad
...
Prendas de imágenes de referencia adaptadas al sujeto, manteniendo intactos el rostro, la pose y la iluminación.
...
### No. 72: Perro Compuesto en una Escena de Retrato
...
Un sujeto tomado de una referencia y colocado en otra con la luz y el fondo emparejados.
...
### No. 73: Boceto Convertido en un Valle Fotorrealista
...
Un dibujo renderizado fotorrealísticamente mientras se preservan su composición, proporciones y perspectiva.
...
### No. 74: Persona Insertada en una Escena de Ataque de Oso
...
Una escena de acción similar a una fotografía, construida alrededor de una persona proporcionada, deliberadamente no cinematográfica.
...
### No. 75: Personaje Consistente de Libro Infantil
...
Un héroe de libro ilustrado en acuarela especificado con suficiente precisión para mantenerse igual en todas las ilustraciones.
...
### No. 76: Retrato Espontáneo del Metro de Nueva York
...
Una indicación para una foto de estilo de vida espontánea de una mujer con rasgos suaves y cabello oscuro desordenado en el metro de Nueva York.
...
### No. 77: Hoja de Referencia de Personaje Cinematográfico Multipanel
...
Una indicación para generar una hoja de referencia de personaje que muestre a la misma mujer real desde vistas frontal, de 3/4, de perfil y trasera.
...
### No. 78: Obra de Arte Minimalista de Viñeta en Acuarela Basada en Foto
...
Una indicación para transformar una fotografía subida en una obra de arte refinada que combine realismo fotográfico con un estilo minimalista de viñeta en acuarela.
...
### No. 2: Transformar Fotos en Pósters Premium Individuales
...
Una instrucción en JSON para convertir cada fotografía subida en un póster separado y de alta calidad, sin fusionarlas.
...
### No. 3: Oficina Nocturna con Pantalla de Diagrama de Flujo
...
Un prompt para generar una habitación de estudio nocturna y luego reemplazar solo el contenido de la pantalla del portátil con un diagrama de flujo de automatización.
...
### No. 4: Redibujo de Manga de Historia de Dos Páginas
...
Un prompt para redibujar una imagen en el estilo de un manga de historia de dos páginas, preservando el diálogo, la trama y la configuración de los personajes.
...
### No. 5: Editar Entorno a Estilo Pictórico
...
Un prompt para editar una placa de entorno a un estilo pictórico más suelto, preservando elementos compositivos específicos.
...
### No. 6: Restaurar Retrato Vintage Dañado
...
Una indicación para restaurar un retrato antiguo severamente dañado en una foto limpia y de aspecto moderno utilizando una imagen cargada como referencia.
...
### No. 7: Recolorear Coche a Negro Neón
...
Un prompt para cambiar el color de un objeto a negro neón mientras se preserva su forma, textura y material originales.
...
### No. 8: Imagen Vertical de Dos Paneles Original y Editada
...
Una indicación para crear una sola imagen vertical con dos paneles apilados, manteniendo el panel superior como la fotografía de referencia original.
...
### No. 9: Reencuadrar Fotografía a Relación de Aspecto Especificada
...
Una indicación para redimensionar una fotografía a una relación de aspecto elegida manteniendo al sujeto principal posicionado de forma natural.
...
### No. 10: Retrato con Luz Dura y Sombras Marcadas
...
Un prompt que describe un retrato iluminado por luz solar dura y sin suavizar, proveniente de una ventana en un ángulo específico, creando sombras marcadas en el rostro.
...
### No. 11: Hoja de Sprites en Pixel Art para Personaje
...
Una indicación para crear una hoja de sprites simplificada de 128 píxeles para los movimientos de batalla de un personaje en pixel art, organizada en una cuadrícula de 4x4 con fondo transparente.
...
### No. 12: Mejorar el Sol y las Nubes para que Parezcan una Flor de Loto
...
Un prompt para mejorar una foto de nubes y sol, haciendo que el sol se asemeje al centro de una flor y las nubes a un loto, sin alterar la imagen original.
...
### No. 13: Infografía Traducida al Español
...
Una edición que cambia solo el idioma del texto y deja intacto cada píxel del diseño.
...
### No. 14: Recorte de Producto sobre Fondo Transparente
...
Una foto de producto aislada sobre un canal alfa limpio, con silueta nítida, sin halos y manteniendo la legibilidad de la etiqueta.
...
### No. 15: Eliminación de Objeto en un Retrato
...
Una edición de una línea que elimina un solo objeto y no cambia nada más.
...
### No. 16: Valla Publicitaria Reavivada como una Noche de Invierno
...
Una edición de seguimiento de cinco palabras que cambia la estación y la hora del día en una maqueta existente.
...
### No. 17: Sillas de Cocina Cambiadas por Madera
...
Una edición de habitación que reemplaza solo las sillas y mantiene el ángulo, la iluminación y las sombras del suelo.
...
### No. 6: Captura de Pantalla Realista de un RPG de Romance de Próxima Generación
...
Un prompt para generar una captura de pantalla realista de un ficticio RPG de romance de mundo abierto en 3D de próxima generación, desde la perspectiva del protagonista.
...
### No. 7: Diorama en Miniatura Premium de un Hito Arquitectónico
...
Un prompt para generar un diorama en 3D adorable y elegante de una estructura famosa, con tonos pastel suaves y detalles artesanales.
...
### No. 8: Arte Botánico en Papel Vertical de una Mujer Esbelta
...
Una obra de arte botánico en papel en formato vertical que representa a una mujer esbelta de perfil, con un vestido de hojas y una sombrilla de marfil.
...
### No. 9: Kit de Modelo Fotorrealista de un Paladín Blanco y Dorado
...
Un prompt para generar una imagen fotorrealista de un robot paladín blanco y dorado como un kit de modelo, exhibido en una tienda de electrónica con muchas cajas uniformes.
...
### No. 10: Foto de Viaje Espontánea en Muro Histórico
...
Una foto de viaje espontánea y realista de una mujer joven junto a un muro histórico de la ciudad por la noche, con un edificio tradicional chino iluminado.
...
### No. 11: Póster de Viaje Vintage para una Ubicación
...
Un prompt para crear un póster de viaje inspirado en los años 1920-1930, con un estilo de ilustración en relieve de papel estratificado y grabado, en una paleta de colores apagados.
...
### No. 12: Foto Macro de Ojo de Mariposa, Bigote de Gato
...
Un acercamiento macro fotorrealista del bigote de un gato, los ojos compuestos de una mariposa y la piel de una niña.
...
### No. 13: Reloj de Lujo en Maqueta de Mármol
...
Una maqueta fotorrealista de anuncio de revista para un cronógrafo de lujo de titanio, con texto claro en la esfera.
...
### No. 14: Maqueta de Producto de Bolsa de Café Premium
...
Una maqueta comercial fotorrealista de una bolsa de café negra mate con arte lineal de montañas sobre madera rústica.
...
### No. 15: Póster de Catálogo de Moda para Comercio Electrónico
...
Un prompt para generar un póster de catálogo de moda limpio, con una modelo femenina joven con atuendo otoñal, utilizando colores pastel suaves.
...
### No. 16: Escena de Viaje en Miniatura con Punto de Referencia
...
Un prompt para generar una escena en miniatura encantadora y hecha a mano, que presenta un pequeño modelo 3D de un punto de referencia icónico.
...
### No. 17: Retrato Editorial de Mujer con Vista a la Ciudad
...
Un retrato editorial fotorrealista de una mujer adulta de Asia Oriental con vista a una ciudad al anochecer.
...
### No. 18: Retrato Cinematográfico de Mujer en Cafetería Bañada por el Sol
...
Un prompt para un retrato cinematográfico fotorrealista de una mujer adulta de Asia Oriental en una cafetería de barrio bañada por la luz del sol.
...
### No. 19: Retrato Editorial Asimétrico de Medio Rostro
...
Una indicación para crear un retrato de estilo editorial con el sujeto posicionado contra el borde izquierdo del encuadre.
...
### No. 20: Póster Artístico Editorial Premium para una Ubicación
...
Una indicación para crear un póster de alta calidad, de estilo moderno como de libro de arte, para una ubicación específica.
...
### No. 21: Escena Nocturna Acogedora de una Mujer Leyendo en Casa
...
Una indicación para generar una foto horizontal realista en formato 16:9 de una mujer en un entorno cálido y cotidiano de apartamento por la noche.
...
### No. 22: Parfait de Lujo con Alimentos No Apreciados
...
Una indicación para generar un parfait de lujo compuesto únicamente por alimentos comúnmente desagradables, con 30 tipos de ingredientes y anotaciones.
...
### No. 23: Póster de Viaje Vintage Japonés de la Era Showa
...
Una indicación para crear un póster de viaje vertical premium, en el estilo de turismo ferroviario japonés de mediados de siglo.
...
### No. 24: Retrato Cinematográfico en un Andén de Metro
...
Un retrato de alta fidelidad de una joven con cabello castaño que permanece quieta mientras un tren pasa a toda velocidad.
...
### No. 25: Retrato en Picado con Qipao
...
Un retrato en picado de una modelo alta y delgada con maquillaje refinado y rostro de zorro, vistiendo un qipao con iluminación suave y onírica.
...
### No. 26: Llanura Inundada con Reflejo Desajustado
...
Una indicación para un fotograma cinematográfico que representa una llanura inundada al anochecer con una granja y álamos, presentando un reflejo desajustado en el agua.
...
### No. 27: Cuadrícula 3x3 al Estilo de MV de Vocaloid
...
Una indicación para crear una cuadrícula de 3x3 con varios planos al estilo de un video musical de Vocaloid con una relación de aspecto 16:9.
...
### No. 28: Hoja de Sprites de Cuervo en 16 Bits
...
Una instrucción para generar una hoja de sprites al estilo de 16 bits de un cuervo en vuelo, despegue y aterrizaje.
...
### No. 29: Gladiador a Caballo desde un Ángulo Bajo
...
Una toma extrema desde un ángulo bajo de un gladiador sobre un caballo de guerra, visto desde un camino rocoso de montaña.
...
### No. 30: Primer Plano de un Arrecife con Pulpo
...
Una instrucción para hacer zoom en un arrecife, observar la luz sobre la piedra e incluir exactamente ocho brazos.
...
### No. 31: Fotograma Cinematográfico Anamórfico de Mujeres en una Peonía
...
Una fotografía anamórfica ancha de cinco mujeres chinas en miniatura sentadas dentro de una gran peonía de color rosa pálido.
...
### No. 32: Mujer entre Densas Ramas Florales Rosas
...
Una fotografía de una mujer rodeada de densas ramas con flores rosas que llenan el primer plano y el fondo.
...
### No. 33: Robot en la Playa al Atardecer
...
Una escena cinematográfica realista de un robot sentado en una playa al atardecer, mirando la arena en su mano.
...
### No. 34: Atuendo Ciberpunk con Orejas de Lobo Esponjosas
...
Una instrucción para generar un disfraz de estilo ciberpunk que presenta orejas de lobo de peluche en neón rosa y verde y un collarín.
...
### No. 35: Selfie en Primer Plano de una Mujer Joven
...
Una instrucción para una foto cruda de iPhone de una mujer joven con pecas y el cabello al viento.
...
### No. 36: Presidente de los 80 Dando la Bienvenida a un Alienígena en el Jardín de la Casa Blanca
...
Una instrucción para generar una imagen que represente una foto al estilo de los años 80 de un Presidente saludando a un alienígena en el jardín de la Casa Blanca.
...
### No. 37: Fotograma de Película de un Banquete Real de la Dinastía Tang
...
Un fotograma histórico de película en pantalla ancha que representa un banquete nocturno real ficticio y lujoso de la Dinastía Tang.
...
### No. 38: Foto de Moda Realista de una Mujer de Asia Oriental
...
Un prompt para una foto de moda realista que presenta a una mujer adulta de Asia Oriental con cabello largo negro, luces y sombras cálidas en su rostro y textura de piel natural.
...
### No. 39: Retrato de Mujer Taiwanesa con Filtro de Niebla Negra
...
Un prompt para un retrato que presenta un filtro de niebla negra, una máscara de superposición y fotografía CCD de luz suave con reflejos sutiles.
...
### No. 40: Lirio de Araña Roja Junto al Río Después de la Lluvia
...
Un prompt para generar una imagen realista de un solo lirio de araña rojo con gotas de lluvia, situado junto a un río después de la lluvia.
...
### No. 41: Escena Callejera Lluviosa Después del Cierre
...
Un prompt para una imagen atmosférica que representa a una persona después de la hora de cierre, centrándose en la lana mojada, la piel y la luz de la calle.
...
### No. 42: Editorial de Moda con Viento y Seda
...
Un prompt para una escena de editorial de moda que presenta a tres personas estilizadas por el viento, con luz solar intensa y abundante seda.
...
### No. 43: Foto Realista de iPhone de un Tesla Model Y
...
Un prompt para generar una foto realista de iPhone de un Tesla Model Y en un estacionamiento, utilizando una cámara de 0.5x.
...
### No. 44: Ciudad Eco-Futurista al Anochecer con Luna
...
Un prompt que describe una ciudad eco-futurista al anochecer, una ciudad lunar con una Tierra gigante, un caballero guardián serafín de la galaxia y una reina de cabello plateado bailando en una catedral de cristal de hielo.
...
### No. 45: Gran Ejército con Dragón Bajo la Lluvia
...
Una escena compleja que presenta un ejército de más de 100 personas, el personaje Luna, un dragón blanco, un letrero japonés, manejo intrincado de lanzas y reflejos lluviosos.
...
### No. 46: Conejo Enano Holandés Gris Saltando
...
Un prompt para generar imágenes de un conejo saltando y un conejo Enano Holandés gris saltando.
...
### No. 47: Pareja de Anime en el Parque, Alto Detalle
...
Un prompt para generar una imagen de un joven y una mujer al estilo anime, con ropa casual en un parque grande, renderizado en ultra alta resolución 16K con contraste y saturación mejorados.
...
### No. 48: Sueño del Pabellón Rojo en Pergamino Largo
...
Un prompt para reconstruir una escena de 'Sueño del Pabellón Rojo' como una pintura tradicional china en pergamino largo.
...
### No. 49: Serie de Arquitectura Brutalista en el Desierto
...
Un prompt para generar imágenes de arquitectura monolítica de tierra en un estilo brutalista desértico, con mezclas de celebridades y arquitectos.
...
### No. 50: Fotografía de Paseo Callejero en la Hora Dorada
...
Un prompt para una foto fotorrealista tomada con smartphone de una mujer caminando en una calle arbolada durante la hora dorada.
...
### No. 51: Colección de Carteles de Viaje de Lujo
...
Un prompt para crear una sofisticada colección de carteles de viaje de lujo inspirada en Santorini, la Costa Amalfitana y París.
...
### No. 52: Retrato Espontáneo en Parque Urbano
...
Un retrato espontáneo al aire libre de una joven con cabello largo castaño oscuro en un parque urbano tranquilo en una tarde soleada.
...
### No. 53: Hoja de Referencia de Personaje: Asesino del Desierto
...
Un prompt para generar una hoja de referencia de personaje cinematográfica que presenta a un asesino mortal del desierto.
...
### No. 54: Foto de Moda de Mujer Asiática Oriental en Salón
...
Un prompt para una foto de moda ultra fotorrealista tomada con smartphone de una hermosa mujer asiática oriental en un salón privado por la noche.
...
### No. 55: Obra de Arte de Sello Postal de Viaje Vintage
...
Un prompt para crear un sello postal de estilo vintage que presenta un hito icónico y elementos culturales de un país.
...
### No. 56: Cartel de Viaje Vintage de Estructura Icónica
...
Un prompt para crear un cartel de viaje vintage estilizado, pintado a mano, que presenta un hito arquitectónico reconocible.
...
### No. 57: Retrato de Moda Espontáneo en Garaje de Estacionamiento
...
Un retrato ultra fotorrealista de una hermosa mujer euroasiática en un garaje de estacionamiento subterráneo moderno.
...
### No. 58: Escena Miniaturizada de Comida Artesanal
...
Una indicación para generar una encantadora escena en miniatura que presenta un plato de comida específico sobre un plato de cerámica.
...
### No. 59: Diorama Miniaturizado de Fachada de Tienda
...
Una indicación para generar un caprichoso diorama en miniatura de arcilla 3D de una tienda o marca reconocible.
...
### No. 60: Diorama Miniaturizado de Estructura Icónica
...
Una indicación para crear un mundo en miniatura detallado y acogedor que presenta una estructura icónica central.
...
### No. 61: Retrato de Estudio Asimétrico de Alta Costura
...
Una indicación para un retrato de primer plano de un hombre contra un fondo de estudio blanco con una composición asimétrica.
...
### No. 62: Paisaje de Laberinto Blanco Tallado por el Viento
...
Una indicación descriptiva para generar un paisaje de un laberinto blanco formado por la erosión eólica a lo largo del tiempo.
...
### No. 63: El Caballero del Dragón Blanco y la Pequeña Piedra
...
Una escena que representa a un Caballero del Dragón Blanco en la noche, detenido no por un enemigo sino por una sola pequeña piedra, con un pie de foto filosófico.
...
### No. 64: Retrato Editorial de Hombre Seguro de Sí Mismo
...
Un prompt para generar un retrato de estudio de estilo editorial premium de un hombre seguro de sí mismo con cabello negro corto.
...
### No. 65: Retrato de Moda de Cuerpo Completo en Estudio
...
Un prompt para generar un retrato de cuerpo completo de un modelo masculino seguro de sí mismo en un entorno de estudio cálido y sin costuras.
...
### No. 66: Obra Maestra de Campaña de Viajes de Lujo
...
Un prompt para una sofisticada campaña de estilo de vida de viajes de lujo que combina experiencias alpinas, de Dubái y de chalet europeo.
...
### No. 67: Rutina Matutina del Maestro Mago Azul
...
Una escena que representa la mañana de un Maestro Mago Azul, donde peines, ligas para el cabello y cordones de zapatos terminan su trabajo mientras él lee informes.
...
### No. 68: Barco Llegando a la Costa de Tiza Blanca
...
Un prompt descriptivo para una escena donde un barco llega a una orilla de tierra blanca, sal y piedra caliza, con tierras invisibles más allá.
...
### No. 69: Retrato de Personaje: Pescador Elfo del Mar
...
Un prompt que describe un elfo que vive junto al mar, un pescador costero que lee las señales del océano.
...
### No. 70: Retrato de Estudio Profesional de Primer Plano
...
Un prompt para generar un retrato de estudio profesional de primer plano de un hombre adulto.
...
### No. 71: Hombre Seguro de Sí Mismo en un Interior Moderno y Lujoso
...
Un retrato de estilo de vida ultrarealista de un hombre seguro de sí mismo en un interior moderno y lujoso con una puerta de madera oscura y un gran espejo.
...
### No. 72: Lancero Fantástico Durmiendo en el Escritorio
...
Un prompt poético que describe la noche de un lancero, recordando la veta de la madera de un escritorio frente a un mapa de otro mundo.
...
### No. 73: Caballero Dragón Descansando a la Sombra
...
Una escena que muestra a dos caballeros dragón tomando un descanso bajo el ala de un dragón, con un mapa y pan duro.
...
### No. 74: Hombre con Estilo en una Acogedora Biblioteca Nocturna
...
Un retrato ultra realista de un hombre relajándose en un salón de biblioteca de lujo durante el atardecer.
...
### No. 75: Cartero Dullahan en una Noche de Otoño
...
Un cartero nocturno camina por un camino otoñal bordeado de lirios araña rojos bajo un cielo nocturno.
...
### No. 76: Retrato Editorial de Cuerpo Completo en Borgoña
...
Un retrato editorial ultra realista de un hombre negro seguro de sí mismo con un traje impecable, sentado en un entorno de estudio minimalista.
...
### No. 77: La Tarde del Maestro Mago Azul
...
Una escena que muestra la tarde de un Maestro Mago Azul, donde la magia despeja la luz del sol y los adoquines antes de que la alcancen.
...
### No. 78: Atardecer sobre Tierra Agrietada con Llamas
...
Un prompt descriptivo para una escena de un páramo al anochecer con finas llamas surgiendo de fisuras en el suelo y el mar Caspio a lo lejos.
...
### No. 79: Barco de Vela Vintage al Atardecer Dorado
...
Una imagen ultra realista de un barco de vela de madera vintage en una escena dramática de océano al atardecer.
...
### No. 80: Caballero Dragón Blanco Revisando Herida en el Ala
...
Una escena del Maestro Caballero Dragón Blanco revisando cuidadosamente la herida en el ala izquierda de un dragón dormido en una cuadra de dragones a la luz de la luna.
...
### No. 81: Viajero Remendando Tela Azul en Ciudad Volcánica
...
Una escena de remendar una tela de viaje azul en una ciudad volcánica durante la tarde, con montañas distantes.
...
### No. 82: Mañana en un Mundo Espejo con un Lancero
...
Una indicación que describe a un lancero que ha perdido su mayor título, comenzando su día desde los cordones de los zapatos mojados en la mañana de un mundo espejo.
...
### No. 83: La Maestra Mago Azul Luna Antes del Amanecer
...
Una escena que representa a la Maestra Mago Azul Luna antes del amanecer, con libros, una silla y té, de una época en la que no necesitaban su cuerpo.
...
### No. 84: Paisaje Donde el Fuego Se Escapa de la Tierra
...
Una indicación descriptiva para un paisaje donde el fuego se escapa de la tierra en un desierto seco, con lodo gris fluyendo y el Mar Caspio a lo lejos.
...
### No. 85: La Caballero Dragón Negro Luna de Noche
...
Una escena que representa a la Caballero Dragón Negro Luna de noche, revisando los callos de su lanza mientras El Drago duerme a su lado.
...
### No. 86: Frieren y Fern en un Buen Lugar
...
Una ilustración SFW que representa una conversación entre los personajes Fern y Frieren.
...
### No. 87: Colinas Talladas por el Viento y la Lluvia
...
Una indicación poética que describe un paisaje donde el verde se desvanece, revelando capas de ocre, óxido, gris-blanco y verde pálido en colinas talladas por el viento y la lluvia.
...
### No. 88: Dama Antigua con Abanico ante el Bambú
...
Un prompt de IA para generar un fondo de pantalla de estética oriental que presenta a una mujer clásica con un abanico redondo contra una pared blanca y sombras de bambú.
...
### No. 89: Robots de Rescate Policial Remolcando una Balsa Salvavidas
...
Un prompt que representa a un Equipo de Robótica de Maquinaria Pesada de la Policía de Tokio rescatando evacuados remolcando una balsa salvavidas.
...
### No. 90: Foto CCD Diurna de Observatorio Urbano
...
Un prompt para generar una foto de estilo de vida brillante y diurna al estilo CCD, que presenta exploración urbana en una plataforma de observación astronómica.
...
Un prompt para generar un retrato realista y espontáneo al estilo iPhone de una mujer joven.
...
### No. 92: Póster de Ventana Floral de Estilo Chino Nuevo
...
Un prompt para generar una imagen de un póster oriental elegante y minimalista que presenta a una mujer clásica junto a una ventana de flores verde jade.
...
### No. 93: Retrato Editorial Fotorrealista de Mujer de Asia Oriental
...
Un prompt detallado para generar un retrato fotorrealista a nivel de los ojos y hasta las rodillas de una joven de Asia Oriental con rasgos faciales específicos.
...
### No. 94: Robots de la Unidad de Maquinaria Pesada Policial Limpiando un Río
...
Un prompt que describe a un escuadrón de robots de la unidad de maquinaria pesada policial limpiando basura que está represando un río.
...
### No. 95: Retrato Editorial Fotorrealista con Rostro Ovalado-Corazón
...
Un prompt detallado para generar un retrato editorial a nivel de los ojos y hasta las rodillas de una joven de Asia Oriental con rasgos faciales específicos.
...
### No. 96: Retrato para iPhone de una Mujer Joven
...
Un prompt para generar una foto vertical 9:16 realista y casual de una mujer de 20 a 26 años, como si fuera tomada con la cámara principal de un iPhone.
...
### No. 97: Mujer Zen junto al Agua en Verano
...
Un prompt para generar un fondo de pantalla de estética oriental que presenta a una mujer junto al agua en un estilo minimalista y refrescante.
...
### No. 98: Retrato de Plano Americano de Mujer de Asia Oriental
...
Un prompt detallado para un retrato editorial fotorrealista de una joven de Asia Oriental con rasgos faciales específicos.
...
### No. 99: Foto de Moda en Cafetería-Librería en Azotea Urbana
...
Un prompt para generar una foto de estilo de vida brillante y diurna al estilo CCD, con un entorno urbano y artístico y ropa específica.
...
### No. 100: Retrato Editorial Fotorrealista de Mujer de Asia Oriental
...
Un prompt detallado para generar un retrato editorial a nivel de la cintura y hasta las rodillas de una joven de Asia Oriental con rasgos faciales específicos.
...
### No. 101: Póster de Portada Minimalista Zen Oriental
...
Un prompt para generar un fondo de pantalla minimalista oriental que presenta a una mujer elegante de estilo antiguo pasando por una puerta azul con flores de cerezo.
...
### No. 102: Equipo de Robots de la Unidad Policial de Maquinaria Pesada
...
Una imagen de un equipo de robots policiales de la Unidad de Contramedidas de Maquinaria Pesada retirando vehículos de una carretera inundada por lluvias torrenciales.
...
### No. 103: Foto de Vida Deportiva Urbana Diurna y Brillante al Estilo CCD
...
Un prompt para generar una foto de estilo de vida diurna y brillante al estilo CCD en un entorno deportivo urbano.
...
### No. 104: Póster de Portada Vertical Minimalista Zen
...
Un prompt para crear una portada vertical minimalista, brillante y limpia en formato 9:16 con estética femenina oriental moderna y ambiente matutino.
...
### No. 105: Mujer Sentada Junto a una Ventana Redonda
...
Un prompt para generar un póster minimalista Zen oriental que presenta a una mujer relajándose junto a una ventana redonda.
...
### No. 106: Escuadrón de Robots Policiales Deteniendo un Camión Descontrolado
...
Una imagen de un escuadrón de robots policiales de la Unidad de Contramedidas de Maquinaria Pesada intentando detener un camión descontrolado.
...
### No. 107: Retrato Editorial de Cuerpo Completo de una Mujer Joven
...
Un prompt para un retrato editorial de cuerpo completo, a nivel de los ojos, de una joven japonesa o coreana que lleva aretes de aro.
...
### No. 108: Retrato Fotorrealista Hasta la Cintura con Gafas
...
Un retrato, visto a nivel de las rodillas y hasta la cintura, de una joven japonesa o coreana que lleva gafas de montura gruesa blanca y llamativa.
...
### No. 109: Póster de Portada Minimalista Zen con Mujer y Campanilla de Viento
...
Un prompt para generar una imagen de una mujer tocando una campanilla de viento junto a una ventana, en un estilo minimalista Zen oriental.
...
### No. 110: Ciudad Post-Apocalíptica con Vegetación Verde
...
Una foto detallada de una ciudad post-apocalíptica en Shenzhen, China, cubierta de vegetación verde.
...
### No. 111: Mujer Japonesa con Rostro Similar a un Tanuki de Noche
...
Un prompt para generar una imagen fotorrealista de una joven japonesa ficticia con un rostro similar al de un tanuki, en un entorno nocturno tranquilo.
...
### No. 112: Vista del Delfín de Mujeres en Acuario de Cristal
...
Una imagen realista desde la perspectiva de un delfín mirando a través de un tanque de cristal de 360 grados a mujeres que visitan un acuario bullicioso solo para mujeres.
...
### No. 113: Escena en Miniatura de Arcilla Polimérica de Tienda de Marca
...
Un prompt para crear un modelo en miniatura de arcilla de una tienda de marca con detalles acogedores en la acera.
...
### No. 114: Anuncio de Moda con Toma Inclinada del Suelo
...
Una campaña publicitaria de moda para una marca ficticia con seis personas con ropa vibrante contra un cielo azul cobalto, filmada desde un ángulo bajo.
...
### No. 115: Duelo Anime Dibujado a Mano con Flores de Cerezo
...
Una escena de una película de animación japonesa dibujada a mano de finales de los años 90, con una mujer con una katana enfrentándose a un espadachín bajo flores de cerezo cayendo.
...
### No. 116: Vestido de Novia Gótico de Novia Embrujada Negra
...
Un prompt para un disfraz de novia de terror gótico de Halloween con elegancia romántica oscura.
...
### No. 117: Retrato Cinematográfico de Humor de Mujer Asiática Oriental
...
Un prompt para un retrato cinematográfico de primer plano de alto contraste de una joven asiática oriental con piel pálida y cabello negro largo.
...
### No. 118: Retrato Cinematográfico Nocturno en Calle Mojada con Paso de Cebra
...
Un prompt para un retrato cinematográfico de una joven asiática oriental en un paso de cebra mojado por la noche.
...
### No. 119: Retrato de Primer Plano con Ojos Dorados Brillantes
...
Un prompt para un retrato cinematográfico de primer plano de una joven asiática oriental con cabello azabache y ojos dorados brillantes.
...
### No. 120: Retrato fotorrealista con gafas y guiño
...
Un retrato fotorrealista de una joven mujer de Asia Oriental con gafas y cabello ondulado, guiñando suavemente un ojo.
...
### No. 121: Retrato estilo película analógica con cabello desordenado
...
Un retrato fotorrealista estilo película analógica de una joven mujer de Asia Oriental con cabello negro desordenado mirando a la cámara.
...
### No. 122: Retrato cinematográfico flotando en agua oscura
...
Un retrato cinematográfico de una joven mujer serena flotando en agua tranquila con el cabello mojado.
...
### No. 123: Retrato de belleza de estudio con trenza lateral
...
Un retrato de belleza fotorrealista de estudio de una joven mujer de Asia Oriental con piel luminosa, cabello negro largo y los ojos cerrados.
...
### No. 124: Retrato de mujer en coche con hijab
...
Un retrato fotorrealista de primer plano de una joven mujer de Asia Oriental en un coche, vistiendo un hijab de color beige claro.
...
### No. 125: Mujer tomándose un selfie con hijab
...
Un prompt para generar una imagen de una joven mujer con un hijab claro tomándose un selfie en una mesa de madera.
...
### No. 126: Retrato de mujer mirando por encima del hombro
...
Un prompt detallado para generar un retrato fotorrealista de una joven mujer de Asia Oriental mirando por encima de su hombro.
...
### No. 127: Retrato de mujer con gafas
...
Un retrato de una joven mujer de Asia Oriental con gafas, cabello ondulado y una expresión tranquila.
...
### No. 128: Retrato de primer plano con lápiz labial vivo
...
Un retrato fotorrealista de una joven mujer de Asia Oriental con piel de porcelana, ojos almendrados y lápiz labial vivo.
...
### No. 129: Retrato con cabello mojado y hombro descubierto
...
Un retrato fotorrealista de una joven mujer con piel húmeda y cabello negro mojado mirando por encima de su hombro.
...
### No. 130: Retrato cinematográfico de mujer de Asia Oriental
...
Un retrato de primer plano de una joven mujer de Asia Oriental con cabello largo, oscuro y ondulado contra un fondo negro.
...
### No. 131: Retrato fotorrealista con gafas
...
Un retrato fotorrealista de una joven mujer de Asia Oriental con cabello largo y ondulado, gafas redondas y una expresión suave.
...
### No. 132: Retrato cinematográfico con reflejos miel
...
Un prompt para un retrato cinematográfico de primer plano de una joven mujer de Asia Oriental con cabello ondulado castaño claro y una expresión tranquila.
...
### No. 133: Retrato fotorrealista con corte bob
...
Un retrato fotorrealista de primer plano de una joven mujer de Asia Oriental con un bob corto negro, sombra de ojos ahumada y piel radiante.
...
### No. 134: Retrato de Mujer con Hiyab y Gorra
...
Un retrato en primer plano de una mujer joven de piel clara y expresión serena, que lleva un hiyab blanco y una gorra de béisbol negra.
...
### No. 135: Selfie con Hiyab de Chiffon
...
Un autorretrato en primer plano de una mujer joven de Asia Oriental, de piel clara y rasgos delicados, que lleva un hiyab de chiffon color taupe polvoriento.
...
### No. 136: Retrato Cinematográfico de Mujer de Asia Oriental Llorosa
...
Un retrato fotorrealista en primer plano de una mujer joven con piel brillante y marcada por lágrimas, y flequillo vaporoso.
...
### No. 137: Retrato de Mujer con Parche de Encaje Enjoyado
...
Un retrato en primer plano de una mujer joven de piel pálida con un bob negro, un ojo rojo visible y el otro cubierto por un parche de encaje negro enjoyado.
...
### No. 138: Retrato Cinematográfico Intenso con Cabello Desordenado
...
Un retrato cinematográfico en primer plano de una mujer joven con cabello largo y negro, mirando directamente a la cámara.
...
### No. 139: Retrato en Primer Plano con Cabello Oscuro Brillante
...
Una indicación detallada para generar un retrato de una mujer joven de piel clara y cabello largo y oscuro.
...
### No. 140: Retrato Sonriente con Brillo de Sudor y Piel Dorada
...
Un retrato en primer plano de una mujer joven de Asia Oriental con cabello negro desordenado, entrecerrando los ojos y sonriendo, con la piel sonrojada y húmeda.
...
### No. 141: Retrato Expresivo con Delineado de Ala
...
Una indicación detallada para generar un retrato en primer plano de una mujer joven del Sudeste Asiático con rasgos faciales y maquillaje específicos.
...
### No. 142: Selfie con Expresión de Beso
...
Una indicación para un autorretrato en primer plano de una mujer joven de Asia Oriental con los ojos cerrados y una expresión relajada.
...
### No. 143: Retrato de Mujer Joven Sonriente
...
Una indicación para generar un retrato de una mujer joven de Asia Oriental o Indonesia, de tez clara, maquillaje suave y una expresión amable y gentil.
...
### No. 144: Selfie de Mujer con Medio Recogido
...
Una indicación para generar un autorretrato fotorrealista de una mujer joven de Asia Oriental con rasgos y peinado específicos.
...
### No. 145: Fases de la Tierra siendo Tragada por un Agujero Negro
...
Una indicación para generar cuatro imágenes que representen las fases visuales de la Tierra siendo tragada por un agujero negro desde el punto de vista de un observador humano.
...
### No. 146: Guerrero Cyberpunk vs. Jefe Mecánico
...
Un prompt que describe dos personajes: un guerrero cyberpunk con katana y una entidad masiva de jefe mecánico.
...
### No. 147: Diosa Celestial Descendiendo ante un Palacio
...
Una imagen de una majestuosa diosa celestial china en hanfu ceremonial, descendiendo a través de nubes rosa-doradas frente a un palacio celestial.
...
### No. 148: Doncella Celestial en Vista de Tres Cuartos Iluminada por el Sol
...
Una imagen de una doncella celestial en hanfu marfil, iluminada por la luz matutina, con cintas flotantes y horquillas doradas en el cabello.
...
### No. 149: Doncella Celestial Sentada junto a un Estanque de Jade
...
Una imagen de una serena doncella celestial china en hanfu de seda, tocando un loto junto a un estanque turquesa.
...
### No. 150: Diosa Celestial en los Escalones del Palacio de Jade
...
Una imagen de una elegante diosa celestial china en lo alto de unos escalones de jade blanco, vistiendo un hanfu bordado con cintas de seda flotantes.
...
### No. 151: Retrato en un Santuario Ritual de la Antigua China
...
Un retrato cinematográfico fotorrealista de una mujer adulta de Asia Oriental en un oscuro santuario ritual de la antigua China, con máscaras Nuo y velas.
...
### No. 152: Retrato de una Mujer en un Oscuro Santuario Ritual
...
Un retrato cinematográfico fotorrealista de una mujer de Asia Oriental con cabello negro húmedo y maquillaje ahumado, en un oscuro santuario antiguo.
...
### No. 153: Retrato de Primer Plano en un Festival Nuo Nocturno
...
Un retrato de primer plano de una mujer adulta de Asia Oriental junto a una máscara Nuo desgastada, durante un festival ritual nocturno.
...
### No. 154: Cerveza con Corona de Espuma Densa
...
Un prompt para generar una imagen fotorrealista de una cerveza con una corona de espuma densa y en cascada, en un vaso de borde afilado.
...
### No. 155: Cubo de Tofu Levantado de un Guiso
...
Un prompt descriptivo para una imagen de un cubo de tofu poroso levantado sobre una olla, con una sola gota de caldo ámbar adherida.
...
### No. 156: Cucharada de Salsa de Chile
...
Una imagen de una cucharada de salsa de chile con cubos rojos de chile distintivos, verduras oscurecidas como el té, pimiento verde brillante, frijoles pálidos y aceite ámbar-rojo translúcido.
...
### No. 157: Retrato en Primer Plano de una Mujer en la Sala de Estar
...
Un retrato en primer plano ultra realista de una mujer joven con una expresión juguetona en una acogedora sala de estar moderna.
...
### No. 158: Retrato de una Mujer Recostada en un Dormitorio Tenue
...
Un prompt para un retrato vertical fotorrealista de una mujer joven recostada sobre la ropa de cama en un dormitorio con poca luz por la noche.
...
### No. 159: Retrato Onírico de una Mujer en la Hierba de Verano
...
Una imagen inspirada en el cine de una mujer joven de Asia Oriental descansando en hierba alta, suavemente iluminada por la cálida luz del día.
...
### No. 160: Retrato de una Mujer junto a un Puerto Azul Brillante
...
Un retrato con estilo de grano cinematográfico de una mujer joven de Asia Oriental agachada casualmente junto a un puerto de color azul brillante en un día soleado y con brisa.
...
### No. 161: Retrato Callejero en París de una Mujer Joven
...
Un prompt para un retrato callejero de alta resolución con luz natural de una mujer joven de aspecto asiático en una calle comercial de inspiración parisina.
...
### No. 162: Retrato Espontáneo en el Metro de Noche
...
Un retrato candidato fotorrealista de una mujer adulta de Asia Oriental sentada junto a la ventana de un tren por la noche.
...
### No. 163: Reloj con Onda de Choque de Hielo y Humo
...
Una imagen de un reloj con una onda de choque circular de hielo y humo detrás, manteniendo una silueta limpia.
...
### No. 164: Exposición de Panadería en Capas con Profundidad
...
Un prompt para generar una imagen de una exhibición de panadería premium con artículos dispuestos en niveles de altura distintos para crear profundidad.
...
### No. 165: Retrato en Dormitorio con Luz Suave en Vestido Camisero
...
Un retrato fotorrealista de una mujer adulta de Asia Oriental que lleva un vestido camisero de satén marfil en un dormitorio con iluminación suave.
...
### No. 166: Coche con Contraste de Penacho de Polvo Explosivo
...
Una imagen de un coche potente generando un enorme penacho de polvo detrás de él, mientras permanece limpio y silencioso en primer plano.
...
### No. 167: Silueta de Bruja Contraluz por Fuego Celestial
...
Una imagen de una silueta de bruja iluminada desde atrás por una enorme nube de fuego celestial anaranjado-dorado.
...
### No. 168: Corazón de Salsa de Tomate Elevándose de un Bol de Koshari
...
Una imagen de salsa de tomate brillante formando una figura de corazón sobre un bol de koshari.
...
### No. 169: Piezas de Ajedrez Esculpidas con Hebras de Fideos
...
Una indicación para generar piezas de ajedrez esculpidas a partir de hebras de fideos artesanales, con siluetas reconocibles.
...
### No. 170: Botella de Aceite de Sésamo con Brazos de Boxeador en el Ring
...
Una imagen de una botella gigante de aceite de sésamo con brazos dorados de boxeador, de pie victoriosa en un ring de boxeo.
...
### No. 171: Escena de Encimera en Cocina de Apartamento Moderno Compacto
...
Una indicación para generar una imagen de una cocina moderna y compacta en un apartamento, con una barra de desayuno, encimera continua, fregadero de acero inoxidable, placa de cocción y sartén.
...
### No. 172: Wrap de Shawarma Inclinado Hacia Arriba Como un Cohete
...
Una indicación para generar una imagen de un wrap de shawarma inclinado como un cohete, enfatizando el relleno abierto como punto focal.
...
### No. 173: Mascota de Plátano Sosteniendo una Lata Gigante
...
Una imagen de una mascota con forma de plátano corriendo, sosteniendo una lata de aluminio fría y gigante hacia la cámara.
...
### No. 174: Foto Nocturna Cándida de Mujer Asiática Oriental
...
Una indicación para generar una foto realista y cándida de una mujer asiática oriental con rasgos específicos y una iluminación determinada.
...
### No. 175: Crema de Galleta como Superficie Miniatura para Patinaje
...
Una imagen de una galleta donde la capa de crema de vainilla se eleva para formar una superficie lisa y miniatura para patinaje, transformando la escala en un mundo invernal.
...
### No. 176: Vía de Montaña Rusa Hecha de Patatas Fritas Apiladas
...
Una imagen de una vía de montaña rusa construida con patatas fritas perfectamente alineadas y apiladas, que presenta un bucle completo.
...
### No. 177: Zonas de Foco Rojo Detrás del Cubo Protagonista
...
Una indicación de imagen que describe tres zonas limpias de foco rojo con momentos de estilo de vida secundarios detrás de un cubo protagonista.
...
### No. 178: Chorro de Fideo Brillante como Línea de Movimiento Vertical
...
Un concepto de póster minimalista que presenta un único chorro de fideo brillante como elemento vertical central.
...
### No. 179: Animación Cinematográfica 2.5D en Gouache
...
Una indicación para crear una animación cinematográfica 2.5D con un estilo pictórico de gouache propio del arte conceptual, que presenta texturas de pincel visibles y bloques de color planos.
...
### No. 180: Retrato Cinematográfico de Humor Oscuro en la Penumbra
...
Un retrato cinematográfico de un hombre con cabello desordenado emergiendo de las sombras, con iluminación dramática y textura ultrarealista.
...
### No. 181: Hombre Gigante Junto a la Estatua de la Libertad
...
Una foto de viaje cinematográfica ultrarealista de un joven apuesto retratado como un gigante de pie junto a la Estatua de la Libertad.
...
### No. 182: Retrato en la Hora Dorada en un Porche Rústico
...
Un retrato de estilo de vida cálido y espontáneo de un joven disfrutando de un té en un porche rústico durante la hora dorada.
...
### No. 183: Retrato Cinematográfico en un Prado
...
Un retrato ultrarealista de una mujer con sombrero de vaquero de pie en un prado verde con artemisa y pinos.
...
### No. 184: Retrato Candidato Vertical de Mujer
...
Una indicación para generar una fotografía candidata vertical de una joven mujer de Asia Oriental con rasgos específicos.
...
### No. 185: Barra Diagonal con Zona de Sabor Desgarrada
...
Una indicación para generar una imagen de una barra de postre envasada en diagonal con un envoltorio desgarrado, creando un efecto de boca abierta dentro de un mundo temático de postres.
...
### No. 186: Retrato Femenino en Espejo Ovalado
...
Un retrato de belleza de una mujer reflejada en un espejo ovalado vertical, con lápiz labial color cobalto mate.
...
### No. 187: Vórtice de Vaso de Cerveza en el Desierto
...
Una imagen surrealista de un vaso de cerveza gigante emergiendo del desierto como un vórtice retorcido de arena y cerveza.
...
### No. 188: Botella de Cerveza en Primer Plano
...
Una indicación para una imagen que presenta una botella de cerveza real grande y nítida, parcialmente recortada, en el primer plano inferior derecho.
...
### No. 217: Hoja de Sprites en Pixel Art del Personaje Zorro
...
Un prompt para generar una hoja de sprites de animación en pixel art pulida de un personaje llamado Noxa, un zorrito que colecciona estrellas.
...
### No. 218: Infografía Conceptual de Teléfono Plegable de Apple
...
Un prompt para generar una infografía fotorrealista de un teléfono plegable de Apple en el estilo limpio característico de la marca.
...
### No. 219: Retrato de Belleza de Cerca de una Joven Asiática Oriental
...
Un retrato fotorrealista de cerca de una joven asiática oriental con iluminación suave y textura de piel detallada.
...
### No. 220: Mujer Asiática en la Carretera Costera al Atardecer
...
Una foto fotorrealista y espontánea de una joven asiática junto a una carretera costera al atardecer, vista desde el interior de un coche.
...
### No. 221: Macro a Nivel del Agua de la Hoja de Loto como Isla
...
Una indicación para un plano macro cinematográfico desde el nivel del agua, que representa una hoja de loto como una isla habitada por tres pequeñas figuras con Hanfu.
...
### No. 222: Garra Gigante de Tres Puntas con Filo de Katana
...
Una indicación para un arma gigante a dos manos con tres puntas cuyas hojas están afiladas y pulidas como una espada japonesa.
...
### No. 223: Embajador de una Estación en la Luz de la Mañana
...
Una indicación poética que describe a un embajador para una estación con luz matutina, piel de revista y cristal tan fino que no oculta.
...
### No. 224: Retrato de Perfil con Corona Geométrica Dorada
...
Una indicación de imagen para una figura imponente en perfil nítido, que lleva una corona de discos geométricos dorados sobre cabello oscuro enrollado.
...
### No. 225: Princesa Radiante con Tiara de Diamantes
...
Una indicación de imagen de IA para una figura radiante que lleva una tiara de diamantes de gran tamaño en perfil nítido.
...
### No. 226: Retrato de Cerca de una Mujer Asiática Oriental en Estilo Wuxia
...
Un retrato hiperrealista de una joven asiática oriental en estilo wuxia con perspectiva de gran angular extrema.
...
### No. 227: Retrato de Cuerpo Completo de una Mujer en Ambiente Hogareño Casual
...
Una indicación para una foto hiperrealista vertical de 9:16, de cuerpo completo, de una joven asiática oriental en un ambiente hogareño relajado con tonos cinematográficos cálidos.
...
### No. 228: Hoja de Sprites de Personaje Chibi con 16 Poses
...
Una indicación para generar una hoja de sprites en cuadrícula 4x4 de un personaje chibi con varias poses.
...
### No. 229: Selfie Fotorealista con Smartphone en el Dormitorio
...
Un selfie fotorealista en formato paisaje, tomado con smartphone, de una joven mujer de Asia Oriental relajándose en una cama por la noche.
...
### No. 230: País en Miniatura 3D de Monumentos Icónicos
...
Un prompt para generar un mapa en miniatura 3D donde el borde de un país está compuesto por sus monumentos icónicos y símbolos culturales.
...
### No. 231: Retrato Cinematográfico de una Mujer en París
...
Un prompt para una foto cinematográfica ultrarealista de una mujer hijabi del Sudeste Asiático caminando cerca de la Torre Eiffel.
...
### No. 232: Animales Reconstruidos con Telas de Alta Costura
...
Un prompt para generar una cuadrícula de 2x2 con animales reconstruidos utilizando las telas características de cuatro casas de moda de lujo icónicas.
...
### No. 233: Póster de Campaña para Smartphone Premium
...
Un prompt para generar un póster promocional de alta gama para un smartphone, en el estilo característico de Apple.
...
### No. 234: Póster de Viaje Moderno con Arquitectura
...
Un prompt para crear un póster de viaje premium con un estilo de serigrafía vintage y una composición de portal arquitectónico.
...
### No. 235: Charmander de Plastilina Animado en Stop Motion
...
Un prompt para crear una animación stop-motion de un Charmander con estilo de plastilina eclosionando de un huevo y lanzando fuego.
...
### No. 236: La Manzana de Magritte como una Pila de Notas
...
Una reinterpretación creativa de 'El Hijo del Hombre' de Magritte, donde la manzana flotante es reemplazada por una pila de notas de papel con forma de manzana.
...
### No. 237: Retrato de Moda Hiperrealista en una Casa Japonesa
...
Un retrato de moda hiperrealista de una mujer caminando por un corredor de madera tradicional japonés.
...
### No. 238: Fondo de Pantalla Ultra-Minimalista del Imperio Romano
...
Un fondo de pantalla ultra-minimalista que representa un gran templo romano con columnas, acueductos y ruinas en tonos dorados cálidos.
...
### No. 239: Fotograma de Anime de Andén Lluvioso
...
Un prompt para generar un fotograma de anime inexistente que muestre lluvia en un andén, un tren llegando y un pez koi flotando sobre una ciudad.
...
### No. 240: Persona que se Hace Amiga de un Gato en Medio del Caos
...
Una escena que representa a alguien que, tras involucrarse en diversas cosas, termina haciéndose amigo de un gato.
...
### No. 241: Medusa Zorro en Acuario de Tierras Altas
...
Una imagen de un zorro de ojos soñolientos y medusas dentro de un acuario en una zona de tierras altas, renderizada en un estilo sin partículas de luz granuladas.
...
### No. 242: Mujer en Kimono Comiendo Arroz con Lengua de Res
...
Una imagen de una mujer en kimono, con una escena que representa una comida de lengua de res y arroz de cebada.
...
### No. 243: Foto Espontánea de Mujer en Acogedora Sala Nocturna
...
Un prompt para una foto fotorrealista y espontánea de una mujer joven en el entorno acogedor de una sala por la noche.
...
### No. 244: Mujer Chuunibyou en Estilo Gótico Lolita
...
Una imagen al estilo anime de una mujer chuunibyou con maquillaje Jirai, vistiendo un conjunto Gótico Lolita con top de hombros descubiertos y un vestido largo con corsé.
...
### No. 245: Mujer que se Queda con su Exnovio Moribundo
...
Un prompt que describe a una mujer que descubre que su exnovio la dejó porque se está muriendo y decide quedarse con él hasta el final.
...
### No. 246: Retrato de una Mujer con Uniforme
...
Un prompt poético que describe a un personaje llamado Rhiannah con un uniforme geométrico, un ojo azul hielo, hombros cuadrados y labios rojos.
...
### No. 247: Taller de Tinte Añil en Jiangnan
...
Un prompt de imagen para una escena de un taller de tinte en Jiangnan, que presenta tinte azul, marcos de madera, un puente de piedra y luz matutina sobre el agua.
...
### No. 248: Retrato de Primer Plano con Pelo Trenzado
...
Un retrato de fondo de pantalla fotorrealista en formato 16:9 de una mujer joven de piel clara con pecas, ojos azules y pelo rubio blanquecino trenzado.
...
### No. 249: Retrato Candidato Fotorrealista de un Marinero
...
Una toma cándida al estilo 35mm de un marinero anciano ajustando su red, con texturas realistas de piel y materiales.
...
### No. 250: Escena de Multitud con Precisión Histórica de 1969
...
Una multitud fotorealista al aire libre en Bethel, Nueva York, en una fecha específica de 1969, ambientada con precisión histórica.
...
### No. 251: Tarjeta Navideña Nostálgica con Oso de Peluche
...
Una tarjeta de vacaciones de calidad de impresión basada en una escena de caja de recuerdos con una línea textual de texto de tarjeta.
...
### No. 252: Avión de Juguete Vintage de Colección en Blíster
...
Una toma de coleccionable al estilo minorista en empaque de blíster con una línea textual de empaque.
...
### No. 253: Oficina de Correos en las Nubes en un Estilo de Libro Ilustrado Sanador
...
Una escena caprichosa de una nube suave transformada en una oficina de correos donde pequeños animales con uniformes clasifican cartas, representada en un estilo suave y sanador de libro ilustrado.
...
### No. 254: Retrato Cinematográfico Hiperrealista en una Motocicleta
...
Un retrato cinematográfico hiperrealista de un hombre barbudo y elegante en una motocicleta personalizada.
...
### No. 255: Retrato Editorial de Alta Costura en Blanco y Negro
...
Una indicación para crear un retrato de alta costura en blanco y negro de un hombre joven con cabello rizado y ropa en capas.
...
### No. 6: Póster Art Deco en Dorado y Azul Marino
...
Una ilustración de póster Art Deco en formato cuadrado, con elegantes líneas de trabajo en dorado y azul marino sobre papel color crema.
...
### No. 7: Colección de Alfileres de Esmalte Hiperrealista
...
Un prompt para crear una colección de ocho alfileres de esmalte premium con contornos dorados y superficies brillantes sobre un fondo oscuro.
...
### No. 8: Interfaz de Usuario de Panel de Análisis SaaS Oscuro
...
Un prompt para generar una interfaz de panel de análisis SaaS con tema oscuro, con etiquetas y elementos de interfaz de usuario específicos.
...
### No. 9: Captura de Pantalla del Sitio Web de una Empresa de Diseño Creativo
...
Un prompt para generar una captura de pantalla completa, frontal y sin perspectiva, de la página web de escritorio para el sitio web chino de una empresa de diseño creativo.
...
### No. 10: Cuadrícula de Fotografía de Moda China Antigua
...
Un prompt para generar una serie profesional y de alta gama de fotografía de moda china antigua que representa el proceso completo de vestimenta de Song Yu en un tocador de la dinastía Song, organizada en una cuadrícula estricta de 3x3.
...
### No. 11: Reloj Analógico, Hamburguesa y Bebida
...
Una instrucción para generar una imagen de un reloj analógico que marca las 15:32, una hamburguesa con queso provolone dorado a la parrilla y un vaso.
...
### No. 12: Diseño Cuadrado de Teléfono y Tarjetas en Azul y Blanco
...
Una imagen cuadrada para redes sociales con colores azul y blanco, que presenta un teléfono inteligente, tres tarjetas de imagen, un título en japonés, amplios márgenes y sin texto adicional.
...
### No. 13: Capítulo de Libro de Física sobre Electromagnetismo
...
Una instrucción para generar un capítulo sobre electromagnetismo para un libro de física en español.
...
### No. 14: Manga de una Página sobre el Desarrollo Espacial
...
Una instrucción para generar un cómic vertical de una página, en blanco y negro, sobre el desarrollo espacial.
...
### No. 15: Cubo de Cristal Isométrico con Esferas de Colores
...
Una perspectiva isométrica de un cubo de cristal transparente que contiene una bola roja en la parte superior-izquierda-trasera y una bola azul en la parte inferior-derecha-delantera, con una bola verde sobre el cubo y una columna amarilla que lo atraviesa de abajo-izquierda a arriba-derecha.
...
### No. 16: Póster de Tipografía y Portada de Revista
...
Un prompt para generar un póster tipográfico con una lista de modelos y una portada de revista con cabecera y líneas de portada.
...
### No. 17: Anuncio Vertical de Reloj de Lujo
...
Un prompt para un anuncio de lujo vertical que presenta un reloj grande en un estudio de color verde esmeralda oscuro.
...
### No. 18: Hoja de Referencia de Diseño de Personaje
...
Un prompt para generar una hoja de referencia de diseño de personaje pictórica con líneas de construcción y un diseño específico.
...
### No. 19: Hoja de Personaje a Pantalla Dividida
...
Un prompt para generar una hoja de personaje premium a pantalla dividida para dos personajes originales.
...
### No. 20: Composición de Collage de Retrato Corporativo
...
Un collage de retrato corporativo ultra realista que presenta una composición de tres capas de un hombre.
...
### No. 21: Composición Dividida entre Foto e Ilustración
...
Un prompt para crear una imagen vertical que combine una foto original con una ilustración dibujada a mano de la misma escena.
...
### No. 22: Hoja de Personaje con Pantalla Dividida
...
Una indicación para crear una hoja de personaje con pantalla dividida, un divisor central audaz y un fondo de acuarela neón.
...
### No. 23: Cómic de Aventureros Planeando en una Taberna
...
Un prompt para generar un manga a color de dos páginas donde aventureros discuten un desafío de mazmorra en una taberna, con diálogos y efectos de sonido.
...
### No. 24: Dibujo Técnico de Máquina de Espresso
...
Un diagrama técnico de una máquina de espresso doméstica en estilo de dibujo mecánico de los años 60.
...
### No. 25: Interfaz Moderna de Panel de Control SaaS para Plataforma de IA
...
Una indicación para generar una interfaz moderna de panel de control SaaS de alta resolución 4K para una plataforma de análisis de IA, con una estética elegante en modo oscuro.
...
### No. 26: Interfaz de Usuario de Inventario para RPG de Fantasía Oscura
...
Un prompt para generar una interfaz de inventario de alta resolución para un RPG de fantasía oscura, que presenta a un paladín acorazado.
...
### No. 27: Póster de Sushi con Logotipo en Bajorrelieve
...
Un prompt para un póster que presenta un gran logotipo en bajorrelieve de color rojo oscuro en el fondo, que no se superpone con la silueta de un sushi.
...
### No. 28: Embalaje de Producto en Tres Zonas
...
Un prompt para visualizar un cartón de producto en tres etapas: como un elemento aislado principal, en el contexto de sus ingredientes y junto al plato terminado.
...
### No. 29: Fotografía de Producto con Ingredientes en el Perímetro
...
Un prompt para una imagen que presenta una bolsa de producto central rodeada de cuencos, bayas, granos y hojas, con un corredor vertical claro.
...
### No. 30: Cuadrícula de Pósters Idénticos de Menú de Café
...
Un prompt para diseñar un póster coleccionable de menú de café con campos negros consistentes, escala de taza, zona de título, microtexto y clips de latón.
...
### No. 31: Valla Publicitaria 3D con Producto que Rompe el Plano
...
Un prompt para una visualización de valla publicitaria 3D donde un bote principal se proyecta más allá del plano interior con sombras de contacto.
...
### No. 32: Alineación de Tres Conos con el Producto Principal en el Centro
...
Un prompt para una composición que presenta tres conos de sabor, donde el cono central de pistacho es dominante y los conos laterales son elementos de encuadre en ángulo.
...
### No. 33: Paneles Apilados con Diseño Consistente
...
Un prompt para generar cinco paneles apilados con un diseño de marca consistente que incluye logotipo, columna de titular, distintivo y composición del producto.
...
### No. 34: Actos de Degustación Horizontales con Nombres de Plato
...
Un prompt para un póster que representa cuatro actos horizontales, cada uno con un cuenco negro con vapor y un nombre de plato en caligrafía de pincel de gran tamaño.
...
### No. 35: Interfaz de Publicación Social Cortando a Través de Salsa
...
Una indicación para una imagen que presenta una banda minimalista negra de interfaz de publicación social cortando horizontalmente un chorro de salsa.
...
### No. 36: Póster de Composición Dividida Verticalmente
...
Una indicación para un póster con una división vertical que muestra un lado natural y limpio frente a un lado oscuro con ingredientes ocultos.
...
### No. 37: Arcos Líquidos de Chocolate Enmarcando el Producto
...
Una indicación para un póster de producto premium que presenta dos arcos líquidos de chocolate oscuro contenido enmarcando el producto en un movimiento orbital simétrico.
...
### No. 38: Dos Barras de Producto Cruzándose en Diagonal
...
Una indicación que describe dos barras de producto envasadas cruzándose en diagonal por el centro en direcciones opuestas.
...
### No. 39: Tres Cuencos Dispuestos en Diagonal
...
Una indicación para una imagen de tres cuencos dispuestos en diagonal desde el primer plano hasta el fondo.
...
### No. 49: Cubiertas de Pared de Propaganda Literaria Dramática
...
Un prompt para generar una cuadrícula 2x2 de cubiertas de pared de estilo propagandístico dramático para cuatro libros de dominio público.
...
### No. 50: Dioramas Conceptuales en Corte Transversal para Cuatro Marcas
...
Un prompt para generar una cuadrícula 2x2 de dioramas conceptuales en corte transversal para cuatro empresas de la lista Fortune 500.
...
### No. 51: Cartel Publicitario de Calzado Infantil con Niña y Zapatilla Gigante
...
Una indicación para generar un cartel publicitario alegre que presenta a una niña y una zapatilla gigante.
...
### No. 52: Storyboard Comercial de Perfume de Lujo
...
Un prompt para un storyboard de producto cinematográfico que presenta un perfume de rosa de lujo, en un diseño editorial limpio.
...
### No. 53: Storyboard Comercial de Perfume de Lujo
...
Un prompt para un storyboard de comercial de producto cinematográfico que presenta un perfume de rosa de lujo.
...
### No. 54: Cuadrícula de Vista Explosionada Técnica
...
Un prompt para generar una cuadrícula de 2x2 de ilustraciones técnicas que muestren vistas explosionadas en 3D de máquinas complejas.
...
### No. 55: Ilustración de Cómic a Color a Página Completa
...
Un prompt para generar una ilustración de manga shonen humorística y colorida a página completa, utilizando una composición auténtica de página de cómic.
...
### No. 56: Infografía Técnica de una Máquina de Café
...
Una infografía explicativa que traza el flujo de una máquina automática de espresso de principio a fin.
...
### No. 57: Anuncio de Campaña de Streetwear con Eslogan Exacto
...
Una imagen de campaña de ropa juvenil streetwear que muestra un eslogan exacto, legiblemente, dentro del diseño.
...
### No. 58: Logotipo Minimalista de Panadería sobre Fondo Transparente
...
Un logotipo de panadería plano, de estilo vectorial, entregado centrado sobre un canal alfa limpio sin fondo.
...
### No. 59: Cómic de Cuatro Viñetas de una Mascota en Casa Sola
...
Una tira vertical de cuatro viñetas que desarrolla un inicio, un giro y un remate a lo largo de los paneles.
...
### No. 60: Interfaz de Usuario de una App de Mercado Agrícola en un Marco de iPhone
...
Una maqueta práctica de aplicación móvil con encabezado, lista de vendedores y ofertas, colocada en un marco de dispositivo.
...
### No. 61: Diagrama de la Respiración Celular para el Aula
...
Un diagrama de biología para secundaria con etiquetas que conecta la glucólisis, el ciclo de Krebs y la cadena de transporte de electrones.
...
### No. 62: Diapositiva de Oportunidad de Mercado para Serie A
...
Una diapositiva para presentación de inversión con un diagrama TAM/SAM/SOM, barras de crecimiento, notas al pie y una jerarquía de datos real.
...
### No. 63: Maqueta de Valla Publicitaria con Titular Exacto
...
Una maqueta de valla publicitaria de carretera que lleva un titular textual en sans-serif negrita.
...
### No. 64: Viñeta de Manga con Bocadillos de Diálogo
...
Una imagen al estilo manga de una chica diciendo "¡Oye, escucha!" y un chico cubriendo su bocadillo de diálogo con su bocadillo de pensamiento que dice "Haré como que no lo oí", dibujada en una relación de aspecto vertical 4:5.
...
### No. 65: Viñeta de Manga: Chica Muerde el Bocadillo de Diálogo
...
Una escena al estilo manga de un chico diciendo "¿No vamos a pelear?" y una chica de aspecto feroz mordiendo su bocadillo de diálogo.
...
### No. 66: Cuadrícula Editorial de Décadas de la Moda
...
Una indicación para generar una cuadrícula de 2x2 que visualice cuatro movimientos de moda de diferentes décadas en un estilo de póster editorial 16:9.
...
### No. 67: Cuadrícula de Sistemas de Gobierno
...
Una indicación para generar una imagen de cuadrícula de 2x2 que visualice cuatro sistemas de gobierno diferentes en un estilo pastel de libro de cuentos.
...
### No. 68: Póster de Legado Heroico para Ajedrecista
...
Una indicación para generar una cuadrícula de 2x2 de pósteres tributo ilustrados heroicos para cuatro leyendas del ajedrez fallecidas.
...
- [Atlas Cloud GPT Image 2.5 Flare text-to-image](https://www.atlascloud.ai/es/models/openai/gpt-image-2.5-flare/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Flare edit](https://www.atlascloud.ai/es/models/openai/gpt-image-2.5-flare/edit?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Sunburst text-to-image](https://www.atlascloud.ai/es/models/openai/gpt-image-2.5-sunburst/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
