...
### No. 3: Портрет миниатюрной испанки у бассейна
...
Отполированный вертикальный портрет миниатюрной испанской женщины, сидящей у бирюзового крытого бассейна.
...
### No. 4: Две женщины в каменной арке
...
Промпт для изображения двух женщин, обрамлённых выцветшей на солнце каменной аркой.
...
### No. 5: Многопанельный портрет для карточки персонажа
...
Промпт для создания карточки персонажа с четырьмя студийными фотографиями одной и той же женщины с разных ракурсов.
...
### No. 6: Набор из девяти стикеров с эмодзи и текстом
...
Запрос на создание сетки 3x3 из различных стикеров с эмодзи на основе референсного персонажа, с китайским и английским текстом на светлом градиентном фоне.
...
### No. 7: Спрайт-лист с четырьмя анимациями персонажа в стиле dot-art
...
Запрос на создание спрайт-листа с четырьмя типами анимаций персонажа в стиле dot-art, каждый до 4 кадров, с сохранением единообразия дизайна.
...
### No. 8: Произведение искусства по мотивам скетча
...
Запрос на создание оригинального произведения искусства на основе скетча, сохраняющего его основную тему, эмоцию и позу, но переосмысляющего детали.
...
### No. 9: Утренний лайфстайл-портрет женщины
...
Фотореалистичный утренний лайфстайл-портрет молодой женщины с рыжевато-красными волосами.
...
### No. 10: Женщина, полулежащая в домашнем офисе
...
Запрос на создание фотореалистичного снимка на смартфон, изображающего молодую женщину, расслабленно лежащую на диване в современном домашнем офисе.
...
### No. 11: Портрет молодой женщины на iPhone
...
Запрос на создание реалистичного портрета молодой женщины на iPhone, снятого в помещении с отражающим фоном.
...
### No. 12: Спрайт-лист в пиксель-арте для персонажа
...
Промпт для создания упрощённого спрайт-листа в пиксель-арте размером 128 пикселей с прозрачным фоном и компоновкой 4x4 для боевых действий персонажа.
...
### No. 13: Дневная кемпинг-площадка из наброска
...
Серия промптов для преобразования детского рисунка в мрачную ночную кемпинг-площадку, затем в дневную версию и, наконец, для изменения одежды персонажа на комбинезон.
...
### No. 14: Минималистский арт страны одной линией
...
Запрос для создания вертикального минималистского художественного принта страны с использованием одной непрерывной линии.
...
### No. 15: Исторический портрет 1985 года: трансформация
...
Запрос для переосмысления внешности человека в стиле 1980-х годов с сохранением его основной идентичности и черт.
...
### No. 16: 3D-макет брендирования оверсайз футболок
...
Запрос для создания 3D-макета двух парящих оверсайз футболок с видами спереди и сзади.
...
### No. 17: Коллаж для люксового мужского эдиториала
...
Запрос для создания коллажа для люксового мужского эдиториала с использованием загруженной фотографии в качестве референса лица.
...
### No. 18: Референс для сохранения идентичности лица и композиции
...
Запрос, инструктирующий использовать загруженное изображение для сохранения черт лица и естественного вида субъекта.
...
### No. 19: Реалистичный профессиональный студийный портрет
...
Запрос для создания профессионального студийного портрета с использованием загруженной фотографии для идентичности лица и композиции.
...
### No. 20: Коллаж для модного эдиториала с единообразной моделью
...
Запрос для создания модного коллажа с единообразной мужской моделью с использованием референса для идентичности лица.
...
### No. 21: Портрет космонавта в футуристической кабине
...
Запрос для создания фотореалистичного портрета уверенной в себе женщины-космонавта в футуристической кабине космического корабля.
...
### No. 22: Ультрареалистичный студийный фэшн-портрет
...
Промпт для создания полноростового ультрареалистичного студийного фэшн-портрета с использованием загруженного изображения в качестве референса лица.
...
### No. 23: Кинематографичный портрет в мотоциклетном стиле
...
Ультрареалистичный портрет мужчины, сидящего на открытом воздухе рядом с премиальным спортивным мотоциклом.
...
### No. 24: Ультрареалистичный редакционный портрет
...
Промпт ИИ для создания ультрареалистичного редакционного портрета мужчины с использованием референса идентичности лица.
...
### No. 25: Премиальный фэшн-портрет по референсу
...
Промпт для создания премиального фэшн-портрета стильного взрослого мужчины с использованием референса идентичности лица.
...
### No. 26: Непостановочный лайфстайл-портрет по референсу
...
Промпт для создания высококачественного ультрафотореалистичного непостановочного лайфстайл-портрета женщины на основе референсного изображения.
...
### No. 27: Зимний фэшн-портрет на улице по фотографии
...
Промпт ИИ для создания реалистичного уличного зимнего фэшн-портрета с использованием фотографии субъекта в качестве референса лица.
...
### No. 28: Сверхреалистичный роскошный студийный портрет
...
Промпт для ИИ, чтобы создать сверхреалистичный роскошный студийный портрет стильного взрослого мужчины.
...
### No. 29: Кинематографичный дождевой портретный коллаж
...
Промпт для создания кинематографичного портретного коллажа в дождь с использованием загруженного изображения в качестве референса для композиции и атмосферы.
...
### No. 30: Селфи на смартфон с сохранением идентичности
...
Промпт для создания вертикального (3:4) сверхреалистичного селфи на смартфон, точно сохраняющего черты лица и внешность конкретной женщины.
...
### No. 31: Кинематографичный фэшн-портрет с идентичностью
...
Промпт для создания крупнопланового фэшн-портрета, сохраняющего личность и внешность модели.
...
### No. 32: Крупноплановый формальный студийный портрет
...
Промпт для создания крупнопланового студийного портрета молодого человека в официальной одежде с использованием референса лица.
...
### No. 33: Кинематографичный фотоснимок образа жизни с сохранением идентичности
...
Запрос на создание фотореалистичного кинематографичного изображения конкретной восточноазиатской женщины с сохранением ее идентичности и черт лица.
...
### No. 34: Кинематографичная фэшн-съемка с референсом идентичности
...
Запрос для генерации кинематографичной фэшн-фотографии женщины в темной обстановке с сохранением ее идентичности на основе референсного изображения.
...
### No. 35: Ультрареалистичный редакционный портрет по референсу
...
Запрос на генерацию изображения для создания ультрареалистичного редакционного портрета взрослого мужчины с использованием загруженного изображения в качестве референса лица.
...
### No. 36: Битва с драконом и предателем с топором
...
Промпт для генерации изображения битвы с драконом, где участвует предатель с топором, с использованием ChatGPT Astra.
...
### No. 37: Героический гигантский робот в фотореалистичном ракурсе
...
Промпт для создания изображения героического гигантского робота с динамичного, фотореалистичного угла.
...
### No. 38: Аниме-стиль на основе загруженного объекта
...
Промпт для создания изображения в аниме-стиле с уверенной линией, минимальным цел-шейдингом и яркими, насыщенными цветами.
...
### No. 39: Фронтальный плоский снимок продукта с чёткой этикеткой
...
Промпт для генерации двух изображений продукта с чёткими, читаемыми этикетками в стиле фронтальной плоской укладки.
...
### No. 40: Фэнтезийная сцена с орлом и отсылкой
...
Запрос для кинематографичной фэнтезийной сцены с женщиной в центре перед гигантским величественным белоголовым орланом с распростертыми крыльями.
...
### No. 41: Реклама высокой моды с идентичностью модели
...
Запрос для создания премиального, гиперреалистичного рекламного изображения в стиле высокой моды, которое сохраняет конкретную лицевую идентичность модели.
...
### No. 42: Статья в четырёхпанельную мангу в стиле журнала Afternoon
...
Запрос на создание четырёхстраничного комикса в стиле японского журнала Afternoon на основе приложенной статьи.
...
### No. 43: Кинематографичный лист персонажа (Character Bible)
...
Запрос на создание разделённого на экраны референс-листа персонажа с использованием строгих визуальных руководств.
...
### No. 44: Лист спрайтов для пиксель-арт сражений
...
Запрос на генерацию упрощённого листа анимации для пиксель-арт (128px) с боем на прозрачном фоне.
...
### No. 45: Лист спрайтов для пиксель-арт: боевые движения персонажа
...
Запрос на создание 16-кадрового листа пиксель-арт спрайтов, отображающего боевые движения персонажа.
...
### No. 46: Пиксельная арт-спрайтлист для битвы персонажа
...
Запрос на создание упрощённой пиксельной арт-спрайтлисты размером 128 пикселей с 16 кадрами для боевых движений персонажа, включая состояния покоя, удара, защиты и падения.
...
### No. 47: Фотореалистичный портрет с референсом идентичности
...
Запрос на создание фотореалистичного портрета в полный рост с использованием референсного фото для сохранения идентичности субъекта.
...
### No. 48: Лист персонажей Марти и Дока
...
Запрос на создание разделённого на экраны референсного листа для двух персонажей с использованием строгих визуальных указаний.
...
### No. 49: Лист персонажей Тэда и Джона
...
Промпт для создания листа персонажей с разделённым экраном, использующий строгие визуальные референсы для двух персонажей.
...
### No. 50: Лист персонажей с разделённым экраном для Дома и Брайана
...
Промпт для создания листа персонажей с разделённым экраном, использующий загруженные референсы для двух персонажей.
...
### No. 51: Кинематографический лист персонажа для Бэйби
...
Промпт для создания премиального листа персонажа для героя Бэйби, с жирной типографикой и строгим следованием визуальным референсам.
...
### No. 52: Кинематографический лист персонажей для Шмидта и Дженко
...
### No. 53: Кинематографический лист персонажа для Гордона
...
Промпт для создания премиального листа персонажа с жирной типографикой и строгим следованием визуальным референсам.
...
### No. 54: Лист персонажей для Джонни и Такера
...
Промпт для создания справочного листа персонажей с разделённым экраном, использующий строгие визуальные руководства.
...
### No. 55: Лист персонажей для Нео и Тринити
...
Промпт для создания справочного листа персонажей с разделённым экраном для Нео и Тринити, использующий строгие визуальные руководства.
...
### No. 56: Лист персонажей «Кевин против Мокрых Бандитов»
...
Промпт для создания премиального листа персонажей для «Кевин против Мокрых Бандитов» с использованием строгих визуальных референсов.
...
### No. 57: Ночная редакционная фэшн-съёмка на крыше со ступенями
...
Промпт для гиперреалистичного фото ночной редакционной фэшн-съёмки на лестнице крыши с прохладным кинематографическим ощущением.
...
### No. 58: Лист персонажей Риггса и Мёртога
...
Промпт для создания справочного листа персонажей с разделённым экраном для двух персонажей, использующий строгие визуальные руководства.
...
### No. 59: Премиальная кинематографическая карточка персонажей для Майка и Маркуса
...
Запрос на создание разделённого на экране референс-листа персонажей с использованием строгих визуальных руководств.
...
### No. 60: Премиальная кинематографическая карточка персонажей для Ли и Картера
...
### No. 76: Нью-Йоркское метро: откровенный портрет
...
Запрос на создание откровенной жизненной фотографии женщины с мягкими чертами лица и растрёпанными тёмными волосами в нью-йоркском метро.
...
### No. 77: Многопанельный референс-лист киноперсонажа
...
Запрос на создание референс-листа персонажа, показывающего одну и ту же реальную женщину в анфас, в три четверти, в профиль и со спины.
...
### No. 78: Минималистичное художественное произведение в технике акварельного виньетирования на основе фотографии
...
Запрос на преобразование загруженной фотографии в утончённое художественное произведение, сочетающее фотореализм с минималистичным стилем акварельной виньетки.
...
### No. 2: Преобразование фотографий в отдельные премиум-постеры
...
Инструкция в формате JSON для преобразования каждой загруженной фотографии в отдельный высококачественный постер без их объединения.
...
### No. 3: Ночной офис с экраном блок-схемы
...
Промпт для создания ночной комнаты для учёбы, а затем замены только содержимого экрана ноутбука на блок-схему автоматизации.
...
### No. 4: Перерисовка в стиле двухстраничной манги
...
Запрос на перерисовку изображения в стиле двухстраничной сюжетной манги с сохранением диалогов, сюжета и характеристик персонажей.
...
### No. 5: Преобразование окружения в живописный стиль
...
Запрос на редактирование фоновой пластины в более свободный, живописный стиль с сохранением конкретных композиционных элементов.
...
### No. 6: Реставрация поврежденного винтажного портрета
...
Запрос для восстановления сильно поврежденного старого портрета в чистое, современно выглядящее фото с использованием загруженного изображения в качестве референса.
...
### No. 7: Перекраска машины в неоновый чёрный
...
Промпт для изменения цвета объекта на неоново-чёрный с сохранением его исходной формы, текстуры и материала.
...
### No. 8: Вертикальное двухпанельное изображение: оригинал и редактированное
...
Запрос на создание единого вертикального изображения с двумя панелями, расположенными одна над другой, где верхняя панель остается исходной референсной фотографией.
...
### No. 9: Перекадрировать фотографию под заданное соотношение сторон
...
Запрос на изменение размера фотографии до выбранного соотношения сторон с сохранением естественного положения основного объекта.
...
### No. 10: Портрет с жёстким светом и резкими тенями
...
Промпт, описывающий портрет, освещённый жёстким, не смягчённым солнечным светом из окна под определённым углом, создающим резкие тени на лице.
...
### No. 6: Реалистичный скриншот из романтической RPG нового поколения
...
Промпт для генерации реалистичного скриншота из вымышленной романтической RPG нового поколения с открытым миром и видом от первого лица.
...
### No. 7: Премиум-диорама известного архитектурного памятника
...
Промпт для создания милой и элегантной 3D-диорамы знаменитого сооружения в мягких пастельных тонах с деталями ручной работы.
...
### No. 8: Вертикальная ботаническая бумажная скульптура стройной женщины
...
Вертикальное ботаническое произведение из бумаги, изображающее стройную женщину в профиль с платьем из листьев и слоновой кости зонтиком.
...
### No. 9: Фотореалистичный модельный набор бело-золотого паладина
...
Промпт для генерации фотореалистичного изображения робота-паладина в бело-золотой расцветке в виде модельного набора, выставленного в магазине электроники среди множества одинаковых коробок.
...
### No. 10: Непостановочное туристическое фото у исторической стены
...
Реалистичное непостановочное туристическое фото молодой женщины у исторической городской стены ночью со светящимся традиционным китайским зданием.
...
### No. 11: Винтажный туристический постер для локации
...
Промпт для создания туристического постера в стиле 1920-1930-х годов с многослойной иллюстрацией в технике бумажного рельефа и тиснения, выполненной в приглушённой цветовой палитре.
...
### No. 12: Макросъемка глаза бабочки и кошачьего уса
...
Фотореалистичный макроснимок кошачьего уса, фасеточных глаз бабочки и кожи девушки.
...
### No. 13: Роскошные часы на мраморном макете
...
Фотореалистичный макет рекламы для журнала: роскошный титановый хронограф с чётким текстом на циферблате.
...
### No. 14: Макет премиального пакета для кофе
...
Фотореалистичный коммерческий макет матового чёрного пакета для кофе с линейным рисунком гор на грубой деревянной поверхности.
...
### No. 15: Постер-лукбук для модного интернет-магазина
...
Промпт для создания чистого постера-лукбука с молодой моделью в осенней одежде, выполненного в мягких пастельных тонах.
...
### No. 16: Миниатюрная туристическая сцена с достопримечательностью
...
Промпт для создания очаровательной, выполненной вручную миниатюрной сцены с крошечной 3D-моделью знаковой достопримечательности.
...
### No. 17: Эдиториал-портрет женщины, смотрящей на город
...
Фотореалистичный эдиториал-портрет взрослой восточноазиатской женщины, смотрящей на город в сумерках.
...
### No. 18: Кинематографичный портрет женщины в солнечном кафе
...
Промпт для фотореалистичного кинематографичного портрета взрослой восточноазиатской женщины в залитом солнцем кафе по соседству.
...
### No. 19: Асимметричный редакционный портрет вполоборота
...
Запрос на создание портрета в редакционном стиле, где объект расположен у левого края кадра.
...
### No. 20: Премиальный редакционный арт-постер для локации
...
Запрос на создание высококачественного постера в современном стиле арт-бука для указанной локации.
...
### No. 21: Теплая ночная сцена: женщина читает дома
...
Запрос на создание реалистичной горизонтальной фотографии 16:9, изображающей женщину в теплой, обычной квартире ночью.
...
### No. 22: Делюкс-парфе из нелюбимых продуктов
...
Запрос на создание делюкс-парфе, состоящего исключительно из обычно нелюбимых продуктов, с 30 видами ингредиентов и аннотациями.
...
### No. 23: Японский винтажный туристический постер эпохи Сёва
...
Запрос на создание премиального вертикального туристического постера в стиле японской железнодорожной рекламы середины века.
...
### No. 24: Кинематографичный портрет на платформе метро
...
Высокодетализированный портрет молодой женщины с каштановыми волосами, неподвижно стоящей на фоне проносящегося поезда.
...
### No. 25: Портрет с верхнего ракурса в ципао
...
Портрет с верхнего ракурса, изображающий высокую стройную модель с утонченным макияжем и лисьими чертами лица, одетую в ципао, в мягком, мечтательном освещении.
...
### No. 26: Затопленная равнина с несоответствующим отражением
...
Запрос на создание кинематографичного кадра из фильма, изображающего затопленную равнину в сумерках с фермерским домом и тополями, с несоответствующим отражением в воде.
...
### No. 27: Сетка 3x3 в стиле клипа Vocaloid
...
Запрос на создание сетки 3x3 из различных кадров в стиле музыкального видео Vocaloid с соотношением сторон 16:9.
...
### No. 28: Спрайт-лист вороны в 16-битном стиле
...
Промпт для создания спрайт-листа в 16-битном стиле, изображающего ворону в полете, взлете и посадке.
...
### No. 29: Гладиатор на коне (низкий ракурс)
...
Кадр, снятый с экстремально низкого ракурса, на котором изображен гладиатор на боевом коне; вид с каменистой горной тропы.
...
### No. 30: Крупный план рифа с осьминогом
...
Промпт, предписывающий приблизиться на риф, наблюдать игру света на камне и включить в кадр ровно восемь щупалец.
...
### No. 31: Кинематографичный анаморфный кадр с женщинами в пионе
...
Широкоформатная анаморфная фотография пяти миниатюрных китаянок, сидящих внутри крупного бледно-розового пиона.
...
### No. 32: Женщина среди густых розовых цветущих ветвей
...
Фотография женщины, окруженной густыми розовыми цветущими ветвями, заполняющими передний и задний план.
...
### No. 33: Робот на пляже на закате
...
Реалистичная кинематографичная сцена: робот сидит на пляже на закате и смотрит на песок в своей руке.
...
### No. 34: Киберпанк-костюм с пушистыми волчьими ушами
...
Промпт для создания киберпанк-стиля костюма с неоново-розовыми и зелеными пушистыми волчьими ушами и чокером.
...
### No. 35: Крупный план селфи молодой женщины
...
Промпт для создания необработанной фотографии с iPhone: молодая женщина с веснушками и ветром в волосах.
...
### No. 36: Президент 1980-х приветствует инопланетянина на лужайке Белого дома
...
Промпт для создания изображения в стиле фотографии 1980-х годов, на котором Президент приветствует инопланетянина на лужайке Белого дома.
...
### No. 37: Кадр из фильма о королевском пире эпохи Тан
...
Широкоэкранный исторический кадр из фильма, изображающий вымышленный роскошный ночной королевский пир эпохи династии Тан.
...
### No. 38: Реалистичная фэшн-фотография восточноазиатской женщины
...
Промпт для создания реалистичной фэшн-фотографии взрослой восточноазиатской женщины с длинными чёрными волосами, тёплым светом и тенями на лице, а также естественной текстурой кожи.
...
### No. 39: Портрет тайваньской женщины с чёрным туманным фильтром
...
Промпт для создания портрета с использованием чёрного туманного фильтра, наложения маски и мягкой световой CCD-съёмки с тонкими бликами.
...
### No. 40: Красный пауковый лилия у реки после дождя
...
Промпт для генерации реалистичного изображения одного красного паукового лилия с каплями дождя, расположенного у реки после дождя.
...
### No. 41: Уличная сцена после закрытия в дождь
...
Промпт для создания атмосферного изображения, изображающего человека после закрытия, с акцентом на мокрую шерсть, кожу и уличный фонарь.
...
### No. 42: Фэшн-редакционная съёмка с ветром и шёлком
...
Промпт для сцены фэшн-редакционной съёмки с тремя людьми, стилизованной ветром, с жёстким солнечным светом и обилием шёлка.
...
### No. 43: Реалистичное фото на iPhone Tesla Model Y
...
Промпт для создания реалистичной фотографии на iPhone, изображающей Tesla Model Y на парковке, снятой на камеру 0.5x.
...
### No. 44: Эко-футуристический город в сумерках с луной
...
Промпт, описывающий эко-футуристический город в сумерках, лунный город с гигантской Землёй, серафима-хранителя-рыцаря галактики и сереброволосую королеву, танцующую в ледяном кристальном соборе.
...
### No. 45: Большая армия с драконом под дождём
...
Сложная сцена, включающая армию из более чем 100 человек, персонажа Луну, белого дракона, японскую вывеску, детальное владение копьём и дождевые отражения.
...
### No. 46: Серый нидерландский карликовый кролик в прыжке
...
Промпт для генерации изображений прыгающего кролика и прыгающего серого нидерландского карликового кролика.
...
### No. 47: Аниме-пара в парке, высокая детализация
...
Запрос на генерацию изображения в стиле аниме: молодой парень и девушка в повседневной одежде в большом парке, отрендерено в сверхвысоком 16K разрешении с усиленной контрастностью и насыщенностью.
...
### No. 48: «Сон в красном тереме» в виде традиционного свитка
...
Запрос на реконструкцию сцены из «Сна в красном тереме» в виде традиционной китайской живописи на длинном свитке.
...
### No. 49: Серия: Архитектура брутализма в пустыне
...
Запрос на генерацию изображений монолитных земляных сооружений в стиле пустынного брутализма, включающих гибриды знаменитых архитекторов.
...
### No. 50: Фотография прогулки по улице в золотой час
...
Запрос на создание фотореалистичного снимка на смартфон: женщина идёт по улице, обсаженной деревьями, в золотой час.
...
### No. 51: Коллекция роскошных туристических постеров
...
Запрос на создание изысканной коллекции туристических постеров класса люкс, вдохновлённых Санторини, Амальфитанским побережьем и Парижем.
...
### No. 52: Непостановочный портрет в городском парке
...
Непостановочный портрет на открытом воздухе: молодая женщина с длинными тёмно-каштановыми волосами в спокойном городском парке в солнечный день.
...
### No. 53: Референсный лист персонажа: Пустынный ассасин
...
Запрос на генерацию кинематографичного референсного листа персонажа, изображающего смертоносного ассасина из пустыни.
...
### No. 54: Модная фотография восточноазиатской женщины в лаунже
...
Запрос на создание ультра-фотореалистичной модной фотографии на смартфон: красивая восточноазиатская женщина в приватном лаунже ночью.
...
### No. 55: Винтажная художественная почтовая марка для путешествий
...
Запрос на создание почтовой марки в винтажном стиле с изображением знаковой достопримечательности и культурных элементов страны.
...
### No. 56: Винтажный туристический постер с узнаваемым сооружением
...
Запрос на создание стилизованного, будто нарисованного вручную, винтажного туристического постера с узнаваемым архитектурным памятником.
...
### No. 57: Непостановочный модный портрет в подземном паркинге
...
Запрос на создание ультра-фотореалистичного портрета красивой евразийской женщины в современном подземном паркинге.
...
### No. 58: Ручная миниатюрная сцена с едой
...
Запрос для создания очаровательной миниатюрной сцены с изображением конкретного блюда на керамической тарелке.
...
### No. 59: Миниатюрная диорама витрины магазина
...
Запрос для создания причудливой 3D-глиняной миниатюрной диорамы узнаваемого магазина или бренда.
...
### No. 60: Миниатюрная диорама знакового сооружения
...
Запрос для создания детализированного, уютного миниатюрного мира с центральным знаковым сооружением.
...
### No. 61: Асимметричная студийная портретная съемка в стиле высокой моды
...
Запрос для создания крупнопланового портрета мужчины на белом студийном фоне с асимметричной композицией.
...
### No. 62: Ландшафт белого лабиринта, вырезанный ветром
...
Описательный запрос для создания ландшафта белого лабиринта, сформированного ветровой эрозией с течением времени.
...
### No. 63: Рыцарь Белого Дракона и маленький камень
...
Сцена, изображающая Рыцаря Белого Дракона ночью, остановленного не врагом, а одним маленьким камнем, с философской подписью.
...
### No. 64: Портрет уверенного мужчины в редакционном стиле
...
Промпт для создания премиального портрета уверенного мужчины с короткими черными волосами в редакционном студийном стиле.
...
### No. 65: Полноростовый студийный фэшн-портрет
...
Промпт для создания полноростового портрета уверенной мужской модели в теплой бесшовной студийной обстановке.
...
### No. 66: Шедевр для кампании в сфере люксовых путешествий
...
Промпт для создания изысканной кампании в стиле luxury-лайфстайл, объединяющей впечатления от Альп, Дубая и европейских шале.
...
### No. 67: Утренний ритуал Мастера Синего Мага
...
Сцена, изображающая утро Мастера Синего Мага, где расчески, резинки для волос и шнурки заканчивают свою работу, пока он читает отчеты.
...
### No. 68: Корабль прибывает к Белому Меловому берегу
...
Описательный промпт для сцены прибытия корабля к берегу из белой земли, соли и известняка, за которым простираются невидимые земли.
...
### No. 69: Портрет персонажа: Морской эльф-рыбак
...
Промпт, описывающий эльфа, живущего у моря, прибрежного рыбака, читающего знаки океана.
...
### No. 70: Профессиональный студийный портрет (хедшот)
...
Промпт для создания профессионального студийного портрета (хедшота) взрослого мужчины.
...
### No. 71: Уверенный мужчина в роскошном современном интерьере
...
Ультрареалистичный лайфстайл-портрет уверенного мужчины в роскошном современном интерьере с темным деревянным дверным проемом и большим зеркалом.
...
### No. 72: Фэнтезийный копейщик, спящий за столом
...
Поэтичное описание ночи копейщика, вспоминающего текстуру дерева стола перед потусторонней картой.
...
### No. 73: Драконий рыцарь отдыхает в тени
...
Сцена, изображающая двух драконьих рыцарей, отдыхающих под крылом дракона, с картой и чёрствым хлебом.
...
### No. 74: Стильный мужчина в уютной вечерней библиотеке
...
Сверхреалистичный портрет мужчины, отдыхающего в элитной библиотеке-лаунже ранним вечером.
...
### No. 75: Почтальон-Дуллахан осенней ночью
...
Ночной почтальон идёт по осенней дороге, усаженной красными пауковыми лилиями, под ночным небом.
...
### No. 76: Ростовой редакционный портрет в бордовом
...
Сверхреалистичный редакционный портрет уверенного в себе чернокожего мужчины в чистом костюме, сидящего в минималистичной студийной обстановке.
...
### No. 77: Послеполуденное время Мастера Синей Магии
...
Сцена, изображающая послеполуденное время Мастера Синей Магии, чья магия рассеивает солнечный свет и булыжники прежде, чем они достигнут её.
...
### No. 78: Закат над потрескавшейся землёй с пламенем
...
Описательный промпт для сцены сумеречной дикой природы с тонкими языками пламени, поднимающимися из трещин в земле, и Каспийским морем вдали.
...
### No. 79: Винтажный парусник на фоне золотого заката
...
Ультрареалистичное изображение винтажного деревянного парусного корабля в драматичной океанской сцене на закате.
...
### No. 80: Рыцарь Белого Дракона осматривает травму крыла
...
Сцена, где Мастер-Рыцарь Белого Дракона осторожно проверяет травму левого крыла спящего дракона в лунном свете драконьей конюшни.
...
### No. 81: Путешественник чинит синюю ткань в вулканическом городе
...
Сцена починки синей дорожной ткани в вулканическом городе днем, на фоне далеких гор.
...
### No. 82: Утро в зеркальном мире с копейщиком
...
Запрос, изображающий копейщика, потерявшего свой высший титул, начинающего свой день с мокрых шнурков утром в зеркальном мире.
...
### No. 83: Мастер Синей Магии Луна перед рассветом
...
Сцена, изображающая Мастера Синей Магии Луну перед рассветом, с книгами, креслом и чаем, из времен, когда ей не было нужно ее тело.
...
### No. 84: Пейзаж, где огонь сочится из земли
...
Описательный запрос для пейзажа, где огонь сочится из земли в сухой пустыне, с серой грязью, стекающей вниз, и Каспийским морем вдали.
...
### No. 85: Ночная Черная Драконья Рыцарь Луна
...
Сцена, изображающая Черную Драконью Рыцарь Луну ночью, проверяющую мозоли на руках от копья, пока Эль Драго спит рядом с ней.
...
### No. 86: Фрирен и Ферн в хорошем месте
...
SFW-иллюстрация, изображающая разговор между персонажами Ферн и Фрирен.
...
### No. 87: Холмы, изрезанные ветром и дождем
...
Поэтичный запрос, описывающий пейзаж, где зелень угасает, обнажая слои охры, ржавчины, серо-белого и бледно-зеленого на холмах, изрезанных ветром и дождем.
...
一个用于生成东方美学壁纸的AI提示，描绘一位古典女子手持团扇，立于白墙与竹影之前。
...
一个描绘东京警方重型机械机器人小队通过拖曳救生艇营救灾民的提示。
...
一个用于生成明亮日间CCD风格生活照片的提示，主题为天文观测台上的城市探索。
...
一个用于生成年轻女子真实、自然的iPhone风格肖像照片的提示。
...
一个图像生成提示，用于创作一幅优雅、简约的东方风格海报，描绘一位古典女子立于翠绿花窗旁。
...
一个详细的提示，用于生成一位年轻东亚女性的膝盖以上、平视视角的超写实肖像，包含具体面部特征描述。
...
一个描述警方重型机械部队的机器人小队清理堵塞河道的垃圾的提示。
...
一个详细的提示，用于生成一位年轻东亚女性的膝盖以上、平视视角的编辑肖像，包含具体面部特征描述。
...
一个用于生成20-26岁女性真实、随意的9:16竖版照片的提示，仿佛使用iPhone主摄像头拍摄。
...
一个用于生成东方美学壁纸的提示，描绘一位女子在水边，呈现极简、清新的风格。
...
一个详细的提示，用于生成一位年轻东亚女性的超写实编辑肖像，包含具体面部特征描述。
...
一个用于生成明亮日间CCD风格生活照片的提示，背景为都市艺术环境，并包含具体服装描述。
...
一个详细的提示，用于生成一位年轻东亚女性的膝盖以上、腰部高度的编辑肖像，包含具体面部特征描述。
...
一个用于生成东方极简风格壁纸的提示，描绘一位优雅的古风女子穿过蓝色门廊，伴有樱花飘落。
...
### No. 102: Роботизированная команда полицейского подразделения по работе с тяжелой техникой
...
Изображение команды полицейских роботов из Подразделения по борьбе с тяжелой техникой, убирающей транспортные средства с дороги, затопленной из-за сильного дождя.
...
### No. 103: Яркая дневная CCD-фотография городской спортивной жизни
...
Промпт для создания яркой дневной фотографии в стиле CCD (сенсор камеры), изображающей повседневную жизнь в городской спортивной обстановке.
...
### No. 104: Вертикальная обложка в дзен-минималистичном стиле
...
Промпт для создания минималистичной, светлой и чистой вертикальной обложки формата 9:16 с современной восточной женской эстетикой и утренним настроением.
...
### No. 105: Женщина сидит у круглого окна
...
Промпт для создания плаката в восточном дзен-минималистичном стиле, изображающего женщину, отдыхающую у круглого окна.
...
### No. 106: Отряд полицейских роботов останавливает неуправляемый грузовик
...
Изображение отряда полицейских роботов из Подразделения по борьбе с тяжелой техникой, пытающегося остановить неуправляемый грузовик.
...
### No. 107: Полноростовой редакционный портрет молодой женщины
...
Промпт для создания полноростового редакционного портрета молодой японской или корейской женщины на уровне глаз, в серьгах-кольцах.
...
### No. 108: Фотореалистичный портрет по пояс в очках
...
Портрет молодой японской или корейской женщины по пояс, снятый с уровня колен, в смелых очках с толстой белой оправой.
...
### No. 109: Минималистичная обложка в стиле дзен с женщиной и ветряным колокольчиком
...
Промпт для создания изображения женщины, касающейся ветряного колокольчика у окна, в минималистичном восточном дзен-стиле.
...
### No. 110: Постапокалиптический город с зеленой растительностью
...
Детализированная фотография постапокалиптического города в Шэньчжэне, Китай, заросшего зеленой растительностью.
...
### No. 111: Японка с лицом, похожим на тануки, ночью
...
Промпт для создания фотореалистичного изображения вымышленной молодой японки с лицом, напоминающим тануки (енотовидную собаку), в тихой ночной обстановке.
...
### No. 112: Взгляд дельфина на женщин в стеклянном аквариуме
...
Реалистичное изображение с перспективы дельфина, смотрящего через 360-градусный стеклянный резервуар на женщин, посещающих оживлённый женский аквариум.
...
### No. 113: Миниатюрная сцена брендового магазина из полимерной глины
...
Промпт для создания миниатюрной глиняной модели брендового магазина с уютными деталями тротуара.
...
### No. 114: Модная реклама с низким ракурсом съёмки
...
Рекламная кампания для вымышленного бренда с шестью людьми в яркой одежде на фоне кобальтового неба, снятая с низкого угла.
...
### No. 115: Ручная отрисовка аниме-дуэли с сакурой
...
Сцена из японского рисованного анимационного фильма конца 1990-х годов: женщина с катаной противостоит фехтовальщику под падающими лепестками сакуры.
...
### No. 116: Чёрное свадебное платье готической невесты-призрака
...
Промпт для костюма готической невесты-ужаса на Хэллоуин, сочетающего тёмную романтическую элегантность.
...
### No. 117: Мрачный кинематографичный портрет восточноазиатской женщины
...
Промпт для контрастного, кинематографичного крупного плана портрета молодой восточноазиатской женщины с бледной кожей и длинными чёрными волосами.
...
### No. 118: Кинематографичный ночной уличный портрет на мокром переходе
...
Промпт для кинематографичного портрета молодой восточноазиатской женщины на мокром пешеходном переходе ночью.
...
### No. 119: Крупный план портрета со светящимися золотыми глазами
...
Промпт для кинематографичного портрета крупным планом молодой восточноазиатской женщины с иссиня-чёрными волосами и светящимися золотыми глазами.
...
### No. 120: Фотореалистичный портрет в очках с подмигиванием
...
Фотореалистичный портрет молодой восточноазиатской женщины в очках с волнистыми волосами, мягко подмигивающей.
...
### No. 121: Портрет в стиле аналоговой плёнки с растрёпанными волосами
...
Фотореалистичный портрет в стиле аналоговой плёнки, изображающий молодую восточноазиатскую женщину с растрёпанными чёрными волосами, смотрящую в камеру.
...
### No. 122: Кинематографичный портрет, парящий в тёмной воде
...
Кинематографичный портрет безмятежной молодой женщины, парящей в неподвижной воде с мокрыми волосами.
...
### No. 123: Студийный портрет красавицы с боковой косой
...
Фотореалистичный студийный портрет красавицы — молодой восточноазиатской женщины со светящейся кожей, длинными чёрными волосами и закрытыми глазами.
...
### No. 124: Портрет женщины в машине в хиджабе
...
Фотореалистичный крупноплановый портрет молодой восточноазиатской женщины в машине, одетой в светло-бежевый хиджаб.
...
### No. 125: Женщина делает селфи в хиджабе
...
Запрос на создание изображения молодой женщины в светлом хиджабе, делающей селфи за деревянным столом.
...
### No. 126: Портрет женщины, смотрящей через плечо
...
Детализированный запрос на создание фотореалистичного портрета молодой восточноазиатской женщины, смотрящей через плечо.
...
### No. 127: Портрет женщины в очках
...
Портрет молодой восточноазиатской женщины в очках, с волнистыми волосами и спокойным выражением лица.
...
### No. 128: Крупноплановый портрет с яркой помадой
...
Фотореалистичный портрет молодой восточноазиатской женщины с фарфоровой кожей, миндалевидными глазами и яркой помадой.
...
### No. 129: Портрет с мокрыми волосами и обнажённым плечом
...
Фотореалистичный портрет молодой женщины с сияющей кожей и мокрыми чёрными волосами, смотрящей через плечо.
...
### No. 130: Кинематографичный портрет восточноазиатской женщины
...
Крупноплановый портрет молодой восточноазиатской женщины с длинными тёмными волнистыми волосами на чёрном фоне.
...
### No. 131: Фотореалистичный портрет в очках
...
Фотореалистичный портрет молодой восточноазиатской женщины с длинными волнистыми волосами, круглыми очками и мягким выражением лица.
...
### No. 132: Кинематографичный портрет с медовыми прядями
...
Запрос на создание кинематографичного крупнопланового портрета молодой восточноазиатской женщины с волнистыми светло-каштановыми волосами и спокойным выражением лица.
...
### No. 133: Фотореалистичный портрет с каре
...
Фотореалистичный крупноплановый портрет молодой восточноазиатской женщины с коротким чёрным каре, дымчатыми тенями и сияющей кожей.
...
### No. 134: Портрет женщины в хиджабе и бейсболке
...
Крупный план портрета молодой женщины со светлой кожей и спокойным выражением лица, в белом хиджабе и черной бейсболке.
...
### No. 135: Селфи-портрет в шифоновом хиджабе
...
Крупный план селфи-портрета молодой восточноазиатской женщины со светлой кожей и тонкими чертами лица, в пыльно-бежевом шифоновом хиджабе.
...
### No. 136: Кинематографичный портрет плачущей восточноазиатской женщины
...
Фотореалистичный крупный план портрета молодой женщины с глянцевой кожей, по которой текут слезы, и тонкой челкой.
...
### No. 137: Портрет женщины с украшенной кружевной повязкой на глазу
...
Крупный план портрета молодой женщины со светлой кожей и черным каре, с одним видимым красным глазом, а другой закрыт украшенной драгоценностями черной кружевной повязкой.
...
### No. 138: Напряженный кинематографичный портрет с растрепанными волосами
...
Крупный план кинематографичного портрета молодой женщины с длинными черными волосами, смотрящей прямо в камеру.
...
### No. 139: Крупный план портрета с глянцевыми темными волосами
...
Детализированный запрос на создание портрета молодой женщины со светлой кожей и длинными темными волосами.
...
### No. 140: Улыбающийся портрет с загаром и влажным блеском кожи
...
Крупный план портрета молодой восточноазиатской женщины с растрепанными черными волосами, щурящейся и улыбающейся, с румяной, сияющей кожей.
...
### No. 141: Выразительный портрет со стрелками на глазах
...
Детализированный запрос на создание крупного плана портрета молодой женщины из Юго-Восточной Азии с определенными чертами лица и макияжем.
...
### No. 142: Селфи-портрет с выражением поцелуя
...
Запрос на создание крупного плана селфи-портрета молодой восточноазиатской женщины с закрытыми глазами и расслабленным выражением лица.
...
### No. 143: Портрет улыбающейся молодой женщины
...
Запрос на создание портрета молодой восточноазиатской или индонезийской женщины со светлым цветом лица, мягким макияжем и нежным, дружелюбным выражением.
...
### No. 144: Селфи женщины с волосами, собранными наполовину
...
Запрос на создание фотореалистичного селфи-портрета молодой восточноазиатской женщины с определенными чертами лица и укладкой.
...
### No. 145: Фазы поглощения Земли черной дырой
...
Запрос на создание четырех изображений, изображающих визуальные фазы поглощения Земли черной дырой с точки зрения человеческого наблюдателя.
...
### No. 146: Киберпанк-воин против механического босса
...
Промпт, описывающий двух персонажей: киберпанк-воина с катаной и массивного механического босса.
...
### No. 147: Небесная богиня, нисходящая перед дворцом
...
Изображение величественной китайской небесной богини в церемониальном ханьфу, спускающейся сквозь розово-золотые облака перед небесным дворцом.
...
### No. 148: Небесная дева в трёхчетвертном ракурсе при солнечном свете
...
Изображение небесной девы в ханьфу цвета слоновой кости, освещённой утренним светом, с развевающимися лентами и золотыми шпильками.
...
### No. 149: Небесная дева, сидящая у нефритового пруда
...
Изображение безмятежной китайской небесной девы в шёлковом ханьфу, касающейся лотоса у бирюзового пруда.
...
### No. 150: Небесная богиня на ступенях нефритового дворца
...
Изображение элегантной китайской небесной богини на вершине ступеней из белого нефрита, в вышитом ханьфу с развевающимися шёлковыми лентами.
...
### No. 151: Портрет в древнем китайском ритуальном святилище
...
Фотореалистичный кинематографичный портрет взрослой восточноазиатской женщины в тёмном древнем китайском ритуальном святилище с масками Нуо и свечами.
...
### No. 152: Портрет женщины в тёмном ритуальном святилище
...
Фотореалистичный кинематографичный портрет восточноазиатской женщины с мокрыми чёрными волосами и дымчатым макияжем в тёмном древнем святилище.
...
### No. 153: Крупный план портрета на ночном фестивале Нуо
...
Крупный план портрета взрослой восточноазиатской женщины рядом с потрёпанной маской Нуо во время ночного ритуального фестиваля.
...
Промпт для генерации фотореалистичного изображения пива с плотной, ниспадающей пеной в стакане с острым краем.
...
### No. 155: Кубик тофу, поднятый из рагу
...
Описательный промпт для изображения пористого кубика тофу, поднятого над кастрюлей, с одной каплей янтарного бульона.
...
### No. 156: Ложка острой приправы из чили
...
Изображение ложки острой приправы из чили с чёткими красными кубиками перца, потемневшей зеленью, ярким зелёным перцем, светлыми бобами и прозрачным янтарно-красным маслом.
...
### No. 157: Крупный план портрета женщины в гостиной
...
Ультрареалистичный крупный план портрета молодой женщины с игривым выражением лица в уютной современной гостиной.
...
### No. 158: Портрет женщины, возлежащей в полумраке спальни
...
Запрос на фотореалистичный вертикальный портрет молодой женщины, возлежащей на постели в слабо освещенной спальне ночью.
...
### No. 159: Мечтательный портрет женщины в летней траве
...
Вдохновленное кинематографом изображение молодой восточноазиатской женщины, отдыхающей в высокой траве, мягко освещенной теплым дневным светом.
...
### No. 160: Портрет женщины у ярко-синей гавани
...
Портрет в стиле с зернистостью пленки, на котором молодая восточноазиатская женщина непринужденно присела у ярко-синей гавани в солнечный ветреный день.
...
### No. 161: Уличный портрет молодой женщины в Париже
...
Запрос на портрет высокого разрешения, сделанный при естественном свете на улице, с молодой женщиной азиатской внешности на торговой улице в парижском стиле.
...
### No. 162: Непринужденный портрет в метро ночью
...
Фотореалистичный непринужденный портрет взрослой восточноазиатской женщины, сидящей у окна поезда ночью.
...
### No. 163: Часы с ледяной и дымовой ударной волной
...
Изображение часов с круговой ударной волной изо льда и дыма позади них, сохраняющее чистый силуэт.
...
### No. 164: Многослойная витрина пекарни с глубиной
...
Запрос на создание изображения премиальной витрины пекарни, где предметы расположены на разных уровнях высоты для создания глубины.
...
### No. 165: Мягко освещенный портрет в спальне в комбиназоне
...
Фотореалистичный портрет взрослой восточноазиатской женщины в комбиназоне из слоновой кости из атласа в мягко освещенной спальне.
...
### No. 166: Автомобиль с контрастным облаком взрывной пыли
...
Изображение мощного автомобиля, создающего за собой массивное облако пыли, в то время как на переднем плане он остаётся чистым и бесшумным.
...
### No. 167: Силуэт ведьмы, подсвеченный небесным огнём
...
Изображение силуэта ведьмы, подсвеченного массивным оранжево-золотым облаком небесного пламени.
...
### No. 168: Сердце из томатного соуса, поднимающееся над миской кошари
...
Изображение глянцевого томатного соуса, формирующего форму сердца над миской с кошари.
...
### No. 169: Шахматные фигуры, вылепленные из нитей лапши
...
Запрос на создание шахматных фигур, вылепленных из нитей лапши ручной работы с узнаваемыми силуэтами.
...
### No. 170: Бутылка кунжутного масла с руками боксёра на ринге
...
Изображение увеличенной бутылки кунжутного масла с золотистыми руками боксёра, стоящего победителем на боксёрском ринге.
...
### No. 171: Сцена на столешнице компактной современной кухни в квартире
...
Запрос на создание изображения компактной современной кухни в квартире с барной стойкой для завтрака, непрерывной столешницей, раковиной из нержавеющей стали, варочной панелью и сковородой.
...
### No. 172: Шаурма, направленная вверх под углом, как ракета
...
Запрос на создание изображения шаурмы, расположенной под углом, как ракета, с акцентом на открытую начинку как на центральный элемент.
...
### No. 173: Талисман-банан, держащий огромную банку
...
Изображение бегущего талисмана в виде банана, держащего огромную холодную алюминиевую банку и направляющего её вперёд к камере.
...
### No. 174: Непостановочная ночная фотография восточноазиатской женщины
...
Запрос на создание реалистичной непостановочной фотографии восточноазиатской женщины с определёнными чертами лица и освещением.
...
### No. 175: Крем печенья как миниатюрная ледяная поверхность для катания
...
Изображение печенья, где слой ванильного крема поднимается, образуя гладкую миниатюрную ледяную поверхность для катания, превращая масштаб в зимний мир.
...
### No. 176: Трасса американских горок из аккуратно сложенных чипсов
...
Изображение трассы американских горок, построенной из идеально выровненных и сложенных чипсов, с полной петлёй.
...
### No. 177: Зоны красного прожектора за главным ведром
...
Запрос на изображение, описывающее три чистые зоны красного прожектора с вторичными бытовыми сценами позади главного ведра.
...
### No. 178: Глянцевый поток лапши как вертикальная линия движения
...
Концепция минималистского постера с единственным глянцевым потоком лапши в качестве центрального вертикального элемента.
...
### No. 179: Кинематографичная 2.5D анимация в технике гуаши
...
Запрос на создание кинематографичной 2.5D анимации в живописном стиле концепт-арта гуашью с видимыми текстурами кисти и плоскими цветовыми блоками.
...
### No. 180: Мрачный кинематографичный портрет в темноте
...
Кинематографичный портрет мужчины с растрепанными волосами, выходящего из теней, с драматическим освещением и ультрареалистичной текстурой.
...
### No. 181: Великан рядом со статуей Свободы
...
Ультрареалистичное кинематографичное туристическое фото красивого молодого человека, изображенного в виде великана, стоящего рядом со статуей Свободы.
...
### No. 182: Портрет в золотой час на деревенском крыльце
...
Теплый, непринужденный портрет в стиле жизни молодого человека, наслаждающегося чаем на деревенском крыльце в золотой час.
...
### No. 183: Кинематографичный портрет на лугу
...
Ультрареалистичный портрет женщины в ковбойской шляпе, стоящей на зеленом лугу с полынью и соснами.
...
### No. 184: Вертикальный непринужденный портрет женщины
...
Запрос для создания вертикальной непринужденной фотографии молодой восточноазиатской женщины с определенными чертами.
...
### No. 185: Диагональная плитка с разорванной зоной вкуса
...
Запрос для создания изображения диагонально упакованной десертной плитки с разорванной оберткой, создающей эффект открытого рта в мире, посвященном десертам.
...
### No. 186: Женский портрет в овальном зеркале
...
Портрет в стиле beauty женщины, отраженной в вертикальном овальном зеркале, с матовой помадой кобальтового цвета.
...
### No. 187: Вихрь пивной кружки в пустыне
...
Сюрреалистичное изображение возвышающейся пивной кружки, возникающей из пустыни в виде закручивающегося вихря из песка и пива.
...
### No. 188: Пивная бутылка на переднем плане
...
Запрос для изображения с большой, четкой, частично обрезанной настоящей пивной бутылкой в правом нижнем углу переднего плана.
...
### No. 189: Картина Мондриана как настольный шкаф для хранения
...
Запрос на преобразование картины Мондриана 'Композиция с красным, синим и желтым' в функциональный настольный шкаф с цветными ящиками.
...
### No. 190: Реалистичное изображение сюрреалистичного объекта
...
Запрос на генерацию фотореалистичного изображения вымышленного, сюрреалистичного предмета или существа.
...
### No. 191: Крошечные люди в мире мандарина
...
Изображение миниатюрных людей, живущих внутри мандарина, где дольки фрукта формируют архитектуру.
...
### No. 192: Угрожающая фигура в резком профиле
...
Запрос на генерацию изображения угрожающей фигуры с иссиня-чёрными волосами и кроваво-красными губами, показанной в резком профиле.
...
### No. 193: Реклама вымышленного приложения для знакомств
...
Запрос на создание рекламы для приложения знакомств, в которой представлены молодые модели народности календжин.
...
### No. 194: Портрет на крыше с радио перед рассветом
...
Запрос на создание портрета человека с уставшим лицом на крыше, держащего радио, в предрассветный час.
...
### No. 195: Пустой туннель Фусими Инари на рассвете
...
Запрос на создание умиротворённой сцены раннего утра с культовыми воротами тории в святилище Фусими Инари в Киото, стилизованной под изображение для туристической кампании.
...
### No. 196: Внутренний мир на основе предпочтений в AI-арте
...
Запрос на создание иллюстрации, отражающей внутренний мир пользователя, основанный на его прошлых предпочтениях в области искусственного интеллекта.
...
### No. 197: Макроснимок футуристического городского процессора
...
Запрос на макроснимок прозрачного процессора размером с комнату, внутри которого находится светящийся город.
...
### No. 198: Символический автопортрет языка и кода
...
Изображение, изображающее символический автопортрет, где язык, код и творчество соединены светом.
...
### No. 199: Инопланетный мир со средиземноморским ретро-футуризмом
...
Запрос на создание изображения человеческого поселения на инопланетном мире с архитектурой в средиземноморском стиле и элементами ретро-футуризма.
...
### No. 200: Портрет Крио Архонта Царицы Анастасии
...
Запрос на создание портрета Царицы, Крио Архонта и правительницы, описанной с различными царственными и скорбными титулами.
...
### No. 201: Автобусная остановка в утреннем тумане
...
Поэтичное изображение автобусной остановки в утреннем тумане, где пар поднимается до чьего-либо прихода, а самый ранний поезд — это мысль внутри.
...
### No. 202: Ночь в прачечной с медузами и космическим прогнозом
...
Сцена, изображающая ночную прачечную с медузами снаружи, где девушка проверяет космический прогноз погоды.
...
### No. 203: Портрет женщины-воина в стиле уся
...
Запрос на создание портрета в соотношении 9:16 высокой, элегантной восточноазиатской женщины-воина в многослойных доспехах и одеждах, вооружённой длинным мечом.
...
### No. 204: Ретро-фото женщины в сельской местности, сделанное на телефон
...
Промпт для создания изображения в соотношении 9:16, изображающего молодую восточноазиатскую женщину в сельской местности, снятую в эстетике ретро-телефона.
...
### No. 205: Две женщины в ципао в китайском саду
...
Промпт для создания гиперреалистичного фото двух молодых восточноазиатских женщин в новых китайских ципао, сидящих в умиротворённом традиционном саду.
...
### No. 206: Селфи танцовщицы в серых тонах
...
Промпт для реалистичного вертикального селфи 9:16 крупным планом молодой восточноазиатской танцовщицы в прохладном, мечтательном, высококлассном сером стиле жизни.
...
### No. 207: Редакционная концертная фотография K-Pop на сцене
...
Промпт для кинематографического, редакционного фото 20-летней K-pop айдол на концерте.
...
### No. 208: Элегантная восточноазиатская женщина на каменном балконе
...
Запрос на создание вертикальной (9:16) модной фотографии красивой взрослой восточноазиатской женщины, опирающейся на классическую каменную балюстраду.
...
### No. 209: Живописный пейзаж с драматическими кучевыми облаками
...
Запрос на создание детализированного, романтичного пейзажа в стиле изящных искусств, сфокусированного на сияющем небе и возвышающихся облаках.
...
### No. 210: Линк, преследуемый кукольными цыплятами
...
Изображение Линка, которого через деревню Какарико преследует разъярённая стая пушистых кукольных цыплят.
...
### No. 211: Рисовые террасы Бали на рассвете
...
Запрос на создание безмятежной, туманной утренней сцены рисовых террас Бали, стилизованной под туристическую рекламную кампанию.
...
### No. 212: Пиксель-арт: Принц Персии в прыжке
...
Запрос на создание изображения в стиле Cobalt Dither Monumentalism, изображающего оригинального персонажа Принца Персии, перепрыгивающего через платформы.
...
### No. 213: Нежный синигами, ведущий души
...
Поэтичный запрос, описывающий девушку, жнеца смерти, стоящую на границе между жизнью и смертью в холодной ночной дымке и протягивающую руку как проводник для тихого прощания.
...
### No. 214: Золотые талисманы в тёмной ночи
...
Сцена, где ночь погружается во тьму, и лишь золото освещает талисманное присутствие, содержащее слова 'Ночная прогулка' и 'Подавление зла'.
...
Поэтичный запрос, описывающий нечеловеческую девушку на границе жизни и смерти, которая мечтает стать невестой и видит своё отражение.
...
### No. 216: Ёкай читает в дождливой комнате
...
Сцена, где страшное существо по имени Фуфу читает книгу в старой комнате в дождливый день, а в комнату залетела маленькая птичка.
...
### No. 253: Почтовое отделение в облаках в целительном стиле книжки-картинки
...
Причудливая сцена, где мягкое облако превращено в почтовое отделение, где маленькие животные в униформе сортируют письма, выполнено в мягком, целительном стиле книжки-картинки.
...
### No. 254: Гиперреалистичный кинематографический портрет на мотоцикле
...
Гиперреалистичный кинематографический портрет стильного бородатого мужчины на кастомном мотоцикле.
...
### No. 255: Чёрно-белый редакционный портрет в стиле высокой моды
...
Запрос на создание чёрно-белого портрета в стиле высокой моды, изображающего молодого мужчину с кудрявыми волосами и многослойной одеждой.
...
### No. 6: Плакат в стиле ар-деко в золотых и темно-синих тонах
...
Иллюстрация плаката в стиле ар-деко квадратного формата с элегантной золотой и темно-синей графикой на кремовой бумаге.
...
### No. 7: Коллекция гиперреалистичных эмалевых значков
...
Промпт для создания коллекции из восьми премиальных эмалевых значков с золотыми контурами и глянцевыми поверхностями на тёмном фоне.
...
### No. 8: Тёмный UI аналитической панели для SaaS
...
Промпт для создания интерфейса аналитической панели SaaS в тёмной теме с конкретными подписями и элементами UI.
...
### No. 9: Скриншот сайта креативного дизайнерского агентства
...
Промпт для генерации полного, фронтального скриншота десктопной веб-страницы без перспективных искажений для китайского сайта креативного дизайнерского агентства.
...
### No. 10: Сетка фотографий древнекитайской моды
...
Промпт для создания профессиональной, высококлассной серии фотографий древнекитайской моды, изображающей полный процесс одевания Сун Юй в будуаре эпохи династии Сун, расположенных в строгой сетке 3x3.
...
### No. 11: Аналоговые часы, бургер и напиток
...
Промпт для создания изображения аналоговых часов, показывающих 15:32, бургера с поджаренным золотистым сыром проволоне и стакана.
...
### No. 12: Компоновка с сине-белым телефоном и карточками
...
Квадратное изображение для социальных сетей в сине-белой цветовой гамме, содержащее один смартфон, три карточки с изображениями, японский заголовок, широкие поля и без дополнительного текста.
...
### No. 13: Глава учебника по физике об электромагнетизме
...
Промпт для создания главы об электромагнетизме для учебника по физике на испанском языке.
...
### No. 14: Одностраничная манга об освоении космоса
...
Промпт для создания одностраничной вертикальной черно-белой комикс-манги об освоении космоса.
...
### No. 15: Изометрический стеклянный куб с цветными сферами
...
Изометрическая проекция прозрачного стеклянного куба, содержащего красный шар в верхнем-левом-заднем углу и синий шар в нижнем-правом-переднем углу, с зелёным шаром над кубом и жёлтой колонной, проходящей снизу-слева вверх-направо.
...
### No. 16: Типографский постер и обложка журнала
...
Промпт для создания типографского постера со списком моделей и обложки журнала с названием и заголовками статей.
...
### No. 17: Вертикальная реклама роскошных часов
...
Запрос на создание вертикальной рекламы класса люкс с крупным изображением часов в тёмной изумрудной студии.
...
### No. 18: Референсный лист дизайна персонажа
...
Запрос на генерацию референсного листа дизайна персонажа в живописной манере, включающего конструктивные линии и определённую компоновку.
...
### No. 19: Разделенный лист персонажей (Character Bible)
...
Промпт для создания премиального разделенного листа персонажей для двух оригинальных героев.
...
### No. 20: Корпоративный портретный коллаж
...
Сверхреалистичный корпоративный портретный коллаж, представляющий собой трёхслойную композицию с изображением мужчины.
...
### No. 21: Композиция из фото и иллюстрации
...
Промпт для создания вертикального изображения, сочетающего оригинальную фотографию с ручной иллюстрацией той же сцены.
...
### No. 22: Лист персонажа в формате разделенного экрана
...
Запрос на создание листа персонажа с разделенным экраном, жирным центральным разделителем и неоновым акварельным фоном.
...
### No. 23: Комикс: Искатели приключений планируют в таверне
...
Промпт для создания двухстраничной цветной манги об искателях приключений, обсуждающих испытание в подземелье в таверне, с диалогами и звуковыми эффектами.
...
### No. 24: Технический чертёж эспрессо-машины
...
Техническая схема бытовой эспрессо-машины в стиле механического чертежа 1960-х годов.
...
### No. 25: Современный UI дашборда SaaS для AI-платформы
...
Запрос на создание высококачественного 4K современного интерфейса дашборда SaaS для аналитической платформы на основе искусственного интеллекта в стильном темном режиме.
...
### No. 26: Интерфейс инвентаря в тёмном фэнтезийном RPG
...
Промпт для генерации высококачественного интерфейса инвентаря в стиле тёмного фэнтези для RPG, изображающий бронированного паладина.
...
### No. 27: Постер с суши и утопленным логотипом
...
Промпт для постера с крупным утопленным логотипом тёмно-красного цвета на заднем плане, который не перекрывает силуэт суши.
...
### No. 28: Упаковка продукта в трёх зонах
...
Промпт для визуализации картонной упаковки продукта в трёх стадиях: как изолированный объект, в контексте ингредиентов и рядом с готовым блюдом.
...
### No. 29: Продуктовый кадр с ингредиентами по периметру
...
Запрос на изображение, где центральный пакет продукта окружен мисками, ягодами, зернами и листьями, с четким вертикальным коридором.
...
### No. 30: Сетка идентичных постеров с меню кофе
...
Запрос на дизайн коллекционного постера с меню кофе, содержащего единообразные черные поля, масштаб чашки, зону заголовка, микрокопию и латунные зажимы.
...
### No. 31: 3D-билборд с продуктом, выходящим за плоскость
...
Запрос на 3D-визуализацию билборда, где главная банка выступает за внутреннюю плоскость, создавая контактные тени.
...
### No. 32: Линейка из трех рожков с центральным героем
...
Запрос на композицию с тремя рожками мороженого разных вкусов, где центральный фисташковый рожок доминирует, а боковые рожки служат обрамляющими элементами под углом.
...
### No. 33: Сложенные панели с единообразной компоновкой
...
Запрос на создание пяти сложенных панелей с единообразным фирменным макетом, включающим логотип, колонку с заголовком, бейдж и композицию с продуктом.
...
### No. 34: Горизонтальные акты дегустации с названиями блюд
...
Запрос на постер, изображающий четыре горизонтальных акта, каждый из которых представляет черную миску с паром и увеличенное название блюда, написанное кистевым шрифтом.
...
### No. 35: Интерфейс социального поста, разрезающий поток соуса
...
Запрос на изображение, где минималистичная чёрная полоса интерфейса социального поста горизонтально разрезает поток соуса.
...
### No. 36: Постер с вертикальным разделением композиции
...
Запрос для постера с вертикальным разделением, показывающего чистую естественную сторону в противовес темной стороне со скрытыми ингредиентами.
...
### No. 37: Жидкие арки из шоколада, обрамляющие продукт
...
Запрос для премиального продуктового постера с двумя сдержанными темными жидкими арками из шоколада, обрамляющими продукт в симметричном орбитальном движении.
...
### No. 38: Две главные плитки, пересекающиеся по диагонали
...
Запрос, описывающий две упакованные продуктовые плитки, пересекающиеся по диагонали через центр в противоположных направлениях.
...
### No. 39: Три чаши, расположенные по диагонали
...
Запрос для изображения трех чаш, расположенных по диагонали от переднего плана к заднему.
...
### No. 40: Туристическая кампания в Instagram со смартфоном как визуальным якорем
...
Запрос на создание премиальной туристической рекламы для Instagram, где современный смартфон служит центральным визуальным элементом.
...
### No. 41: Вертикальный постер для соцсетей: коллекционная фигурка
...
Запрос на создание высококачественного вертикального постера для социальных сетей, рекламирующего премиальную коллекционную фигурку, с жирной типографикой и плоским жёлтым фоном.
...
### No. 42: Дизайн обложки книги с иерархией
...
Запрос на дизайн обложки книги с чёткой типографской иерархией и высокой читаемостью.
...
### No. 43: Постер для конференции по нейробиологии
...
Запрос на создание постера для конференции по нейробиологии 2026 года на основе предоставленной статьи и регламента.
...
### No. 44: Парящая сетка диорам знаковых городов
...
Запрос на создание сетки 2x2 из парящих городских диорам, подвешенных в серой студии.
...
### No. 45: Сатирическая сетка системных постеров на раздражающие темы
...
Запрос на создание сетки 2x2 сатирических редакционных постеров на раздражающие темы.
...
### No. 46: Шаблон туристического постера в виде бумажной диорамы
...
Запрос на создание премиального вертикального туристического постера, изображающего городскую достопримечательность в виде детализированной ручной бумажной диорамы.
...
### No. 47: Кинематографический лист персонажей для Кальвина и Боба
...
Запрос на создание разделённого на экраны листа персонажей с акварельным фоном.
...
### No. 48: Кинематографический лист персонажа для Софии
...
Промпт для создания премиального листа персонажа с жирной типографикой и драматическим главным изображением баристы по имени София.
...
### No. 64: Манга-панель с речевыми пузырями
...
Изображение в стиле манга, где девушка говорит "Эй, послушай!", а парень закрывает её речевой пузырь своим пузырём мысли со словами "Сделаю вид, что не слышал", нарисованное в вертикальном формате 4:5.
...
### No. 65: Манга-панель: девушка кусает речевой пузырь
...
Сцена в стиле манга, где парень говорит "Мы не будем драться?", а свирепо выглядящая девушка кусает его речевой пузырь.
...
### No. 66: Редакционная сетка модных десятилетий
...
Запрос на создание сетки 2x2, визуализирующей четыре модных движения из разных десятилетий, в стиле редакционного постера 16:9.
...
### No. 67: Сетка систем государственного управления
...
Запрос на создание сетки 2x2, визуализирующей четыре различные системы государственного управления, в пастельном сказочном стиле.
...
### No. 68: Постер героического наследия для шахматиста
...
Запрос на создание сетки 2x2 из героических иллюстрированных памятных постеров для четырёх ушедших легенд шахмат.
...
- [Atlas Cloud GPT Image 2.5 Flare text-to-image](https://www.atlascloud.ai/ru/models/openai/gpt-image-2.5-flare/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Flare edit](https://www.atlascloud.ai/ru/models/openai/gpt-image-2.5-flare/edit?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Sunburst text-to-image](https://www.atlascloud.ai/ru/models/openai/gpt-image-2.5-sunburst/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
