...
### No. 3: Portrait of Petite Spanish Woman by Pool
...
A polished vertical beauty portrait of a petite Spanish woman seated beside a mint-green indoor pool.
...
### No. 4: Two Women in Stone Archway
...
A prompt for an image of two women framed by a sun-bleached stone archway.
...
### No. 5: Multi-Panel Character Sheet Portrait
...
A prompt for generating a character sheet with four studio photographs of the same woman from different angles.
...
### No. 6: Nine Emoji Stickers with Text
...
A prompt to generate a 3x3 grid of different emoji stickers based on a reference character, featuring Chinese and English text on a light gradient background.
...
### No. 7: Sprite Sheet of Four Dot-Art Character Motions
...
A prompt to generate a sprite sheet with four types of dot art character animations, each up to 4 frames, maintaining consistent design.
...
### No. 8: Artwork Inspired by Sketch
...
A prompt to create an original artwork based on a sketch, preserving its core subject, emotion, and gesture while reimagining the details.
...
### No. 9: Morning Lifestyle Photo of Woman
...
A photorealistic morning lifestyle portrait of a young woman with auburn-red hair.
...
### No. 10: Woman Reclining in Home Office
...
A prompt to generate a photorealistic smartphone photo of a young woman relaxing on a sofa in a modern home office.
...
### No. 11: iPhone Portrait of Young Woman
...
A prompt for generating a realistic iPhone portrait of a young woman indoors with a reflective background.
...
### No. 12: Pixel Art Sprite Sheet For Character
...
A prompt to generate a simplified 128px pixel art sprite sheet with transparent background and a 4x4 layout for character battle actions.
...
### No. 13: Daytime Campsite from Sketch
...
A series of prompts to transform a child's drawing into a moody night campsite, then a daytime version, and finally change the character's clothing to overalls.
...
### No. 14: Minimalist Single-Line Country Art
...
A prompt for creating a vertical minimalist art print of a country using a single continuous line.
...
### No. 15: 1985 Historical Portrait Transformation
...
A prompt to reimagine a person's appearance in the 1980s while preserving their core identity and features.
...
### No. 16: 3D Oversized T-Shirt Branding Mockup
...
A prompt for generating a 3D mockup of two floating oversized T-shirts showing front and back views.
...
### No. 17: Luxury Menswear Editorial Collage
...
A prompt to create a luxury menswear editorial collage using an uploaded photo as a facial reference.
...
### No. 18: Facial Identity and Composition Reference
...
A prompt instructing the use of an uploaded image to preserve a subject's facial features and natural appearance.
...
### No. 19: Realistic Professional Studio Portrait
...
A prompt for creating a professional studio portrait using an uploaded photo for facial identity and composition.
...
### No. 20: Fashion Editorial Collage with Consistent Model
...
A prompt for creating a fashion collage with a consistent male model using a facial identity reference.
...
### No. 21: Astronaut in Futuristic Cockpit Portrait
...
A prompt for generating a photorealistic portrait of a confident female astronaut in a futuristic spacecraft cockpit.
...
### No. 22: Ultra-Realistic Studio Fashion Portrait
...
A prompt for creating a full-body, ultra-realistic studio fashion portrait using an uploaded image as a facial reference.
...
### No. 23: Cinematic Motorcycle Lifestyle Portrait
...
An ultra-realistic portrait of a man seated outdoors next to a premium sport motorcycle.
...
### No. 24: Ultra-Realistic Editorial Portrait
...
An AI prompt for creating an ultra-realistic editorial portrait of a man using a facial identity reference.
...
### No. 25: Premium Fashion Portrait from Reference
...
A prompt for creating a premium fashion portrait of a stylish adult man using a facial identity reference.
...
### No. 26: Candid Lifestyle Portrait From Reference
...
A prompt for generating a high-quality, ultra-photorealistic candid lifestyle portrait of a woman based on a reference image.
...
### No. 27: Winter Fashion Portrait From Photo
...
An AI prompt for creating a realistic outdoor winter fashion portrait using a subject photo for facial reference.
...
### No. 28: Ultra-Realistic Luxury Studio Portrait
...
An AI prompt to generate an ultra-realistic luxury studio portrait of a stylish adult man.
...
### No. 29: Cinematic Rain Portrait Collage
...
A prompt for creating a cinematic rain portrait collage using an uploaded image as a reference for composition and atmosphere.
...
### No. 30: Smartphone Selfie Identity Preservation
...
A prompt for generating a 3:4 vertical, ultra-realistic smartphone selfie that faithfully preserves a specific woman's facial features and appearance.
...
### No. 31: Cinematic Fashion Portrait Identity
...
A prompt for generating a close-up fashion portrait that preserves a subject's identity and appearance.
...
### No. 32: Close-Up Formal Studio Portrait
...
A prompt for creating a close-up studio portrait of a young man in formal attire using a facial reference.
...
### No. 33: Cinematic Lifestyle Photo with Identity Preservation
...
A prompt for creating a photorealistic cinematic image of a specific East Asian woman, preserving her identity and features.
...
### No. 34: Cinematic Fashion Editorial with Identity Reference
...
A prompt for generating a cinematic fashion photograph of a woman in a dark setting, preserving her identity from a reference image.
...
### No. 35: Ultra-Realistic Editorial Portrait from Reference
...
An image generation prompt for creating an ultra-realistic editorial portrait of an adult man, using an uploaded image as a facial identity reference.
...
### No. 36: Dragon Battle with Betraying Axe-Wielder
...
A prompt for generating an image of a dragon battle with a traitorous axe-wielder, using ChatGPT Astra.
...
### No. 37: Heroic Giant Robot Photorealistic Angle
...
A prompt to create an image showing a heroic giant robot from a dynamic, photorealistic angle.
...
### No. 38: Anime Style From Uploaded Subject
...
A prompt for creating an anime-style image with confident line-work, minimal cel shading, and bright, saturated colors.
...
### No. 39: Product Front-Flat Shot with Clear Label
...
A prompt for generating two product images with clear, readable labels in a front-facing, flat-lay style.
...
### No. 40: Fantasy Scene with Eagle and Reference
...
A prompt for a cinematic fantasy scene featuring a woman centered before a gigantic, majestic bald eagle with spread wings.
...
### No. 41: High-Fashion Ad with Model Identity
...
A prompt for creating a premium, hyper-realistic high-fashion advertising image that preserves a specific model's facial identity.
...
### No. 42: Article to Four-Panel Manga in Afternoon Style
...
A prompt to generate a four-page comic in the style of the Japanese magazine Afternoon based on an attached article.
...
### No. 43: Premium Cinematic Character Bible Sheet
...
A prompt for creating a split-screen character reference sheet using strict visual guidelines.
...
### No. 44: Pixel Art Combat Sprite Sheet
...
A prompt to generate a simplified 128px pixel art combat animation sprite sheet with a transparent background.
...
### No. 45: Character Battle Sprite Sheet Pixel Art
...
A prompt to generate a 16-frame pixel art sprite sheet for a character's battle motions.
...
### No. 46: Character Battle Sprite Sheet Pixel Art
...
A prompt to create a 128px simplified pixel art sprite sheet with 16 frames for a character's combat motions, including idle, slashing, guarding, and knockdown states.
...
### No. 47: Photorealistic Portrait with Identity Reference
...
A prompt for creating a full-body, photorealistic portrait using a reference photo to preserve the subject's identity.
...
### No. 48: Marty & Doc Character Bible Sheet
...
A prompt to generate a split-screen character reference sheet for two characters using strict visual guidelines.
...
### No. 49: Ted & John Character Bible Sheet
...
A prompt to generate a split-screen character sheet using strict visual references for two characters.
...
### No. 50: Split-Screen Character Bible For Dom & Brian
...
A prompt to generate a split-screen character sheet using uploaded references for two characters.
...
### No. 51: Cinematic Character Bible Sheet For Baby
...
A prompt to generate a premium character sheet for the character Baby, featuring bold typography and strict visual reference adherence.
...
### No. 52: Cinematic Character Bible For Schmidt & Jenko
...
### No. 53: Cinematic Character Bible For Gordon
...
A prompt for creating a premium character sheet with bold typography and strict visual reference.
...
### No. 54: Character Bible Sheet for Johnny & Tucker
...
A prompt to generate a split-screen character reference sheet using strict visual guidelines.
...
### No. 55: Character Bible Sheet for Neo & Trinity
...
A prompt to generate a split-screen character reference sheet for Neo and Trinity using strict visual guidelines.
...
### No. 56: Kevin Vs The Wet Bandits Character Bible
...
A prompt to generate a premium character sheet for Kevin vs the Wet Bandits using strict visual references.
...
### No. 57: Night Rooftop Stairs Editorial Fashion Shot
...
A prompt for a hyper-realistic photo of a nighttime rooftop stairs fashion editorial with a cool cinematic feel.
...
### No. 58: Riggs & Murtaugh Character Bible Sheet
...
### No. 59: Premium Cinematic Character Bible Sheet for Mike & Marcus
...
### No. 60: Premium Cinematic Character Bible Sheet for Lee & Carter
...
A prompt for creating a split-screen character reference sheet using strict visual guides.
...
### No. 61: Realistic 1/7 Scale Figure on Desk
...
A prompt for generating an image of a realistic 1/7 scale character figure on a computer desk with a transparent base.
...
### No. 62: Facial Identity Reference Across Composition
...
An AI prompt to generate a single photo featuring seven versions of the same adult man using a facial identity reference.
...
### No. 63: Fashion Portrait Using Facial Identity Reference
...
A prompt for generating a premium, full-body fashion portrait using a photo as a facial identity reference.
...
### No. 64: Dreamy Cinematic Portrait from Reference
...
A prompt for creating a realistic, dreamy cinematic portrait while preserving the subject's identity and natural features.
...
### No. 65: 3D Claymation Portrait from Photo
...
A prompt for generating a detailed, cute 3D claymation portrait that retains the subject's identity and likeness from a user-uploaded photo.
...
### No. 66: Editorial Art Poster for a Location
...
A prompt for creating a high-resolution vertical editorial poster in a playful Japanese design-zine style.
...
### No. 67: Animated Scene from Two Reference Images
...
A prompt to create an animated scene of a toddler playing in a cozy bedroom.
...
### No. 68: 1980s Portrait from Facial Reference
...
A prompt to generate a portrait in a 1980s retro-vintage style, preserving the subject's exact facial features and identity.
...
### No. 69: Character Design Reference Sheet
...
A prompt for generating a professional character model sheet based on a provided reference image.
...
### No. 70: Style Transfer to a Motorcycle Rider
...
A new subject rendered in the exact visual style carried by the input image.
...
### No. 71: Outfit Swap Preserving Identity
...
Garments from reference images fitted onto the subject with face, pose and lighting untouched.
...
### No. 72: Dog Composited into a Portrait Scene
...
A subject taken from one reference and placed into another with matched light and background.
...
### No. 73: Sketch Turned into a Photoreal Valley
...
A drawing rendered photorealistically while its layout, proportions and perspective are preserved.
...
### No. 74: Person Inserted into a Bear Attack Scene
...
A photograph-like action scene built around a supplied person, deliberately uncinematic.
...
### No. 75: Consistent Childrens Book Character
...
A watercolour picture-book hero specified tightly enough to stay the same across illustrations.
...
### No. 76: NYC Subway Candid Portrait
...
A prompt for a candid lifestyle photo of a woman with soft features and messy dark hair in a NYC subway.
...
### No. 77: Multi-Panel Film Character Reference Sheet
...
A prompt to generate a character reference sheet showing the same real woman from front, 3/4, profile, and rear views.
...
### No. 78: Photo-Based Minimal Watercolor Vignette Artwork
...
A prompt to transform an uploaded photograph into a refined artwork combining photo realism with a minimal watercolor vignette style.
...
### No. 2: Transform Photos Into Individual Premium Posters
...
A JSON instruction to convert each uploaded photograph into a separate, high-quality poster without merging them.
...
### No. 3: Night Office with Flowchart Screen
...
A prompt to generate a night study room and then replace only the laptop screen content with an automation flowchart.
...
### No. 4: Two-Page Story Manga Redraw
...
A prompt to redraw an image into a two-page story manga style while preserving dialogue, story, and character settings.
...
### No. 5: Edit Environment to Painterly Style
...
A prompt to edit an environment plate into a looser painterly style while preserving specific compositional elements.
...
### No. 6: Restore Damaged Vintage Portrait
...
A prompt for restoring a severely damaged old portrait into a clean, modern-looking photo using an uploaded image as reference.
...
### No. 7: Recolor Car to Neon Black
...
A prompt to change an object's color to neon black while preserving its original shape, texture, and material.
...
### No. 8: Vertical Two-Panel Original and Edited Image
...
A prompt to create a single vertical image with two stacked panels, keeping the top panel as the original reference photograph.
...
### No. 9: Reframe Photograph to Specified Aspect Ratio
...
A prompt to resize a photograph to a chosen aspect ratio while keeping the main subject naturally positioned.
...
### No. 10: Hard Light Portrait with Sharp Shadows
...
A prompt describing a portrait lit by hard, unsoftened sunlight from a window at a specific angle, creating sharp shadows on the face.
...
### No. 11: Pixel Art Sprite Sheet for Character
...
A prompt to create a simplified 128px pixel art battle motion sprite sheet for a character, arranged in a 4x4 grid with a transparent background.
...
### No. 12: Enhance Sun and Clouds into Lotus Flower
...
A prompt to enhance a photo of clouds and sun to make the sun resemble a flower's center and the clouds a lotus, without altering the original image.
...
### No. 13: Infographic Translated into Spanish
...
An edit that swaps only the language of the text and leaves every other pixel of the layout alone.
...
### No. 14: Product Cutout on Transparent Background
...
A packshot isolated on clean alpha with crisp silhouette, no halos and label legibility intact.
...
### No. 15: Object Removal from a Portrait
...
A one-line edit that removes a single object and changes nothing else.
...
### No. 16: Billboard Rekindled as a Winter Evening
...
A five-word follow-up edit that changes season and time of day on an existing mockup.
...
### No. 17: Kitchen Chairs Swapped to Wood
...
A room edit that replaces only the chairs and keeps angle, lighting and floor shadows.
...
### No. 6: Realistic Screenshot of Next-Gen Romance RPG
...
A prompt to generate a realistic screenshot from a fictional next-gen 3D open-world romance RPG from the protagonist's perspective.
...
### No. 7: Premium Miniature Diorama of a Landmark
...
A prompt for generating a cute, elegant 3D diorama of a famous structure with soft pastel tones and handcrafted details.
...
### No. 8: Vertical Botanical Paper Art of Slender Woman
...
A vertical botanical paper artwork depicting a slender woman in profile with a leaf gown and an ivory parasol.
...
### No. 9: Photoreal Model Kit of White and Gold Paladin
...
A prompt to generate a photorealistic image of a white and gold paladin robot as a model kit, displayed in an electronics store with many uniform boxes.
...
### No. 10: Candid Travel Photo at Historic Wall
...
A realistic candid travel photo of a young woman by a historic city wall at night with a glowing traditional Chinese building.
...
### No. 11: Vintage Travel Poster for Location
...
A prompt for creating a 1920s-1930s inspired travel poster with a layered paper-relief and embossed illustration style in a muted color palette.
...
### No. 12: Macro Photo of Butterfly Eye, Cat Whisker
...
A photorealistic macro close-up of a cat's whisker, butterfly compound eyes, and a girl's skin.
...
### No. 13: Luxury Watch on Marble Mockup
...
A photorealistic magazine ad mockup of a luxury titanium chronograph watch with clear dial text.
...
### No. 14: Premium Coffee Bag Product Mockup
...
A photorealistic commercial mockup of a matte black coffee bag with mountain line-art on rustic wood.
...
A prompt for generating a clean fashion lookbook poster with a young female model in autumn attire using soft pastel colors.
...
### No. 16: Miniature Travel Scene with Landmark
...
A prompt for generating a charming, handcrafted miniature scene featuring a tiny 3D model of an iconic landmark.
...
### No. 17: Editorial Portrait Of Woman Overlooking City
...
A photorealistic editorial portrait of an adult East Asian woman overlooking a city at dusk.
...
### No. 18: Cinematic Portrait Of Woman In Sunlit Cafe
...
A prompt for a photorealistic cinematic portrait of an adult East Asian woman in a sunlit neighborhood cafe.
...
### No. 19: Asymmetrical Editorial Half-Face Portrait
...
A prompt for creating an editorial-style portrait with the subject positioned against the left edge of the frame.
...
### No. 20: Premium Editorial Art Poster for a Location
...
A prompt for creating a high-quality, modern art-book style poster for a specified location.
...
### No. 21: Warm Night Scene of Woman Reading at Home
...
A prompt for generating a realistic 16:9 horizontal photo of a woman in a warm, ordinary apartment setting at night.
...
### No. 22: Deluxe Parfait of Disliked Foods
...
A prompt to generate a deluxe parfait composed only of commonly disliked foods, with 30 types of ingredients and annotations.
...
### No. 23: Showa-Era Japanese Vintage Travel Poster
...
A prompt for creating a premium, vertical travel poster in a mid-century Japanese railway tourism style.
...
### No. 24: Cinematic Portrait on a Subway Platform
...
A high-fidelity portrait of a young woman with brown hair standing still as a train rushes by.
...
### No. 25: High-Angle Portrait in Qipao
...
A high-angle portrait of a tall, slender model with refined makeup and a fox-like face, wearing a qipao in soft, dreamy lighting.
...
### No. 26: Flooded Plain with Mismatched Reflection
...
A prompt for a cinematic film still depicting a flooded plain at twilight with a farmhouse and poplars, featuring a mismatched reflection in the water.
...
### No. 27: Vocaloid MV Style 3x3 Grid
...
A prompt to create a 3x3 grid of various shots in a Vocaloid MV style with a 16:9 aspect ratio.
...
### No. 28: 16-Bit Crow Sprite Sheet
...
A prompt to generate a 16-bit style sprite sheet of a crow in flight, takeoff, and landing.
...
### No. 29: Low-Angle Gladiator on Horseback
...
An extreme low-angle shot of a gladiator on a warhorse, viewed from a rocky mountain path.
...
### No. 30: Close-Up of Reef with Octopus
...
A prompt instructing to zoom in on a reef, observe light on stone, and include exactly eight arms.
...
### No. 31: Cinematic Anamorphic Still of Women in Peony
...
A wide anamorphic photograph of five miniature Chinese women seated inside a large pale-pink peony.
...
### No. 32: Woman Among Dense Pink Flowering Branches
...
A photograph of a woman surrounded by dense pink flowering branches that fill the foreground and background.
...
### No. 33: Robot on Beach at Sunset
...
A realistic cinematic scene of a robot sitting on a beach at sunset, looking at sand in its hand.
...
### No. 34: Cyberpunk Fluffy Wolf Ears Outfit
...
A prompt for generating a cyberpunk-style fluffy costume featuring neon pink and green fur wolf ears and a choker.
...
### No. 35: Close-Up Selfie of Young Woman
...
A prompt for a raw iPhone photo of a young woman with freckles and windblown hair.
...
### No. 36: 1980s President Welcoming Alien on White House Lawn
...
A prompt to generate an image depicting a 1980s-style photo of a President greeting an alien on the White House lawn.
...
### No. 37: Tang Dynasty Royal Banquet Movie Still
...
A widescreen historical movie still depicting a fictional, lavish Tang Dynasty royal night banquet.
...
### No. 38: Realistic Fashion Photo of East Asian Woman
...
A prompt for a realistic fashion photo featuring an adult East Asian woman with black long hair, warm light and shadow on her face, and natural skin texture.
...
### No. 39: Taiwanese Woman Portrait With Black Mist Filter
...
A prompt for a portrait featuring a black mist filter, overlay mask, and soft-light CCD photography with subtle highlights.
...
### No. 40: Red Spider Lily By River After Rain
...
A prompt for generating a realistic image of a single red spider lily with raindrops, set by a riverside after rain.
...
### No. 41: Rainy Street Scene After Closing
...
A prompt for an atmospheric image depicting a person after closing time, focusing on wet wool, skin, and streetlight.
...
### No. 42: Fashion Editorial with Wind and Silk
...
A prompt for a fashion editorial scene featuring three people styled by wind, with hard sunlight and abundant silk.
...
### No. 43: Realistic iPhone Photo of Tesla Model Y
...
A prompt for generating a realistic iPhone photo of a Tesla Model Y in a parking lot using a 0.5x camera.
...
### No. 44: Dusk Eco-Future City With Moon
...
A prompt describing a twilight eco-future city, a lunar city with a giant Earth, a seraphim guardian knight of the galaxy, and a silver-haired queen dancing in an ice crystal cathedral.
...
### No. 45: Large Army With Dragon In Rain
...
A complex scene featuring an army of over 100 people, the character Luna, a white dragon, a Japanese sign, intricate spear handling, and rainy reflections.
...
### No. 46: Gray Netherland Dwarf Rabbit Jumping
...
A prompt for generating images of a rabbit hopping and a grey Netherland Dwarf rabbit hopping.
...
### No. 47: Anime Couple In Park High Detail
...
An image generation prompt for an anime-style young man and woman in casual clothes in a large park, rendered in ultra-high 16K resolution with enhanced contrast and saturation.
...
### No. 48: Dream Of Red Mansions Long Scroll
...
A prompt to reconstruct a scene from Dream of the Red Mansions as a traditional Chinese long scroll painting.
...
### No. 49: Desert Brutalism Architecture Series
...
A prompt for generating images of monolithic earth architecture in a desert brutalism style, featuring celebrity-architect mashups.
...
### No. 50: Golden Hour Street Walk Photograph
...
A prompt for a photorealistic smartphone photo of a woman walking on a tree-lined street at golden hour.
...
### No. 51: Luxury Travel Poster Collection
...
A prompt for creating a sophisticated luxury travel-poster collection inspired by Santorini, Amalfi Coast, and Paris.
...
### No. 52: Candid Portrait in Urban Park
...
A candid outdoor portrait of a young woman with long dark-brown hair in a peaceful urban park on a sunny afternoon.
...
### No. 53: Desert Assassin Character Reference Sheet
...
A prompt for generating a cinematic character reference sheet featuring a deadly desert assassin.
...
### No. 54: East Asian Woman Fashion Photo in Lounge
...
A prompt for an ultra-photorealistic smartphone fashion photo of a beautiful East Asian woman in a private lounge at night.
...
### No. 55: Vintage Travel Postage Stamp Artwork
...
A prompt for creating a vintage-style postage stamp featuring a country's iconic landmark and cultural elements.
...
### No. 56: Vintage Travel Poster of Iconic Structure
...
A prompt for creating a stylized, hand-painted vintage travel poster featuring a recognizable architectural landmark.
...
### No. 57: Candid Fashion Portrait in Parking Garage
...
An ultra-photorealistic portrait of a beautiful Eurasian woman in a modern underground parking garage.
...
### No. 58: Handcrafted Miniature Food Scene
...
A prompt for generating a charming miniature scene featuring a specific food dish on a ceramic plate.
...
### No. 59: Storefront Miniature Diorama
...
A prompt to generate a whimsical 3D clay miniature diorama of a recognizable store or brand.
...
### No. 60: Iconic Structure Miniature Diorama
...
A prompt for creating a detailed, cozy miniature world featuring a central iconic structure.
...
### No. 61: Asymmetric High-Fashion Studio Portrait
...
A prompt for a close-up portrait of a man against a white studio background with an asymmetric composition.
...
### No. 62: Wind-Carved White Maze Landscape
...
A descriptive prompt for generating a landscape of a white maze formed by wind erosion over time.
...
### No. 63: White Dragon Knight and Small Stone
...
A scene depicting a White Dragon Knight at night, halted not by an enemy but by a single small stone, with a philosophical caption.
...
### No. 64: Confident Man Editorial Portrait
...
A prompt for generating a premium editorial-style studio portrait of a confident man with short black hair.
...
### No. 65: Full-Body Studio Fashion Portrait
...
A prompt for generating a full-body, confident male model portrait in a warm, seamless studio setting.
...
### No. 66: Luxury Travel Campaign Masterpiece
...
A prompt for a sophisticated luxury lifestyle travel campaign combining Alpine, Dubai, and European chalet experiences.
...
### No. 67: Blue Mage Master's Morning Routine
...
A scene depicting a Blue Mage Master's morning where combs, hair ties, and shoelaces finish their work as he reads reports.
...
### No. 68: Ship Arriving at White Chalk Coast
...
A descriptive prompt for a scene where a ship arrives at a shore of white earth, salt, and limestone, with unseen lands beyond.
...
### No. 69: Sea Elf Fisherman Character Portrait
...
A prompt describing an elf who lives by the sea, a coastal fisherman who reads the ocean's signs.
...
### No. 70: Professional Studio Headshot Portrait
...
A prompt for generating a professional studio headshot portrait of an adult man.
...
### No. 71: Confident Man In Luxurious Modern Interior
...
An ultra-realistic lifestyle portrait of a confident man in a luxurious modern interior with a dark wooden doorway and large mirror.
...
### No. 72: Fantasy Spearman Sleeping at Desk
...
A poetic prompt describing a spearman's night, remembering the wood grain of a desk before an otherworldly map.
...
### No. 73: Dragon Knight Resting in the Shade
...
A scene depicting two dragon knights taking a break under a dragon's wing, with a map and hard bread.
...
### No. 74: Stylish Man in Cozy Evening Library
...
An ultra-realistic portrait of a man relaxing in an upscale library lounge during early evening.
...
### No. 75: Dullahan Mail Carrier on Autumn Night
...
A night mail carrier walks an autumn road lined with red spider lilies under a night sky.
...
### No. 76: Full-Body Editorial Portrait in Burgundy
...
An ultra-realistic editorial portrait of a confident Black man in a clean suit, seated in a minimalist studio setting.
...
### No. 77: Blue Mage Master's Afternoon
...
A scene depicting a Blue Mage Master's afternoon where magic clears sunlight and cobblestones before they reach her.
...
### No. 78: Sunset Over Cracked Earth With Flames
...
A descriptive prompt for a scene of a twilight wilderness with thin flames rising from ground fissures and the Caspian Sea in the distance.
...
### No. 79: Vintage Sailing Ship At Golden Sunset
...
An ultra-realistic image of a vintage wooden sailing ship in a dramatic ocean sunset scene.
...
### No. 80: White Dragon Knight Checking Wing Injury
...
A scene of a White Dragon Knight Master carefully checking the left wing injury of a sleeping dragon in a moonlit dragon stable.
...
### No. 81: Traveler Mending Blue Cloth In Volcanic City
...
A scene of mending a blue travel cloth in a volcanic city during the afternoon, with distant mountains.
...
### No. 82: Morning in a Mirror World with a Spearman
...
A prompt depicting a spearman who has lost his greatest title, starting his day from wet shoelaces in the morning of a mirror world.
...
### No. 83: Blue Mage Master Luna Before Dawn
...
A scene depicting Blue Mage Master Luna before dawn, with books, a chair, and tea, from a time when they did not need her body.
...
### No. 84: Landscape Where Fire Leaks from the Earth
...
A descriptive prompt for a landscape where fire leaks from the earth in a dry wilderness, with grey mud flowing and the Caspian Sea in the distance.
...
### No. 85: Night Black Dragon Knight Luna
...
A scene depicting the Black Dragon Knight Luna at night, checking her spear calluses while El Drago sleeps beside her.
...
### No. 86: Frieren and Fern in a Good Place
...
An SFW illustration depicting a conversation between the characters Fern and Frieren.
...
### No. 87: Hills Carved by Wind and Rain
...
A poetic prompt describing a landscape where green fades, revealing layers of ochre, rust, gray-white, and pale green on wind- and rain-carved hills.
...
### No. 88: Ancient Lady with Fan Before Bamboo
...
An AI prompt to generate an Eastern aesthetic wallpaper featuring a classical woman with a round fan against a white wall and bamboo shadows.
...
### No. 89: Police Rescue Robots Towing Lifeboat
...
A prompt depicting a Tokyo Police Heavy Machinery Robot Team rescuing evacuees by towing a lifeboat.
...
### No. 90: Urban Observatory Daytime CCD Photo
...
A prompt for generating a bright daytime CCD-style lifestyle photo featuring urban exploration on an astronomy observation deck.
...
### No. 91: Vertical iPhone Lifestyle Portrait
...
A prompt for generating a realistic, candid iPhone-style portrait of a young woman.
...
### No. 92: New Chinese Style Floral Window Poster
...
An image generation prompt for an elegant, minimalist oriental poster featuring a classical woman by a jade-green flower window.
...
### No. 93: Photorealistic Editorial Portrait of East Asian Woman
...
A detailed prompt for generating a knee-up, eye-level photorealistic portrait of a young East Asian woman with specific facial features.
...
### No. 94: Police Heavy Machinery Unit Robots Cleaning River
...
A prompt describing a robot squad from the police heavy machinery unit cleaning garbage that is damming a river.
...
### No. 95: Photorealistic Editorial Portrait with Heart-Oval Face
...
A detailed prompt for generating a knee-up, eye-level editorial portrait of a young East Asian woman with specific facial features.
...
### No. 96: iPhone Portrait of a Young Woman
...
A prompt for generating a realistic, casual 9:16 vertical photo of a woman aged 20-26, as if taken with an iPhone's main camera.
...
### No. 97: Zen Woman by Water in Summer
...
A prompt for generating an Eastern aesthetic wallpaper featuring a woman by the water in a minimalist, refreshing style.
...
### No. 98: Cowboy Shot Portrait of East Asian Woman
...
A detailed prompt for a photorealistic editorial portrait of a young East Asian woman with specific facial features.
...
### No. 99: Urban Rooftop Book Cafe Fashion Shot
...
A prompt for generating a bright, daytime CCD-style lifestyle photo with an urban, artistic setting and specific clothing.
...
### No. 100: Photorealistic Editorial Portrait Of East Asian Woman
...
A detailed prompt for generating a knee-up, waist-level editorial portrait of a young East Asian woman with specific facial features.
...
### No. 101: Oriental Zen Minimalist Cover Poster
...
A prompt for generating an oriental minimalist wallpaper featuring a graceful ancient-style woman passing through a blue doorway with cherry blossoms.
...
### No. 102: Police Heavy Machinery Unit Robot Team
...
An image of a police robot team from the Heavy Machinery Countermeasures Unit moving vehicles from a road flooded by heavy rain.
...
### No. 103: Daytime Bright CCD Urban Sports Life Photo
...
A prompt for generating a bright daytime CCD-style lifestyle photo in an urban sports setting.
...
### No. 104: Zen Minimalist Vertical Cover Poster
...
A prompt for creating a minimalist, bright, and clean 9:16 vertical cover with modern Eastern female aesthetics and a morning vibe.
...
### No. 105: Woman Sitting by Round Window
...
A prompt for generating an Eastern Zen minimalist poster featuring a woman relaxing by a round window.
...
### No. 106: Police Robot Squad Stopping Runaway Truck
...
An image of a police robot squad from the Heavy Machinery Countermeasures Unit attempting to stop a runaway truck.
...
### No. 107: Full-Body Editorial Portrait of Young Woman
...
A prompt for a full-body, eye-level editorial portrait of a young Japanese or Korean woman wearing hoop earrings.
...
### No. 108: Photorealistic Waist-Up Portrait with Glasses
...
A waist-up, knee-level view portrait of a young Japanese or Korean woman wearing bold, white thick-frame glasses.
...
### No. 109: Zen Minimalist Cover Poster with Woman and Wind Chime
...
A prompt for generating an image of a woman touching a wind chime by a window in a minimalist Eastern Zen style.
...
### No. 110: Post-Apocalyptic City with Green Vegetation
...
A detailed photo of a post-apocalyptic city in Shenzhen, China, overgrown with green vegetation.
...
### No. 111: Japanese Woman with Tanuki-Like Face at Night
...
A prompt for generating a photorealistic image of a fictional young Japanese woman with a tanuki-like face in a quiet night setting.
...
A realistic image from a dolphin's perspective looking through a 360-degree glass tank at women visiting a bustling, women-only aquarium.
...
### No. 113: Polymer Clay Miniature Brand Store Scene
...
A prompt for creating a miniature clay model of a brand store with cozy sidewalk details.
...
### No. 114: Fashion Ad with Tilted Ground Shot
...
A fashion ad campaign for a fictional brand featuring six people in vibrant clothing against a cobalt blue sky, shot from a low angle.
...
### No. 115: Hand-Drawn Anime Duel with Cherry Blossoms
...
A scene from a late 1990s Japanese hand-drawn animated film, featuring a woman with a katana facing a swordsman under falling cherry blossoms.
...
### No. 116: Black Haunted Bride Gothic Wedding Gown
...
A prompt for a gothic Halloween horror bride costume with dark romantic elegance.
...
### No. 117: Moody Cinematic Portrait of East Asian Woman
...
A prompt for a high-contrast, cinematic close-up portrait of a young East Asian woman with pale skin and long black hair.
...
### No. 118: Cinematic Night Street Portrait on Wet Crosswalk
...
A prompt for a cinematic portrait of a young East Asian woman on a wet crosswalk at night.
...
### No. 119: Close-Up Portrait with Glowing Gold Eyes
...
A prompt for a cinematic close-up portrait of a young East Asian woman with jet-black hair and glowing golden eyes.
...
### No. 120: Photorealistic Portrait with Glasses and Wink
...
A photorealistic portrait of a young East Asian woman with glasses and wavy hair, winking softly.
...
### No. 121: Analog-Film Style Portrait with Tousled Hair
...
A photorealistic analog-film style portrait of a young East Asian woman with messy black hair looking at the camera.
...
### No. 122: Cinematic Portrait Floating in Dark Water
...
A cinematic portrait of a serene young woman floating in still water with wet hair.
...
### No. 123: Studio Beauty Portrait with Side Braid
...
A photorealistic studio beauty portrait of a young East Asian woman with luminous skin, long black hair, and closed eyes.
...
### No. 124: Portrait of Woman in Car with Hijab
...
A photorealistic close-up portrait of a young East Asian woman in a car, wearing a light beige hijab.
...
### No. 125: Woman Taking Selfie in Hijab
...
A prompt to generate an image of a young woman in a light hijab taking a selfie at a wooden table.
...
### No. 126: Portrait of Woman Looking Over Shoulder
...
A detailed prompt for generating a photorealistic portrait of a young East Asian woman looking over her shoulder.
...
### No. 127: Portrait of Woman with Glasses
...
A portrait of a young East Asian woman with glasses, wavy hair, and a calm expression.
...
### No. 128: Close-Up Portrait with Vivid Lipstick
...
A photorealistic portrait of a young East Asian woman with porcelain skin, almond eyes, and vivid lipstick.
...
### No. 129: Portrait with Wet Hair and Bare Shoulder
...
A photorealistic portrait of a young woman with dewy skin and wet black hair looking over her shoulder.
...
### No. 130: Cinematic Portrait of East Asian Woman
...
A close-up portrait of a young East Asian woman with long dark wavy hair against a black background.
...
### No. 131: Photorealistic Portrait with Glasses
...
A photorealistic portrait of a young East Asian woman with long wavy hair, round glasses, and a soft expression.
...
### No. 132: Cinematic Portrait with Honey Highlights
...
A prompt for a cinematic close-up portrait of a young East Asian woman with wavy light brown hair and a calm expression.
...
### No. 133: Photorealistic Portrait with Bob Haircut
...
A photorealistic close-up portrait of a young East Asian woman with a short black bob, smoky eyeshadow, and glowing skin.
...
### No. 134: Portrait of Woman in Hijab and Cap
...
A close-up portrait of a young woman with fair skin and a calm expression, wearing a white hijab and a black baseball cap.
...
### No. 135: Selfie Portrait in Chiffon Hijab
...
A close-up selfie portrait of a young East Asian woman with fair skin and delicate features, wearing a dusty taupe chiffon hijab.
...
### No. 136: Cinematic Portrait of Tearful East Asian Woman
...
A photorealistic close-up portrait of a young woman with glossy, tear-streaked skin and wispy bangs.
...
### No. 137: Portrait of Woman with Jeweled Lace Eyepatch
...
A close-up portrait of a pale-skinned young woman with a black bob, one red eye visible and the other covered by a jeweled black lace eyepatch.
...
### No. 138: Intense Cinematic Portrait with Messy Hair
...
A close-up cinematic portrait of a young woman with long black hair, looking directly at the camera.
...
### No. 139: Close-Up Portrait with Glossy Dark Hair
...
A detailed prompt for generating a portrait of a young woman with fair skin and long dark hair.
...
### No. 140: Smiling Sun-Kissed Portrait with Sweat Sheen
...
A close-up portrait of a young East Asian woman with messy black hair, squinting and smiling with flushed, dewy skin.
...
### No. 141: Expressive Portrait with Winged Eyeliner
...
A detailed prompt for generating a close-up portrait of a young Southeast Asian woman with specific facial features and makeup.
...
### No. 142: Selfie Portrait with Kissing Expression
...
A prompt for a close-up selfie portrait of a young East Asian woman with closed eyes and a relaxed expression.
...
### No. 143: Portrait of Smiling Young Woman
...
A prompt for generating a portrait of a young East Asian or Indonesian woman with a fair complexion, soft makeup, and a gentle, friendly expression.
...
### No. 144: Selfie of Woman with Half-Up Hair
...
A prompt for generating a photorealistic selfie portrait of a young East Asian woman with specific features and styling.
...
### No. 145: Earth Swallowed By Black Hole Phases
...
A prompt to generate four pictures depicting the visual phases of Earth being swallowed by a black hole from a human observer's point of view.
...
### No. 146: Cyberpunk Warrior vs. Mechanical Boss Characters
...
A prompt describing two characters: a cyberpunk katana warrior and a massive mechanical boss entity.
...
### No. 147: Celestial Goddess Descending Before Palace
...
An image of a majestic Chinese celestial goddess in ceremonial hanfu descending through rose-gold clouds before a heavenly palace.
...
### No. 148: Celestial Maiden in Sunlit Three-Quarter View
...
An image of a celestial maiden in ivory hanfu, lit by morning light with flowing ribbons and golden hairpins.
...
### No. 149: Celestial Maiden Seated by Jade Pool
...
An image of a serene Chinese celestial maiden in silk hanfu touching a lotus by a turquoise pool.
...
### No. 150: Celestial Goddess on Jade Palace Steps
...
An image of an elegant Chinese celestial goddess atop white jade steps, wearing embroidered hanfu with drifting silk ribbons.
...
### No. 151: Portrait in Ancient Chinese Ritual Shrine
...
A photorealistic cinematic portrait of an adult East Asian woman in a dark ancient Chinese ritual shrine with Nuo masks and candles.
...
### No. 152: Portrait of Woman in Dark Ritual Shrine
...
A photorealistic cinematic portrait of an East Asian woman with wet black hair and smoky makeup in a dark ancient shrine.
...
### No. 153: Close-Up Portrait at Nighttime Nuo Festival
...
A close-up portrait of an adult East Asian woman beside a weathered Nuo mask during a nighttime ritual festival.
...
### No. 154: Beer with Dense Foam Crown
...
A prompt for generating a photorealistic image of a beer with a dense, cascading foam crown on a sharp-rimmed glass.
...
### No. 155: Tofu Cube Lifted from Stew
...
A descriptive prompt for an image of a porous tofu cube lifted above a pot, with a single amber broth drip attached.
...
### No. 156: Spoonful of Chili Relish
...
An image of a spoonful of chili relish with distinct red chili cubes, tea-darkened greens, bright green pepper, pale beans, and translucent amber-red oil.
...
### No. 157: Close-Up Portrait of Woman in Living Room
...
An ultra-realistic close-up portrait of a young woman with a playful expression in a cozy modern living room.
...
### No. 158: Portrait of Woman Reclining in Dim Bedroom
...
A prompt for a photorealistic vertical portrait of a young woman reclining on bedding in a dimly lit bedroom at night.
...
### No. 159: Dreamy Portrait of Woman in Summer Grass
...
A film-inspired image of a young East Asian woman resting in tall grass, softly lit by warm daylight.
...
### No. 160: Portrait of Woman by Bright Blue Harbor
...
A film-grain style portrait of a young East Asian woman casually crouching by a bright blue harbor on a sunny, breezy day.
...
### No. 161: Paris Street Portrait of Young Woman
...
A prompt for a high-resolution, natural-light street portrait of a young Asian-looking woman on a Paris-inspired shopping street.
...
### No. 162: Candid Subway Portrait at Night
...
A photorealistic candid portrait of an adult East Asian woman sitting by a train window at night.
...
### No. 163: Watch with Ice and Smoke Shockwave
...
An image of a watch with a circular ice-and-smoke shockwave behind it, maintaining a clean silhouette.
...
### No. 164: Layered Bakery Spread with Depth
...
A prompt for generating an image of a premium bakery display with items arranged in distinct height tiers to create depth.
...
### No. 165: Softly Lit Bedroom Portrait in Slip Dress
...
A photorealistic portrait of an adult East Asian woman wearing an ivory satin slip dress in a softly lit bedroom.
...
### No. 166: Car with Explosive Dust Plume Contrast
...
An image of a powerful car generating a massive dust plume behind it while remaining clean and silent in the foreground.
...
### No. 167: Witch Silhouette Backlit by Celestial Fire
...
An image of a witch silhouette backlit by a massive orange-gold celestial fire cloud.
...
### No. 168: Tomato Sauce Heart Rising from Koshari Bowl
...
An image of glossy tomato sauce forming a heart shape above a bowl of koshari.
...
### No. 169: Chess Pieces Sculpted from Noodle Strands
...
A prompt to generate chess pieces sculpted from handcrafted noodle strands with recognizable silhouettes.
...
### No. 170: Sesame Oil Bottle with Boxer Arms in Ring
...
An image of an oversized sesame oil bottle with golden boxer arms standing victorious in a boxing ring.
...
### No. 171: Compact Modern Apartment Kitchen Counter Scene
...
A prompt for generating an image of a compact modern apartment kitchen with a breakfast counter, continuous countertop, stainless steel sink, stovetop, and frying pan.
...
### No. 172: Shawarma Wrap Angled Upward Like a Rocket
...
A prompt to generate an image of a shawarma wrap angled like a rocket, emphasizing the open filling as the focal point.
...
### No. 173: Banana Mascot Holding Oversized Can
...
An image of a running banana mascot holding an oversized cold aluminum can forward toward the camera.
...
### No. 174: East Asian Woman Candid Night Photo
...
A prompt for generating a realistic candid photo of an East Asian woman with specific features and lighting.
...
### No. 175: Cookie Cream as Miniature Skating Surface
...
An image of a cookie where the vanilla creme layer rises to form a smooth miniature skating surface, transforming the scale into a winter world.
...
### No. 176: Roller Coaster Track Made of Stacked Crisps
...
An image of a roller coaster track constructed from perfectly aligned stacked crisps, featuring a full loop.
...
### No. 177: Red Spotlight Zones Behind Hero Bucket
...
An image prompt describing three clean red spotlight zones with secondary lifestyle moments behind a hero bucket.
...
### No. 178: Glossy Noodle Stream as Vertical Motion Line
...
A minimalist poster concept featuring a single glossy noodle stream as the central vertical element.
...
### No. 179: Cinematic 2.5D Gouache Animation
...
A prompt for creating a cinematic 2.5D animation with a painterly, gouache concept-art style featuring visible brush textures and flat color blocks.
...
### No. 180: Moody Cinematic Portrait in Darkness
...
A cinematic portrait of a man with messy hair emerging from shadows, featuring dramatic lighting and ultra-realistic texture.
...
### No. 181: Giant Man Beside Statue of Liberty
...
An ultra-realistic cinematic travel photo of a handsome young man portrayed as a giant standing beside the Statue of Liberty.
...
### No. 182: Golden Hour Portrait on Rustic Porch
...
A warm, candid lifestyle portrait of a young man enjoying tea on a rustic porch during golden hour.
...
### No. 183: Cinematic Portrait in Meadow
...
An ultra-realistic portrait of a woman in a cowboy hat standing in a green meadow with sagebrush and pine trees.
...
### No. 184: Vertical Candid Portrait of Woman
...
A prompt for generating a vertical candid photograph of a young East Asian woman with specific features.
...
### No. 185: Diagonal Bar with Torn Flavor Zone
...
A prompt for generating an image of a diagonally packaged dessert bar with a torn wrapper, creating an open-mouth effect within a dessert-themed world.
...
### No. 186: Female Portrait in Oval Mirror
...
A beauty portrait of a woman reflected in a vertical oval mirror, featuring matte cobalt lipstick.
...
### No. 187: Pint Glass Vortex in Desert
...
A surreal image of a towering pint glass emerging from the desert as a twisting vortex of sand and beer.
...
### No. 188: Beer Bottle in Foreground
...
A prompt for an image featuring a large, sharp, partially cropped real beer bottle in the lower-right foreground.
...
### No. 189: Mondrian Painting as Desktop Storage Cabinet
...
A prompt to transform Mondrian's 'Composition with Red, Blue and Yellow' into a functional desktop storage cabinet with colored drawers.
...
### No. 190: Realistic Image of a Surreal Thing
...
A prompt to generate a highly realistic image of an imagined surreal subject.
...
### No. 191: Tiny Humans In A Tangerine World
...
An image of minuscule humans living inside a tangerine, with fruit segments forming architecture.
...
### No. 192: Menacing Figure in Sharp Profile
...
A prompt for generating an image of a menacing figure with raven-black hair and blood-red lips in sharp profile.
...
### No. 193: Fictional Dating App Advertisement
...
A prompt to generate an advertisement for a dating app featuring young Kalenjin models.
...
### No. 194: Rooftop Radio Portrait Before Sunrise
...
A prompt to generate a portrait of a weathered face on a rooftop with a radio before sunrise.
...
### No. 195: Empty Fushimi Inari Tunnel at Dawn
...
A prompt for generating a serene, early morning scene of the iconic vermillion gates at Kyoto's Fushimi Inari shrine, styled as a travel campaign image.
...
### No. 196: Inner World Based on AI Art Preferences
...
A prompt requesting an illustration that reflects the user's inner world based on their past AI art preferences.
...
### No. 197: Macro Shot Of Futuristic City Processor
...
A prompt for a macro shot of a transparent, room-sized processor containing a glowing city.
...
### No. 198: Symbolic Self-Portrait Of Language And Code
...
An image depicting a symbolic self-portrait where language, code, and creativity are interconnected by light.
...
### No. 199: Alien World With Mediterranean Retro-Futurism
...
A prompt for generating an image of a human settlement on an alien world featuring Mediterranean-inspired architecture with retro-futurist elements.
...
### No. 200: Portrait of the Cryo Archon Tsaritsa Anastasya
...
A prompt to generate a portrait of the Tsaritsa, a Cryo Archon and sovereign, described with various regal and sorrowful titles.
...
### No. 201: Bus Stop In The Morning Mist
...
A poetic image of a bus stop in morning fog, where steam rises before anyone arrives, and the earliest train is a thought within.
...
### No. 202: Laundromat Night With Jellyfish And Cosmic Forecast
...
A scene depicting a night-time laundromat with jellyfish outside, where a girl checks a cosmic weather forecast.
...
### No. 203: Wuxia Female Warrior Portrait
...
A prompt for generating a 9:16 portrait of a tall, elegant East Asian female warrior in layered armor and robes, wielding a long sword.
...
### No. 204: Rural Retro Phone Photo of Woman
...
A prompt for a 9:16 image depicting a young East Asian woman in a rural setting, captured with a retro phone aesthetic.
...
### No. 205: Two Women in Qipao in Chinese Garden
...
A prompt for generating a hyper-realistic photo of two young East Asian women in new Chinese-style qipaos sitting in a serene traditional garden.
...
### No. 206: Selfie of a Dancer in Grey Tones
...
A prompt for a 9:16 vertical, realistic close-up selfie of a young East Asian dancer in a cool, dreamy, high-end gray lifestyle style.
...
### No. 207: K-Pop Concert Stage Editorial Photography
...
A prompt for a cinematic, editorial-style photo of a 20-year-old K-pop female idol at a concert.
...
### No. 208: Elegant East Asian Woman At Stone Balcony
...
A prompt for a 9:16 vertical fashion photo of a beautiful adult East Asian woman leaning against a classical stone railing.
...
### No. 209: Painterly Landscape with Dramatic Cumulus Clouds
...
A prompt for generating a detailed, romantic fine-art landscape focused on a luminous sky and towering clouds.
...
### No. 210: Link Chased By Puppet Chickens
...
An image of Link being chased by an angry flock of fluffy puppet chickens through Kakariko Village.
...
### No. 211: Bali Rice Terraces At Dawn
...
An image prompt for a serene, misty morning scene of Bali's rice terraces, styled like a travel campaign.
...
### No. 212: Prince Of Persia Jumping Pixel Art
...
A prompt to generate an image in the style of Cobalt Dither Monumentalism, depicting the original Prince of Persia character jumping across platforms.
...
### No. 213: Gentle Shinigami Guiding Souls
...
A poetic prompt describing a girl, a reaper of death, standing at the boundary between life and death in a cold night mist, offering a hand as a guide for a quiet farewell.
...
### No. 214: Gold Talismans In The Dark Night
...
A scene of night sinking into black, where only gold illuminates a talismanic presence, featuring the words 'Night Walk' and 'Suppress Evil'.
...
### No. 215: Bride's Dream At The Boundary
...
A poetic prompt describing a non-human girl at the boundary of life and death dreaming of becoming a bride and seeing her own reflection.
...
### No. 216: Yokai Reading In A Rainy Room
...
A scene of a feared being, Fufu, reading a book in an old room on a rainy day, with a small bird that has wandered in.
...
### No. 217: Pixel Art Sprite Sheet of Fox Character
...
A prompt to generate a polished pixel-art animation sprite sheet of a character named Noxa, a tiny fox who collects stars.
...
### No. 218: Apple Foldable Phone Concept Infographic
...
A prompt for generating a photorealistic infographic of an Apple foldable phone in the brand's signature clean style.
...
### No. 219: Close-Up Beauty Portrait of Young East Asian Woman
...
A close-up photorealistic portrait of a young East Asian woman with soft lighting and detailed skin texture.
...
### No. 220: Asian Woman at Coastal Road Sunset
...
A photorealistic candid photo of a young Asian woman beside a coastal road at sunset, viewed from inside a car.
...
### No. 221: Water-Level Macro of Lotus Leaf Island
...
A prompt for a cinematic macro shot from water level, depicting a lotus leaf as an island inhabited by three tiny figures in Hanfu.
...
### No. 222: Giant Three-Pronged Claw with Katana Edge
...
A prompt for a giant two-handed weapon featuring three prongs with blades sharpened and polished like a Japanese sword.
...
### No. 223: Ambassador of a Season in Morning Light
...
A poetic prompt describing an ambassador for a season with morning light, magazine skin, and glass thin enough not to hide.
...
### No. 224: Geometric Gold Crown Profile Portrait
...
An image prompt for a commanding figure in sharp profile wearing a crown of geometric gold discs over coiled dark hair.
...
### No. 225: Radiant Princess with Diamond Tiara
...
An AI image prompt for a radiant figure wearing an oversized diamond tiara in sharp profile.
...
### No. 226: Close-Up Portrait of an East Asian Woman in Wuxia Style
...
A hyper-realistic portrait of a young East Asian woman in a wuxia style with extreme wide-angle perspective.
...
### No. 227: Full-Body Portrait of a Woman in Casual Home Setting
...
A prompt for a 9:16 vertical, full-body, hyper-realistic photo of a young East Asian woman in a lazy home atmosphere with warm cinematic tones.
...
### No. 228: Chibi Character Sprite Sheet with 16 Poses
...
A prompt for generating a 4x4 grid sprite sheet of a chibi character with various poses.
...
### No. 229: Photorealistic Smartphone Selfie in Bedroom
...
A photorealistic landscape smartphone selfie of a young East Asian woman relaxing on a bed at night.
...
### No. 230: 3D Miniature Country from Iconic Landmarks
...
A prompt to generate a 3D miniature map where a country's border is composed of its iconic landmarks and cultural symbols.
...
### No. 231: Cinematic Portrait of a Woman in Paris
...
A prompt for an ultra-realistic cinematic photo of a Southeast Asian hijabi woman walking near the Eiffel Tower.
...
### No. 232: Animals Rebuilt with Luxury Fashion Fabrics
...
A prompt to generate a 2x2 grid of animals reconstructed using the signature fabrics of four iconic luxury fashion houses.
...
### No. 233: Premium Smartphone Campaign Poster
...
A prompt for generating a high-end smartphone promotional poster in Apple's signature style.
...
### No. 234: Modern Travel Poster with Architecture
...
A prompt for creating a premium travel poster with a vintage screen-print style and architectural portal composition.
...
### No. 235: Stop Motion Claymation Charmander Hatching
...
A prompt for creating a stop-motion animation of a clay-style Charmander hatching from an egg and breathing fire.
...
### No. 236: Magritte's Apple as a Notepad Stack
...
A creative reinterpretation of Magritte's 'The Son of Man' where the floating apple is replaced by a stack of apple-shaped paper notes.
...
### No. 237: Hyperrealistic Fashion Portrait in Japanese House
...
A hyperrealistic fashion portrait of a woman walking in a traditional Japanese wooden corridor.
...
### No. 238: Ultra-Minimal Roman Empire Wallpaper
...
An ultra-minimal wallpaper depicting a grand Roman temple with columns, aqueducts, and ruins in warm golden tones.
...
### No. 239: Anime Frame of Rainy Train Platform
...
A prompt to generate a non-existent anime frame featuring rain on a platform, an arriving train, and a koi fish drifting over a city.
...
### No. 240: Person Befriending a Cat Amid Chaos
...
A scene depicting someone who, after getting involved in various things, ends up befriending a cat.
...
### No. 241: Fox Jellyfish in Highland Aquarium
...
An image of a sleepy-eyed fox and jellyfish inside an aquarium on a highland, rendered in a style without grainy light particles.
...
### No. 242: Woman in Kimono Eating Beef Tongue Rice
...
An image of a woman in a kimono, with a scene depicting a meal of beef tongue and barley rice.
...
### No. 243: Candid Photo of Woman in Cozy Night Living Room
...
A prompt for a photorealistic candid photo of a young woman in a cozy nighttime living room setting.
...
### No. 244: Chuunibyou Woman In Gothic Lolita
...
An anime-style image of a chuunibyou woman with Jirai Make wearing a Gothic Lolita outfit with shoulder cutout tops and a corset long dress.
...
### No. 245: Woman Staying With Dying Ex-Boyfriend
...
A prompt describing a woman who learns her ex-boyfriend left her because he is dying and decides to stay with him until the end.
...
### No. 246: Portrait Of A Woman In Uniform
...
A poetic prompt describing a character named Rhiannah with a geometric uniform, an ice-blue eye, squared shoulders, and red lips.
...
### No. 247: Indigo Dye Workshop In Jiangnan
...
An image prompt for a Jiangnan dye workshop scene featuring blue dye, wooden frames, a stone bridge, and morning light on water.
...
### No. 248: Close-Up Portrait With Braided Hair
...
A 16:9 photorealistic wallpaper portrait of a fair-skinned young woman with freckles, blue eyes, and braided white-blonde hair.
...
### No. 249: Photorealistic Candid Portrait of a Sailor
...
A 35mm-style candid of an elderly sailor adjusting his net, with real skin and material texture.
...
### No. 250: Period-Accurate 1969 Crowd Scene
...
A photoreal outdoor crowd in Bethel, New York on a named 1969 date, staged period-accurately.
...
### No. 251: Nostalgic Christmas Card with Teddy Bear
...
A print-quality holiday card built on a keepsake-box scene with one verbatim line of card text.
...
### No. 252: Vintage Toy Airplane Collectible in Blister Pack
...
A retail-style collectible shot in blister packaging with one verbatim packaging line.
...
### No. 253: Cloud Post Office in a Healing Picture Book Style
...
A whimsical scene of a soft cloud transformed into a post office where small animals in uniforms sort letters, rendered in a soft, healing picture-book style.
...
### No. 254: Hyper-Realistic Cinematic Portrait on a Motorcycle
...
A hyper-realistic cinematic portrait of a stylish bearded man on a custom motorcycle.
...
### No. 255: High-Fashion Black and White Editorial Portrait
...
A prompt for creating a black and white high-fashion portrait of a young man with curly hair and layered clothing.
...
### No. 6: Art Deco Poster in Gold and Navy
...
An Art Deco poster illustration in a square format with elegant gold and navy line work on cream paper.
...
### No. 7: Hyper-Realistic Enamel Pin Collection
...
A prompt for creating a collection of eight premium enamel pins with gold outlines and glossy surfaces on a dark background.
...
### No. 8: Dark SaaS Analytics Dashboard UI
...
A prompt for generating a dark-themed SaaS analytics dashboard interface with specific labels and UI elements.
...
### No. 9: Creative Design Company Website Screenshot
...
A prompt to generate a full, front-facing, perspective-free desktop webpage screenshot for a creative design company's Chinese website.
...
### No. 10: Ancient Chinese Fashion Photography Grid
...
A prompt for generating a professional, high-end ancient Chinese fashion photography series depicting the full dressing process of Song Yu in a Song Dynasty boudoir, arranged in a strict 3x3 grid.
...
### No. 11: Analog Clock, Burger, and Drink
...
A prompt to generate an image of an analog clock showing 15:32, a burger with grilled golden provolone cheese, and a glass.
...
### No. 12: Square Blue-White Phone and Cards Layout
...
A square SNS image with blue and white colors, featuring one smartphone, three image cards, a Japanese title, wide margins, and no additional text.
...
### No. 13: Physics Textbook Chapter on Electromagnetism
...
A prompt to generate a chapter on electromagnetism for a physics book in Spanish.
...
### No. 14: One-Page Manga on Space Development
...
A prompt to generate a one-page, vertical, black-and-white comic about space development.
...
### No. 15: Isometric Glass Cube with Colored Spheres
...
An isometric perspective of a transparent glass cube containing a red ball at the top-left-back and a blue ball at the bottom-right-front, with a green ball above the cube and a yellow column passing through from bottom-left to top-right.
...
### No. 16: Typography Poster and Magazine Cover
...
A prompt for generating a typographic poster with a model list and a magazine cover with masthead and coverlines.
...
### No. 17: Vertical Luxury Watch Advertisement
...
A prompt for a vertical luxury ad featuring a large watch in a dark emerald studio.
...
### No. 18: Character Design Reference Sheet
...
A prompt for generating a painterly character design reference sheet with construction lines and a specific layout.
...
### No. 19: Split-Screen Character Bible Sheet
...
A prompt to generate a premium split-screen character sheet for two original characters.
...
### No. 20: Corporate Portrait Collage Composition
...
An ultra-realistic corporate portrait collage featuring a three-layer composition of a man.
...
### No. 21: Photo and Illustration Split Composition
...
A prompt to create a vertical image combining an original photo with a hand-drawn illustration of the same scene.
...
### No. 22: Split Screen Character Bible Sheet
...
A prompt for creating a split-screen character sheet with a bold central divider and a neon watercolor background.
...
### No. 23: Adventurers Planning in a Tavern Comic
...
A prompt for generating a two-page color manga of adventurers discussing a dungeon challenge in a tavern, with dialogue and sound effects.
...
### No. 24: Espresso Machine Technical Drawing
...
A technical diagram of a domestic espresso machine in a 1960s mechanical drawing style.
...
### No. 25: Modern SaaS Dashboard UI for AI Platform
...
A prompt for generating a high-resolution 4K modern SaaS dashboard interface for an AI analytics platform with a sleek dark mode aesthetic.
...
### No. 26: Dark Fantasy RPG Inventory User Interface
...
A prompt for generating a high-resolution dark fantasy RPG inventory interface featuring an armored paladin.
...
### No. 27: Sushi Poster with Recessed Wordmark
...
A prompt for a poster featuring a large, recessed deep-red wordmark in the background that does not overlap with a sushi silhouette.
...
### No. 28: Product Packaging in Three Zones
...
A prompt to visualize a product carton in three stages: as an isolated hero, in ingredient context, and beside the finished dish.
...
### No. 29: Product Shot with Perimeter Ingredients
...
A prompt for an image featuring a central product pouch surrounded by bowls, berries, grains, and leaves, with a clear vertical corridor.
...
### No. 30: Grid of Identical Coffee Menu Posters
...
A prompt for designing a collectible coffee menu poster with consistent black fields, cup scale, title zone, microcopy, and brass clips.
...
### No. 31: 3D Billboard with Product Breaking Plane
...
A prompt for a 3D billboard visual where a hero tub projects beyond the inner plane with contact shadows.
...
### No. 32: Three-Cone Lineup with Central Hero
...
A prompt for a composition featuring three flavor cones where the central pistachio cone is dominant and the side cones are angled framing elements.
...
### No. 33: Stacked Panels with Consistent Layout
...
A prompt for generating five stacked panels with a consistent brand layout including logo, headline column, badge, and product composition.
...
### No. 34: Horizontal Tasting Acts with Dish Names
...
A prompt for a poster depicting four horizontal acts, each featuring a black bowl with steam and an oversized brush-script dish name.
...
### No. 35: Social Post Interface Cutting Through Sauce
...
A prompt for an image featuring a minimal black social-post interface band cutting horizontally through a stream of sauce.
...
### No. 36: Vertical Split Composition Poster
...
A prompt for a poster with a vertical split showing a clean natural side versus a dark side with hidden ingredients.
...
### No. 37: Chocolate Liquid Arcs Framing Product
...
A prompt for a premium product poster featuring two restrained dark chocolate liquid arcs framing the product in symmetrical orbit motion.
...
### No. 38: Two Hero Bars Crossing Diagonally
...
A prompt describing two packaged product bars crossing diagonally through the center in opposite directions.
...
### No. 39: Three Bowls Arranged Diagonally
...
A prompt for an image of three bowls arranged diagonally from the foreground to the background.
...
### No. 40: Instagram Travel Campaign with Smartphone Anchor
...
A prompt for creating a premium Instagram travel ad featuring a modern smartphone as a visual anchor.
...
### No. 41: Vertical Social Poster for Collectible Figure
...
A prompt for a high-resolution vertical social media poster advertising a premium collectible figure with bold typography and a flat yellow background.
...
### No. 42: Hierarchical Book Cover Design
...
A prompt for designing a book cover with strong typographic hierarchy and readability.
...
### No. 43: Neuroscience Conference Poster
...
A prompt to generate a conference poster for a 2026 neuroscience meeting based on provided paper and regulations.
...
### No. 44: Floating Diorama Grid Of Iconic Cities
...
A prompt to generate a 2x2 grid of floating city dioramas suspended in a grey studio.
...
### No. 45: Satirical System Poster Grid On Frustrating Topics
...
A prompt for a 2x2 grid of satirical editorial posters on frustrating topics.
...
### No. 46: Paper Diorama Travel Poster Template
...
A prompt for creating a premium vertical travel poster depicting a city landmark as a detailed handmade paper diorama.
...
### No. 47: Cinematic Character Sheet For Calvin & Bob
...
A prompt for creating a split-screen character sheet with a watercolor background.
...
### No. 48: Cinematic Character Bible Sheet For Sofia
...
A prompt to generate a premium character sheet featuring bold typography and a dramatic hero image of a barista named Sofia.
...
### No. 49: Dramatic Literary Propaganda Wall Covers
...
A prompt to generate a 2x2 grid of dramatic propaganda-style wall covers for four public domain books.
...
### No. 50: Conceptual Cutaway Dioramas for Four Brands
...
A prompt to generate a 2x2 grid of conceptual cutaway dioramas for four Fortune 500 companies.
...
### No. 51: Kids Footwear Ad Poster with Girl and Giant Sneaker
...
A prompt for generating a joyful advertisement poster featuring a girl and a giant sneaker.
...
### No. 52: Luxury Perfume Commercial Storyboard
...
A prompt for a cinematic product storyboard featuring a luxury rose perfume in a clean editorial layout.
...
### No. 53: Luxury Perfume Commercial Storyboard
...
A prompt for a cinematic product commercial storyboard featuring a luxury rose perfume.
...
### No. 54: Technical Exploded View Grid
...
A prompt for generating a 2x2 grid of technical illustrations showing exploded 3D views of complex machines.
...
### No. 55: Full-Page Color Comic Illustration
...
A prompt to generate a full-page, colorful, and humorous shonen manga illustration using authentic comic page composition.
...
### No. 56: Technical Infographic of a Coffee Machine
...
An explanatory infographic tracing the flow of an automatic espresso machine end to end.
...
### No. 57: Streetwear Campaign Ad with Exact Tagline
...
A youth streetwear campaign image that renders one exact tagline, legibly, inside the layout.
...
### No. 58: Minimal Bakery Logo on Transparent Background
...
A flat, vector-like bakery logo delivered centered on clean alpha with no backdrop.
...
### No. 59: Four-Panel Comic of a Pet Home Alone
...
A vertical four-panel strip carrying a beginning, turn and punchline across panels.
...
### No. 60: Farmers Market App UI in an iPhone Frame
...
A practical mobile app mockup with header, vendor list and specials, placed in a device frame.
...
### No. 61: Cellular Respiration Classroom Diagram
...
A labelled high-school biology diagram connecting glycolysis, Krebs cycle and electron transport.
...
### No. 62: Series A Market Opportunity Slide
...
A pitch-deck slide with a TAM/SAM/SOM diagram, growth bars, footnotes and real data hierarchy.
...
### No. 63: Billboard Mockup with Exact Headline
...
A highway billboard mockup carrying one verbatim headline in bold sans-serif.
...
### No. 64: Manga Panel With Speech Bubbles
...
A manga-style image of a girl saying "Hey, listen!" and a boy covering her speech bubble with his thought bubble saying "I'll pretend I didn't hear that", drawn in a vertical 4:5 aspect ratio.
...
### No. 65: Manga Panel Girl Bites Speech Bubble
...
A manga-style scene of a boy saying "We won't fight?" and a fierce-looking girl biting his speech bubble.
...
### No. 66: Fashion Decades Editorial Grid
...
A prompt to generate a 2x2 grid visualizing four fashion movements from different decades in a 16:9 editorial poster style.
...
### No. 67: Systems Of Government Grid
...
A prompt to generate a 2x2 grid image visualizing four different systems of government in a pastel storybook style.
...
### No. 68: Heroic Legacy Poster For Chess Player
...
A prompt to generate a 2x2 grid of heroic illustrated tribute posters for four deceased chess legends.
...
- [Atlas Cloud GPT Image 2.5 Flare text-to-image](https://www.atlascloud.ai/models/openai/gpt-image-2.5-flare/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Flare edit](https://www.atlascloud.ai/models/openai/gpt-image-2.5-flare/edit?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
- [Atlas Cloud GPT Image 2.5 Sunburst text-to-image](https://www.atlascloud.ai/models/openai/gpt-image-2.5-sunburst/text-to-image?utm_source=github&utm_campaign=awesome-gpt-image-2.5-prompts)
